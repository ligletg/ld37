...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("assets/images/enemy-immortanjoe.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/enemy-zorg.png", "assets/images/enemy-zorg.png");
			type.set ("assets/images/enemy-zorg.png", Reflect.field (AssetType, "image".toUpperCase ()));
