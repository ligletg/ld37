...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "myapp", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "myapp";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "myapp", null, { width: 1280, height: 1024 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 1280, height: 1024 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 1280, 1024, "null");
		#end
		#else
		create ();
		#end
