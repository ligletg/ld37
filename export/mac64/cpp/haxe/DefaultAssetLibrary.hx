...
@:sound("/usr/local/lib/haxe/lib/flixel/4,2,0/assets/sounds/beep.ogg") @:keep #if display private #end class __ASSET__flixel_sounds_beep_ogg extends flash.media.Sound {}
@:sound("/usr/local/lib/haxe/lib/flixel/4,2,0/assets/sounds/flixel.ogg") @:keep #if display private #end class __ASSET__flixel_sounds_flixel_ogg extends flash.media.Sound {}
@:font("/usr/local/lib/haxe/lib/flixel/4,2,0/assets/fonts/nokiafc22.ttf") @:keep #if display private #end class __ASSET__flixel_fonts_nokiafc22_ttf extends flash.text.Font {}
@:font("/usr/local/lib/haxe/lib/flixel/4,2,0/assets/fonts/monsterrat.ttf") @:keep #if display private #end class __ASSET__flixel_fonts_monsterrat_ttf extends flash.text.Font {}
@:bitmap("/usr/local/lib/haxe/lib/flixel/4,2,0/assets/images/ui/button.png") @:keep #if display private #end class __ASSET__flixel_images_ui_button_png extends flash.display.BitmapData {}
@:bitmap("/usr/local/lib/haxe/lib/flixel/4,2,0/assets/images/logo/default.png") @:keep #if display private #end class __ASSET__flixel_images_logo_default_png extends flash.display.BitmapData {}
...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/images/enemy-immortanjoe.png", "assets/images/enemy-immortanjoe.png");
		type.set ("assets/images/enemy-immortanjoe.png", AssetType.IMAGE);
		path.set ("assets/images/enemy-zorg.png", "assets/images/enemy-zorg.png");
		type.set ("assets/images/enemy-zorg.png", AssetType.IMAGE);
		...
		id = "assets/images/enemy-immortanjoe.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/enemy-zorg.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
...
@:file("/usr/local/lib/haxe/lib/flixel/4,2,0/assets/sounds/beep.ogg") #if display private #end class __ASSET__flixel_sounds_beep_ogg extends lime.utils.ByteArray {}
@:file("/usr/local/lib/haxe/lib/flixel/4,2,0/assets/sounds/flixel.ogg") #if display private #end class __ASSET__flixel_sounds_flixel_ogg extends lime.utils.ByteArray {}
