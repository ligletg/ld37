...
class HXCPP_CLASS_ATTRIBUTES TiledMap_obj : public hx::Object
{
	...
	public:
		...
		static hx::ObjectPtr< TiledMap_obj > __new( ::Dynamic data,::String __o_rootPath);
		static hx::ObjectPtr< TiledMap_obj > __alloc(hx::Ctx *_hx_ctx, ::Dynamic data,::String __o_rootPath);
