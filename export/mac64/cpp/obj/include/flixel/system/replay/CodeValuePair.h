...
class HXCPP_CLASS_ATTRIBUTES CodeValuePair_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< CodeValuePair_obj > __new(int code,int value) {
			hx::ObjectPtr< CodeValuePair_obj > __this = new CodeValuePair_obj();
			__this->__construct(code,value);
			return __this;
		}

		static hx::ObjectPtr< CodeValuePair_obj > __alloc(hx::Ctx *_hx_ctx,int code,int value) {
