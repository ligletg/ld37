...
HX_DECLARE_STACK_FRAME(_hx_pos_fa93722f50df8cd4_30_new)
...
class HXCPP_CLASS_ATTRIBUTES MouseRecord_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< MouseRecord_obj > __new(int x,int y,int button,int wheel) {
			hx::ObjectPtr< MouseRecord_obj > __this = new MouseRecord_obj();
			__this->__construct(x,y,button,wheel);
			return __this;
		}

		static hx::ObjectPtr< MouseRecord_obj > __alloc(hx::Ctx *_hx_ctx,int x,int y,int button,int wheel) {
...
HXLINE(  31)		( ( ::flixel::_hx_system::replay::MouseRecord)(__this) )->x = x;
HXLINE(  32)		( ( ::flixel::_hx_system::replay::MouseRecord)(__this) )->y = y;
HXLINE(  33)		( ( ::flixel::_hx_system::replay::MouseRecord)(__this) )->button = button;
HXLINE(  34)		( ( ::flixel::_hx_system::replay::MouseRecord)(__this) )->wheel = wheel;
            	}
