...
HX_DECLARE_STACK_FRAME(_hx_pos_102f69689d37b2bb_210_new)
...
HXLINE( 212)		( ( ::haxe::Timer)(__this) )->mTime = time;
HXLINE( 213)		::haxe::Timer_obj::sRunningTimers->push(__this);
HXLINE( 214)		Float _hx_tmp = ::haxe::Timer_obj::getMS();
HXDLIN( 214)		( ( ::haxe::Timer)(__this) )->mFireAt = (_hx_tmp + ( ( ::haxe::Timer)(__this) )->mTime);
HXLINE( 215)		( ( ::haxe::Timer)(__this) )->mRunning = true;
            	}
