...
class HXCPP_CLASS_ATTRIBUTES Enemy_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		void __construct( ::Dynamic __o_X, ::Dynamic __o_Y,::String EType);
		...
		static hx::ObjectPtr< Enemy_obj > __new( ::Dynamic __o_X, ::Dynamic __o_Y,::String EType);
		static hx::ObjectPtr< Enemy_obj > __alloc(hx::Ctx *_hx_ctx, ::Dynamic __o_X, ::Dynamic __o_Y,::String EType);
