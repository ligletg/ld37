...
HX_DEFINE_STACK_FRAME(_hx_pos_629439de4a709677_1_boot,"__ASSET__flixel_sounds_beep_ogg","boot",0x46b5879a,"__ASSET__flixel_sounds_beep_ogg.boot","?",1,0x0000003f)
...
HXLINE(2287)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::__ASSET__flixel_sounds_beep_ogg_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:sound___ASSET__flixel_sounds_beep_ogg",ac,ee,6e,4e);
            	}
}
