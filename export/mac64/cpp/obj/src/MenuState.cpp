...
HX_DEFINE_STACK_FRAME(_hx_pos_1f119275e66a7b90_14_create,"MenuState","create",0xe57b7c18,"MenuState.create","MenuState.hx",14,0xdfbcb22c)
HX_DEFINE_STACK_FRAME(_hx_pos_1f119275e66a7b90_24_clickPLay,"MenuState","clickPLay",0x5f5256a0,"MenuState.clickPLay","MenuState.hx",24,0xdfbcb22c)
HX_DEFINE_STACK_FRAME(_hx_pos_1f119275e66a7b90_29_update,"MenuState","update",0xf0719b25,"MenuState.update","MenuState.hx",29,0xdfbcb22c)
...
void MenuState_obj::create(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  16)		this->_btnPlay =  ::flixel::ui::FlxButton_obj::__alloc( HX_CTX ,(int)0,(int)0,HX_("Play !",15,23,4d,6c),this->clickPLay_dyn());
HXLINE(  17)		this->_btnPlay->screenCenter(null());
HXLINE(  18)		this->add(this->_btnPlay);
HXLINE(  19)		this->super::create();
            	}


void MenuState_obj::clickPLay(){
            	HX_GC_STACKFRAME(&_hx_pos_1f119275e66a7b90_24_clickPLay)
            	HX_STACK_THIS(this)
HXLINE(  24)		HX_VARI(  ::flixel::FlxState,nextState) =  ::PlayState_obj::__alloc( HX_CTX ,null());
...
void MenuState_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_1f119275e66a7b90_29_update)
            	HX_STACK_THIS(this)
...
static ::String MenuState_obj_sMemberFields[] = {
	...
	HX_HCSTRING("clickPLay","\x3c","\x52","\x41","\x29"),
