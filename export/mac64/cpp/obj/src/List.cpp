...
HX_DEFINE_STACK_FRAME(_hx_pos_ddfdb35c92fd9637_52_add,"List","add",0xed7f2231,"List.add","/usr/local/lib/haxe/std/List.hx",52,0xdb880ee3)
HX_DEFINE_STACK_FRAME(_hx_pos_ddfdb35c92fd9637_67_push,"List","push",0xebb5efca,"List.push","/usr/local/lib/haxe/std/List.hx",67,0xdb880ee3)
HX_DEFINE_STACK_FRAME(_hx_pos_ddfdb35c92fd9637_114_isEmpty,"List","isEmpty",0xaa565653,"List.isEmpty","/usr/local/lib/haxe/std/List.hx",114,0xdb880ee3)
HX_DEFINE_STACK_FRAME(_hx_pos_ddfdb35c92fd9637_137_remove,"List","remove",0x4b44d634,"List.remove","/usr/local/lib/haxe/std/List.hx",137,0xdb880ee3)
HX_DEFINE_STACK_FRAME(_hx_pos_ddfdb35c92fd9637_161_iterator,"List","iterator",0x2d4cdfde,"List.iterator","/usr/local/lib/haxe/std/List.hx",161,0xdb880ee3)
...
HXLINE(  53)		HX_VARI(  ::_List::ListNode,x) =  ::_List::ListNode_obj::__alloc( HX_CTX ,item,null());
...
void List_obj::push( ::Dynamic item){
            	HX_GC_STACKFRAME(&_hx_pos_ddfdb35c92fd9637_67_push)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(item,"item")
HXLINE(  68)		HX_VARI(  ::_List::ListNode,x) =  ::_List::ListNode_obj::__alloc( HX_CTX ,item,this->h);
HXLINE(  69)		this->h = x;
...
bool List_obj::isEmpty(){
            	HX_STACKFRAME(&_hx_pos_ddfdb35c92fd9637_114_isEmpty)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(List_obj,remove,return )
 ...
 ::_List::ListIterator List_obj::iterator(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 161)		return  ::_List::ListIterator_obj::__alloc( HX_CTX ,this->h);
            	}
