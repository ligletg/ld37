...
HX_DEFINE_STACK_FRAME(_hx_pos_3e7f1148457df64b_31_requestContext3D,"openfl.display.Stage3D","requestContext3D",0x80c219da,"openfl.display.Stage3D.requestContext3D","openfl/display/Stage3D.hx",31,0x37141b9b)
HX_DEFINE_STACK_FRAME(_hx_pos_3e7f1148457df64b_27_requestContext3D,"openfl.display.Stage3D","requestContext3D",0x80c219da,"openfl.display.Stage3D.requestContext3D","openfl/display/Stage3D.hx",27,0x37141b9b)
namespace openfl{
namespace display{
...
HXLINE(  27)		HX_VARI(  ::openfl::display::Stage3D,_gthis) = hx::ObjectPtr<OBJ_>(this);
