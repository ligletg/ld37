...
HX_DEFINE_STACK_FRAME(_hx_pos_c1a0d6ee9eb05388_17_clone,"openfl.events.IOErrorEvent","clone",0xfbdc4afe,"openfl.events.IOErrorEvent.clone","openfl/events/IOErrorEvent.hx",17,0x9ba976af)
HX_DEFINE_STACK_FRAME(_hx_pos_c1a0d6ee9eb05388_32_toString,"openfl.events.IOErrorEvent","toString",0xfbbd53ab,"openfl.events.IOErrorEvent.toString","openfl/events/IOErrorEvent.hx",32,0x9ba976af)
...
HX_DEFINE_STACK_FRAME(_hx_pos_c1a0d6ee9eb05388_7_boot,"openfl.events.IOErrorEvent","boot",0xd28edbb1,"openfl.events.IOErrorEvent.boot","openfl/events/IOErrorEvent.hx",7,0x9ba976af)
namespace openfl{
namespace events{
...
bool IOErrorEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_legacy::events::Event IOErrorEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  19)		HX_VARI(  ::openfl::events::IOErrorEvent,event) =  ::openfl::events::IOErrorEvent_obj::__alloc( HX_CTX ,this->get_type(),this->get_bubbles(),this->get_cancelable(),this->text,this->errorID);
HXLINE(  20)		event->set_target(this->get_target());
HXLINE(  21)		event->set_currentTarget(this->get_currentTarget());
...
::String IOErrorEvent_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  32)		return this->_hx___formatToString(HX_("IOErrorEvent",b8,16,b3,65),::Array_obj< ::String >::fromData( _hx_array_data_1ffe394f_3,5));
            	}
