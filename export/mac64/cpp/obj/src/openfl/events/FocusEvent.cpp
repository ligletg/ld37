...
HX_DEFINE_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_31_clone,"openfl.events.FocusEvent","clone",0x40033148,"openfl.events.FocusEvent.clone","openfl/events/FocusEvent.hx",31,0xe559e625)
HX_DEFINE_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_46_toString,"openfl.events.FocusEvent","toString",0x8b53f7a1,"openfl.events.FocusEvent.toString","openfl/events/FocusEvent.hx",46,0xe559e625)
...
HX_DEFINE_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_10_boot,"openfl.events.FocusEvent","boot",0x10dacca7,"openfl.events.FocusEvent.boot","openfl/events/FocusEvent.hx",10,0xe559e625)
HX_DEFINE_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_11_boot,"openfl.events.FocusEvent","boot",0x10dacca7,"openfl.events.FocusEvent.boot","openfl/events/FocusEvent.hx",11,0xe559e625)
HX_DEFINE_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_12_boot,"openfl.events.FocusEvent","boot",0x10dacca7,"openfl.events.FocusEvent.boot","openfl/events/FocusEvent.hx",12,0xe559e625)
HX_DEFINE_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_13_boot,"openfl.events.FocusEvent","boot",0x10dacca7,"openfl.events.FocusEvent.boot","openfl/events/FocusEvent.hx",13,0xe559e625)
namespace openfl{
namespace events{
...
bool FocusEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_legacy::events::Event FocusEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  33)		HX_VARI(  ::openfl::events::FocusEvent,event) =  ::openfl::events::FocusEvent_obj::__alloc( HX_CTX ,this->get_type(),this->get_bubbles(),this->get_cancelable(),this->relatedObject,this->shiftKey,this->keyCode);
HXLINE(  34)		event->set_target(this->get_target());
HXLINE(  35)		event->set_currentTarget(this->get_currentTarget());
HXLINE(  39)		return event;
            	}
...
::String FocusEvent_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  46)		return this->_hx___formatToString(HX_("FocusEvent",42,6d,d7,2e),::Array_obj< ::String >::fromData( _hx_array_data_ade3ec19_3,6));
            	}
...
HXLINE(  10)		FOCUS_IN = HX_("focusIn",dd,45,83,41);
            	}
{
            	HX_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_11_boot)
HXLINE(  11)		FOCUS_OUT = HX_("focusOut",96,6f,5e,11);
            	}
{
            	HX_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_12_boot)
HXLINE(  12)		KEY_FOCUS_CHANGE = HX_("keyFocusChange",09,9c,8e,e5);
            	}
{
            	HX_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_13_boot)
HXLINE(  13)		MOUSE_FOCUS_CHANGE = HX_("mouseFocusChange",43,f1,81,96);
            	}
}
