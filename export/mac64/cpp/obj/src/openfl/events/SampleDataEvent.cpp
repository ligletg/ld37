...
HX_DEFINE_STACK_FRAME(_hx_pos_aba8a98acfdcfbe6_28_clone,"openfl.events.SampleDataEvent","clone",0xed066b5e,"openfl.events.SampleDataEvent.clone","openfl/events/SampleDataEvent.hx",28,0x7507e28f)
HX_DEFINE_STACK_FRAME(_hx_pos_aba8a98acfdcfbe6_43_toString,"openfl.events.SampleDataEvent","toString",0x071baf4b,"openfl.events.SampleDataEvent.toString","openfl/events/SampleDataEvent.hx",43,0x7507e28f)
static const ::String _hx_array_data_8459d1af_3[] = {
	HX_("type",ba,f2,08,4d),HX_("bubbles",67,bb,56,61),HX_("cancelable",14,a0,79,c4),
};
HX_DEFINE_STACK_FRAME(_hx_pos_aba8a98acfdcfbe6_11_boot,"openfl.events.SampleDataEvent","boot",0x656ee751,"openfl.events.SampleDataEvent.boot","openfl/events/SampleDataEvent.hx",11,0x7507e28f)
namespace openfl{
namespace events{
...
bool SampleDataEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_legacy::events::Event SampleDataEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  30)		HX_VARI(  ::openfl::events::SampleDataEvent,event) =  ::openfl::events::SampleDataEvent_obj::__alloc( HX_CTX ,this->get_type(),this->get_bubbles(),this->get_cancelable());
HXLINE(  31)		event->set_target(this->get_target());
HXLINE(  32)		event->set_currentTarget(this->get_currentTarget());
...
::String SampleDataEvent_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  43)		return this->_hx___formatToString(HX_("SampleDataEvent",e6,7b,b4,20),::Array_obj< ::String >::fromData( _hx_array_data_8459d1af_3,3));
            	}
