...
HX_DEFINE_STACK_FRAME(_hx_pos_c2f85669dc13e38b_21_clone,"openfl.events.UncaughtErrorEvent","clone",0x483db70d,"openfl.events.UncaughtErrorEvent.clone","openfl/events/UncaughtErrorEvent.hx",21,0x0dad2340)
HX_DEFINE_STACK_FRAME(_hx_pos_c2f85669dc13e38b_36_toString,"openfl.events.UncaughtErrorEvent","toString",0x4ef19afc,"openfl.events.UncaughtErrorEvent.toString","openfl/events/UncaughtErrorEvent.hx",36,0x0dad2340)
...
HX_DEFINE_STACK_FRAME(_hx_pos_c2f85669dc13e38b_7_boot,"openfl.events.UncaughtErrorEvent","boot",0x5936e682,"openfl.events.UncaughtErrorEvent.boot","openfl/events/UncaughtErrorEvent.hx",7,0x0dad2340)
namespace openfl{
namespace events{
...
bool UncaughtErrorEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_legacy::events::Event UncaughtErrorEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  23)		HX_VARI(  ::openfl::events::UncaughtErrorEvent,event) =  ::openfl::events::UncaughtErrorEvent_obj::__alloc( HX_CTX ,this->get_type(),this->get_bubbles(),this->get_cancelable(),this->error);
HXLINE(  24)		event->set_target(this->get_target());
HXLINE(  25)		event->set_currentTarget(this->get_currentTarget());
HXLINE(  29)		return event;
            	}
...
::String UncaughtErrorEvent_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  36)		return this->_hx___formatToString(HX_("UncaughtErrorEvent",47,72,9a,e0),::Array_obj< ::String >::fromData( _hx_array_data_4614201e_3,4));
            	}
...
HXLINE(   7)		UNCAUGHT_ERROR = HX_("uncaughtError",f3,98,8b,8b);
            	}
}
