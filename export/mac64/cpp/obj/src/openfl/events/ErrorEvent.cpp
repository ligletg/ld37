...
HX_DEFINE_STACK_FRAME(_hx_pos_0aefc26d1b1b4062_20_clone,"openfl.events.ErrorEvent","clone",0xbbab6b58,"openfl.events.ErrorEvent.clone","openfl/events/ErrorEvent.hx",20,0x9d2fc215)
HX_DEFINE_STACK_FRAME(_hx_pos_0aefc26d1b1b4062_35_toString,"openfl.events.ErrorEvent","toString",0x299f6791,"openfl.events.ErrorEvent.toString","openfl/events/ErrorEvent.hx",35,0x9d2fc215)
...
HX_DEFINE_STACK_FRAME(_hx_pos_0aefc26d1b1b4062_7_boot,"openfl.events.ErrorEvent","boot",0xced38497,"openfl.events.ErrorEvent.boot","openfl/events/ErrorEvent.hx",7,0x9d2fc215)
namespace openfl{
namespace events{
...
bool ErrorEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_legacy::events::Event ErrorEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  22)		HX_VARI(  ::openfl::events::ErrorEvent,event) =  ::openfl::events::ErrorEvent_obj::__alloc( HX_CTX ,this->get_type(),this->get_bubbles(),this->get_cancelable(),this->text,this->errorID);
HXLINE(  23)		event->set_target(this->get_target());
HXLINE(  24)		event->set_currentTarget(this->get_currentTarget());
HXLINE(  28)		return event;
            	}


::String ErrorEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_0aefc26d1b1b4062_35_toString)
            	HX_STACK_THIS(this)
HXLINE(  35)		return this->_hx___formatToString(HX_("ErrorEvent",52,bb,79,e1),::Array_obj< ::String >::fromData( _hx_array_data_60863a29_3,5));
            	}
