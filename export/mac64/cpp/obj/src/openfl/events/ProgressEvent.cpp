...
HX_DEFINE_STACK_FRAME(_hx_pos_b09527e17bebd012_24_clone,"openfl.events.ProgressEvent","clone",0xca4c7f85,"openfl.events.ProgressEvent.clone","openfl/events/ProgressEvent.hx",24,0xea3bf808)
HX_DEFINE_STACK_FRAME(_hx_pos_b09527e17bebd012_39_toString,"openfl.events.ProgressEvent","toString",0x8ba16d84,"openfl.events.ProgressEvent.toString","openfl/events/ProgressEvent.hx",39,0xea3bf808)
...
HX_DEFINE_STACK_FRAME(_hx_pos_b09527e17bebd012_7_boot,"openfl.events.ProgressEvent","boot",0x04d8d50a,"openfl.events.ProgressEvent.boot","openfl/events/ProgressEvent.hx",7,0xea3bf808)
HX_DEFINE_STACK_FRAME(_hx_pos_b09527e17bebd012_8_boot,"openfl.events.ProgressEvent","boot",0x04d8d50a,"openfl.events.ProgressEvent.boot","openfl/events/ProgressEvent.hx",8,0xea3bf808)
namespace openfl{
namespace events{
...
bool ProgressEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_legacy::events::Event ProgressEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  26)		HX_VARI(  ::openfl::events::ProgressEvent,event) =  ::openfl::events::ProgressEvent_obj::__alloc( HX_CTX ,this->get_type(),this->get_bubbles(),this->get_cancelable(),this->bytesLoaded,this->bytesTotal);
HXLINE(  27)		event->set_target(this->get_target());
HXLINE(  28)		event->set_currentTarget(this->get_currentTarget());
...
::String ProgressEvent_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  39)		return this->_hx___formatToString(HX_("ProgressEvent",0d,9d,55,84),::Array_obj< ::String >::fromData( _hx_array_data_cbc8be96_3,5));
            	}
