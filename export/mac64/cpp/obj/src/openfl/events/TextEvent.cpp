...
HX_DEFINE_STACK_FRAME(_hx_pos_a9542994cee360f6_22_clone,"openfl.events.TextEvent","clone",0x41494205,"openfl.events.TextEvent.clone","openfl/events/TextEvent.hx",22,0x23b91588)
HX_DEFINE_STACK_FRAME(_hx_pos_a9542994cee360f6_37_toString,"openfl.events.TextEvent","toString",0x2a253b04,"openfl.events.TextEvent.toString","openfl/events/TextEvent.hx",37,0x23b91588)
...
HX_DEFINE_STACK_FRAME(_hx_pos_a9542994cee360f6_7_boot,"openfl.events.TextEvent","boot",0x7707e28a,"openfl.events.TextEvent.boot","openfl/events/TextEvent.hx",7,0x23b91588)
HX_DEFINE_STACK_FRAME(_hx_pos_a9542994cee360f6_8_boot,"openfl.events.TextEvent","boot",0x7707e28a,"openfl.events.TextEvent.boot","openfl/events/TextEvent.hx",8,0x23b91588)
namespace openfl{
namespace events{
...
bool TextEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_legacy::events::Event TextEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  24)		HX_VARI(  ::openfl::events::TextEvent,event) =  ::openfl::events::TextEvent_obj::__alloc( HX_CTX ,this->get_type(),this->get_bubbles(),this->get_cancelable(),this->text);
HXLINE(  25)		event->set_target(this->get_target());
HXLINE(  26)		event->set_currentTarget(this->get_currentTarget());
...
::String TextEvent_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  37)		return this->_hx___formatToString(HX_("TextEvent",0d,38,85,b0),::Array_obj< ::String >::fromData( _hx_array_data_52f4a116_3,4));
            	}
...
HXLINE(   7)		LINK = HX_("link",fa,17,b3,47);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a9542994cee360f6_8_boot)
HXLINE(   8)		TEXT_INPUT = HX_("textInput",1d,54,0b,57);
            	}
}
