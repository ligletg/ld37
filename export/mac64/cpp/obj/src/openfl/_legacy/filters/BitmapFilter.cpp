...
HX_DEFINE_STACK_FRAME(_hx_pos_ee8120f3a30d9c30_19_clone,"openfl._legacy.filters.BitmapFilter","clone",0x22ab288d,"openfl._legacy.filters.BitmapFilter.clone","openfl/_legacy/filters/BitmapFilter.hx",19,0xbc61c83d)
namespace openfl{
namespace _legacy{
namespace filters{
...
bool BitmapFilter_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_legacy::filters::BitmapFilter BitmapFilter_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  19)		return  ::openfl::_legacy::filters::BitmapFilter_obj::__alloc( HX_CTX ,this->type);
            	}
