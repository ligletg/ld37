...
HX_DEFINE_STACK_FRAME(_hx_pos_085d934050f918cd_143_toString,"openfl._legacy.text.Font","toString",0x25d1dc6e,"openfl._legacy.text.Font.toString","openfl/_legacy/text/Font.hx",143,0x48d29f73)
HX_DEFINE_STACK_FRAME(_hx_pos_085d934050f918cd_148___fromBytes,"openfl._legacy.text.Font","__fromBytes",0xb85e74ff,"openfl._legacy.text.Font.__fromBytes","openfl/_legacy/text/Font.hx",148,0x48d29f73)
HX_DEFINE_STACK_FRAME(_hx_pos_085d934050f918cd_176___fromFile,"openfl._legacy.text.Font","__fromFile",0x99cf1068,"openfl._legacy.text.Font.__fromFile","openfl/_legacy/text/Font.hx",176,0x48d29f73)
HX_DEFINE_STACK_FRAME(_hx_pos_085d934050f918cd_65_enumerateFonts,"openfl._legacy.text.Font","enumerateFonts",0x85cd9342,"openfl._legacy.text.Font.enumerateFonts","openfl/_legacy/text/Font.hx",65,0x48d29f73)
HX_DEFINE_STACK_FRAME(_hx_pos_085d934050f918cd_75_enumerateFonts,"openfl._legacy.text.Font","enumerateFonts",0x85cd9342,"openfl._legacy.text.Font.enumerateFonts","openfl/_legacy/text/Font.hx",75,0x48d29f73)
HX_DEFINE_STACK_FRAME(_hx_pos_085d934050f918cd_88_fromBytes,"openfl._legacy.text.Font","fromBytes",0x3b68309f,"openfl._legacy.text.Font.fromBytes","openfl/_legacy/text/Font.hx",88,0x48d29f73)
HX_DEFINE_STACK_FRAME(_hx_pos_085d934050f918cd_97_fromFile,"openfl._legacy.text.Font","fromFile",0x8eeaa8c8,"openfl._legacy.text.Font.fromFile","openfl/_legacy/text/Font.hx",97,0x48d29f73)
HX_DEFINE_STACK_FRAME(_hx_pos_085d934050f918cd_109_load,"openfl._legacy.text.Font","load",0x47751ce8,"openfl._legacy.text.Font.load","openfl/_legacy/text/Font.hx",109,0x48d29f73)
HX_DEFINE_STACK_FRAME(_hx_pos_085d934050f918cd_117_loadBytes,"openfl._legacy.text.Font","loadBytes",0xa2169263,"openfl._legacy.text.Font.loadBytes","openfl/_legacy/text/Font.hx",117,0x48d29f73)
HX_DEFINE_STACK_FRAME(_hx_pos_085d934050f918cd_122_registerFont,"openfl._legacy.text.Font","registerFont",0xb6b0b294,"openfl._legacy.text.Font.registerFont","openfl/_legacy/text/Font.hx",122,0x48d29f73)
HX_DEFINE_STACK_FRAME(_hx_pos_085d934050f918cd_30_boot,"openfl._legacy.text.Font","boot",0x40d906f4,"openfl._legacy.text.Font.boot","openfl/_legacy/text/Font.hx",30,0x48d29f73)
HX_DEFINE_STACK_FRAME(_hx_pos_085d934050f918cd_234_boot,"openfl._legacy.text.Font","boot",0x40d906f4,"openfl._legacy.text.Font.boot","openfl/_legacy/text/Font.hx",234,0x48d29f73)
HX_DEFINE_STACK_FRAME(_hx_pos_085d934050f918cd_235_boot,"openfl._legacy.text.Font","boot",0x40d906f4,"openfl._legacy.text.Font.boot","openfl/_legacy/text/Font.hx",235,0x48d29f73)
HX_DEFINE_STACK_FRAME(_hx_pos_085d934050f918cd_236_boot,"openfl._legacy.text.Font","boot",0x40d906f4,"openfl._legacy.text.Font.boot","openfl/_legacy/text/Font.hx",236,0x48d29f73)
namespace openfl{
namespace _legacy{
namespace text{
...
HXLINE(  36)		if ((filename == HX_("",00,00,00,00))) {
HXLINE(  38)			HX_VARI( hx::Class,fontClass) = ::Type_obj::getClass(hx::ObjectPtr<OBJ_>(this));
...
::String Font_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 143)		::String _hx_tmp = ((HX_("{ name=",2d,2a,c0,5c) + this->fontName) + HX_(", style=",60,5b,2d,1d));
...
HXLINE( 150)		HX_VARI(  ::Dynamic,details) = ::openfl::_legacy::text::Font_obj::loadBytes(bytes);
...
HXLINE( 182)			HX_VARI(  ::Dynamic,details) = ::openfl::_legacy::text::Font_obj::load(this->_hx___fontPath);
...
HXLINE(  67)		HX_VARI( ::Array< ::Dynamic>,result) = ::openfl::_legacy::text::Font_obj::_hx___registeredFonts->copy();
...
HXLINE(  74)				HX_VARI( ::Array< ::Dynamic>,styles) = ::Array_obj< ::Dynamic>::__new(4)->init(0,::openfl::_legacy::text::FontStyle_obj::BOLD_dyn())->init(1,::openfl::_legacy::text::FontStyle_obj::BOLD_ITALIC_dyn())->init(2,::openfl::_legacy::text::FontStyle_obj::ITALIC_dyn())->init(3,::openfl::_legacy::text::FontStyle_obj::REGULAR_dyn());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,enumerateFonts,return )
 ...
 ::openfl::_legacy::text::Font Font_obj::fromBytes( ::openfl::_legacy::utils::ByteArray bytes){
            	...
            	HX_STACK_ARG(bytes,"bytes")
HXLINE(  90)		HX_VARI(  ::openfl::_legacy::text::Font,font) =  ::openfl::_legacy::text::Font_obj::__alloc( HX_CTX ,null(),null(),null());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,fromBytes,return )
 ...
 ::openfl::_legacy::text::Font Font_obj::fromFile(::String path){
            	...
            	HX_STACK_ARG(path,"path")
HXLINE(  99)		HX_VARI(  ::openfl::_legacy::text::Font,font) =  ::openfl::_legacy::text::Font_obj::__alloc( HX_CTX ,null(),null(),null());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,fromFile,return )
 ...
 ::Dynamic Font_obj::load(::String filename){
            	HX_STACKFRAME(&_hx_pos_085d934050f918cd_109_load)
            	HX_STACK_ARG(filename,"filename")
HXLINE( 109)		return ::openfl::_legacy::text::Font_obj::freetype_import_font(filename,null(),(int)20480,null());
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,load,return )
 ...
 ::Dynamic Font_obj::loadBytes( ::openfl::_legacy::utils::ByteArray bytes){
            	HX_STACKFRAME(&_hx_pos_085d934050f918cd_117_loadBytes)
            	HX_STACK_ARG(bytes,"bytes")
HXLINE( 117)		return ::openfl::_legacy::text::Font_obj::freetype_import_font(HX_("",00,00,00,00),null(),(int)20480,bytes);
            	}
...
HXLINE( 124)		HX_VARI(  ::openfl::_legacy::text::Font,instance) = ( ( ::openfl::_legacy::text::Font)(::Type_obj::createInstance(font,::cpp::VirtualArray_obj::__new(0))) );
HXLINE( 126)		if (hx::IsNotNull( instance )) {
HXLINE( 128)			if (::Reflect_obj::hasField(font,HX_("resourceName",39,7a,62,90))) {
HXLINE( 130)				HX_VARI_NAME( ::String,instance1,"instance") = instance->fontName;
HXDLIN( 130)				 ::openfl::_legacy::utils::ByteArray _hx_tmp = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(( (::String)(::Reflect_obj::field(font,HX_("resourceName",39,7a,62,90))) )));
HXDLIN( 130)				::openfl::_legacy::text::Font_obj::lime_font_register_font(instance1,_hx_tmp);
            			}
...
HXLINE(  30)		_hx___registeredFonts = ::Array_obj< ::Dynamic>::__new();
            	}
{
            	HX_STACKFRAME(&_hx_pos_085d934050f918cd_234_boot)
HXLINE( 234)		freetype_import_font = ::openfl::_legacy::Lib_obj::load(HX_("lime-legacy",c1,7f,b9,87),HX_("freetype_import_font",90,2e,4f,69),(int)4);
            	}
{
            	HX_STACKFRAME(&_hx_pos_085d934050f918cd_235_boot)
HXLINE( 235)		lime_font_register_font = ::openfl::_legacy::Lib_obj::load(HX_("lime-legacy",c1,7f,b9,87),HX_("lime_legacy_font_register_font",47,6d,d6,d3),(int)2);
            	}
{
            	HX_STACKFRAME(&_hx_pos_085d934050f918cd_236_boot)
HXLINE( 236)		lime_font_iterate_device_fonts = ::openfl::_legacy::Lib_obj::load(HX_("lime-legacy",c1,7f,b9,87),HX_("lime_legacy_font_iterate_device_fonts",64,c7,1f,cb),(int)1);
            	}
}
