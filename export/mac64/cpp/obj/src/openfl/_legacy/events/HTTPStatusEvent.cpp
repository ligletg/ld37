...
HX_DEFINE_STACK_FRAME(_hx_pos_b535c9bcb6504c30_25_clone,"openfl._legacy.events.HTTPStatusEvent","clone",0x2d221e1e,"openfl._legacy.events.HTTPStatusEvent.clone","openfl/_legacy/events/HTTPStatusEvent.hx",25,0xa6d8d4ae)
HX_DEFINE_STACK_FRAME(_hx_pos_b535c9bcb6504c30_32_toString,"openfl._legacy.events.HTTPStatusEvent","toString",0xb0c4348b,"openfl._legacy.events.HTTPStatusEvent.toString","openfl/_legacy/events/HTTPStatusEvent.hx",32,0xa6d8d4ae)
HX_DEFINE_STACK_FRAME(_hx_pos_b535c9bcb6504c30_7_boot,"openfl._legacy.events.HTTPStatusEvent","boot",0x6c9bcc91,"openfl._legacy.events.HTTPStatusEvent.boot","openfl/_legacy/events/HTTPStatusEvent.hx",7,0xa6d8d4ae)
namespace openfl{
namespace _legacy{
namespace events{
...
bool HTTPStatusEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_legacy::events::Event HTTPStatusEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  25)		return  ::openfl::_legacy::events::HTTPStatusEvent_obj::__alloc( HX_CTX ,this->get_type(),this->get_bubbles(),this->get_cancelable(),this->status);
            	}
...
::String HTTPStatusEvent_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  32)		::String _hx_tmp = ((HX_("[HTTPStatusEvent type=",c8,a0,6f,f4) + this->get_type()) + HX_(" bubbles=",16,5f,ba,28));
...
HXLINE(   7)		HTTP_STATUS = HX_("httpStatus",da,4c,74,0a);
            	}
}
