...
HX_DEFINE_STACK_FRAME(_hx_pos_b8839de8ae042556_25_clone,"openfl._legacy.events.SystemEvent","clone",0x962f4689,"openfl._legacy.events.SystemEvent.clone","openfl/_legacy/events/SystemEvent.hx",25,0x919fdfe3)
HX_DEFINE_STACK_FRAME(_hx_pos_b8839de8ae042556_32_toString,"openfl._legacy.events.SystemEvent","toString",0x6519e100,"openfl._legacy.events.SystemEvent.toString","openfl/_legacy/events/SystemEvent.hx",32,0x919fdfe3)
HX_DEFINE_STACK_FRAME(_hx_pos_b8839de8ae042556_10_boot,"openfl._legacy.events.SystemEvent","boot",0xdebada86,"openfl._legacy.events.SystemEvent.boot","openfl/_legacy/events/SystemEvent.hx",10,0x919fdfe3)
namespace openfl{
namespace _legacy{
namespace events{
...
bool SystemEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_legacy::events::Event SystemEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  25)		return  ::openfl::_legacy::events::SystemEvent_obj::__alloc( HX_CTX ,this->get_type(),this->get_bubbles(),this->get_cancelable(),this->data);
            	}
...
::String SystemEvent_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  32)		::String _hx_tmp = ((HX_("[SystemEvent type=",33,96,7e,b4) + this->get_type()) + HX_(" bubbles=",16,5f,ba,28));
...
HXLINE(  10)		SYSTEM = HX_("system",ef,96,e2,f2);
            	}
}
