...
HX_DEFINE_STACK_FRAME(_hx_pos_968bec0d92372e1f_52___createSimilar,"openfl._legacy.events.TouchEvent","__createSimilar",0xbdda25cd,"openfl._legacy.events.TouchEvent.__createSimilar","openfl/_legacy/events/TouchEvent.hx",52,0x427be0d3)
HX_DEFINE_STACK_FRAME(_hx_pos_968bec0d92372e1f_40___create,"openfl._legacy.events.TouchEvent","__create",0x2136c3fe,"openfl._legacy.events.TouchEvent.__create","openfl/_legacy/events/TouchEvent.hx",40,0x427be0d3)
HX_DEFINE_STACK_FRAME(_hx_pos_968bec0d92372e1f_11_boot,"openfl._legacy.events.TouchEvent","boot",0xd2385d14,"openfl._legacy.events.TouchEvent.boot","openfl/_legacy/events/TouchEvent.hx",11,0x427be0d3)
HX_DEFINE_STACK_FRAME(_hx_pos_968bec0d92372e1f_12_boot,"openfl._legacy.events.TouchEvent","boot",0xd2385d14,"openfl._legacy.events.TouchEvent.boot","openfl/_legacy/events/TouchEvent.hx",12,0x427be0d3)
HX_DEFINE_STACK_FRAME(_hx_pos_968bec0d92372e1f_13_boot,"openfl._legacy.events.TouchEvent","boot",0xd2385d14,"openfl._legacy.events.TouchEvent.boot","openfl/_legacy/events/TouchEvent.hx",13,0x427be0d3)
HX_DEFINE_STACK_FRAME(_hx_pos_968bec0d92372e1f_14_boot,"openfl._legacy.events.TouchEvent","boot",0xd2385d14,"openfl._legacy.events.TouchEvent.boot","openfl/_legacy/events/TouchEvent.hx",14,0x427be0d3)
HX_DEFINE_STACK_FRAME(_hx_pos_968bec0d92372e1f_15_boot,"openfl._legacy.events.TouchEvent","boot",0xd2385d14,"openfl._legacy.events.TouchEvent.boot","openfl/_legacy/events/TouchEvent.hx",15,0x427be0d3)
HX_DEFINE_STACK_FRAME(_hx_pos_968bec0d92372e1f_16_boot,"openfl._legacy.events.TouchEvent","boot",0xd2385d14,"openfl._legacy.events.TouchEvent.boot","openfl/_legacy/events/TouchEvent.hx",16,0x427be0d3)
HX_DEFINE_STACK_FRAME(_hx_pos_968bec0d92372e1f_17_boot,"openfl._legacy.events.TouchEvent","boot",0xd2385d14,"openfl._legacy.events.TouchEvent.boot","openfl/_legacy/events/TouchEvent.hx",17,0x427be0d3)
HX_DEFINE_STACK_FRAME(_hx_pos_968bec0d92372e1f_18_boot,"openfl._legacy.events.TouchEvent","boot",0xd2385d14,"openfl._legacy.events.TouchEvent.boot","openfl/_legacy/events/TouchEvent.hx",18,0x427be0d3)
namespace openfl{
namespace _legacy{
namespace events{
...
HXLINE(  54)		 ::openfl::_legacy::display::InteractiveObject touchEvent;
HXDLIN(  54)		if (hx::IsNull( related )) {
HXLINE(  54)			touchEvent = this->relatedObject;
            		}
            		else {
HXLINE(  54)			touchEvent = related;
            		}
HXDLIN(  54)		HX_VARI_NAME(  ::openfl::_legacy::events::TouchEvent,touchEvent1,"touchEvent") =  ::openfl::_legacy::events::TouchEvent_obj::__alloc( HX_CTX ,type,this->get_bubbles(),this->get_cancelable(),this->localX,this->localY,this->sizeX,this->sizeY,touchEvent,this->ctrlKey,this->altKey,this->shiftKey,this->buttonDown,this->delta,this->commandKey,this->clickCount);
HXLINE(  56)		touchEvent1->touchPointID = this->touchPointID;
HXLINE(  57)		touchEvent1->isPrimaryTouchPoint = this->isPrimaryTouchPoint;
HXLINE(  59)		if (hx::IsNotNull( target )) {
HXLINE(  61)			touchEvent1->set_target(target);
            		}
HXLINE(  65)		return touchEvent1;
            	}
...
::String TouchEvent_obj::TOUCH_TAP;
 ...
 ::openfl::_legacy::events::TouchEvent TouchEvent_obj::_hx___create(::String type, ::Dynamic event, ::openfl::_legacy::geom::Point local, ::openfl::_legacy::display::InteractiveObject target,Float sizeX,Float sizeY){
            	...
            	HX_STACK_ARG(sizeX,"sizeX")
            	HX_STACK_ARG(sizeY,"sizeY")
HXLINE(  42)		HX_VARI( int,flags) = ( (int)(event->__Field(HX_("flags",47,2b,8c,02),hx::paccDynamic)) );
HXLINE(  43)		HX_VARI(  ::openfl::_legacy::events::TouchEvent,touchEvent) =  ::openfl::_legacy::events::TouchEvent_obj::__alloc( HX_CTX ,type,true,false,local->x,local->y,sizeX,sizeY,null(),(((int)flags & (int)::openfl::_legacy::events::MouseEvent_obj::efCtrlDown) != (int)0),(((int)flags & (int)::openfl::_legacy::events::MouseEvent_obj::efAltDown) != (int)0),(((int)flags & (int)::openfl::_legacy::events::MouseEvent_obj::efShiftDown) != (int)0),(((int)flags & (int)::openfl::_legacy::events::MouseEvent_obj::efLeftDown) != (int)0),(int)0,null(),(int)0);
HXLINE(  44)		touchEvent->stageX = ( (Float)(event->__Field(HX_("x",78,00,00,00),hx::paccDynamic)) );
HXLINE(  45)		touchEvent->stageY = ( (Float)(event->__Field(HX_("y",79,00,00,00),hx::paccDynamic)) );
HXLINE(  46)		touchEvent->set_target(target);
HXLINE(  47)		return touchEvent;
            	}
...
HXLINE(  11)		TOUCH_BEGIN = HX_("touchBegin",ea,cd,e6,a9);
            	}
{
            	HX_STACKFRAME(&_hx_pos_968bec0d92372e1f_12_boot)
HXLINE(  12)		TOUCH_END = HX_("touchEnd",5c,c5,09,00);
            	}
{
            	HX_STACKFRAME(&_hx_pos_968bec0d92372e1f_13_boot)
HXLINE(  13)		TOUCH_MOVE = HX_("touchMove",70,72,cd,0d);
            	}
{
            	HX_STACKFRAME(&_hx_pos_968bec0d92372e1f_14_boot)
HXLINE(  14)		TOUCH_OUT = HX_("touchOut",0f,62,11,00);
            	}
{
            	HX_STACKFRAME(&_hx_pos_968bec0d92372e1f_15_boot)
HXLINE(  15)		TOUCH_OVER = HX_("touchOver",b3,20,25,0f);
            	}
{
            	HX_STACKFRAME(&_hx_pos_968bec0d92372e1f_16_boot)
HXLINE(  16)		TOUCH_ROLL_OUT = HX_("touchRollOut",12,0f,74,87);
            	}
{
            	HX_STACKFRAME(&_hx_pos_968bec0d92372e1f_17_boot)
HXLINE(  17)		TOUCH_ROLL_OVER = HX_("touchRollOver",50,d6,19,fe);
            	}
{
            	HX_STACKFRAME(&_hx_pos_968bec0d92372e1f_18_boot)
HXLINE(  18)		TOUCH_TAP = HX_("touchTap",e4,1b,15,00);
            	}
}
