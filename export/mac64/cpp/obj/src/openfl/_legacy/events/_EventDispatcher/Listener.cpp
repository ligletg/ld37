...
HX_DEFINE_STACK_FRAME(_hx_pos_435c6002c1b7a0fd_223_match,"openfl._legacy.events._EventDispatcher.Listener","match",0x366ad5a6,"openfl._legacy.events._EventDispatcher.Listener.match","openfl/_legacy/events/EventDispatcher.hx",223,0xebfd71ed)
namespace openfl{
namespace _legacy{
namespace events{
...
bool Listener_obj::match( ::Dynamic callback,bool useCapture){
            	...
            	HX_STACK_ARG(callback,"callback")
            	HX_STACK_ARG(useCapture,"useCapture")
HXLINE( 223)		if (::Reflect_obj::compareMethods(this->callback,callback)) {
