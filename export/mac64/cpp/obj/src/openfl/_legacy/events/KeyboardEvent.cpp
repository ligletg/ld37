...
HX_DEFINE_STACK_FRAME(_hx_pos_8542a5fd974ce238_38_clone,"openfl._legacy.events.KeyboardEvent","clone",0xa856f591,"openfl._legacy.events.KeyboardEvent.clone","openfl/_legacy/events/KeyboardEvent.hx",38,0x7429199b)
HX_DEFINE_STACK_FRAME(_hx_pos_8542a5fd974ce238_45_toString,"openfl._legacy.events.KeyboardEvent","toString",0x96f346f8,"openfl._legacy.events.KeyboardEvent.toString","openfl/_legacy/events/KeyboardEvent.hx",45,0x7429199b)
HX_DEFINE_STACK_FRAME(_hx_pos_8542a5fd974ce238_7_boot,"openfl._legacy.events.KeyboardEvent","boot",0xb57be47e,"openfl._legacy.events.KeyboardEvent.boot","openfl/_legacy/events/KeyboardEvent.hx",7,0x7429199b)
HX_DEFINE_STACK_FRAME(_hx_pos_8542a5fd974ce238_8_boot,"openfl._legacy.events.KeyboardEvent","boot",0xb57be47e,"openfl._legacy.events.KeyboardEvent.boot","openfl/_legacy/events/KeyboardEvent.hx",8,0x7429199b)
namespace openfl{
namespace _legacy{
namespace events{
...
bool KeyboardEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_legacy::events::Event KeyboardEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  38)		return  ::openfl::_legacy::events::KeyboardEvent_obj::__alloc( HX_CTX ,this->get_type(),this->get_bubbles(),this->get_cancelable(),this->charCode,this->keyCode,this->keyLocation,this->ctrlKey,this->altKey,this->shiftKey,this->controlKey,this->commandKey);
            	}
...
::String KeyboardEvent_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  45)		::String _hx_tmp = ((HX_("[KeyboardEvent type=",bb,ae,1e,4c) + this->get_type()) + HX_(" bubbles=",16,5f,ba,28));
...
HXLINE(   7)		KEY_DOWN = HX_("keyDown",a1,69,47,9c);
            	}
{
            	HX_STACKFRAME(&_hx_pos_8542a5fd974ce238_8_boot)
HXLINE(   8)		KEY_UP = HX_("keyUp",da,b9,fe,de);
            	}
}
