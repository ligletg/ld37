...
HX_DEFINE_STACK_FRAME(_hx_pos_6d4f3d21636ac416_40_load,"openfl._legacy.display.Loader","load",0xb38642b1,"openfl._legacy.display.Loader.load","openfl/_legacy/display/Loader.hx",40,0x567a0778)
HX_DEFINE_STACK_FRAME(_hx_pos_6d4f3d21636ac416_47_loadBytes,"openfl._legacy.display.Loader","loadBytes",0x6a7ad3fa,"openfl._legacy.display.Loader.loadBytes","openfl/_legacy/display/Loader.hx",47,0x567a0778)
HX_DEFINE_STACK_FRAME(_hx_pos_6d4f3d21636ac416_64_unload,"openfl._legacy.display.Loader","unload",0x60bec24a,"openfl._legacy.display.Loader.unload","openfl/_legacy/display/Loader.hx",64,0x567a0778)
HX_DEFINE_STACK_FRAME(_hx_pos_6d4f3d21636ac416_92___onComplete,"openfl._legacy.display.Loader","__onComplete",0x75dcfba3,"openfl._legacy.display.Loader.__onComplete","openfl/_legacy/display/Loader.hx",92,0x567a0778)
HX_DEFINE_STACK_FRAME(_hx_pos_6d4f3d21636ac416_132_contentLoaderInfo_onData,"openfl._legacy.display.Loader","contentLoaderInfo_onData",0xe2fdc719,"openfl._legacy.display.Loader.contentLoaderInfo_onData","openfl/_legacy/display/Loader.hx",132,0x567a0778)
namespace openfl{
namespace _legacy{
namespace display{
...
void Loader_obj::loadBytes( ::openfl::_legacy::utils::ByteArray bytes, ::openfl::_hx_system::LoaderContext context){
            	...
            	HX_STACK_ARG(context,"context")
HXLINE(  47)		if (this->_hx___onComplete(bytes)) {
HXLINE(  49)			HX_VARI(  ::openfl::_legacy::events::Event,event) =  ::openfl::_legacy::events::Event_obj::__alloc( HX_CTX ,::openfl::_legacy::events::Event_obj::COMPLETE,null(),null());
...
void Loader_obj::unload(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  64)		if ((this->get_numChildren() > (int)0)) {
...
HXLINE(  83)			HX_VARI(  ::openfl::_legacy::events::Event,event) =  ::openfl::_legacy::events::Event_obj::__alloc( HX_CTX ,::openfl::_legacy::events::Event_obj::UNLOAD,null(),null());
...
HXLINE( 103)			HX_VARI(  ::openfl::_legacy::display::Bitmap,bitmap) =  ::openfl::_legacy::display::Bitmap_obj::__alloc( HX_CTX ,this->_hx___image,null(),null());
