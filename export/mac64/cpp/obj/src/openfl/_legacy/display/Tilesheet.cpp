...
HX_DEFINE_STACK_FRAME(_hx_pos_4410a112331db337_54_addTileRect,"openfl._legacy.display.Tilesheet","addTileRect",0x2df55dc6,"openfl._legacy.display.Tilesheet.addTileRect","openfl/_legacy/display/Tilesheet.hx",54,0x425689e0)
HX_DEFINE_STACK_FRAME(_hx_pos_4410a112331db337_67_drawTiles,"openfl._legacy.display.Tilesheet","drawTiles",0x43ceeb34,"openfl._legacy.display.Tilesheet.drawTiles","openfl/_legacy/display/Tilesheet.hx",67,0x425689e0)
HX_DEFINE_STACK_FRAME(_hx_pos_4410a112331db337_73_getTileCenter,"openfl._legacy.display.Tilesheet","getTileCenter",0x967135ac,"openfl._legacy.display.Tilesheet.getTileCenter","openfl/_legacy/display/Tilesheet.hx",73,0x425689e0)
HX_DEFINE_STACK_FRAME(_hx_pos_4410a112331db337_77_getTileRect,"openfl._legacy.display.Tilesheet","getTileRect",0x228ce93b,"openfl._legacy.display.Tilesheet.getTileRect","openfl/_legacy/display/Tilesheet.hx",77,0x425689e0)
HX_DEFINE_STACK_FRAME(_hx_pos_4410a112331db337_81_getTileUVs,"openfl._legacy.display.Tilesheet","getTileUVs",0x4630c6db,"openfl._legacy.display.Tilesheet.getTileUVs","openfl/_legacy/display/Tilesheet.hx",81,0x425689e0)
HX_DEFINE_STACK_FRAME(_hx_pos_4410a112331db337_15_boot,"openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",15,0x425689e0)
HX_DEFINE_STACK_FRAME(_hx_pos_4410a112331db337_16_boot,"openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",16,0x425689e0)
HX_DEFINE_STACK_FRAME(_hx_pos_4410a112331db337_17_boot,"openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",17,0x425689e0)
HX_DEFINE_STACK_FRAME(_hx_pos_4410a112331db337_18_boot,"openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",18,0x425689e0)
HX_DEFINE_STACK_FRAME(_hx_pos_4410a112331db337_19_boot,"openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",19,0x425689e0)
HX_DEFINE_STACK_FRAME(_hx_pos_4410a112331db337_20_boot,"openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",20,0x425689e0)
HX_DEFINE_STACK_FRAME(_hx_pos_4410a112331db337_21_boot,"openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",21,0x425689e0)
HX_DEFINE_STACK_FRAME(_hx_pos_4410a112331db337_22_boot,"openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",22,0x425689e0)
HX_DEFINE_STACK_FRAME(_hx_pos_4410a112331db337_23_boot,"openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",23,0x425689e0)
HX_DEFINE_STACK_FRAME(_hx_pos_4410a112331db337_24_boot,"openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",24,0x425689e0)
HX_DEFINE_STACK_FRAME(_hx_pos_4410a112331db337_25_boot,"openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",25,0x425689e0)
HX_DEFINE_STACK_FRAME(_hx_pos_4410a112331db337_26_boot,"openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",26,0x425689e0)
HX_DEFINE_STACK_FRAME(_hx_pos_4410a112331db337_32_boot,"openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",32,0x425689e0)
HX_DEFINE_STACK_FRAME(_hx_pos_4410a112331db337_90_boot,"openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",90,0x425689e0)
HX_DEFINE_STACK_FRAME(_hx_pos_4410a112331db337_91_boot,"openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",91,0x425689e0)
namespace openfl{
namespace _legacy{
namespace display{
...
HXLINE(  58)			this->_tilePoints->push( ::openfl::_legacy::geom::Point_obj::__alloc( HX_CTX ,((Float)centerPoint->x / (Float)rectangle->width),((Float)centerPoint->y / (Float)rectangle->height)));
            		}
HXLINE(  59)		this->_tileUVs->push( ::openfl::_legacy::geom::Rectangle_obj::__alloc( HX_CTX ,((Float)rectangle->get_left() / (Float)this->_bitmapWidth),((Float)rectangle->get_top() / (Float)this->_bitmapHeight),((Float)rectangle->get_right() / (Float)this->_bitmapWidth),((Float)rectangle->get_bottom() / (Float)this->_bitmapHeight)));
HXLINE(  60)		return ::openfl::_legacy::display::Tilesheet_obj::lime_tilesheet_add_rect(this->_hx___handle,rectangle,centerPoint);
            	}
...
HXLINE(  67)		graphics->drawTiles(hx::ObjectPtr<OBJ_>(this),tileData,smooth,flags,count);
            	}
...
HXLINE(  73)		return this->_tilePoints->__get(index).StaticCast<  ::openfl::_legacy::geom::Point >();
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Tilesheet_obj,getTileCenter,return )
 ...
 ::openfl::_legacy::geom::Rectangle Tilesheet_obj::getTileRect(int index){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
HXLINE(  77)		return this->_tiles->__get(index).StaticCast<  ::openfl::_legacy::geom::Rectangle >();
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Tilesheet_obj,getTileRect,return )
 ...
 ::openfl::_legacy::geom::Rectangle Tilesheet_obj::getTileUVs(int index){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
HXLINE(  81)		return this->_tileUVs->__get(index).StaticCast<  ::openfl::_legacy::geom::Rectangle >();
            	}
...
HXLINE(  22)		TILE_BLEND_NORMAL = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_4410a112331db337_23_boot)
HXLINE(  23)		TILE_BLEND_ADD = (int)65536;
            	}
{
            	HX_STACKFRAME(&_hx_pos_4410a112331db337_24_boot)
HXLINE(  24)		TILE_BLEND_MULTIPLY = (int)131072;
            	}
{
            	HX_STACKFRAME(&_hx_pos_4410a112331db337_25_boot)
HXLINE(  25)		TILE_BLEND_SCREEN = (int)262144;
            	}
{
            	HX_STACKFRAME(&_hx_pos_4410a112331db337_26_boot)
HXLINE(  26)		TILE_BLEND_SUBTRACT = (int)524288;
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_4410a112331db337_32_boot)
HXLINE(  32)		defaultRatio =  ::openfl::_legacy::geom::Point_obj::__alloc( HX_CTX ,(int)0,(int)0);
            	}
{
            	HX_STACKFRAME(&_hx_pos_4410a112331db337_90_boot)
HXLINE(  90)		lime_tilesheet_create = ::openfl::_legacy::Lib_obj::load(HX_("lime-legacy",c1,7f,b9,87),HX_("lime_legacy_tilesheet_create",96,fb,d0,b7),(int)1);
            	}
{
            	HX_STACKFRAME(&_hx_pos_4410a112331db337_91_boot)
HXLINE(  91)		lime_tilesheet_add_rect = ::openfl::_legacy::Lib_obj::load(HX_("lime-legacy",c1,7f,b9,87),HX_("lime_legacy_tilesheet_add_rect",5c,8e,ab,c3),(int)3);
            	}
}
