...
HX_DEFINE_STACK_FRAME(_hx_pos_f98b58d7b7079c84_68_load,"openfl._legacy.display.LoaderInfo","load",0x4f690de3,"openfl._legacy.display.LoaderInfo.load","openfl/_legacy/display/LoaderInfo.hx",68,0xb6d254aa)
HX_DEFINE_STACK_FRAME(_hx_pos_f98b58d7b7079c84_101_this_onComplete,"openfl._legacy.display.LoaderInfo","this_onComplete",0x99e9f7dc,"openfl._legacy.display.LoaderInfo.this_onComplete","openfl/_legacy/display/LoaderInfo.hx",101,0xb6d254aa)
HX_DEFINE_STACK_FRAME(_hx_pos_f98b58d7b7079c84_118_get_bytes,"openfl._legacy.display.LoaderInfo","get_bytes",0x13e243e5,"openfl._legacy.display.LoaderInfo.get_bytes","openfl/_legacy/display/LoaderInfo.hx",118,0xb6d254aa)
HX_DEFINE_STACK_FRAME(_hx_pos_f98b58d7b7079c84_50_create,"openfl._legacy.display.LoaderInfo","create",0xe9d303f9,"openfl._legacy.display.LoaderInfo.create","openfl/_legacy/display/LoaderInfo.hx",50,0xb6d254aa)
namespace openfl{
namespace _legacy{
namespace display{
...
HXLINE(  71)		HX_VARI( int,dot) = this->_hx___pendingURL.lastIndexOf(HX_(".",2e,00,00,00),null());
HXLINE(  72)		HX_VAR( ::String,extension);
HXDLIN(  72)		if ((dot > (int)0)) {
HXLINE(  72)			extension = this->_hx___pendingURL.substr((dot + (int)1),null()).toLowerCase();
            		}
            		else {
...
HXLINE(  52)		HX_VARI(  ::openfl::_legacy::display::LoaderInfo,loaderInfo) =  ::openfl::_legacy::display::LoaderInfo_obj::__alloc( HX_CTX );
