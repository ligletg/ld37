...
HX_DEFINE_STACK_FRAME(_hx_pos_ea4f748fa8bf82f1_26_startDrag,"openfl._legacy.display.Sprite","startDrag",0x2d8cdb7d,"openfl._legacy.display.Sprite.startDrag","openfl/_legacy/display/Sprite.hx",26,0xb166f6c6)
HX_DEFINE_STACK_FRAME(_hx_pos_ea4f748fa8bf82f1_37_stopDrag,"openfl._legacy.display.Sprite","stopDrag",0xe37418ef,"openfl._legacy.display.Sprite.stopDrag","openfl/_legacy/display/Sprite.hx",37,0xb166f6c6)
HX_DEFINE_STACK_FRAME(_hx_pos_ea4f748fa8bf82f1_46___getType,"openfl._legacy.display.Sprite","__getType",0xd3032957,"openfl._legacy.display.Sprite.__getType","openfl/_legacy/display/Sprite.hx",46,0xb166f6c6)
namespace openfl{
namespace _legacy{
namespace display{
...
::String Sprite_obj::_hx___getType(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  48)		HX_VARI( ::String,type) = ::Type_obj::getClassName(::Type_obj::getClass(hx::ObjectPtr<OBJ_>(this)));
