...
HX_DEFINE_STACK_FRAME(_hx_pos_9f614fea56ab1524_16_getType,"openfl._legacy.gl.GLTexture","getType",0x8a6a2093,"openfl._legacy.gl.GLTexture.getType","openfl/_legacy/gl/GLTexture.hx",16,0x6f86168c)
namespace openfl{
namespace _legacy{
namespace gl{
...
::String GLTexture_obj::getType(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  16)		return HX_("Texture",bb,f0,31,6c);
            	}
