...
HX_DEFINE_STACK_FRAME(_hx_pos_c27bfd3e1a26e9b8_16_getType,"openfl._legacy.gl.GLFramebuffer","getType",0x179461a5,"openfl._legacy.gl.GLFramebuffer.getType","openfl/_legacy/gl/GLFramebuffer.hx",16,0x94ab3a3a)
namespace openfl{
namespace _legacy{
namespace gl{
...
::String GLFramebuffer_obj::getType(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  16)		return HX_("Framebuffer",cd,ac,7a,5e);
            	}
