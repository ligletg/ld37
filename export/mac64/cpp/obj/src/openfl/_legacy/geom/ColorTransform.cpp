...
HX_DEFINE_STACK_FRAME(_hx_pos_6d5d677b3a30f551_32_concat,"openfl._legacy.geom.ColorTransform","concat",0x00eda8eb,"openfl._legacy.geom.ColorTransform.concat","openfl/_legacy/geom/ColorTransform.hx",32,0x065f2cc8)
HX_DEFINE_STACK_FRAME(_hx_pos_6d5d677b3a30f551_51_get_color,"openfl._legacy.geom.ColorTransform","get_color",0xcc126e43,"openfl._legacy.geom.ColorTransform.get_color","openfl/_legacy/geom/ColorTransform.hx",51,0x065f2cc8)
HX_DEFINE_STACK_FRAME(_hx_pos_6d5d677b3a30f551_56_set_color,"openfl._legacy.geom.ColorTransform","set_color",0xaf635a4f,"openfl._legacy.geom.ColorTransform.set_color","openfl/_legacy/geom/ColorTransform.hx",56,0x065f2cc8)
namespace openfl{
namespace _legacy{
namespace geom{
...
int ColorTransform_obj::get_color(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  51)		int _hx_tmp = ((int)::Std_obj::_hx_int(this->redOffset) << (int)(int)16);
