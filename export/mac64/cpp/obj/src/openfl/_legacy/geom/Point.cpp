...
HX_DEFINE_STACK_FRAME(_hx_pos_7b5fa247dae29567_22_add,"openfl._legacy.geom.Point","add",0xbb3d7995,"openfl._legacy.geom.Point.add","openfl/_legacy/geom/Point.hx",22,0x10b884db)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5fa247dae29567_29_clone,"openfl._legacy.geom.Point","clone",0x4cde5fd1,"openfl._legacy.geom.Point.clone","openfl/_legacy/geom/Point.hx",29,0x10b884db)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5fa247dae29567_34_copyFrom,"openfl._legacy.geom.Point","copyFrom",0x0ba9ffcb,"openfl._legacy.geom.Point.copyFrom","openfl/_legacy/geom/Point.hx",34,0x10b884db)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5fa247dae29567_53_equals,"openfl._legacy.geom.Point","equals",0xa75a874b,"openfl._legacy.geom.Point.equals","openfl/_legacy/geom/Point.hx",53,0x10b884db)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5fa247dae29567_67_normalize,"openfl._legacy.geom.Point","normalize",0x482dce01,"openfl._legacy.geom.Point.normalize","openfl/_legacy/geom/Point.hx",67,0x10b884db)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5fa247dae29567_82_offset,"openfl._legacy.geom.Point","offset",0x47a7309f,"openfl._legacy.geom.Point.offset","openfl/_legacy/geom/Point.hx",82,0x10b884db)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5fa247dae29567_97_setTo,"openfl._legacy.geom.Point","setTo",0x7eaade31,"openfl._legacy.geom.Point.setTo","openfl/_legacy/geom/Point.hx",97,0x10b884db)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5fa247dae29567_107_subtract,"openfl._legacy.geom.Point","subtract",0x3b5a6920,"openfl._legacy.geom.Point.subtract","openfl/_legacy/geom/Point.hx",107,0x10b884db)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5fa247dae29567_114_toString,"openfl._legacy.geom.Point","toString",0x7bb7c4b8,"openfl._legacy.geom.Point.toString","openfl/_legacy/geom/Point.hx",114,0x10b884db)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5fa247dae29567_128_get_length,"openfl._legacy.geom.Point","get_length",0xee0613bb,"openfl._legacy.geom.Point.get_length","openfl/_legacy/geom/Point.hx",128,0x10b884db)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5fa247dae29567_42_distance,"openfl._legacy.geom.Point","distance",0xaf428741,"openfl._legacy.geom.Point.distance","openfl/_legacy/geom/Point.hx",42,0x10b884db)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5fa247dae29567_60_interpolate,"openfl._legacy.geom.Point","interpolate",0x68e8f035,"openfl._legacy.geom.Point.interpolate","openfl/_legacy/geom/Point.hx",60,0x10b884db)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5fa247dae29567_92_polar,"openfl._legacy.geom.Point","polar",0xcb0d3c32,"openfl._legacy.geom.Point.polar","openfl/_legacy/geom/Point.hx",92,0x10b884db)
namespace openfl{
namespace _legacy{
namespace geom{
...
bool Point_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_legacy::geom::Point Point_obj::add( ::openfl::_legacy::geom::Point v){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
HXLINE(  22)		return  ::openfl::_legacy::geom::Point_obj::__alloc( HX_CTX ,(v->x + this->x),(v->y + this->y));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Point_obj,add,return )
 ...
 ::openfl::_legacy::geom::Point Point_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  29)		return  ::openfl::_legacy::geom::Point_obj::__alloc( HX_CTX ,this->x,this->y);
            	}
...
HXLINE(  53)		if ((toCompare->x == this->x)) {
HXLINE(  53)			return (toCompare->y == this->y);
            		}
            		else {
...
HXLINE(  67)			_hx_tmp = (this->y == (int)0);
            		}
            		else {
...
HXLINE(  73)			HX_VARI( Float,norm) = ((Float)thickness / (Float)::Math_obj::sqrt(((this->x * this->x) + (this->y * this->y))));
HXLINE(  74)			 ::openfl::_legacy::geom::Point _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  74)			_hx_tmp1->x = (_hx_tmp1->x * norm);
HXLINE(  75)			 ::openfl::_legacy::geom::Point _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  75)			_hx_tmp2->y = (_hx_tmp2->y * norm);
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(Point_obj,setTo,(void))
 ...
 ::openfl::_legacy::geom::Point Point_obj::subtract( ::openfl::_legacy::geom::Point v){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
HXLINE( 107)		return  ::openfl::_legacy::geom::Point_obj::__alloc( HX_CTX ,(this->x - v->x),(this->y - v->y));
            	}
...
::String Point_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 114)		return ((((HX_("(",28,00,00,00) + this->x) + HX_(", ",74,26,00,00)) + this->y) + HX_(")",29,00,00,00));
            	}
...
Float Point_obj::get_length(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 128)		return ::Math_obj::sqrt(((this->x * this->x) + (this->y * this->y)));
            	}
...
HXLINE(  44)		HX_VARI( Float,dx) = (pt1->x - pt2->x);
HXLINE(  45)		HX_VARI( Float,dy) = (pt1->y - pt2->y);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Point_obj,distance,return )
 ...
 ::openfl::_legacy::geom::Point Point_obj::interpolate( ::openfl::_legacy::geom::Point pt1, ::openfl::_legacy::geom::Point pt2,Float f){
            	...
            	HX_STACK_ARG(pt2,"pt2")
            	HX_STACK_ARG(f,"f")
HXLINE(  60)		return  ::openfl::_legacy::geom::Point_obj::__alloc( HX_CTX ,(pt2->x + (f * (pt1->x - pt2->x))),(pt2->y + (f * (pt1->y - pt2->y))));
            	}
...
HXLINE(  92)		return  ::openfl::_legacy::geom::Point_obj::__alloc( HX_CTX ,(len * ::Math_obj::cos(angle)),(len * ::Math_obj::sin(angle)));
            	}
