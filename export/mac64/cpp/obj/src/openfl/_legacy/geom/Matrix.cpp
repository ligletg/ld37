...
HX_DEFINE_STACK_FRAME(_hx_pos_a60a08489e20943f_32_clone,"openfl._legacy.geom.Matrix","clone",0xe1cf561e,"openfl._legacy.geom.Matrix.clone","openfl/_legacy/geom/Matrix.hx",32,0x35542610)
HX_DEFINE_STACK_FRAME(_hx_pos_a60a08489e20943f_37_concat,"openfl._legacy.geom.Matrix","concat",0x6d1e2f33,"openfl._legacy.geom.Matrix.concat","openfl/_legacy/geom/Matrix.hx",37,0x35542610)
HX_DEFINE_STACK_FRAME(_hx_pos_a60a08489e20943f_57_copyColumnFrom,"openfl._legacy.geom.Matrix","copyColumnFrom",0x3ed57494,"openfl._legacy.geom.Matrix.copyColumnFrom","openfl/_legacy/geom/Matrix.hx",57,0x35542610)
HX_DEFINE_STACK_FRAME(_hx_pos_a60a08489e20943f_83_copyColumnTo,"openfl._legacy.geom.Matrix","copyColumnTo",0xc37e3625,"openfl._legacy.geom.Matrix.copyColumnTo","openfl/_legacy/geom/Matrix.hx",83,0x35542610)
HX_DEFINE_STACK_FRAME(_hx_pos_a60a08489e20943f_110_copyFrom,"openfl._legacy.geom.Matrix","copyFrom",0xfa1c379e,"openfl._legacy.geom.Matrix.copyFrom","openfl/_legacy/geom/Matrix.hx",110,0x35542610)
HX_DEFINE_STACK_FRAME(_hx_pos_a60a08489e20943f_124_copyRowFrom,"openfl._legacy.geom.Matrix","copyRowFrom",0x44438ef0,"openfl._legacy.geom.Matrix.copyRowFrom","openfl/_legacy/geom/Matrix.hx",124,0x35542610)
HX_DEFINE_STACK_FRAME(_hx_pos_a60a08489e20943f_150_copyRowTo,"openfl._legacy.geom.Matrix","copyRowTo",0xc56dc181,"openfl._legacy.geom.Matrix.copyRowTo","openfl/_legacy/geom/Matrix.hx",150,0x35542610)
HX_DEFINE_STACK_FRAME(_hx_pos_a60a08489e20943f_175_createBox,"openfl._legacy.geom.Matrix","createBox",0x9be3cbb0,"openfl._legacy.geom.Matrix.createBox","openfl/_legacy/geom/Matrix.hx",175,0x35542610)
HX_DEFINE_STACK_FRAME(_hx_pos_a60a08489e20943f_207_createGradientBox,"openfl._legacy.geom.Matrix","createGradientBox",0x67a6cca0,"openfl._legacy.geom.Matrix.createGradientBox","openfl/_legacy/geom/Matrix.hx",207,0x35542610)
HX_DEFINE_STACK_FRAME(_hx_pos_a60a08489e20943f_235_deltaTransformPoint,"openfl._legacy.geom.Matrix","deltaTransformPoint",0x05467fdd,"openfl._legacy.geom.Matrix.deltaTransformPoint","openfl/_legacy/geom/Matrix.hx",235,0x35542610)
HX_DEFINE_STACK_FRAME(_hx_pos_a60a08489e20943f_242_equals,"openfl._legacy.geom.Matrix","equals",0x6541145e,"openfl._legacy.geom.Matrix.equals","openfl/_legacy/geom/Matrix.hx",242,0x35542610)
HX_DEFINE_STACK_FRAME(_hx_pos_a60a08489e20943f_247_identity,"openfl._legacy.geom.Matrix","identity",0xeaea711d,"openfl._legacy.geom.Matrix.identity","openfl/_legacy/geom/Matrix.hx",247,0x35542610)
HX_DEFINE_STACK_FRAME(_hx_pos_a60a08489e20943f_259_invert,"openfl._legacy.geom.Matrix","invert",0x45270d35,"openfl._legacy.geom.Matrix.invert","openfl/_legacy/geom/Matrix.hx",259,0x35542610)
HX_DEFINE_STACK_FRAME(_hx_pos_a60a08489e20943f_289_mult,"openfl._legacy.geom.Matrix","mult",0x84c7784f,"openfl._legacy.geom.Matrix.mult","openfl/_legacy/geom/Matrix.hx",289,0x35542610)
HX_DEFINE_STACK_FRAME(_hx_pos_a60a08489e20943f_306_rotate,"openfl._legacy.geom.Matrix","rotate",0x706e6c7a,"openfl._legacy.geom.Matrix.rotate","openfl/_legacy/geom/Matrix.hx",306,0x35542610)
HX_DEFINE_STACK_FRAME(_hx_pos_a60a08489e20943f_326_scale,"openfl._legacy.geom.Matrix","scale",0x123b114b,"openfl._legacy.geom.Matrix.scale","openfl/_legacy/geom/Matrix.hx",326,0x35542610)
HX_DEFINE_STACK_FRAME(_hx_pos_a60a08489e20943f_340_setRotation,"openfl._legacy.geom.Matrix","setRotation",0x8d9f5081,"openfl._legacy.geom.Matrix.setRotation","openfl/_legacy/geom/Matrix.hx",340,0x35542610)
HX_DEFINE_STACK_FRAME(_hx_pos_a60a08489e20943f_350_setTo,"openfl._legacy.geom.Matrix","setTo",0x139bd47e,"openfl._legacy.geom.Matrix.setTo","openfl/_legacy/geom/Matrix.hx",350,0x35542610)
HX_DEFINE_STACK_FRAME(_hx_pos_a60a08489e20943f_364_toString,"openfl._legacy.geom.Matrix","toString",0x6a29fc8b,"openfl._legacy.geom.Matrix.toString","openfl/_legacy/geom/Matrix.hx",364,0x35542610)
HX_DEFINE_STACK_FRAME(_hx_pos_a60a08489e20943f_371_transformPoint,"openfl._legacy.geom.Matrix","transformPoint",0x4131ac63,"openfl._legacy.geom.Matrix.transformPoint","openfl/_legacy/geom/Matrix.hx",371,0x35542610)
HX_DEFINE_STACK_FRAME(_hx_pos_a60a08489e20943f_376_translate,"openfl._legacy.geom.Matrix","translate",0x9b8b0e8f,"openfl._legacy.geom.Matrix.translate","openfl/_legacy/geom/Matrix.hx",376,0x35542610)
namespace openfl{
namespace _legacy{
namespace geom{
...
bool Matrix_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_legacy::geom::Matrix Matrix_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  32)		return  ::openfl::_legacy::geom::Matrix_obj::__alloc( HX_CTX ,this->a,this->b,this->c,this->d,this->tx,this->ty);
            	}
...
HXLINE(  40)		this->b = ((this->a * m->b) + (this->b * m->d));
HXLINE(  41)		this->a = a1;
HXLINE(  43)		HX_VARI( Float,c1) = ((this->c * m->a) + (this->d * m->c));
HXLINE(  44)		this->d = ((this->c * m->b) + (this->d * m->d));
HXLINE(  46)		this->c = c1;
HXLINE(  48)		HX_VARI( Float,tx1) = (((this->tx * m->a) + (this->ty * m->c)) + m->tx);
HXLINE(  49)		this->ty = (((this->tx * m->b) + (this->ty * m->d)) + m->ty);
...
HXLINE( 235)		return  ::openfl::_legacy::geom::Point_obj::__alloc( HX_CTX ,((point->x * this->a) + (point->y * this->c)),((point->x * this->b) + (point->y * this->d)));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Matrix_obj,invert,return )
 ...
 ::openfl::_legacy::geom::Matrix Matrix_obj::mult( ::openfl::_legacy::geom::Matrix m){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(m,"m")
HXLINE( 291)		HX_VARI(  ::openfl::_legacy::geom::Matrix,result) =  ::openfl::_legacy::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
HXLINE( 293)		result->a = ((this->a * m->a) + (this->b * m->c));
HXLINE( 294)		result->b = ((this->a * m->b) + (this->b * m->d));
HXLINE( 295)		result->c = ((this->c * m->a) + (this->d * m->c));
HXLINE( 296)		result->d = ((this->c * m->b) + (this->d * m->d));
HXLINE( 298)		result->tx = (((this->tx * m->a) + (this->ty * m->c)) + m->tx);
HXLINE( 299)		result->ty = (((this->tx * m->b) + (this->ty * m->d)) + m->ty);
...
HX_DEFINE_DYNAMIC_FUNC0(Matrix_obj,toString,return )
 ...
 ::openfl::_legacy::geom::Point Matrix_obj::transformPoint( ::openfl::_legacy::geom::Point point){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(point,"point")
HXLINE( 371)		return  ::openfl::_legacy::geom::Point_obj::__alloc( HX_CTX ,(((point->x * this->a) + (point->y * this->c)) + this->tx),(((point->x * this->b) + (point->y * this->d)) + this->ty));
            	}
