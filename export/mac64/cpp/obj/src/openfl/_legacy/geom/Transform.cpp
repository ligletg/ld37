...
HX_DEFINE_STACK_FRAME(_hx_pos_2e374971fb646e73_38_get_colorTransform,"openfl._legacy.geom.Transform","get_colorTransform",0xe3304ac2,"openfl._legacy.geom.Transform.get_colorTransform","openfl/_legacy/geom/Transform.hx",38,0xd117dfbf)
HX_DEFINE_STACK_FRAME(_hx_pos_2e374971fb646e73_39_set_colorTransform,"openfl._legacy.geom.Transform","set_colorTransform",0xbfdf7d36,"openfl._legacy.geom.Transform.set_colorTransform","openfl/_legacy/geom/Transform.hx",39,0xd117dfbf)
HX_DEFINE_STACK_FRAME(_hx_pos_2e374971fb646e73_40_get_concatenatedColorTransform,"openfl._legacy.geom.Transform","get_concatenatedColorTransform",0xd587cdb1,"openfl._legacy.geom.Transform.get_concatenatedColorTransform","openfl/_legacy/geom/Transform.hx",40,0xd117dfbf)
HX_DEFINE_STACK_FRAME(_hx_pos_2e374971fb646e73_41_get_concatenatedMatrix,"openfl._legacy.geom.Transform","get_concatenatedMatrix",0xcd19c469,"openfl._legacy.geom.Transform.get_concatenatedMatrix","openfl/_legacy/geom/Transform.hx",41,0xd117dfbf)
HX_DEFINE_STACK_FRAME(_hx_pos_2e374971fb646e73_44_get_matrix,"openfl._legacy.geom.Transform","get_matrix",0x8296487a,"openfl._legacy.geom.Transform.get_matrix","openfl/_legacy/geom/Transform.hx",44,0xd117dfbf)
HX_DEFINE_STACK_FRAME(_hx_pos_2e374971fb646e73_57_set_matrix,"openfl._legacy.geom.Transform","set_matrix",0x8613e6ee,"openfl._legacy.geom.Transform.set_matrix","openfl/_legacy/geom/Transform.hx",57,0xd117dfbf)
HX_DEFINE_STACK_FRAME(_hx_pos_2e374971fb646e73_80_get_matrix3D,"openfl._legacy.geom.Transform","get_matrix3D",0x0b1507ab,"openfl._legacy.geom.Transform.get_matrix3D","openfl/_legacy/geom/Transform.hx",80,0xd117dfbf)
HX_DEFINE_STACK_FRAME(_hx_pos_2e374971fb646e73_94_set_matrix3D,"openfl._legacy.geom.Transform","set_matrix3D",0x200e2b1f,"openfl._legacy.geom.Transform.set_matrix3D","openfl/_legacy/geom/Transform.hx",94,0xd117dfbf)
HX_DEFINE_STACK_FRAME(_hx_pos_2e374971fb646e73_118_get_pixelBounds,"openfl._legacy.geom.Transform","get_pixelBounds",0xdcf2a8c2,"openfl._legacy.geom.Transform.get_pixelBounds","openfl/_legacy/geom/Transform.hx",118,0xd117dfbf)
namespace openfl{
namespace _legacy{
namespace geom{
...
HXLINE( 109)			this->_hx___parent->_hx___setMatrix( ::openfl::_legacy::geom::Matrix_obj::__alloc( HX_CTX ,value->rawData->__get((int)0),value->rawData->__get((int)1),value->rawData->__get((int)4),value->rawData->__get((int)5),value->rawData->__get((int)12),value->rawData->__get((int)13)));
            		}
