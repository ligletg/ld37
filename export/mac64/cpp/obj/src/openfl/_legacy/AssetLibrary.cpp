...
HX_DEFINE_STACK_FRAME(_hx_pos_c4c22aed151307ca_1266_exists,"openfl._legacy.AssetLibrary","exists",0xa21c837b,"openfl._legacy.AssetLibrary.exists","openfl/_legacy/Assets.hx",1266,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_c4c22aed151307ca_1273_getBitmapData,"openfl._legacy.AssetLibrary","getBitmapData",0x1ad22e30,"openfl._legacy.AssetLibrary.getBitmapData","openfl/_legacy/Assets.hx",1273,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_c4c22aed151307ca_1280_getBytes,"openfl._legacy.AssetLibrary","getBytes",0x53c76354,"openfl._legacy.AssetLibrary.getBytes","openfl/_legacy/Assets.hx",1280,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_c4c22aed151307ca_1287_getFont,"openfl._legacy.AssetLibrary","getFont",0x28df9306,"openfl._legacy.AssetLibrary.getFont","openfl/_legacy/Assets.hx",1287,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_c4c22aed151307ca_1294_getMovieClip,"openfl._legacy.AssetLibrary","getMovieClip",0x2a5c8609,"openfl._legacy.AssetLibrary.getMovieClip","openfl/_legacy/Assets.hx",1294,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_c4c22aed151307ca_1301_getMusic,"openfl._legacy.AssetLibrary","getMusic",0xa68a2b8e,"openfl._legacy.AssetLibrary.getMusic","openfl/_legacy/Assets.hx",1301,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_c4c22aed151307ca_1308_getPath,"openfl._legacy.AssetLibrary","getPath",0x2f711adc,"openfl._legacy.AssetLibrary.getPath","openfl/_legacy/Assets.hx",1308,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_c4c22aed151307ca_1315_getSound,"openfl._legacy.AssetLibrary","getSound",0x16fbe7b8,"openfl._legacy.AssetLibrary.getSound","openfl/_legacy/Assets.hx",1315,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_c4c22aed151307ca_1320_getText,"openfl._legacy.AssetLibrary","getText",0x321901e4,"openfl._legacy.AssetLibrary.getText","openfl/_legacy/Assets.hx",1320,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_c4c22aed151307ca_1347_isLocal,"openfl._legacy.AssetLibrary","isLocal",0x2812f2a2,"openfl._legacy.AssetLibrary.isLocal","openfl/_legacy/Assets.hx",1347,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_c4c22aed151307ca_1354_list,"openfl._legacy.AssetLibrary","list",0x9ccc8c3d,"openfl._legacy.AssetLibrary.list","openfl/_legacy/Assets.hx",1354,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_c4c22aed151307ca_1361_load,"openfl._legacy.AssetLibrary","load",0x9cd10a05,"openfl._legacy.AssetLibrary.load","openfl/_legacy/Assets.hx",1361,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_c4c22aed151307ca_1368_loadBitmapData,"openfl._legacy.AssetLibrary","loadBitmapData",0x8b0b5c1e,"openfl._legacy.AssetLibrary.loadBitmapData","openfl/_legacy/Assets.hx",1368,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_c4c22aed151307ca_1375_loadBytes,"openfl._legacy.AssetLibrary","loadBytes",0x2fb8fc26,"openfl._legacy.AssetLibrary.loadBytes","openfl/_legacy/Assets.hx",1375,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_c4c22aed151307ca_1382_loadFont,"openfl._legacy.AssetLibrary","loadFont",0xeab87a74,"openfl._legacy.AssetLibrary.loadFont","openfl/_legacy/Assets.hx",1382,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_c4c22aed151307ca_1389_loadMovieClip,"openfl._legacy.AssetLibrary","loadMovieClip",0x251fefdb,"openfl._legacy.AssetLibrary.loadMovieClip","openfl/_legacy/Assets.hx",1389,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_c4c22aed151307ca_1396_loadMusic,"openfl._legacy.AssetLibrary","loadMusic",0x827bc460,"openfl._legacy.AssetLibrary.loadMusic","openfl/_legacy/Assets.hx",1396,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_c4c22aed151307ca_1403_loadSound,"openfl._legacy.AssetLibrary","loadSound",0xf2ed808a,"openfl._legacy.AssetLibrary.loadSound","openfl/_legacy/Assets.hx",1403,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_c4c22aed151307ca_1414_loadText,"openfl._legacy.AssetLibrary","loadText",0xf3f1e952,"openfl._legacy.AssetLibrary.loadText","openfl/_legacy/Assets.hx",1414,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_c4c22aed151307ca_1426_loadText,"openfl._legacy.AssetLibrary","loadText",0xf3f1e952,"openfl._legacy.AssetLibrary.loadText","openfl/_legacy/Assets.hx",1426,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_c4c22aed151307ca_1437_unload,"openfl._legacy.AssetLibrary","unload",0x47c9069e,"openfl._legacy.AssetLibrary.unload","openfl/_legacy/Assets.hx",1437,0x9276b055)
namespace openfl{
namespace _legacy{
...
HX_DEFINE_DYNAMIC_FUNC1(AssetLibrary_obj,getMovieClip,return )
 ...
 ::openfl::_legacy::media::Sound AssetLibrary_obj::getMusic(::String id){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE(1301)		return this->getSound(id);
            	}
...
::String AssetLibrary_obj::getText(::String id){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE(1324)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,bytes) = this->getBytes(id);
...
HXLINE(1361)		handler(hx::ObjectPtr<OBJ_>(this));
            	}
...
void AssetLibrary_obj::loadBitmapData(::String id, ::Dynamic handler){
            	...
            	HX_STACK_ARG(id,"id")
            	HX_STACK_ARG(handler,"handler")
HXLINE(1368)		handler(this->getBitmapData(id));
            	}
...
void AssetLibrary_obj::loadBytes(::String id, ::Dynamic handler){
            	...
            	HX_STACK_ARG(id,"id")
            	HX_STACK_ARG(handler,"handler")
HXLINE(1375)		handler(this->getBytes(id));
            	}
...
void AssetLibrary_obj::loadFont(::String id, ::Dynamic handler){
            	...
            	HX_STACK_ARG(id,"id")
            	HX_STACK_ARG(handler,"handler")
HXLINE(1382)		handler(this->getFont(id));
            	}
...
void AssetLibrary_obj::loadMovieClip(::String id, ::Dynamic handler){
            	...
            	HX_STACK_ARG(id,"id")
            	HX_STACK_ARG(handler,"handler")
HXLINE(1389)		handler(this->getMovieClip(id));
            	}
...
void AssetLibrary_obj::loadMusic(::String id, ::Dynamic handler){
            	...
            	HX_STACK_ARG(id,"id")
            	HX_STACK_ARG(handler,"handler")
HXLINE(1396)		handler(this->getMusic(id));
            	}
...
void AssetLibrary_obj::loadSound(::String id, ::Dynamic handler){
            	...
            	HX_STACK_ARG(id,"id")
            	HX_STACK_ARG(handler,"handler")
HXLINE(1403)		handler(this->getSound(id));
            	}
...
HXLINE(1420)				::String callback = bytes->readUTFBytes(bytes->length);
HXDLIN(1420)				handler(callback);
            			}
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_STACKFRAME(&_hx_pos_c4c22aed151307ca_1426_loadText)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
            	HX_STACK_ARG(handler,"handler")
HXLINE(1426)		this->loadBytes(id, ::Dynamic(new _hx_Closure_0(handler)));
            	}
