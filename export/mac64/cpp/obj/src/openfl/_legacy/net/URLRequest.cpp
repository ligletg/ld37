...
HX_DEFINE_STACK_FRAME(_hx_pos_567fe10fbce05cdc_55_basicAuth,"openfl._legacy.net.URLRequest","basicAuth",0x6693ca9d,"openfl._legacy.net.URLRequest.basicAuth","openfl/_legacy/net/URLRequest.hx",55,0xc5bb36e6)
HX_DEFINE_STACK_FRAME(_hx_pos_567fe10fbce05cdc_63_digestAuth,"openfl._legacy.net.URLRequest","digestAuth",0xbef19285,"openfl._legacy.net.URLRequest.digestAuth","openfl/_legacy/net/URLRequest.hx",63,0xc5bb36e6)
HX_DEFINE_STACK_FRAME(_hx_pos_567fe10fbce05cdc_71___prepare,"openfl._legacy.net.URLRequest","__prepare",0xdd9f87ce,"openfl._legacy.net.URLRequest.__prepare","openfl/_legacy/net/URLRequest.hx",71,0xc5bb36e6)
HX_DEFINE_STACK_FRAME(_hx_pos_567fe10fbce05cdc_12_boot,"openfl._legacy.net.URLRequest","boot",0xccf7d82b,"openfl._legacy.net.URLRequest.boot","openfl/_legacy/net/URLRequest.hx",12,0xc5bb36e6)
HX_DEFINE_STACK_FRAME(_hx_pos_567fe10fbce05cdc_13_boot,"openfl._legacy.net.URLRequest","boot",0xccf7d82b,"openfl._legacy.net.URLRequest.boot","openfl/_legacy/net/URLRequest.hx",13,0xc5bb36e6)
HX_DEFINE_STACK_FRAME(_hx_pos_567fe10fbce05cdc_14_boot,"openfl._legacy.net.URLRequest","boot",0xccf7d82b,"openfl._legacy.net.URLRequest.boot","openfl/_legacy/net/URLRequest.hx",14,0xc5bb36e6)
HX_DEFINE_STACK_FRAME(_hx_pos_567fe10fbce05cdc_15_boot,"openfl._legacy.net.URLRequest","boot",0xccf7d82b,"openfl._legacy.net.URLRequest.boot","openfl/_legacy/net/URLRequest.hx",15,0xc5bb36e6)
HX_DEFINE_STACK_FRAME(_hx_pos_567fe10fbce05cdc_16_boot,"openfl._legacy.net.URLRequest","boot",0xccf7d82b,"openfl._legacy.net.URLRequest.boot","openfl/_legacy/net/URLRequest.hx",16,0xc5bb36e6)
HX_DEFINE_STACK_FRAME(_hx_pos_567fe10fbce05cdc_17_boot,"openfl._legacy.net.URLRequest","boot",0xccf7d82b,"openfl._legacy.net.URLRequest.boot","openfl/_legacy/net/URLRequest.hx",17,0xc5bb36e6)
namespace openfl{
namespace _legacy{
namespace net{
...
HXLINE(  90)					HX_VARI( ::String,str) = ( ( ::openfl::net::URLVariables)(this->data) )->toString();
...
HXLINE(  96)						HX_VARI_NAME( ::String,str1,"str") = ( (::String)(this->data) );
...
HXLINE( 102)							HX_VARI(  ::openfl::net::URLVariables,vars) =  ::openfl::net::URLVariables_obj::__alloc( HX_CTX ,null());
HXLINE( 104)							{
HXLINE( 104)								HX_VARI( int,_g) = (int)0;
HXDLIN( 104)								HX_VARI( ::Array< ::String >,_g1) = ::Reflect_obj::fields(this->data);
HXDLIN( 104)								while((_g < _g1->length)){
HXLINE( 104)									HX_VARI( ::String,i) = _g1->__get(_g);
HXDLIN( 104)									_g = (_g + (int)1);
HXLINE( 106)									::Reflect_obj::setField(vars,i,::Reflect_obj::field(this->data,i));
            								}
            							}
HXLINE( 110)							HX_VARI_NAME( ::String,str2,"str") = vars->toString();
