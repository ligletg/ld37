...
HX_DEFINE_STACK_FRAME(_hx_pos_14f5ddd2e4dd829a_211_close,"openfl._legacy.net.URLLoader","close",0xa8c42b97,"openfl._legacy.net.URLLoader.close","openfl/_legacy/net/URLLoader.hx",211,0xef414054)
HX_DEFINE_STACK_FRAME(_hx_pos_14f5ddd2e4dd829a_218_dispatchHTTPStatus,"openfl._legacy.net.URLLoader","dispatchHTTPStatus",0xa730fcd5,"openfl._legacy.net.URLLoader.dispatchHTTPStatus","openfl/_legacy/net/URLLoader.hx",218,0xef414054)
HX_DEFINE_STACK_FRAME(_hx_pos_14f5ddd2e4dd829a_240_getCookies,"openfl._legacy.net.URLLoader","getCookies",0x87bf411a,"openfl._legacy.net.URLLoader.getCookies","openfl/_legacy/net/URLLoader.hx",240,0xef414054)
HX_DEFINE_STACK_FRAME(_hx_pos_14f5ddd2e4dd829a_260_load,"openfl._legacy.net.URLLoader","load",0xd559e727,"openfl._legacy.net.URLLoader.load","openfl/_legacy/net/URLLoader.hx",260,0xef414054)
HX_DEFINE_STACK_FRAME(_hx_pos_14f5ddd2e4dd829a_265_loadInCURLThread,"openfl._legacy.net.URLLoader","loadInCURLThread",0x330ed8c2,"openfl._legacy.net.URLLoader.loadInCURLThread","openfl/_legacy/net/URLLoader.hx",265,0xef414054)
HX_DEFINE_STACK_FRAME(_hx_pos_14f5ddd2e4dd829a_320_onError,"openfl._legacy.net.URLLoader","onError",0x131c73c8,"openfl._legacy.net.URLLoader.onError","openfl/_legacy/net/URLLoader.hx",320,0xef414054)
HX_DEFINE_STACK_FRAME(_hx_pos_14f5ddd2e4dd829a_330_update,"openfl._legacy.net.URLLoader","update",0x7b95d54a,"openfl._legacy.net.URLLoader.update","openfl/_legacy/net/URLLoader.hx",330,0xef414054)
HX_DEFINE_STACK_FRAME(_hx_pos_14f5ddd2e4dd829a_379___dataComplete,"openfl._legacy.net.URLLoader","__dataComplete",0x1fc1c864,"openfl._legacy.net.URLLoader.__dataComplete","openfl/_legacy/net/URLLoader.hx",379,0xef414054)
HX_DEFINE_STACK_FRAME(_hx_pos_14f5ddd2e4dd829a_246_hasActive,"openfl._legacy.net.URLLoader","hasActive",0xff70e41f,"openfl._legacy.net.URLLoader.hasActive","openfl/_legacy/net/URLLoader.hx",246,0xef414054)
HX_DEFINE_STACK_FRAME(_hx_pos_14f5ddd2e4dd829a_253_initialize,"openfl._legacy.net.URLLoader","initialize",0x7e2ab511,"openfl._legacy.net.URLLoader.initialize","openfl/_legacy/net/URLLoader.hx",253,0xef414054)
HX_DEFINE_STACK_FRAME(_hx_pos_14f5ddd2e4dd829a_406___loadPending,"openfl._legacy.net.URLLoader","__loadPending",0x19792290,"openfl._legacy.net.URLLoader.__loadPending","openfl/_legacy/net/URLLoader.hx",406,0xef414054)
HX_DEFINE_STACK_FRAME(_hx_pos_14f5ddd2e4dd829a_411_enqueueEvent,"openfl._legacy.net.URLLoader","enqueueEvent",0x05a8e873,"openfl._legacy.net.URLLoader.enqueueEvent","openfl/_legacy/net/URLLoader.hx",411,0xef414054)
HX_DEFINE_STACK_FRAME(_hx_pos_14f5ddd2e4dd829a_414___pollData,"openfl._legacy.net.URLLoader","__pollData",0xcd9682ea,"openfl._legacy.net.URLLoader.__pollData","openfl/_legacy/net/URLLoader.hx",414,0xef414054)
HX_DEFINE_STACK_FRAME(_hx_pos_14f5ddd2e4dd829a_174_boot,"openfl._legacy.net.URLLoader","boot",0xcebdd133,"openfl._legacy.net.URLLoader.boot","openfl/_legacy/net/URLLoader.hx",174,0xef414054)
HX_DEFINE_STACK_FRAME(_hx_pos_14f5ddd2e4dd829a_175_boot,"openfl._legacy.net.URLLoader","boot",0xcebdd133,"openfl._legacy.net.URLLoader.boot","openfl/_legacy/net/URLLoader.hx",175,0xef414054)
HX_DEFINE_STACK_FRAME(_hx_pos_14f5ddd2e4dd829a_178_boot,"openfl._legacy.net.URLLoader","boot",0xcebdd133,"openfl._legacy.net.URLLoader.boot","openfl/_legacy/net/URLLoader.hx",178,0xef414054)
HX_DEFINE_STACK_FRAME(_hx_pos_14f5ddd2e4dd829a_180_boot,"openfl._legacy.net.URLLoader","boot",0xcebdd133,"openfl._legacy.net.URLLoader.boot","openfl/_legacy/net/URLLoader.hx",180,0xef414054)
HX_DEFINE_STACK_FRAME(_hx_pos_14f5ddd2e4dd829a_181_boot,"openfl._legacy.net.URLLoader","boot",0xcebdd133,"openfl._legacy.net.URLLoader.boot","openfl/_legacy/net/URLLoader.hx",181,0xef414054)
HX_DEFINE_STACK_FRAME(_hx_pos_14f5ddd2e4dd829a_186_boot,"openfl._legacy.net.URLLoader","boot",0xcebdd133,"openfl._legacy.net.URLLoader.boot","openfl/_legacy/net/URLLoader.hx",186,0xef414054)
namespace openfl{
namespace _legacy{
namespace net{
...
HXLINE( 220)		HX_VARI(  ::openfl::_legacy::events::HTTPStatusEvent,event) =  ::openfl::_legacy::events::HTTPStatusEvent_obj::__alloc( HX_CTX ,::openfl::_legacy::events::HTTPStatusEvent_obj::HTTP_STATUS,false,false,code);
HXLINE( 221)		HX_VARI( ::Array< ::String >,headers) = ::openfl::_legacy::net::_URLLoader::URLLoadersManager_obj::getInstance()->getHeaders(this->_hx___handle);
HXLINE( 223)		{
HXLINE( 223)			HX_VARI( int,_g) = (int)0;
HXDLIN( 223)			while((_g < headers->length)){
HXLINE( 223)				HX_VARI( ::String,header) = headers->__get(_g);
HXDLIN( 223)				_g = (_g + (int)1);
HXLINE( 225)				HX_VARI( int,index) = header.indexOf(HX_(": ",a6,32,00,00),null());
HXLINE( 226)				if ((index > (int)0)) {
HXLINE( 228)					HX_VARI_NAME( ::Array< ::Dynamic>,event1,"event") = event->responseHeaders;
...
HXLINE( 269)		HX_VARI( ::String,pref) = request->url.substr((int)0,(int)7);
...
HXLINE( 274)				HX_VARI(  ::openfl::_legacy::utils::ByteArray,bytes) = ::openfl::_legacy::utils::ByteArray_obj::readFile(request->url);
...
HXLINE( 282)				 ::Dynamic _hx_switch_0 = this->dataFormat;
...
HXLINE( 332)			HX_VARI( int,old_loaded) = this->bytesLoaded;
HXLINE( 333)			HX_VARI( int,old_total) = this->bytesTotal;
...
HXLINE( 342)				::openfl::_legacy::net::URLLoader_obj::enqueueEvent(hx::ObjectPtr<OBJ_>(this), ::openfl::events::ProgressEvent_obj::__alloc( HX_CTX ,HX_("progress",ad,f7,2a,86),false,false,this->bytesLoaded,this->bytesTotal));
            			}
HXLINE( 345)			HX_VARI( int,code) = ::openfl::_legacy::net::_URLLoader::URLLoadersManager_obj::getInstance()->getCode(this->_hx___handle);
HXLINE( 347)			if ((this->state == (int)3)) {
HXLINE( 349)				this->dispatchHTTPStatus(code);
HXLINE( 350)				HX_VARI(  ::openfl::_legacy::utils::ByteArray,bytes) = ::openfl::_legacy::net::_URLLoader::URLLoadersManager_obj::getInstance()->getData(this->_hx___handle);
HXLINE( 351)				 ::Dynamic _hx_switch_0 = this->dataFormat;
...
HXLINE( 361)					HX_VARI(  ::openfl::events::IOErrorEvent,event) =  ::openfl::events::IOErrorEvent_obj::__alloc( HX_CTX ,HX_("ioError",02,fe,41,76),true,false,this->data,code);
...
HXLINE( 369)					HX_VARI_NAME(  ::openfl::events::IOErrorEvent,event1,"event") =  ::openfl::events::IOErrorEvent_obj::__alloc( HX_CTX ,HX_("ioError",02,fe,41,76),true,false,::openfl::_legacy::net::_URLLoader::URLLoadersManager_obj::getInstance()->getErrorMessage(this->_hx___handle),code);
...
HXLINE( 416)		HX_VARI(  ::Dynamic,evt) = ::openfl::_legacy::net::URLLoader_obj::eventsQueue->shift();
