...
HX_DEFINE_STACK_FRAME(_hx_pos_0edee752e4d83061_79_getByteBuffer,"openfl._legacy.utils.ArrayBufferView","getByteBuffer",0x3010f1ed,"openfl._legacy.utils.ArrayBufferView.getByteBuffer","openfl/_legacy/utils/ArrayBufferView.hx",79,0xb2044664)
HX_DEFINE_STACK_FRAME(_hx_pos_0edee752e4d83061_87_getFloat32,"openfl._legacy.utils.ArrayBufferView","getFloat32",0x59ee0856,"openfl._legacy.utils.ArrayBufferView.getFloat32","openfl/_legacy/utils/ArrayBufferView.hx",87,0xb2044664)
HX_DEFINE_STACK_FRAME(_hx_pos_0edee752e4d83061_99_getInt16,"openfl._legacy.utils.ArrayBufferView","getInt16",0x25f27bef,"openfl._legacy.utils.ArrayBufferView.getInt16","openfl/_legacy/utils/ArrayBufferView.hx",99,0xb2044664)
HX_DEFINE_STACK_FRAME(_hx_pos_0edee752e4d83061_111_getInt32,"openfl._legacy.utils.ArrayBufferView","getInt32",0x25f27da9,"openfl._legacy.utils.ArrayBufferView.getInt32","openfl/_legacy/utils/ArrayBufferView.hx",111,0xb2044664)
HX_DEFINE_STACK_FRAME(_hx_pos_0edee752e4d83061_122_getLength,"openfl._legacy.utils.ArrayBufferView","getLength",0x0ee2ba2b,"openfl._legacy.utils.ArrayBufferView.getLength","openfl/_legacy/utils/ArrayBufferView.hx",122,0xb2044664)
HX_DEFINE_STACK_FRAME(_hx_pos_0edee752e4d83061_130_getNativePointer,"openfl._legacy.utils.ArrayBufferView","getNativePointer",0xd6cecd41,"openfl._legacy.utils.ArrayBufferView.getNativePointer","openfl/_legacy/utils/ArrayBufferView.hx",130,0xb2044664)
HX_DEFINE_STACK_FRAME(_hx_pos_0edee752e4d83061_140_getStart,"openfl._legacy.utils.ArrayBufferView","getStart",0xebdd5ebd,"openfl._legacy.utils.ArrayBufferView.getStart","openfl/_legacy/utils/ArrayBufferView.hx",140,0xb2044664)
HX_DEFINE_STACK_FRAME(_hx_pos_0edee752e4d83061_148_getUInt8,"openfl._legacy.utils.ArrayBufferView","getUInt8",0xf64839d9,"openfl._legacy.utils.ArrayBufferView.getUInt8","openfl/_legacy/utils/ArrayBufferView.hx",148,0xb2044664)
HX_DEFINE_STACK_FRAME(_hx_pos_0edee752e4d83061_160_setFloat32,"openfl._legacy.utils.ArrayBufferView","setFloat32",0x5d6ba6ca,"openfl._legacy.utils.ArrayBufferView.setFloat32","openfl/_legacy/utils/ArrayBufferView.hx",160,0xb2044664)
HX_DEFINE_STACK_FRAME(_hx_pos_0edee752e4d83061_172_setInt16,"openfl._legacy.utils.ArrayBufferView","setInt16",0xd44fd563,"openfl._legacy.utils.ArrayBufferView.setInt16","openfl/_legacy/utils/ArrayBufferView.hx",172,0xb2044664)
HX_DEFINE_STACK_FRAME(_hx_pos_0edee752e4d83061_184_setInt32,"openfl._legacy.utils.ArrayBufferView","setInt32",0xd44fd71d,"openfl._legacy.utils.ArrayBufferView.setInt32","openfl/_legacy/utils/ArrayBufferView.hx",184,0xb2044664)
HX_DEFINE_STACK_FRAME(_hx_pos_0edee752e4d83061_196_setUInt8,"openfl._legacy.utils.ArrayBufferView","setUInt8",0xa4a5934d,"openfl._legacy.utils.ArrayBufferView.setUInt8","openfl/_legacy/utils/ArrayBufferView.hx",196,0xb2044664)
HX_DEFINE_STACK_FRAME(_hx_pos_0edee752e4d83061_18_boot,"openfl._legacy.utils.ArrayBufferView","boot",0x79da6283,"openfl._legacy.utils.ArrayBufferView.boot","openfl/_legacy/utils/ArrayBufferView.hx",18,0xb2044664)
namespace openfl{
namespace _legacy{
namespace utils{
...
HXLINE(  87)		::Array< unsigned char > _hx_tmp = this->bytes;
...
int ArrayBufferView_obj::getInt16(int position){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(position,"position")
HXLINE(  99)		::Array< unsigned char > _hx_tmp = this->bytes;
...
int ArrayBufferView_obj::getInt32(int position){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(position,"position")
HXLINE( 111)		::Array< unsigned char > _hx_tmp = this->bytes;
...
int ArrayBufferView_obj::getUInt8(int position){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(position,"position")
HXLINE( 148)		::Array< unsigned char > _hx_tmp = this->bytes;
...
HXLINE( 160)		::Array< unsigned char > _hx_tmp = this->bytes;
...
void ArrayBufferView_obj::setInt16(int position,int value){
            	...
            	HX_STACK_ARG(position,"position")
            	HX_STACK_ARG(value,"value")
HXLINE( 172)		::Array< unsigned char > _hx_tmp = this->bytes;
...
void ArrayBufferView_obj::setInt32(int position,int value){
            	...
            	HX_STACK_ARG(position,"position")
            	HX_STACK_ARG(value,"value")
HXLINE( 184)		::Array< unsigned char > _hx_tmp = this->bytes;
...
void ArrayBufferView_obj::setUInt8(int position,int value){
            	...
            	HX_STACK_ARG(position,"position")
            	HX_STACK_ARG(value,"value")
HXLINE( 196)		::Array< unsigned char > _hx_tmp = this->bytes;
