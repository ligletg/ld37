...
HX_DEFINE_STACK_FRAME(_hx_pos_78e25bd7169acb7a_1715_onComplete,"openfl._legacy.Future","onComplete",0x222e6abf,"openfl._legacy.Future.onComplete","openfl/_legacy/Assets.hx",1715,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_78e25bd7169acb7a_1742_onError,"openfl._legacy.Future","onError",0x410f8202,"openfl._legacy.Future.onError","openfl/_legacy/Assets.hx",1742,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_78e25bd7169acb7a_1769_onProgress,"openfl._legacy.Future","onProgress",0x289161b3,"openfl._legacy.Future.onProgress","openfl/_legacy/Assets.hx",1769,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_78e25bd7169acb7a_1790_then,"openfl._legacy.Future","then",0x005d7964,"openfl._legacy.Future.then","openfl/_legacy/Assets.hx",1790,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_78e25bd7169acb7a_1807_then,"openfl._legacy.Future","then",0x005d7964,"openfl._legacy.Future.then","openfl/_legacy/Assets.hx",1807,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_78e25bd7169acb7a_1831_get_isCompleted,"openfl._legacy.Future","get_isCompleted",0x8d5428b1,"openfl._legacy.Future.get_isCompleted","openfl/_legacy/Assets.hx",1831,0x9276b055)
namespace openfl{
namespace _legacy{
...
HXLINE(1694)		if (hx::IsNotNull( work )) {
HXLINE(1696)			HX_VARI(  ::openfl::_legacy::Promise,promise) =  ::openfl::_legacy::Promise_obj::__alloc( HX_CTX );
HXLINE(1697)			promise->future = hx::ObjectPtr<OBJ_>(this);
HXLINE(1699)			try {
            				HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE(1702)				promise->complete(work());
            			}
            			catch( ::Dynamic _hx_e){
...
HXLINE(1790)		if (this->_hx___completed) {
HXLINE(1792)			return next(this->value);
            		}
            		else {
HXLINE(1794)			if (this->_hx___errored) {
HXLINE(1796)				HX_VARI(  ::openfl::_legacy::Future,future) =  ::openfl::_legacy::Future_obj::__alloc( HX_CTX ,null());
...
HXLINE(1809)					HX_VARI_NAME(  ::openfl::_legacy::Future,future1,"future") = ( ( ::openfl::_legacy::Future)(next(val)) );
HXLINE(1810)					future1->onError(promise->error_dyn());
HXLINE(1811)					future1->onComplete(promise->complete_dyn());
            				}
            				HX_END_LOCAL_FUNC1((void))

HXLINE(1802)				HX_VARI(  ::openfl::_legacy::Promise,promise) =  ::openfl::_legacy::Promise_obj::__alloc( HX_CTX );
...
bool Future_obj::get_isCompleted(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1831)		if (!(this->_hx___completed)) {
HXLINE(1831)			return this->_hx___errored;
            		}
            		else {
