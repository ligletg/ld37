...
HX_DEFINE_STACK_FRAME(_hx_pos_d3f310d7f87f6475_362_add,"openfl._legacy.media.AudioThreadState","add",0x785b05b2,"openfl._legacy.media.AudioThreadState.add","openfl/_legacy/media/SoundChannel.hx",362,0xd2a8ca59)
HX_DEFINE_STACK_FRAME(_hx_pos_d3f310d7f87f6475_372_remove,"openfl._legacy.media.AudioThreadState","remove",0x1bfd5953,"openfl._legacy.media.AudioThreadState.remove","openfl/_legacy/media/SoundChannel.hx",372,0xd2a8ca59)
HX_DEFINE_STACK_FRAME(_hx_pos_d3f310d7f87f6475_401_updateComplete,"openfl._legacy.media.AudioThreadState","updateComplete",0xf710d7f1,"openfl._legacy.media.AudioThreadState.updateComplete","openfl/_legacy/media/SoundChannel.hx",401,0xd2a8ca59)
namespace openfl{
namespace _legacy{
namespace media{
...
HXLINE( 362)		if (!(::Lambda_obj::has(this->channelList,channel))) {
...
HXLINE( 405)		{
HXLINE( 405)			HX_VARI( int,_g) = (int)0;
HXDLIN( 405)			HX_VARI( ::Array< ::Dynamic>,_g1) = this->channelList;
HXDLIN( 405)			while((_g < _g1->length)){
HXLINE( 405)				HX_VARI(  ::openfl::_legacy::media::SoundChannel,channel) = _g1->__get(_g).StaticCast<  ::openfl::_legacy::media::SoundChannel >();
