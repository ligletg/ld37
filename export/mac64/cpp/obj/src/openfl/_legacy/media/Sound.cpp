...
HX_DEFINE_STACK_FRAME(_hx_pos_2862c8c6e0e16506_65_addEventListener,"openfl._legacy.media.Sound","addEventListener",0xf036769a,"openfl._legacy.media.Sound.addEventListener","openfl/_legacy/media/Sound.hx",65,0xdb1efaa0)
HX_DEFINE_STACK_FRAME(_hx_pos_2862c8c6e0e16506_85_close,"openfl._legacy.media.Sound","close",0xfab0cfcb,"openfl._legacy.media.Sound.close","openfl/_legacy/media/Sound.hx",85,0xdb1efaa0)
HX_DEFINE_STACK_FRAME(_hx_pos_2862c8c6e0e16506_110_load,"openfl._legacy.media.Sound","load",0x128fc573,"openfl._legacy.media.Sound.load","openfl/_legacy/media/Sound.hx",110,0xdb1efaa0)
HX_DEFINE_STACK_FRAME(_hx_pos_2862c8c6e0e16506_136_loadCompressedDataFromByteArray,"openfl._legacy.media.Sound","loadCompressedDataFromByteArray",0x906313a9,"openfl._legacy.media.Sound.loadCompressedDataFromByteArray","openfl/_legacy/media/Sound.hx",136,0xdb1efaa0)
HX_DEFINE_STACK_FRAME(_hx_pos_2862c8c6e0e16506_152_loadPCMFromByteArray,"openfl._legacy.media.Sound","loadPCMFromByteArray",0x1758a6c0,"openfl._legacy.media.Sound.loadPCMFromByteArray","openfl/_legacy/media/Sound.hx",152,0xdb1efaa0)
HX_DEFINE_STACK_FRAME(_hx_pos_2862c8c6e0e16506_200_play,"openfl._legacy.media.Sound","play",0x15325941,"openfl._legacy.media.Sound.play","openfl/_legacy/media/Sound.hx",200,0xdb1efaa0)
HX_DEFINE_STACK_FRAME(_hx_pos_2862c8c6e0e16506_251___checkLoading,"openfl._legacy.media.Sound","__checkLoading",0xfefc3741,"openfl._legacy.media.Sound.__checkLoading","openfl/_legacy/media/Sound.hx",251,0xdb1efaa0)
HX_DEFINE_STACK_FRAME(_hx_pos_2862c8c6e0e16506_276___onError,"openfl._legacy.media.Sound","__onError",0x92dc789c,"openfl._legacy.media.Sound.__onError","openfl/_legacy/media/Sound.hx",276,0xdb1efaa0)
HX_DEFINE_STACK_FRAME(_hx_pos_2862c8c6e0e16506_292_get_id3,"openfl._legacy.media.Sound","get_id3",0x51feef62,"openfl._legacy.media.Sound.get_id3","openfl/_legacy/media/Sound.hx",292,0xdb1efaa0)
HX_DEFINE_STACK_FRAME(_hx_pos_2862c8c6e0e16506_309_get_isBuffering,"openfl._legacy.media.Sound","get_isBuffering",0x33178c02,"openfl._legacy.media.Sound.get_isBuffering","openfl/_legacy/media/Sound.hx",309,0xdb1efaa0)
HX_DEFINE_STACK_FRAME(_hx_pos_2862c8c6e0e16506_317_get_length,"openfl._legacy.media.Sound","get_length",0xa94e27bc,"openfl._legacy.media.Sound.get_length","openfl/_legacy/media/Sound.hx",317,0xdb1efaa0)
HX_DEFINE_STACK_FRAME(_hx_pos_2862c8c6e0e16506_337_boot,"openfl._legacy.media.Sound","boot",0x0bf3af7f,"openfl._legacy.media.Sound.boot","openfl/_legacy/media/Sound.hx",337,0xdb1efaa0)
HX_DEFINE_STACK_FRAME(_hx_pos_2862c8c6e0e16506_338_boot,"openfl._legacy.media.Sound","boot",0x0bf3af7f,"openfl._legacy.media.Sound.boot","openfl/_legacy/media/Sound.hx",338,0xdb1efaa0)
HX_DEFINE_STACK_FRAME(_hx_pos_2862c8c6e0e16506_339_boot,"openfl._legacy.media.Sound","boot",0x0bf3af7f,"openfl._legacy.media.Sound.boot","openfl/_legacy/media/Sound.hx",339,0xdb1efaa0)
HX_DEFINE_STACK_FRAME(_hx_pos_2862c8c6e0e16506_340_boot,"openfl._legacy.media.Sound","boot",0x0bf3af7f,"openfl._legacy.media.Sound.boot","openfl/_legacy/media/Sound.hx",340,0xdb1efaa0)
HX_DEFINE_STACK_FRAME(_hx_pos_2862c8c6e0e16506_341_boot,"openfl._legacy.media.Sound","boot",0x0bf3af7f,"openfl._legacy.media.Sound.boot","openfl/_legacy/media/Sound.hx",341,0xdb1efaa0)
HX_DEFINE_STACK_FRAME(_hx_pos_2862c8c6e0e16506_342_boot,"openfl._legacy.media.Sound","boot",0x0bf3af7f,"openfl._legacy.media.Sound.boot","openfl/_legacy/media/Sound.hx",342,0xdb1efaa0)
HX_DEFINE_STACK_FRAME(_hx_pos_2862c8c6e0e16506_343_boot,"openfl._legacy.media.Sound","boot",0x0bf3af7f,"openfl._legacy.media.Sound.boot","openfl/_legacy/media/Sound.hx",343,0xdb1efaa0)
namespace openfl{
namespace _legacy{
namespace media{
...
HXLINE( 119)			::haxe::Log_obj::trace(((HX_("Error: Could not load \"",42,96,d0,bd) + stream->url) + HX_("\"",22,00,00,00)),hx::SourceInfo(HX_("Sound.hx",6f,1d,3b,f3),119,HX_("openfl._legacy.media.Sound",41,f8,25,4a),HX_("load",26,9a,b7,47)));
...
HXLINE( 141)		this->_hx___handle = ::openfl::_legacy::media::Sound_obj::lime_sound_from_data(bytes,length,forcePlayAsMusic);
...
HXLINE( 154)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,wav) =  ::openfl::_legacy::utils::ByteArray_obj::__alloc( HX_CTX ,null());
HXLINE( 155)		wav->set_endian(::openfl::utils::_Endian::Endian_Impl__obj::toString((int)1));
HXLINE( 157)		HX_VAR( int,audioFormat);
...
HXLINE( 161)			HX_STACK_DO_THROW( ::openfl::errors::Error_obj::__alloc( HX_CTX ,(HX_("Unsupported format ",7e,06,66,fe) + format),null()));
            		...
            		_hx_goto_5:;
HXLINE( 165)		HX_VAR( int,numChannels);
...
HXLINE( 166)		HX_VARI_NAME( int,sampleRate1,"sampleRate") = ::Std_obj::_hx_int(sampleRate);
HXLINE( 167)		HX_VAR( int,bitsPerSample);
...
HXLINE( 171)			HX_STACK_DO_THROW( ::openfl::errors::Error_obj::__alloc( HX_CTX ,(HX_("Unsupported format ",7e,06,66,fe) + format),null()));
            		...
            		_hx_goto_6:;
HXLINE( 175)		HX_VARI( int,byteRate) = ::Std_obj::_hx_int(((Float)((sampleRate1 * numChannels) * bitsPerSample) / (Float)(int)8));
HXLINE( 176)		HX_VARI( int,blockAlign) = ::Std_obj::_hx_int(((Float)(numChannels * bitsPerSample) / (Float)(int)8));
HXLINE( 177)		::Std_obj::_hx_int(((Float)bytes->length / (Float)blockAlign));
...
HXLINE( 206)			HX_VARI(  ::openfl::events::SampleDataEvent,request) =  ::openfl::events::SampleDataEvent_obj::__alloc( HX_CTX ,HX_("sampleData",74,3f,0b,5e),null(),null());
...
HXLINE( 217)				HX_VARI(  ::openfl::_legacy::media::SoundChannel,channel) =  ::openfl::_legacy::media::SoundChannel_obj::__alloc( HX_CTX ,null(),startTime,loops,soundTransform);
HXLINE( 218)				channel->_hx___soundInstance = hx::ObjectPtr<OBJ_>(this);
HXLINE( 220)				return channel;
            			}
HXLINE( 224)			HX_VARI(  ::openfl::_legacy::media::SoundChannel,result) = ::openfl::_legacy::media::SoundChannel_obj::createDynamic(this->_hx___handle,soundTransform,hx::ObjectPtr<OBJ_>(this));
...
HXLINE( 232)				HX_VARI_NAME(  ::openfl::_legacy::media::SoundChannel,channel1,"channel") =  ::openfl::_legacy::media::SoundChannel_obj::__alloc( HX_CTX ,null(),startTime,loops,soundTransform);
HXLINE( 233)				channel1->_hx___soundInstance = hx::ObjectPtr<OBJ_>(this);
HXLINE( 235)				return channel1;
            			}
HXLINE( 239)			HX_VARI_NAME(  ::openfl::_legacy::media::SoundChannel,channel2,"channel") =  ::openfl::_legacy::media::SoundChannel_obj::__alloc( HX_CTX ,this->_hx___handle,startTime,loops,soundTransform);
...
HXLINE( 251)			_hx_tmp1 = this->_hx___loading;
            		}
            		else {
HXLINE( 251)			_hx_tmp1 = false;
            		}
HXDLIN( 251)		if (_hx_tmp1) {
HXLINE( 251)			_hx_tmp = hx::IsNotNull( this->_hx___handle );
            		}
            		else {
HXLINE( 251)			_hx_tmp = false;
            		}
HXDLIN( 251)		if (_hx_tmp) {
HXLINE( 253)			HX_VARI(  ::Dynamic,status) = ::openfl::_legacy::media::Sound_obj::lime_sound_get_status(this->_hx___handle);
...
HXLINE( 302)		HX_VARI(  ::openfl::media::ID3Info,id3) =  ::openfl::media::ID3Info_obj::__alloc( HX_CTX );
...
HXLINE( 325)		return ::openfl::_legacy::media::Sound_obj::lime_sound_get_length(this->_hx___handle);
            	}
...
HXLINE( 337)		lime_sound_from_file = ::openfl::_legacy::Lib_obj::load(HX_("lime-legacy",c1,7f,b9,87),HX_("lime_legacy_sound_from_file",f5,6f,9a,2f),(int)2);
            	}
{
            	HX_STACKFRAME(&_hx_pos_2862c8c6e0e16506_338_boot)
HXLINE( 338)		lime_sound_from_data = ::openfl::_legacy::Lib_obj::load(HX_("lime-legacy",c1,7f,b9,87),HX_("lime_legacy_sound_from_data",a3,f7,41,2e),(int)3);
            	}
{
            	HX_STACKFRAME(&_hx_pos_2862c8c6e0e16506_339_boot)
HXLINE( 339)		lime_sound_get_id3 = ::openfl::_legacy::Lib_obj::load(HX_("lime-legacy",c1,7f,b9,87),HX_("lime_legacy_sound_get_id3",d3,be,22,75),(int)2);
            	}
{
            	HX_STACKFRAME(&_hx_pos_2862c8c6e0e16506_340_boot)
HXLINE( 340)		lime_sound_get_length = ::openfl::_legacy::Lib_obj::load(HX_("lime-legacy",c1,7f,b9,87),HX_("lime_legacy_sound_get_length",eb,d4,e6,fb),(int)1);
            	}
{
            	HX_STACKFRAME(&_hx_pos_2862c8c6e0e16506_341_boot)
HXLINE( 341)		lime_sound_close = ::openfl::_legacy::Lib_obj::load(HX_("lime-legacy",c1,7f,b9,87),HX_("lime_legacy_sound_close",fc,30,15,f3),(int)1);
            	}
{
            	HX_STACKFRAME(&_hx_pos_2862c8c6e0e16506_342_boot)
HXLINE( 342)		lime_sound_get_status = ::openfl::_legacy::Lib_obj::load(HX_("lime-legacy",c1,7f,b9,87),HX_("lime_legacy_sound_get_status",37,27,db,62),(int)1);
            	}
{
            	HX_STACKFRAME(&_hx_pos_2862c8c6e0e16506_343_boot)
HXLINE( 343)		lime_sound_channel_create_dynamic = ::openfl::_legacy::Lib_obj::load(HX_("lime-legacy",c1,7f,b9,87),HX_("lime_legacy_sound_channel_create_dynamic",74,91,c1,2c),(int)2);
            	}
}
