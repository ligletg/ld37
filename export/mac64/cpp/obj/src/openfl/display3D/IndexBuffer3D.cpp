...
HX_DEFINE_STACK_FRAME(_hx_pos_0f6a02916d47e310_32_dispose,"openfl.display3D.IndexBuffer3D","dispose",0xbcffb1db,"openfl.display3D.IndexBuffer3D.dispose","openfl/display3D/IndexBuffer3D.hx",32,0x3d934296)
HX_DEFINE_STACK_FRAME(_hx_pos_0f6a02916d47e310_37_uploadFromByteArray,"openfl.display3D.IndexBuffer3D","uploadFromByteArray",0x61713322,"openfl.display3D.IndexBuffer3D.uploadFromByteArray","openfl/display3D/IndexBuffer3D.hx",37,0x3d934296)
HX_DEFINE_STACK_FRAME(_hx_pos_0f6a02916d47e310_67_uploadFromVector,"openfl.display3D.IndexBuffer3D","uploadFromVector",0xaabe3672,"openfl.display3D.IndexBuffer3D.uploadFromVector","openfl/display3D/IndexBuffer3D.hx",67,0x3d934296)
HX_DEFINE_STACK_FRAME(_hx_pos_0f6a02916d47e310_89_uploadFromInt16Array,"openfl.display3D.IndexBuffer3D","uploadFromInt16Array",0x04669c94,"openfl.display3D.IndexBuffer3D.uploadFromInt16Array","openfl/display3D/IndexBuffer3D.hx",89,0x3d934296)
namespace openfl{
namespace display3D{
...
HXLINE(  44)		HX_VARI(  ::openfl::_legacy::utils::Int16Array,indices) =  ::openfl::_legacy::utils::Int16Array_obj::__alloc( HX_CTX ,byteArray,(byteArrayOffset + (startOffset * (int)2)),(count * (int)2));
HXLINE(  62)		{
HXLINE(  62)			int usage = this->bufferUsage;
HXDLIN(  62)			 ::openfl::_legacy::utils::ByteArray _hx_tmp1 = ::openfl::_legacy::utils::IMemoryRange_obj::getByteBuffer(indices);
HXDLIN(  62)			int _hx_tmp2 = ::openfl::_legacy::utils::IMemoryRange_obj::getStart(indices);
HXDLIN(  62)			int _hx_tmp3 = ::openfl::_legacy::utils::IMemoryRange_obj::getLength(indices);
HXDLIN(  62)			::openfl::_legacy::gl::GL_obj::lime_gl_buffer_data((int)34963,_hx_tmp1,_hx_tmp2,_hx_tmp3,usage);
            		}
            	}
...
HXLINE(  70)		HX_VARI(  ::openfl::_legacy::utils::Int16Array,indices) =  ::openfl::_legacy::utils::Int16Array_obj::__alloc( HX_CTX ,data,startOffset,count);
HXLINE(  84)		{
HXLINE(  84)			int usage = this->bufferUsage;
HXDLIN(  84)			 ::openfl::_legacy::utils::ByteArray _hx_tmp1 = ::openfl::_legacy::utils::IMemoryRange_obj::getByteBuffer(indices);
HXDLIN(  84)			int _hx_tmp2 = ::openfl::_legacy::utils::IMemoryRange_obj::getStart(indices);
HXDLIN(  84)			int _hx_tmp3 = ::openfl::_legacy::utils::IMemoryRange_obj::getLength(indices);
HXDLIN(  84)			::openfl::_legacy::gl::GL_obj::lime_gl_buffer_data((int)34963,_hx_tmp1,_hx_tmp2,_hx_tmp3,usage);
            		}
            	}
...
HXDLIN(  92)			 ::openfl::_legacy::utils::ByteArray _hx_tmp1 = ::openfl::_legacy::utils::IMemoryRange_obj::getByteBuffer(data);
HXDLIN(  92)			int _hx_tmp2 = ::openfl::_legacy::utils::IMemoryRange_obj::getStart(data);
HXDLIN(  92)			int _hx_tmp3 = ::openfl::_legacy::utils::IMemoryRange_obj::getLength(data);
HXDLIN(  92)			::openfl::_legacy::gl::GL_obj::lime_gl_buffer_data((int)34963,_hx_tmp1,_hx_tmp2,_hx_tmp3,usage);
            		}
            	}
