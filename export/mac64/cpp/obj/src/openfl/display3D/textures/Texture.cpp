...
HX_DEFINE_STACK_FRAME(_hx_pos_c910f1c2855eeb73_58_uploadCompressedTextureFromByteArray,"openfl.display3D.textures.Texture","uploadCompressedTextureFromByteArray",0xe2c5b53e,"openfl.display3D.textures.Texture.uploadCompressedTextureFromByteArray","openfl/display3D/textures/Texture.hx",58,0x3ee19dbf)
HX_DEFINE_STACK_FRAME(_hx_pos_c910f1c2855eeb73_65_uploadFromBitmapData,"openfl.display3D.textures.Texture","uploadFromBitmapData",0x5c4e9314,"openfl.display3D.textures.Texture.uploadFromBitmapData","openfl/display3D/textures/Texture.hx",65,0x3ee19dbf)
HX_DEFINE_STACK_FRAME(_hx_pos_c910f1c2855eeb73_115_uploadFromByteArray,"openfl.display3D.textures.Texture","uploadFromByteArray",0x0d748876,"openfl.display3D.textures.Texture.uploadFromByteArray","openfl/display3D/textures/Texture.hx",115,0x3ee19dbf)
HX_DEFINE_STACK_FRAME(_hx_pos_c910f1c2855eeb73_120_uploadFromUInt8Array,"openfl.display3D.textures.Texture","uploadFromUInt8Array",0xb98d8296,"openfl.display3D.textures.Texture.uploadFromUInt8Array","openfl/display3D/textures/Texture.hx",120,0x3ee19dbf)
HX_DEFINE_STACK_FRAME(_hx_pos_c910f1c2855eeb73_18_boot,"openfl.display3D.textures.Texture","boot",0x536eb1a2,"openfl.display3D.textures.Texture.boot","openfl/display3D/textures/Texture.hx",18,0x3ee19dbf)
namespace openfl{
namespace display3D{
namespace textures{
...
HXLINE(  69)		HX_VARI( int,rgbaData) = bitmapData->get_width();
HXDLIN(  69)		HX_VARI_NAME( int,rgbaData1,"rgbaData") = bitmapData->get_height();
HXDLIN(  69)		HX_VARI_NAME(  ::openfl::_legacy::display::BitmapData,rgbaData2,"rgbaData") =  ::openfl::_legacy::display::BitmapData_obj::__alloc( HX_CTX ,rgbaData,rgbaData1,bitmapData->get_transparent(),null(),null());
HXDLIN(  69)		HX_VARI(  ::openfl::_legacy::geom::Rectangle,rect) = bitmapData->get_rect();
HXDLIN(  69)		HX_VARI(  ::openfl::_legacy::geom::Point,point) =  ::openfl::_legacy::geom::Point_obj::__alloc( HX_CTX ,(int)0,(int)0);
...
HXDLIN(  69)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,pixels) = rgbaData2->getPixels(rect);
...
int miplevel = __o_miplevel.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_c910f1c2855eeb73_115_uploadFromByteArray)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(data,"data")
            	HX_STACK_ARG(byteArrayOffset,"byteArrayOffset")
            	HX_STACK_ARG(miplevel,"miplevel")
HXLINE( 115)		this->uploadFromUInt8Array( ::openfl::_legacy::utils::UInt8Array_obj::__alloc( HX_CTX ,data,null(),null()),miplevel);
            	}
...
int miplevel = __o_miplevel.Default(0);
            	...
            	HX_STACK_ARG(miplevel,"miplevel")
HXLINE( 122)		{
HXLINE( 122)			HX_VARI(  ::openfl::_legacy::gl::GLTexture,texture) = this->glTexture;
...
HXLINE( 134)		{
HXLINE( 134)			 ::openfl::_legacy::utils::ByteArray _hx_tmp1;
HXDLIN( 134)			if (hx::IsNull( data )) {
HXLINE( 134)				_hx_tmp1 = null();
            			}
            			else {
HXLINE( 134)				_hx_tmp1 = data->getByteBuffer();
            			}
...
HXLINE( 134)				_hx_tmp2 = data->getStart();
            			}
HXDLIN( 134)			::openfl::_legacy::gl::GL_obj::lime_gl_tex_image_2d((int)3553,miplevel,::openfl::display3D::textures::Texture_obj::internalFormat,this->width,this->height,(int)0,::openfl::display3D::textures::Texture_obj::internalFormat,(int)5121,_hx_tmp1,_hx_tmp2);
            		}
