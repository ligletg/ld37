...
HX_DEFINE_STACK_FRAME(_hx_pos_6659164148434b5e_33_dispose,"openfl.display3D.textures.TextureBase","dispose",0xa678dd60,"openfl.display3D.textures.TextureBase.dispose","openfl/display3D/textures/TextureBase.hx",33,0x7b0f92ae)
namespace openfl{
namespace display3D{
namespace textures{
