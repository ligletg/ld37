...
HX_DEFINE_STACK_FRAME(_hx_pos_574e9a3948a11606_47_uploadFromBitmapData,"openfl.display3D.textures.RectangleTexture","uploadFromBitmapData",0x711b2e49,"openfl.display3D.textures.RectangleTexture.uploadFromBitmapData","openfl/display3D/textures/RectangleTexture.hx",47,0x83565556)
HX_DEFINE_STACK_FRAME(_hx_pos_574e9a3948a11606_65_uploadFromByteArray,"openfl.display3D.textures.RectangleTexture","uploadFromByteArray",0xfd7a0ae1,"openfl.display3D.textures.RectangleTexture.uploadFromByteArray","openfl/display3D/textures/RectangleTexture.hx",65,0x83565556)
namespace openfl{
namespace display3D{
namespace textures{
...
HXLINE(  52)		HX_VARI( int,rgbaData) = bitmapData->get_width();
HXDLIN(  52)		HX_VARI_NAME( int,rgbaData1,"rgbaData") = bitmapData->get_height();
HXDLIN(  52)		HX_VARI_NAME(  ::openfl::_legacy::display::BitmapData,rgbaData2,"rgbaData") =  ::openfl::_legacy::display::BitmapData_obj::__alloc( HX_CTX ,rgbaData,rgbaData1,bitmapData->get_transparent(),null(),null());
HXDLIN(  52)		HX_VARI(  ::openfl::_legacy::geom::Rectangle,rect) = bitmapData->get_rect();
HXDLIN(  52)		HX_VARI(  ::openfl::_legacy::geom::Point,point) =  ::openfl::_legacy::geom::Point_obj::__alloc( HX_CTX ,(int)0,(int)0);
...
HXDLIN(  52)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,p) = rgbaData2->getPixels(rect);
...
HXLINE( 106)		HX_VARI(  ::openfl::_legacy::utils::UInt8Array,source) =  ::openfl::_legacy::utils::UInt8Array_obj::__alloc( HX_CTX ,data,null(),null());
HXLINE( 112)		{
HXLINE( 112)			 ::openfl::_legacy::utils::ByteArray _hx_tmp1;
HXDLIN( 112)			if (hx::IsNull( source )) {
HXLINE( 112)				_hx_tmp1 = null();
            			}
            			else {
HXLINE( 112)				_hx_tmp1 = source->getByteBuffer();
            			}
HXDLIN( 112)			 ::Dynamic _hx_tmp2;
HXDLIN( 112)			if (hx::IsNull( source )) {
HXLINE( 112)				_hx_tmp2 = null();
            			}
            			else {
HXLINE( 112)				_hx_tmp2 = source->getStart();
            			}
HXDLIN( 112)			::openfl::_legacy::gl::GL_obj::lime_gl_tex_image_2d((int)3553,(int)0,(int)6408,this->width,this->height,(int)0,(int)6408,(int)5121,_hx_tmp1,_hx_tmp2);
            		}
