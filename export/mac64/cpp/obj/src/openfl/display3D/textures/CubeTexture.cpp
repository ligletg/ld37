...
HX_DEFINE_STACK_FRAME(_hx_pos_ccb53fcc86b81631_41_glTextureAt,"openfl.display3D.textures.CubeTexture","glTextureAt",0xa081fde4,"openfl.display3D.textures.CubeTexture.glTextureAt","openfl/display3D/textures/CubeTexture.hx",41,0xffe9b114)
HX_DEFINE_STACK_FRAME(_hx_pos_ccb53fcc86b81631_46_uploadCompressedTextureFromByteArray,"openfl.display3D.textures.CubeTexture","uploadCompressedTextureFromByteArray",0x47d49053,"openfl.display3D.textures.CubeTexture.uploadCompressedTextureFromByteArray","openfl/display3D/textures/CubeTexture.hx",46,0xffe9b114)
HX_DEFINE_STACK_FRAME(_hx_pos_ccb53fcc86b81631_53_uploadFromBitmapData,"openfl.display3D.textures.CubeTexture","uploadFromBitmapData",0xf44b3429,"openfl.display3D.textures.CubeTexture.uploadFromBitmapData","openfl/display3D/textures/CubeTexture.hx",53,0xffe9b114)
HX_DEFINE_STACK_FRAME(_hx_pos_ccb53fcc86b81631_102_uploadFromByteArray,"openfl.display3D.textures.CubeTexture","uploadFromByteArray",0x1e356101,"openfl.display3D.textures.CubeTexture.uploadFromByteArray","openfl/display3D/textures/CubeTexture.hx",102,0xffe9b114)
namespace openfl{
namespace display3D{
namespace textures{
...
HXDLIN(  32)				_hx_tmp[(_g - (int)1)] =  ::openfl::_legacy::gl::GLTexture_obj::__alloc( HX_CTX ,_hx_tmp1,::openfl::_legacy::gl::GL_obj::lime_gl_create_texture());
            			}
            		}
            	}
...
HXLINE(  58)		HX_VARI( int,rgbaData) = bitmapData->get_width();
HXDLIN(  58)		HX_VARI_NAME( int,rgbaData1,"rgbaData") = bitmapData->get_height();
HXDLIN(  58)		HX_VARI_NAME(  ::openfl::_legacy::display::BitmapData,rgbaData2,"rgbaData") =  ::openfl::_legacy::display::BitmapData_obj::__alloc( HX_CTX ,rgbaData,rgbaData1,bitmapData->get_transparent(),null(),null());
HXDLIN(  58)		HX_VARI(  ::openfl::_legacy::geom::Rectangle,rect) = bitmapData->get_rect();
HXDLIN(  58)		HX_VARI(  ::openfl::_legacy::geom::Point,point) =  ::openfl::_legacy::geom::Point_obj::__alloc( HX_CTX ,(int)0,(int)0);
...
HXDLIN(  58)		HX_VARI(  ::openfl::_legacy::utils::UInt8Array,source) =  ::openfl::_legacy::utils::UInt8Array_obj::__alloc( HX_CTX ,rgbaData2->getPixels(rect),null(),null());
HXLINE(  63)		{
...
HXDLIN(  69)				 ::openfl::_legacy::utils::ByteArray _hx_tmp1;
HXDLIN(  69)				if (hx::IsNull( source )) {
HXLINE(  69)					_hx_tmp1 = null();
            				}
            				else {
HXLINE(  69)					_hx_tmp1 = source->getByteBuffer();
            				}
HXDLIN(  69)				 ::Dynamic _hx_tmp2;
HXDLIN(  69)				if (hx::IsNull( source )) {
HXLINE(  69)					_hx_tmp2 = null();
            				}
            				else {
HXLINE(  69)					_hx_tmp2 = source->getStart();
            				}
HXDLIN(  69)				::openfl::_legacy::gl::GL_obj::lime_gl_tex_image_2d((int)34069,miplevel,(int)6408,width,height,(int)0,(int)6408,(int)5121,_hx_tmp1,_hx_tmp2);
            			}
            			break;
            			case (int)1: {
HXLINE(  73)				int width1 = bitmapData->get_width();
HXDLIN(  73)				int height1 = bitmapData->get_height();
HXDLIN(  73)				 ::openfl::_legacy::utils::ByteArray _hx_tmp3;
HXDLIN(  73)				if (hx::IsNull( source )) {
HXLINE(  73)					_hx_tmp3 = null();
            				}
            				else {
HXLINE(  73)					_hx_tmp3 = source->getByteBuffer();
            				}
HXDLIN(  73)				 ::Dynamic _hx_tmp4;
HXDLIN(  73)				if (hx::IsNull( source )) {
HXLINE(  73)					_hx_tmp4 = null();
            				}
            				else {
HXLINE(  73)					_hx_tmp4 = source->getStart();
            				}
HXDLIN(  73)				::openfl::_legacy::gl::GL_obj::lime_gl_tex_image_2d((int)34070,miplevel,(int)6408,width1,height1,(int)0,(int)6408,(int)5121,_hx_tmp3,_hx_tmp4);
            			}
            			break;
            			case (int)2: {
HXLINE(  77)				int width2 = bitmapData->get_width();
HXDLIN(  77)				int height2 = bitmapData->get_height();
HXDLIN(  77)				 ::openfl::_legacy::utils::ByteArray _hx_tmp5;
HXDLIN(  77)				if (hx::IsNull( source )) {
HXLINE(  77)					_hx_tmp5 = null();
            				}
            				else {
HXLINE(  77)					_hx_tmp5 = source->getByteBuffer();
            				}
HXDLIN(  77)				 ::Dynamic _hx_tmp6;
HXDLIN(  77)				if (hx::IsNull( source )) {
HXLINE(  77)					_hx_tmp6 = null();
            				}
            				else {
HXLINE(  77)					_hx_tmp6 = source->getStart();
            				}
HXDLIN(  77)				::openfl::_legacy::gl::GL_obj::lime_gl_tex_image_2d((int)34071,miplevel,(int)6408,width2,height2,(int)0,(int)6408,(int)5121,_hx_tmp5,_hx_tmp6);
            			}
            			break;
            			case (int)3: {
HXLINE(  81)				int width3 = bitmapData->get_width();
HXDLIN(  81)				int height3 = bitmapData->get_height();
HXDLIN(  81)				 ::openfl::_legacy::utils::ByteArray _hx_tmp7;
HXDLIN(  81)				if (hx::IsNull( source )) {
HXLINE(  81)					_hx_tmp7 = null();
            				}
            				else {
HXLINE(  81)					_hx_tmp7 = source->getByteBuffer();
            				}
HXDLIN(  81)				 ::Dynamic _hx_tmp8;
HXDLIN(  81)				if (hx::IsNull( source )) {
HXLINE(  81)					_hx_tmp8 = null();
            				}
            				else {
HXLINE(  81)					_hx_tmp8 = source->getStart();
            				}
HXDLIN(  81)				::openfl::_legacy::gl::GL_obj::lime_gl_tex_image_2d((int)34072,miplevel,(int)6408,width3,height3,(int)0,(int)6408,(int)5121,_hx_tmp7,_hx_tmp8);
            			}
            			break;
            			case (int)4: {
HXLINE(  85)				int width4 = bitmapData->get_width();
HXDLIN(  85)				int height4 = bitmapData->get_height();
HXDLIN(  85)				 ::openfl::_legacy::utils::ByteArray _hx_tmp9;
HXDLIN(  85)				if (hx::IsNull( source )) {
HXLINE(  85)					_hx_tmp9 = null();
            				}
            				else {
HXLINE(  85)					_hx_tmp9 = source->getByteBuffer();
            				}
...
HXLINE(  85)					_hx_tmp10 = source->getStart();
            				}
HXDLIN(  85)				::openfl::_legacy::gl::GL_obj::lime_gl_tex_image_2d((int)34073,miplevel,(int)6408,width4,height4,(int)0,(int)6408,(int)5121,_hx_tmp9,_hx_tmp10);
            			}
            			break;
            			case (int)5: {
HXLINE(  89)				int width5 = bitmapData->get_width();
HXDLIN(  89)				int height5 = bitmapData->get_height();
HXDLIN(  89)				 ::openfl::_legacy::utils::ByteArray _hx_tmp11;
HXDLIN(  89)				if (hx::IsNull( source )) {
HXLINE(  89)					_hx_tmp11 = null();
            				}
            				else {
HXLINE(  89)					_hx_tmp11 = source->getByteBuffer();
            				}
HXDLIN(  89)				 ::Dynamic _hx_tmp12;
HXDLIN(  89)				if (hx::IsNull( source )) {
HXLINE(  89)					_hx_tmp12 = null();
            				}
            				else {
HXLINE(  89)					_hx_tmp12 = source->getStart();
            				}
HXDLIN(  89)				::openfl::_legacy::gl::GL_obj::lime_gl_tex_image_2d((int)34074,miplevel,(int)6408,width5,height5,(int)0,(int)6408,(int)5121,_hx_tmp11,_hx_tmp12);
            			}
            			break;
            			default:{
