...
HX_DEFINE_STACK_FRAME(_hx_pos_8e0849c8e2179fab_34_dispose,"openfl.display3D.VertexBuffer3D","dispose",0x6b6860bf,"openfl.display3D.VertexBuffer3D.dispose","openfl/display3D/VertexBuffer3D.hx",34,0xb1ad396e)
HX_DEFINE_STACK_FRAME(_hx_pos_8e0849c8e2179fab_39_uploadFromByteArray,"openfl.display3D.VertexBuffer3D","uploadFromByteArray",0x0096a806,"openfl.display3D.VertexBuffer3D.uploadFromByteArray","openfl/display3D/VertexBuffer3D.hx",39,0xb1ad396e)
HX_DEFINE_STACK_FRAME(_hx_pos_8e0849c8e2179fab_70_uploadFromFloat32Array,"openfl.display3D.VertexBuffer3D","uploadFromFloat32Array",0xa0c31ae9,"openfl.display3D.VertexBuffer3D.uploadFromFloat32Array","openfl/display3D/VertexBuffer3D.hx",70,0xb1ad396e)
HX_DEFINE_STACK_FRAME(_hx_pos_8e0849c8e2179fab_78_uploadFromVector,"openfl.display3D.VertexBuffer3D","uploadFromVector",0xcf228b0e,"openfl.display3D.VertexBuffer3D.uploadFromVector","openfl/display3D/VertexBuffer3D.hx",78,0xb1ad396e)
namespace openfl{
namespace display3D{
...
HXLINE(  47)		HX_VARI(  ::openfl::_legacy::utils::Float32Array,float32Array) =  ::openfl::_legacy::utils::Float32Array_obj::__alloc( HX_CTX ,byteArray,(byteArrayOffset + (startOffset * bytesPerVertex)),(count * bytesPerVertex));
HXLINE(  65)		{
HXLINE(  65)			int usage = this->bufferUsage;
HXDLIN(  65)			 ::openfl::_legacy::utils::ByteArray _hx_tmp1 = ::openfl::_legacy::utils::IMemoryRange_obj::getByteBuffer(float32Array);
HXDLIN(  65)			int _hx_tmp2 = ::openfl::_legacy::utils::IMemoryRange_obj::getStart(float32Array);
HXDLIN(  65)			int _hx_tmp3 = ::openfl::_legacy::utils::IMemoryRange_obj::getLength(float32Array);
HXDLIN(  65)			::openfl::_legacy::gl::GL_obj::lime_gl_buffer_data((int)34962,_hx_tmp1,_hx_tmp2,_hx_tmp3,usage);
            		}
            	}
...
HXDLIN(  73)			 ::openfl::_legacy::utils::ByteArray _hx_tmp1 = ::openfl::_legacy::utils::IMemoryRange_obj::getByteBuffer(data);
HXDLIN(  73)			int _hx_tmp2 = ::openfl::_legacy::utils::IMemoryRange_obj::getStart(data);
HXDLIN(  73)			int _hx_tmp3 = ::openfl::_legacy::utils::IMemoryRange_obj::getLength(data);
HXDLIN(  73)			::openfl::_legacy::gl::GL_obj::lime_gl_buffer_data((int)34962,_hx_tmp1,_hx_tmp2,_hx_tmp3,usage);
            		}
            	}
...
HXLINE(  86)		HX_VARI(  ::openfl::_legacy::utils::Float32Array,float32Array) =  ::openfl::_legacy::utils::Float32Array_obj::__alloc( HX_CTX ,data,startVertex,(numVertices * this->data32PerVertex));
HXLINE( 100)		{
HXLINE( 100)			int usage = this->bufferUsage;
HXDLIN( 100)			 ::openfl::_legacy::utils::ByteArray _hx_tmp1 = ::openfl::_legacy::utils::IMemoryRange_obj::getByteBuffer(float32Array);
HXDLIN( 100)			int _hx_tmp2 = ::openfl::_legacy::utils::IMemoryRange_obj::getStart(float32Array);
HXDLIN( 100)			int _hx_tmp3 = ::openfl::_legacy::utils::IMemoryRange_obj::getLength(float32Array);
HXDLIN( 100)			::openfl::_legacy::gl::GL_obj::lime_gl_buffer_data((int)34962,_hx_tmp1,_hx_tmp2,_hx_tmp3,usage);
            		}
