...
HX_DEFINE_STACK_FRAME(_hx_pos_536f681b10c755a2_26_dispose,"openfl.display3D.Program3D","dispose",0x556f61ad,"openfl.display3D.Program3D.dispose","openfl/display3D/Program3D.hx",26,0x0a985b04)
HX_DEFINE_STACK_FRAME(_hx_pos_536f681b10c755a2_31_upload,"openfl.display3D.Program3D","upload",0x91a244b3,"openfl.display3D.Program3D.upload","openfl/display3D/Program3D.hx",31,0x0a985b04)
namespace openfl{
namespace display3D{
...
void Program3D_obj::dispose(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  26)		this->context->_hx___deleteProgram(hx::ObjectPtr<OBJ_>(this));
            	}
...
HXLINE(  35)		{
HXLINE(  35)			HX_VARI(  ::openfl::_legacy::gl::GLProgram,program) = this->glProgram;
HXDLIN(  35)			program->attach(vertexShader);
HXDLIN(  35)			::openfl::_legacy::gl::GL_obj::lime_gl_attach_shader(program->id,vertexShader->id);
            		}
HXLINE(  36)		{
HXLINE(  36)			HX_VARI_NAME(  ::openfl::_legacy::gl::GLProgram,program1,"program") = this->glProgram;
...
HXLINE(  41)			HX_VARI( ::String,result) = ( (::String)(::openfl::_legacy::gl::GL_obj::lime_gl_get_program_info_log(this->glProgram->id)) );
