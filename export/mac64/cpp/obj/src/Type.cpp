...
HX_DEFINE_STACK_FRAME(_hx_pos_6ebc4c1d0351a436_47_getEnum,"Type","getEnum",0x326d2523,"Type.getEnum","/usr/local/lib/haxe/std/cpp/_std/Type.hx",47,0xb5f2d6e2)
...
HX_DEFINE_STACK_FRAME(_hx_pos_6ebc4c1d0351a436_64_getEnumName,"Type","getEnumName",0x9b42910e,"Type.getEnumName","/usr/local/lib/haxe/std/cpp/_std/Type.hx",64,0xb5f2d6e2)
...
HX_DEFINE_STACK_FRAME(_hx_pos_6ebc4c1d0351a436_88_createEmptyInstance,"Type","createEmptyInstance",0xcb752312,"Type.createEmptyInstance","/usr/local/lib/haxe/std/cpp/_std/Type.hx",88,0xb5f2d6e2)
HX_DEFINE_STACK_FRAME(_hx_pos_6ebc4c1d0351a436_92_createEnum,"Type","createEnum",0xd8d56d31,"Type.createEnum","/usr/local/lib/haxe/std/cpp/_std/Type.hx",92,0xb5f2d6e2)
HX_DEFINE_STACK_FRAME(_hx_pos_6ebc4c1d0351a436_95_createEnumIndex,"Type","createEnumIndex",0xd21e2c21,"Type.createEnumIndex","/usr/local/lib/haxe/std/cpp/_std/Type.hx",95,0xb5f2d6e2)
HX_DEFINE_STACK_FRAME(_hx_pos_6ebc4c1d0351a436_102_getInstanceFields,"Type","getInstanceFields",0xe970f890,"Type.getInstanceFields","/usr/local/lib/haxe/std/cpp/_std/Type.hx",102,0xb5f2d6e2)
HX_DEFINE_STACK_FRAME(_hx_pos_6ebc4c1d0351a436_106_getClassFields,"Type","getClassFields",0x7edf22ef,"Type.getClassFields","/usr/local/lib/haxe/std/cpp/_std/Type.hx",106,0xb5f2d6e2)
HX_DEFINE_STACK_FRAME(_hx_pos_6ebc4c1d0351a436_110_getEnumConstructs,"Type","getEnumConstructs",0x7f46cf7f,"Type.getEnumConstructs","/usr/local/lib/haxe/std/cpp/_std/Type.hx",110,0xb5f2d6e2)
HX_DEFINE_STACK_FRAME(_hx_pos_6ebc4c1d0351a436_113_typeof,"Type","typeof",0xd6c51d65,"Type.typeof","/usr/local/lib/haxe/std/cpp/_std/Type.hx",113,0xb5f2d6e2)
HX_DEFINE_STACK_FRAME(_hx_pos_6ebc4c1d0351a436_130_enumEq,"Type","enumEq",0x855650e1,"Type.enumEq","/usr/local/lib/haxe/std/cpp/_std/Type.hx",130,0xb5f2d6e2)
HX_DEFINE_STACK_FRAME(_hx_pos_6ebc4c1d0351a436_135_enumConstructor,"Type","enumConstructor",0x45f8fde5,"Type.enumConstructor","/usr/local/lib/haxe/std/cpp/_std/Type.hx",135,0xb5f2d6e2)
...
HX_DEFINE_STACK_FRAME(_hx_pos_6ebc4c1d0351a436_147_enumIndex,"Type","enumIndex",0xb61f99bd,"Type.enumIndex","/usr/local/lib/haxe/std/cpp/_std/Type.hx",147,0xb5f2d6e2)
HX_DEFINE_STACK_FRAME(_hx_pos_6ebc4c1d0351a436_150_allEnums,"Type","allEnums",0x86200985,"Type.allEnums","/usr/local/lib/haxe/std/cpp/_std/Type.hx",150,0xb5f2d6e2)
...
hx::Class Type_obj::getEnum( ::Dynamic o){
            	HX_STACKFRAME(&_hx_pos_6ebc4c1d0351a436_47_getEnum)
            	HX_STACK_ARG(o,"o")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Type_obj,createEnum,return )
 ...
 ::Dynamic Type_obj::createEnumIndex(hx::Class e,int index,::cpp::VirtualArray params){
            	HX_STACKFRAME(&_hx_pos_6ebc4c1d0351a436_95_createEnumIndex)
            	HX_STACK_ARG(e,"e")
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(params,"params")
HXLINE(  96)		HX_VARI( ::String,c) = ::Type_obj::getEnumConstructs(e)->__get(index);
...
::Array< ::String > Type_obj::getClassFields(hx::Class c){
            	HX_STACKFRAME(&_hx_pos_6ebc4c1d0351a436_106_getClassFields)
            	HX_STACK_ARG(c,"c")
...
::Array< ::String > Type_obj::getEnumConstructs(hx::Class e){
            	...
            	HX_STACK_ARG(e,"e")
HXLINE( 110)		return e->GetClassFields();
            	}
...
bool Type_obj::enumEq( ::Dynamic a, ::Dynamic b){
            	HX_STACKFRAME(&_hx_pos_6ebc4c1d0351a436_130_enumEq)
            	HX_STACK_ARG(a,"a")
            	HX_STACK_ARG(b,"b")
...
::String Type_obj::enumConstructor( ::Dynamic e){
            	HX_STACKFRAME(&_hx_pos_6ebc4c1d0351a436_135_enumConstructor)
            	HX_STACK_ARG(e,"e")
...
int Type_obj::enumIndex( ::Dynamic e){
            	HX_STACKFRAME(&_hx_pos_6ebc4c1d0351a436_147_enumIndex)
            	HX_STACK_ARG(e,"e")
...
::cpp::VirtualArray Type_obj::allEnums(hx::Class e){
            	HX_STACKFRAME(&_hx_pos_6ebc4c1d0351a436_150_allEnums)
            	HX_STACK_ARG(e,"e")
HXLINE( 151)		HX_VARI( ::Array< ::String >,names) = ( (::Array< ::String >)(e->GetClassFields()) );
HXLINE( 152)		HX_VARI( ::cpp::VirtualArray,enums) = ::cpp::VirtualArray_obj::__new();
HXLINE( 153)		{
HXLINE( 153)			HX_VARI( int,_g) = (int)0;
HXDLIN( 153)			while((_g < names->length)){
HXLINE( 153)				HX_VARI( ::String,name) = names->__get(_g);
HXDLIN( 153)				_g = (_g + (int)1);
HXLINE( 155)				try {
            					HX_STACK_CATCHABLE(::String, 0);
HXLINE( 156)					HX_VARI(  ::Dynamic,result) = e->ConstructEnum(name,null());
