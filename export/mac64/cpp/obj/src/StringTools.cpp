...
HX_DEFINE_STACK_FRAME(_hx_pos_0e615b5827179e15_45_urlEncode,"StringTools","urlEncode",0x06afdce1,"StringTools.urlEncode","/usr/local/lib/haxe/std/StringTools.hx",45,0x3f930611)
HX_DEFINE_STACK_FRAME(_hx_pos_0e615b5827179e15_115_urlDecode,"StringTools","urlDecode",0x71b947f9,"StringTools.urlDecode","/usr/local/lib/haxe/std/StringTools.hx",115,0x3f930611)
HX_DEFINE_STACK_FRAME(_hx_pos_0e615b5827179e15_153_htmlEscape,"StringTools","htmlEscape",0x0e1a5dd0,"StringTools.htmlEscape","/usr/local/lib/haxe/std/StringTools.hx",153,0x3f930611)
HX_DEFINE_STACK_FRAME(_hx_pos_0e615b5827179e15_173_htmlUnescape,"StringTools","htmlUnescape",0x7457fea9,"StringTools.htmlUnescape","/usr/local/lib/haxe/std/StringTools.hx",173,0x3f930611)
...
HX_DEFINE_STACK_FRAME(_hx_pos_0e615b5827179e15_331_lpad,"StringTools","lpad",0x23bd8feb,"StringTools.lpad","/usr/local/lib/haxe/std/StringTools.hx",331,0x3f930611)
HX_DEFINE_STACK_FRAME(_hx_pos_0e615b5827179e15_353_rpad,"StringTools","rpad",0x27b4d7a5,"StringTools.rpad","/usr/local/lib/haxe/std/StringTools.hx",353,0x3f930611)
...
HX_DEFINE_STACK_FRAME(_hx_pos_0e615b5827179e15_442_fastCodeAt,"StringTools","fastCodeAt",0x6fd011c0,"StringTools.fastCodeAt","/usr/local/lib/haxe/std/StringTools.hx",442,0x3f930611)
HX_DEFINE_STACK_FRAME(_hx_pos_0e615b5827179e15_467_isEof,"StringTools","isEof",0x69d30eee,"StringTools.isEof","/usr/local/lib/haxe/std/StringTools.hx",467,0x3f930611)
HX_DEFINE_STACK_FRAME(_hx_pos_0e615b5827179e15_488_quoteUnixArg,"StringTools","quoteUnixArg",0xc59dac56,"StringTools.quoteUnixArg","/usr/local/lib/haxe/std/StringTools.hx",488,0x3f930611)
HX_DEFINE_STACK_FRAME(_hx_pos_0e615b5827179e15_521_quoteWinArg,"StringTools","quoteWinArg",0x7e16b8f2,"StringTools.quoteWinArg","/usr/local/lib/haxe/std/StringTools.hx",521,0x3f930611)
...
HX_DEFINE_STACK_FRAME(_hx_pos_0e615b5827179e15_506_boot,"StringTools","boot",0x1d20b7b6,"StringTools.boot","/usr/local/lib/haxe/std/StringTools.hx",506,0x3f930611)
...
::String StringTools_obj::htmlEscape(::String s, ::Dynamic quotes){
            	HX_STACKFRAME(&_hx_pos_0e615b5827179e15_153_htmlEscape)
            	HX_STACK_ARG(s,"s")
...
::String StringTools_obj::htmlUnescape(::String s){
            	HX_STACKFRAME(&_hx_pos_0e615b5827179e15_173_htmlUnescape)
            	HX_STACK_ARG(s,"s")
...
::String StringTools_obj::lpad(::String s,::String c,int l){
            	HX_STACKFRAME(&_hx_pos_0e615b5827179e15_331_lpad)
            	HX_STACK_ARG(s,"s")
            	HX_STACK_ARG(c,"c")
            	HX_STACK_ARG(l,"l")
...
::String StringTools_obj::rpad(::String s,::String c,int l){
            	HX_STACKFRAME(&_hx_pos_0e615b5827179e15_353_rpad)
            	HX_STACK_ARG(s,"s")
            	HX_STACK_ARG(c,"c")
            	HX_STACK_ARG(l,"l")
...
int StringTools_obj::fastCodeAt(::String s,int index){
            	HX_STACKFRAME(&_hx_pos_0e615b5827179e15_442_fastCodeAt)
            	HX_STACK_ARG(s,"s")
...
bool StringTools_obj::isEof(int c){
            	HX_STACKFRAME(&_hx_pos_0e615b5827179e15_467_isEof)
            	HX_STACK_ARG(c,"c")
...
::String StringTools_obj::quoteUnixArg(::String argument){
            	HX_GC_STACKFRAME(&_hx_pos_0e615b5827179e15_488_quoteUnixArg)
...
::String StringTools_obj::quoteWinArg(::String argument,bool escapeMetaCharacters){
            	HX_GC_STACKFRAME(&_hx_pos_0e615b5827179e15_521_quoteWinArg)
            	HX_STACK_ARG(argument,"argument")
...
HXLINE( 528)			HX_VARI(  ::StringBuf,result) =  ::StringBuf_obj::__alloc( HX_CTX );
...
HXLINE( 534)			HX_VARI(  ::StringBuf,bs_buf) =  ::StringBuf_obj::__alloc( HX_CTX );
HXLINE( 535)			{
...
HXLINE( 536)					{
HXLINE( 536)						HX_VARI(  ::Dynamic,_g2) = argument.charCodeAt((_g1 - (int)1));
HXDLIN( 536)						if (hx::IsNull( _g2 )) {
HXLINE( 549)							if ((bs_buf->get_length() > (int)0)) {
HXLINE( 550)								{
HXLINE( 550)									HX_VARI( ::String,x) = bs_buf->toString();
...
HXLINE( 550)										HX_VARI_NAME( ::Array< ::String >,result1,"result") = result->b;
...
HXDLIN( 553)								result->charBuf->push(_g2);
            							}
            						}
            						else {
HXLINE( 536)							 ::Dynamic _hx_switch_0 = _g2;
            							if (  (_hx_switch_0==(int)34) ){
HXLINE( 542)								HX_VARI( ::String,bs) = bs_buf->toString();
HXLINE( 543)								{
...
HXLINE( 543)										HX_VARI_NAME( ::Array< ::String >,result2,"result") = result->b;
...
HXLINE( 544)										HX_VARI_NAME( ::Array< ::String >,result3,"result") = result->b;
...
HXLINE( 549)								if ((bs_buf->get_length() > (int)0)) {
HXLINE( 550)									{
HXLINE( 550)										HX_VARI_NAME( ::String,x1,"x") = bs_buf->toString();
HXDLIN( 550)										if (hx::IsNotNull( result->charBuf )) {
HXLINE( 550)											result->flush();
            										}
HXDLIN( 550)										if (hx::IsNull( result->b )) {
...
HXLINE( 550)											HX_VARI_NAME( ::Array< ::String >,result4,"result") = result->b;
...
HXLINE( 558)			{
HXLINE( 558)				HX_VARI_NAME( ::String,x2,"x") = bs_buf->toString();
...
HXLINE( 558)					HX_VARI_NAME( ::Array< ::String >,result5,"result") = result->b;
HXDLIN( 558)					result5->push(::Std_obj::string(x2));
            				}
            			}
HXLINE( 560)			if (needquote) {
HXLINE( 561)				{
HXLINE( 561)					HX_VARI_NAME( ::String,x3,"x") = bs_buf->toString();
...
HXLINE( 561)						HX_VARI_NAME( ::Array< ::String >,result6,"result") = result->b;
...
HXLINE( 569)			HX_VARI_NAME(  ::StringBuf,result7,"result") =  ::StringBuf_obj::__alloc( HX_CTX );
HXLINE( 570)			{
...
HXLINE( 571)					HX_VARI(  ::Dynamic,c) = argument.charCodeAt((_g11 - (int)1));
HXLINE( 572)					if ((::StringTools_obj::winMetaCharacters->indexOf(c,null()) >= (int)0)) {
...
HXDLIN( 575)						result7->charBuf->push(c);
            					}
            				}
            			}
...
{
{
            	HX_STACKFRAME(&_hx_pos_0e615b5827179e15_506_boot)
HXLINE( 506)		winMetaCharacters = ::Array_obj< int >::fromData( _hx_array_data_0363db6a_34,15);
            	}
}
