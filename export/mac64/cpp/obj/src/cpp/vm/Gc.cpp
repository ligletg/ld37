...
HX_DEFINE_STACK_FRAME(_hx_pos_be3f97a95d181a8b_38_run,"cpp.vm.Gc","run",0x3d3e0d65,"cpp.vm.Gc.run","/usr/local/lib/haxe/std/cpp/vm/Gc.hx",38,0x44f3d2d3)
namespace cpp{
namespace vm{
...
void Gc_obj::run(bool major){
            	HX_STACKFRAME(&_hx_pos_be3f97a95d181a8b_38_run)
