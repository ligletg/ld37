...
HX_DEFINE_STACK_FRAME(_hx_pos_1ad9843c233ece44_28_new,"cpp.vm.Mutex","new",0xabb3ca05,"cpp.vm.Mutex.new","/usr/local/lib/haxe/std/cpp/vm/Mutex.hx",28,0xf5cf408e)
HX_DEFINE_STACK_FRAME(_hx_pos_1ad9843c233ece44_31_acquire,"cpp.vm.Mutex","acquire",0xc3527bfb,"cpp.vm.Mutex.acquire","/usr/local/lib/haxe/std/cpp/vm/Mutex.hx",31,0xf5cf408e)
HX_DEFINE_STACK_FRAME(_hx_pos_1ad9843c233ece44_37_release,"cpp.vm.Mutex","release",0x675bb5ec,"cpp.vm.Mutex.release","/usr/local/lib/haxe/std/cpp/vm/Mutex.hx",37,0xf5cf408e)
namespace cpp{
namespace vm{

void Mutex_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_1ad9843c233ece44_28_new)
            	HX_STACK_THIS(this)
...
void Mutex_obj::acquire(){
            	HX_STACKFRAME(&_hx_pos_1ad9843c233ece44_31_acquire)
            	HX_STACK_THIS(this)
...
void Mutex_obj::release(){
            	HX_STACKFRAME(&_hx_pos_1ad9843c233ece44_37_release)
            	HX_STACK_THIS(this)
