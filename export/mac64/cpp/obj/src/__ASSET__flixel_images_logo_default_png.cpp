...
HX_DEFINE_STACK_FRAME(_hx_pos_24dce183e298e1e9_2010_new,"__ASSET__flixel_images_logo_default_png","new",0xe2ac399d,"__ASSET__flixel_images_logo_default_png.new","openfl/_legacy/Assets.hx",2010,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_d329051c686ea84b_1_boot,"__ASSET__flixel_images_logo_default_png","boot",0x6c1f3055,"__ASSET__flixel_images_logo_default_png.boot","?",1,0x0000003f)
...
void __ASSET__flixel_images_logo_default_png_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACKFRAME(&_hx_pos_24dce183e298e1e9_2010_new)
            	HX_STACK_THIS(this)
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::__ASSET__flixel_images_logo_default_png_obj::resourceName));
...
void *__ASSET__flixel_images_logo_default_png_obj::_hx_vtable = 0;
...
bool __ASSET__flixel_images_logo_default_png_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x0cd766e7) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x0cd766e7;
	} else {
		return inClassId==(int)0x2bf5b37f;
	}
}
...
hx::ObjectPtr< __ASSET__flixel_images_logo_default_png_obj > __ASSET__flixel_images_logo_default_png_obj::__new(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA) {
	hx::ObjectPtr< __ASSET__flixel_images_logo_default_png_obj > __this = new __ASSET__flixel_images_logo_default_png_obj();
	__this->__construct(width,height,__o_transparent,__o_fillRGBA);
	return __this;
}

hx::ObjectPtr< __ASSET__flixel_images_logo_default_png_obj > __ASSET__flixel_images_logo_default_png_obj::__alloc(hx::Ctx *_hx_ctx,int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA) {
	__ASSET__flixel_images_logo_default_png_obj *__this = (__ASSET__flixel_images_logo_default_png_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(__ASSET__flixel_images_logo_default_png_obj), true, "__ASSET__flixel_images_logo_default_png"));
	*(void **)__this = __ASSET__flixel_images_logo_default_png_obj::_hx_vtable;
	__this->__construct(width,height,__o_transparent,__o_fillRGBA);
	return __this;
}
...
{
	hx::Object *dummy = new __ASSET__flixel_images_logo_default_png_obj;
	__ASSET__flixel_images_logo_default_png_obj::_hx_vtable = *(void **)dummy;
...
{
{
            	HX_STACKFRAME(&_hx_pos_d329051c686ea84b_1_boot)
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap___ASSET__flixel_images_logo_default_png",85,a1,73,91);
            	}
}
