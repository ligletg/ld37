...
HX_DEFINE_STACK_FRAME(_hx_pos_8b63e6eaf513c097_31_new,"StringBuf","new",0xaaa8f4b4,"StringBuf.new","/usr/local/lib/haxe/std/cpp/_std/StringBuf.hx",31,0x6c227dbe)
HX_DEFINE_STACK_FRAME(_hx_pos_8b63e6eaf513c097_35_charBufAsString,"StringBuf","charBufAsString",0x54d38cd4,"StringBuf.charBufAsString","/usr/local/lib/haxe/std/cpp/_std/StringBuf.hx",35,0x6c227dbe)
HX_DEFINE_STACK_FRAME(_hx_pos_8b63e6eaf513c097_41_flush,"StringBuf","flush",0xc7c14418,"StringBuf.flush","/usr/local/lib/haxe/std/cpp/_std/StringBuf.hx",41,0x6c227dbe)
HX_DEFINE_STACK_FRAME(_hx_pos_8b63e6eaf513c097_48_get_length,"StringBuf","get_length",0xe673d2db,"StringBuf.get_length","/usr/local/lib/haxe/std/cpp/_std/StringBuf.hx",48,0x6c227dbe)
HX_DEFINE_STACK_FRAME(_hx_pos_8b63e6eaf513c097_79_toString,"StringBuf","toString",0x68f17bd8,"StringBuf.toString","/usr/local/lib/haxe/std/cpp/_std/StringBuf.hx",79,0x6c227dbe)

void StringBuf_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_8b63e6eaf513c097_31_new)
            	HX_STACK_THIS(this)
            	}
...
::String StringBuf_obj::charBufAsString(){
            	HX_STACKFRAME(&_hx_pos_8b63e6eaf513c097_35_charBufAsString)
            	HX_STACK_THIS(this)
HXLINE(  36)		HX_VARI( int,len) = this->charBuf->length;
HXLINE(  37)		this->charBuf->push((int)0);
HXLINE(  38)		return ::String(( (::cpp::Pointer< char >)(::cpp::Pointer_obj::arrayElem(this->charBuf,(int)0)) )->ptr,len);
            	}
...
void StringBuf_obj::flush(){
            	HX_STACKFRAME(&_hx_pos_8b63e6eaf513c097_41_flush)
            	HX_STACK_THIS(this)
...
int StringBuf_obj::get_length(){
            	HX_STACKFRAME(&_hx_pos_8b63e6eaf513c097_48_get_length)
            	HX_STACK_THIS(this)
HXLINE(  49)		HX_VARI( int,len) = (int)0;
...
HXDLIN(  53)			HX_VARI( ::Array< ::String >,_g1) = this->b;
HXDLIN(  53)			while((_g < _g1->length)){
HXLINE(  53)				HX_VARI( ::String,s) = _g1->__get(_g);
...
::String StringBuf_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_8b63e6eaf513c097_79_toString)
            	HX_STACK_THIS(this)
HXLINE(  80)		if (hx::IsNotNull( this->charBuf )) {
HXLINE(  82)			if (hx::IsNull( this->b )) {
HXLINE(  83)				return this->charBufAsString();
            			}
HXLINE(  84)			this->flush();
            		}
HXLINE(  86)		if (hx::IsNull( this->b )) {
HXLINE(  87)			return HX_("",00,00,00,00);
            		}
HXLINE(  88)		return this->b->join(HX_("",00,00,00,00));
            	}
