...
HX_DEFINE_STACK_FRAME(_hx_pos_6fcf922b66429816_52_main,"ApplicationMain","main",0x93d2f73e,"ApplicationMain.main","ApplicationMain.hx",52,0x0780ded5)
HX_DEFINE_STACK_FRAME(_hx_pos_6fcf922b66429816_27_main,"ApplicationMain","main",0x93d2f73e,"ApplicationMain.main","ApplicationMain.hx",27,0x0780ded5)
...
HXLINE(  29)		::openfl::_legacy::Lib_obj::setPackage(HX_("HaxeFlixel",42,8f,0c,ac),HX_("myapp",b5,08,f2,12),HX_("com.example.myapp",84,30,57,c1),HX_("0.0.1",35,3d,c8,c1));
HXLINE(  52)		::openfl::_legacy::Lib_obj::create( ::Dynamic(new _hx_Closure_0()),(int)1280,(int)1024,(int)60,(int)0,((int)((int)((int)((int)((int)((int)((int)((int)((int)((int)::openfl::_legacy::Lib_obj::HARDWARE | (int)::openfl::_legacy::Lib_obj::ALLOW_SHADERS) | (int)(int)0) | (int)(int)0) | (int)(int)0) | (int)::openfl::_legacy::Lib_obj::RESIZABLE) | (int)(int)0) | (int)::openfl::_legacy::Lib_obj::VSYNC) | (int)(int)0) | (int)(int)0) | (int)(int)0),HX_("myapp",b5,08,f2,12),null(),null());
            	}
