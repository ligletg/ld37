...
HX_DEFINE_STACK_FRAME(_hx_pos_89babae20dffc326_24_addAnimationFrame,"flixel.addons.editors.tiled.TiledTilePropertySet","addAnimationFrame",0x771c8f6e,"flixel.addons.editors.tiled.TiledTilePropertySet.addAnimationFrame","flixel/addons/editors/tiled/TiledTilePropertySet.hx",24,0xb74dff0a)
namespace flixel{
namespace addons{
namespace editors{
namespace tiled{
...
HXLINE(  24)		this->animationFrames->push( ::Dynamic(hx::Anon_obj::Create(2)
