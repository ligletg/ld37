...
HX_DEFINE_STACK_FRAME(_hx_pos_e42a345368be2532_28_loadObjects,"flixel.addons.editors.tiled.TiledObjectLayer","loadObjects",0x0117c705,"flixel.addons.editors.tiled.TiledObjectLayer.loadObjects","flixel/addons/editors/tiled/TiledObjectLayer.hx",28,0xb63a8297)
namespace flixel{
namespace addons{
namespace editors{
namespace tiled{
...
void TiledObjectLayer_obj::loadObjects( ::haxe::xml::Fast source){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
HXLINE(  28)		HX_VARI(  ::_List::ListNode,_g_head) = source->nodes->resolve(HX_("object",bf,7e,3f,15))->h;
HXDLIN(  28)		while(hx::IsNotNull( _g_head )){
HXLINE(  28)			HX_VARI(  ::haxe::xml::Fast,val) = ( ( ::haxe::xml::Fast)(_g_head->item) );
HXDLIN(  28)			_g_head = _g_head->next;
HXLINE(  30)			::Array< ::Dynamic> _hx_tmp = this->objects;
HXDLIN(  30)			_hx_tmp->push( ::flixel::addons::editors::tiled::TiledObject_obj::__alloc( HX_CTX ,val,hx::ObjectPtr<OBJ_>(this)));
            		}
            	}
