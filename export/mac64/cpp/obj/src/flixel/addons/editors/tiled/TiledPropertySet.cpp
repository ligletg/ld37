...
HX_DEFINE_STACK_FRAME(_hx_pos_f7469de85736df0a_21_get,"flixel.addons.editors.tiled.TiledPropertySet","get",0x0edc9a88,"flixel.addons.editors.tiled.TiledPropertySet.get","flixel/addons/editors/tiled/TiledPropertySet.hx",21,0x279539bc)
HX_DEFINE_STACK_FRAME(_hx_pos_f7469de85736df0a_26_contains,"flixel.addons.editors.tiled.TiledPropertySet","contains",0x498ff2ed,"flixel.addons.editors.tiled.TiledPropertySet.contains","flixel/addons/editors/tiled/TiledPropertySet.hx",26,0x279539bc)
HX_DEFINE_STACK_FRAME(_hx_pos_f7469de85736df0a_31_resolve,"flixel.addons.editors.tiled.TiledPropertySet","resolve",0x30670dde,"flixel.addons.editors.tiled.TiledPropertySet.resolve","flixel/addons/editors/tiled/TiledPropertySet.hx",31,0x279539bc)
HX_DEFINE_STACK_FRAME(_hx_pos_f7469de85736df0a_36_keysIterator,"flixel.addons.editors.tiled.TiledPropertySet","keysIterator",0x218013d0,"flixel.addons.editors.tiled.TiledPropertySet.keysIterator","flixel/addons/editors/tiled/TiledPropertySet.hx",36,0x279539bc)
HX_DEFINE_STACK_FRAME(_hx_pos_f7469de85736df0a_41_extend,"flixel.addons.editors.tiled.TiledPropertySet","extend",0xeb97fb28,"flixel.addons.editors.tiled.TiledPropertySet.extend","flixel/addons/editors/tiled/TiledPropertySet.hx",41,0x279539bc)
namespace flixel{
namespace addons{
namespace editors{
namespace tiled{
...
void TiledPropertySet_obj::__construct(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  16)		this->keys =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
...
HXLINE(  21)		return ( (::String)(::haxe::IMap_obj::get(this->keys,Key)) );
            	}
...
HXLINE(  31)		return this->keys->get(Name);
            	}
...
HXLINE(  41)		HX_VARI(  ::_List::ListNode,_g_head) = Source->nodes->resolve(HX_("property",55,48,38,ac))->h;
HXDLIN(  41)		while(hx::IsNotNull( _g_head )){
HXLINE(  41)			HX_VARI(  ::haxe::xml::Fast,val) = ( ( ::haxe::xml::Fast)(_g_head->item) );
HXDLIN(  41)			_g_head = _g_head->next;
HXLINE(  43)			{
HXLINE(  43)				::Dynamic this1 = this->keys;
HXDLIN(  43)				::String key = val->att->resolve(HX_("name",4b,72,ff,48));
HXDLIN(  43)				( ( ::haxe::ds::StringMap)(this1) )->set(key,val->att->resolve(HX_("value",71,7f,b8,31)));
            			}
            		}
            	}
