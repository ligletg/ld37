...
HXLINE(  19)		HX_VARI(  ::_List::ListNode,_g_head) = Source->nodes->resolve(HX_("image",5b,1f,69,bd))->h;
HXDLIN(  19)		while(hx::IsNotNull( _g_head )){
HXLINE(  19)			HX_VARI(  ::haxe::xml::Fast,val) = ( ( ::haxe::xml::Fast)(_g_head->item) );
HXDLIN(  19)			_g_head = _g_head->next;
HXLINE(  21)			this->width = ::Std_obj::parseFloat(val->att->resolve(HX_("width",06,b6,62,ca)));
HXLINE(  22)			this->height = ::Std_obj::parseFloat(val->att->resolve(HX_("height",e7,07,4c,02)));
