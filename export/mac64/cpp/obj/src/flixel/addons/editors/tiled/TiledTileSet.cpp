...
HX_DEFINE_STACK_FRAME(_hx_pos_c73e981696bb0370_175_hasGid,"flixel.addons.editors.tiled.TiledTileSet","hasGid",0x55a8bbaf,"flixel.addons.editors.tiled.TiledTileSet.hasGid","flixel/addons/editors/tiled/TiledTileSet.hx",175,0x504d33d5)
HX_DEFINE_STACK_FRAME(_hx_pos_c73e981696bb0370_180_fromGid,"flixel.addons.editors.tiled.TiledTileSet","fromGid",0xe24bb3f1,"flixel.addons.editors.tiled.TiledTileSet.fromGid","flixel/addons/editors/tiled/TiledTileSet.hx",180,0x504d33d5)
HX_DEFINE_STACK_FRAME(_hx_pos_c73e981696bb0370_185_toGid,"flixel.addons.editors.tiled.TiledTileSet","toGid",0xbfce2440,"flixel.addons.editors.tiled.TiledTileSet.toGid","flixel/addons/editors/tiled/TiledTileSet.hx",185,0x504d33d5)
HX_DEFINE_STACK_FRAME(_hx_pos_c73e981696bb0370_189_getPropertiesByGid,"flixel.addons.editors.tiled.TiledTileSet","getPropertiesByGid",0x4c2032e9,"flixel.addons.editors.tiled.TiledTileSet.getPropertiesByGid","flixel/addons/editors/tiled/TiledTileSet.hx",189,0x504d33d5)
HX_DEFINE_STACK_FRAME(_hx_pos_c73e981696bb0370_200_getProperties,"flixel.addons.editors.tiled.TiledTileSet","getProperties",0x8aac6822,"flixel.addons.editors.tiled.TiledTileSet.getProperties","flixel/addons/editors/tiled/TiledTileSet.hx",200,0x504d33d5)
HX_DEFINE_STACK_FRAME(_hx_pos_c73e981696bb0370_204_getImageSourceByGid,"flixel.addons.editors.tiled.TiledTileSet","getImageSourceByGid",0x251eb564,"flixel.addons.editors.tiled.TiledTileSet.getImageSourceByGid","flixel/addons/editors/tiled/TiledTileSet.hx",204,0x504d33d5)
HX_DEFINE_STACK_FRAME(_hx_pos_c73e981696bb0370_215_getImageSource,"flixel.addons.editors.tiled.TiledTileSet","getImageSource",0xba92f787,"flixel.addons.editors.tiled.TiledTileSet.getImageSource","flixel/addons/editors/tiled/TiledTileSet.hx",215,0x504d33d5)
HX_DEFINE_STACK_FRAME(_hx_pos_c73e981696bb0370_221_getRect,"flixel.addons.editors.tiled.TiledTileSet","getRect",0xa87c5c13,"flixel.addons.editors.tiled.TiledTileSet.getRect","flixel/addons/editors/tiled/TiledTileSet.hx",221,0x504d33d5)
namespace flixel{
namespace addons{
namespace editors{
namespace tiled{
...
HXLINE(  49)				source =  ::haxe::xml::Fast_obj::__alloc( HX_CTX ,::Xml_obj::parse(( ( ::openfl::_legacy::utils::ByteArray)(data) )->toString()));
...
HXLINE(  61)			HX_VARI( ::String,sourcePath) = (rootPath + source->att->resolve(HX_("source",db,b0,31,32)));
...
HXLINE(  88)				{
HXLINE(  88)					HX_VARI(  ::_List::ListNode,_g_head) = source->nodes->resolve(HX_("tile",2e,cb,fc,4c))->h;
HXDLIN(  88)					while(hx::IsNotNull( _g_head )){
HXLINE(  88)						HX_VARI(  ::haxe::xml::Fast,val) = ( ( ::haxe::xml::Fast)(_g_head->item) );
HXDLIN(  88)						_g_head = _g_head->next;
HXLINE(  90)						if (!(val->has->resolve(HX_("id",db,5b,00,00)))) {
HXLINE(  92)							continue;
            						}
HXLINE(  95)						HX_VARI( int,id) = ::Std_obj::parseInt(val->att->resolve(HX_("id",db,5b,00,00)));
HXLINE(  96)						this->tileImagesSources[id] =  ::flixel::addons::editors::tiled::TiledImageTile_obj::__alloc( HX_CTX ,val);
            					}
            				}
            			}
...
HXLINE( 132)			{
HXLINE( 132)				HX_VARI_NAME(  ::_List::ListNode,_g_head1,"_g_head") = source->nodes->resolve(HX_("properties",f3,fb,0e,61))->h;
HXDLIN( 132)				while(hx::IsNotNull( _g_head1 )){
HXLINE( 132)					HX_VARI_NAME(  ::haxe::xml::Fast,val1,"val") = ( ( ::haxe::xml::Fast)(_g_head1->item) );
...
HXLINE( 138)			{
HXLINE( 138)				HX_VARI_NAME(  ::_List::ListNode,_g_head2,"_g_head") = source->nodes->resolve(HX_("tile",2e,cb,fc,4c))->h;
HXDLIN( 138)				while(hx::IsNotNull( _g_head2 )){
HXLINE( 138)					HX_VARI_NAME(  ::haxe::xml::Fast,val2,"val") = ( ( ::haxe::xml::Fast)(_g_head2->item) );
HXDLIN( 138)					_g_head2 = _g_head2->next;
HXLINE( 140)					if (!(val2->has->resolve(HX_("id",db,5b,00,00)))) {
HXLINE( 142)						continue;
            					}
HXLINE( 145)					HX_VARI_NAME( int,id1,"id") = ::Std_obj::parseInt(val2->att->resolve(HX_("id",db,5b,00,00)));
HXLINE( 146)					this->tileProps[id1] =  ::flixel::addons::editors::tiled::TiledTilePropertySet_obj::__alloc( HX_CTX ,id1);
HXLINE( 147)					{
...
HXLINE( 148)					{
HXLINE( 148)						HX_VARI_NAME(  ::_List::ListNode,_g_head3,"_g_head") = val2->nodes->resolve(HX_("properties",f3,fb,0e,61))->h;
HXDLIN( 148)						while(hx::IsNotNull( _g_head3 )){
HXLINE( 148)							HX_VARI_NAME(  ::haxe::xml::Fast,val3,"val") = ( ( ::haxe::xml::Fast)(_g_head3->item) );
...
HXLINE( 152)					if (val2->hasNode->resolve(HX_("animation",04,ef,34,4b))) {
HXLINE( 154)						HX_VARI_NAME(  ::_List::ListNode,_g_head4,"_g_head") = val2->node->resolve(HX_("animation",04,ef,34,4b))->nodes->resolve(HX_("frame",2d,78,83,06))->h;
HXDLIN( 154)						while(hx::IsNotNull( _g_head4 )){
HXLINE( 154)							HX_VARI_NAME(  ::haxe::xml::Fast,val4,"val") = ( ( ::haxe::xml::Fast)(_g_head4->item) );
HXDLIN( 154)							_g_head4 = _g_head4->next;
HXLINE( 156)							 ::flixel::addons::editors::tiled::TiledTilePropertySet _hx_tmp1 = this->tileProps->__get(id1).StaticCast<  ::flixel::addons::editors::tiled::TiledTilePropertySet >();
HXLINE( 157)							 ::Dynamic _hx_tmp2 = ::Std_obj::parseInt(val4->att->resolve(HX_("tileid",89,ce,28,1e)));
HXLINE( 156)							_hx_tmp1->addAnimationFrame(_hx_tmp2,::Std_obj::parseFloat(val4->att->resolve(HX_("duration",54,0f,8e,14))));
            						}
            					}
            				}
            			}
...
HXLINE( 164)				_hx_tmp3 = (this->tileHeight > (int)0);
            			}
            			else {
...
HX_DEFINE_DYNAMIC_FUNC1(TiledTileSet_obj,getImageSource,return )
 ...
 ::openfl::_legacy::geom::Rectangle TiledTileSet_obj::getRect(int ID){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(ID,"ID")
HXLINE( 221)		return  ::openfl::_legacy::geom::Rectangle_obj::__alloc( HX_CTX ,(hx::Mod(ID,this->numCols) * this->tileWidth),(((Float)ID / (Float)this->numCols) * this->tileHeight),null(),null());
            	}
