...
HX_DEFINE_STACK_FRAME(_hx_pos_6e8a9623e9d30997_44_getByteArrayData,"flixel.addons.editors.tiled.TiledTileLayer","getByteArrayData",0x4a9ded1d,"flixel.addons.editors.tiled.TiledTileLayer.getByteArrayData","flixel/addons/editors/tiled/TiledTileLayer.hx",44,0x5f61a546)
HX_DEFINE_STACK_FRAME(_hx_pos_6e8a9623e9d30997_85_base64ToByteArray,"flixel.addons.editors.tiled.TiledTileLayer","base64ToByteArray",0x153e24cf,"flixel.addons.editors.tiled.TiledTileLayer.base64ToByteArray","flixel/addons/editors/tiled/TiledTileLayer.hx",85,0x5f61a546)
HX_DEFINE_STACK_FRAME(_hx_pos_6e8a9623e9d30997_135_resolveTile,"flixel.addons.editors.tiled.TiledTileLayer","resolveTile",0xa03c3be2,"flixel.addons.editors.tiled.TiledTileLayer.resolveTile","flixel/addons/editors/tiled/TiledTileLayer.hx",135,0x5f61a546)
HX_DEFINE_STACK_FRAME(_hx_pos_6e8a9623e9d30997_153_get_encoding,"flixel.addons.editors.tiled.TiledTileLayer","get_encoding",0x31302834,"flixel.addons.editors.tiled.TiledTileLayer.get_encoding","flixel/addons/editors/tiled/TiledTileLayer.hx",153,0x5f61a546)
HX_DEFINE_STACK_FRAME(_hx_pos_6e8a9623e9d30997_157_get_csvData,"flixel.addons.editors.tiled.TiledTileLayer","get_csvData",0x6c5b0ccf,"flixel.addons.editors.tiled.TiledTileLayer.get_csvData","flixel/addons/editors/tiled/TiledTileLayer.hx",157,0x5f61a546)
HX_DEFINE_STACK_FRAME(_hx_pos_6e8a9623e9d30997_173_get_tileArray,"flixel.addons.editors.tiled.TiledTileLayer","get_tileArray",0x6cbb250a,"flixel.addons.editors.tiled.TiledTileLayer.get_tileArray","flixel/addons/editors/tiled/TiledTileLayer.hx",173,0x5f61a546)
HX_DEFINE_STACK_FRAME(_hx_pos_6e8a9623e9d30997_22_boot,"flixel.addons.editors.tiled.TiledTileLayer","boot",0x6bf6538a,"flixel.addons.editors.tiled.TiledTileLayer.boot","flixel/addons/editors/tiled/TiledTileLayer.hx",22,0x5f61a546)
namespace flixel{
namespace addons{
namespace editors{
namespace tiled{
...
bool TiledTileLayer_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_legacy::utils::ByteArray TiledTileLayer_obj::getByteArrayData(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  45)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,result) = null();
HXLINE(  47)		if ((this->get_encoding() == HX_("base64",8f,fd,27,55))) {
HXLINE(  50)			HX_VARI( bool,compressed) = false;
HXLINE(  52)			result = this->base64ToByteArray(this->xmlData->get_innerData());
...
HXLINE(  57)				if ((this->xmlData->att->resolve(HX_("compression",66,b7,2b,77)) == HX_("zlib",0b,57,f6,50))) {
...
HXLINE(  86)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,output) =  ::openfl::_legacy::utils::ByteArray_obj::__alloc( HX_CTX ,null());
...
HXDLIN(  91)				HX_VARI( int,c) = (_g1 - (int)1);
...
HXLINE( 106)			HX_VARI( int,a0) = lookup->__get(data.charCodeAt(i));
HXLINE( 107)			HX_VARI( int,a1) = lookup->__get(data.charCodeAt((i + (int)1)));
HXLINE( 108)			HX_VARI( int,a2) = lookup->__get(data.charCodeAt((i + (int)2)));
HXLINE( 109)			HX_VARI( int,a3) = lookup->__get(data.charCodeAt((i + (int)3)));
HXLINE( 112)			if ((a1 < (int)64)) {
HXLINE( 114)				output->ensureElem(output->position,true);
HXDLIN( 114)				output->b[output->position++] = (((int)a0 << (int)(int)2) + ((int)((int)a1 & (int)(int)48) >> (int)(int)4));
            			}
HXLINE( 116)			if ((a2 < (int)64)) {
HXLINE( 118)				output->ensureElem(output->position,true);
HXDLIN( 118)				output->b[output->position++] = (((int)((int)a1 & (int)(int)15) << (int)(int)4) + ((int)((int)a2 & (int)(int)60) >> (int)(int)2));
            			}
HXLINE( 120)			if ((a3 < (int)64)) {
HXLINE( 122)				output->ensureElem(output->position,true);
HXDLIN( 122)				output->b[output->position++] = (((int)((int)a2 & (int)(int)3) << (int)(int)6) + a3);
            			}
...
HXLINE( 136)		HX_VARI(  ::flixel::addons::editors::tiled::TiledTile,tile) =  ::flixel::addons::editors::tiled::TiledTile_obj::__alloc( HX_CTX ,globalTileId);
HXLINE( 138)		HX_VARI( int,tilesetID) = tile->tilesetID;
HXLINE( 139)		{
HXLINE( 139)			HX_VARI(  ::Dynamic,tileset) = this->map->tilesets->iterator();
HXDLIN( 139)			while(( (bool)(tileset->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 139)				HX_VARI_NAME(  ::flixel::addons::editors::tiled::TiledTileSet,tileset1,"tileset") = ( ( ::flixel::addons::editors::tiled::TiledTileSet)(tileset->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
...
::String TiledTileLayer_obj::get_encoding(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 153)		if (hx::IsNotNull( this->encoding )) {
...
HXLINE( 197)				HX_VARI(  ::openfl::_legacy::utils::ByteArray,mapData) = this->getByteArrayData();
