...
HX_DEFINE_STACK_FRAME(_hx_pos_1ff3326fd807048e_41_loadProperties,"flixel.addons.editors.tiled.TiledLayer","loadProperties",0x66f78643,"flixel.addons.editors.tiled.TiledLayer.loadProperties","flixel/addons/editors/tiled/TiledLayer.hx",41,0x30daee78)
namespace flixel{
namespace addons{
namespace editors{
namespace tiled{
...
void TiledLayer_obj::loadProperties( ::haxe::xml::Fast source){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
HXLINE(  41)		HX_VARI(  ::_List::ListNode,_g_head) = source->nodes->resolve(HX_("properties",f3,fb,0e,61))->h;
