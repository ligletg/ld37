...
HX_DEFINE_STACK_FRAME(_hx_pos_67d155f97991e016_78_loadAttributes,"flixel.addons.editors.tiled.TiledMap","loadAttributes",0x4081997c,"flixel.addons.editors.tiled.TiledMap.loadAttributes","flixel/addons/editors/tiled/TiledMap.hx",78,0xfb5e15cd)
HX_DEFINE_STACK_FRAME(_hx_pos_67d155f97991e016_95_loadProperties,"flixel.addons.editors.tiled.TiledMap","loadProperties",0x0a1eec98,"flixel.addons.editors.tiled.TiledMap.loadProperties","flixel/addons/editors/tiled/TiledMap.hx",95,0xfb5e15cd)
HX_DEFINE_STACK_FRAME(_hx_pos_67d155f97991e016_115_loadTilesets,"flixel.addons.editors.tiled.TiledMap","loadTilesets",0x94e39a24,"flixel.addons.editors.tiled.TiledMap.loadTilesets","flixel/addons/editors/tiled/TiledMap.hx",115,0xfb5e15cd)
HX_DEFINE_STACK_FRAME(_hx_pos_67d155f97991e016_130_loadLayers,"flixel.addons.editors.tiled.TiledMap","loadLayers",0x89a88fa7,"flixel.addons.editors.tiled.TiledMap.loadLayers","flixel/addons/editors/tiled/TiledMap.hx",130,0xfb5e15cd)
HX_DEFINE_STACK_FRAME(_hx_pos_67d155f97991e016_153_getTileSet,"flixel.addons.editors.tiled.TiledMap","getTileSet",0x10a90a7d,"flixel.addons.editors.tiled.TiledMap.getTileSet","flixel/addons/editors/tiled/TiledMap.hx",153,0xfb5e15cd)
HX_DEFINE_STACK_FRAME(_hx_pos_67d155f97991e016_158_getLayer,"flixel.addons.editors.tiled.TiledMap","getLayer",0xf247f6fa,"flixel.addons.editors.tiled.TiledMap.getLayer","flixel/addons/editors/tiled/TiledMap.hx",158,0xfb5e15cd)
HX_DEFINE_STACK_FRAME(_hx_pos_67d155f97991e016_165_getGidOwner,"flixel.addons.editors.tiled.TiledMap","getGidOwner",0xd5d72748,"flixel.addons.editors.tiled.TiledMap.getGidOwner","flixel/addons/editors/tiled/TiledMap.hx",165,0xfb5e15cd)
namespace flixel{
namespace addons{
namespace editors{
namespace tiled{
...
void TiledMap_obj::loadProperties( ::haxe::xml::Fast source){
            	...
            	HX_STACK_ARG(source,"source")
HXLINE(  96)		{
HXLINE(  96)			HX_VARI(  ::_List::ListNode,_g_head) = source->nodes->resolve(HX_("properties",f3,fb,0e,61))->h;
HXDLIN(  96)			while(hx::IsNotNull( _g_head )){
HXLINE(  96)				HX_VARI(  ::haxe::xml::Fast,val) = ( ( ::haxe::xml::Fast)(_g_head->item) );
...
HXLINE( 104)			HX_VARI( ::Array< ::String >,noLoadArr) =  ::EReg_obj::__alloc( HX_CTX ,HX_("[,;|]",8b,5e,b9,82),HX_("",00,00,00,00))->split(noLoadStr);
HXLINE( 106)			{
...
void TiledMap_obj::loadTilesets( ::haxe::xml::Fast source){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
HXLINE( 115)		HX_VARI(  ::_List::ListNode,_g_head) = source->nodes->resolve(HX_("tileset",34,81,93,45))->h;
HXDLIN( 115)		while(hx::IsNotNull( _g_head )){
HXLINE( 115)			HX_VARI(  ::haxe::xml::Fast,val) = ( ( ::haxe::xml::Fast)(_g_head->item) );
HXDLIN( 115)			_g_head = _g_head->next;
HXLINE( 117)			HX_VAR( ::String,name);
HXDLIN( 117)			if (val->has->resolve(HX_("name",4b,72,ff,48))) {
...
HXLINE( 121)				HX_VARI(  ::flixel::addons::editors::tiled::TiledTileSet,ts) =  ::flixel::addons::editors::tiled::TiledTileSet_obj::__alloc( HX_CTX ,val,this->rootPath);
...
void TiledMap_obj::loadLayers( ::haxe::xml::Fast source){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(source,"source")
HXLINE( 130)		HX_VARI(  ::Dynamic,el) = source->get_elements();
HXDLIN( 130)		while(( (bool)(el->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 130)			HX_VARI_NAME(  ::haxe::xml::Fast,el1,"el") = ( ( ::haxe::xml::Fast)(el->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
...
HXDLIN( 135)			::String _hx_switch_0 = el1->get_name().toLowerCase();
...
HXLINE( 166)		{
HXLINE( 166)			HX_VARI(  ::Dynamic,set) = this->tilesets->iterator();
HXDLIN( 166)			while(( (bool)(set->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 166)				HX_VARI_NAME(  ::flixel::addons::editors::tiled::TiledTileSet,set1,"set") = ( ( ::flixel::addons::editors::tiled::TiledTileSet)(set->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
