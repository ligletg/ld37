...
HXLINE( 225)		this->postProcessLayer =  ::openfl::_legacy::display::Sprite_obj::__alloc( HX_CTX );
HXLINE( 201)		this->_resetGame = false;
HXLINE( 191)		this->_startFullscreen = false;
...
HXLINE( 252)		this->_startFullscreen = StartFullscreen;
HXLINE( 256)		this->_inputContainer =  ::openfl::_legacy::display::Sprite_obj::__alloc( HX_CTX );
HXLINE( 258)		if ((GameWidth == (int)0)) {
HXLINE( 259)			GameWidth = ::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_stageWidth();
            		}
HXLINE( 260)		if ((GameHeight == (int)0)) {
HXLINE( 261)			GameHeight = ::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_stageHeight();
            		}
...
HXLINE( 278)		this->addEventListener(::openfl::_legacy::events::Event_obj::ADDED_TO_STAGE,this->create_dyn(),null(),null(),null());
            	}
...
void FlxGame_obj::create( ::Dynamic _){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(_,"_")
HXLINE( 294)		if (hx::IsNull( this->get_stage() )) {
HXLINE( 296)			return;
            		}
HXLINE( 298)		this->removeEventListener(::openfl::_legacy::events::Event_obj::ADDED_TO_STAGE,this->create_dyn(),null());
...
HXLINE( 304)		::flixel::FlxG_obj::set_fullscreen(this->_startFullscreen);
HXLINE( 308)		this->get_stage()->set_scaleMode(::openfl::_legacy::display::StageScaleMode_obj::NO_SCALE_dyn());
HXLINE( 309)		this->get_stage()->set_align(::openfl::_legacy::display::StageAlign_obj::TOP_LEFT_dyn());
HXLINE( 310)		this->get_stage()->set_frameRate(::flixel::FlxG_obj::drawFramerate);
HXLINE( 312)		this->addChild(this->_inputContainer);
HXLINE( 316)		this->addChild(this->postProcessLayer);
HXLINE( 321)		int _hx_tmp1 = ::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_stageWidth();
HXDLIN( 321)		this->debugger =  ::flixel::_hx_system::debug::FlxDebugger_obj::__alloc( HX_CTX ,_hx_tmp1,::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_stageHeight());
HXLINE( 322)		this->addChild(this->debugger);
HXLINE( 329)		this->soundTray = ( ( ::flixel::_hx_system::ui::FlxSoundTray)(::Type_obj::createInstance(this->_customSoundTray,::cpp::VirtualArray_obj::__new(0))) );
HXLINE( 330)		this->addChild(this->soundTray);
HXLINE( 341)		this->get_stage()->addEventListener(HX_("focusOut",96,6f,5e,11),this->onFocusLost_dyn(),null(),null(),null());
HXLINE( 342)		this->get_stage()->addEventListener(HX_("focusIn",dd,45,83,41),this->onFocus_dyn(),null(),null(),null());
HXLINE( 349)		{
...
HXLINE( 349)				_hx_tmp2 = hx::IsNotNull( ::flixel::_hx_system::FlxSplash_obj::nextState );
            			}
            			else {
...
HXDLIN( 349)			if (::Std_obj::is(this->_requestedState,hx::ClassOf< ::flixel::FlxSubState >())) {
HXLINE( 349)				HX_STACK_DO_THROW(HX_("You can't set FlxSubState class instance as the state for you game",f2,8e,2c,80));
            			}
HXDLIN( 349)			::flixel::FlxG_obj::reset();
HXDLIN( 349)			::flixel::FlxG_obj::signals->postGameReset->dispatch();
            		}
HXLINE( 350)		this->switchState();
HXLINE( 352)		if ((::flixel::FlxG_obj::updateFramerate < ::flixel::FlxG_obj::drawFramerate)) {
HXLINE( 354)			::flixel::FlxG_obj::log->advanced(HX_("FlxG.updateFramerate: The update framerate shouldn't be smaller than the draw framerate, since it can slow down your game.",81,2e,69,6b),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
            		}
HXLINE( 358)		this->get_stage()->addEventListener(::openfl::_legacy::events::Event_obj::ENTER_FRAME,this->onEnterFrame_dyn(),null(),null(),null());
HXLINE( 362)		this->get_stage()->addEventListener(::openfl::_legacy::events::Event_obj::RESIZE,this->onResize_dyn(),null(),null(),null());
HXLINE( 365)		int _hx_tmp3 = ::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_stageWidth();
HXDLIN( 365)		this->resizeGame(_hx_tmp3,::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_stageHeight());
HXLINE( 367)		::openfl::_legacy::Assets_obj::addEventListener(::openfl::_legacy::events::Event_obj::CHANGE,::flixel::FlxG_obj::bitmap->onAssetsReload_dyn(),null(),null(),null());
            	}
...
void FlxGame_obj::onFocus( ::Dynamic _){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(_,"_")
HXLINE( 381)		if (!(this->_onFocusFiredOnce)) {
HXLINE( 383)			this->_onFocusFiredOnce = true;
HXLINE( 384)			return;
            		}
...
HXLINE( 410)		this->debugger->stats->onFocus();
HXLINE( 413)		this->get_stage()->set_frameRate(::flixel::FlxG_obj::drawFramerate);
...
HXLINE( 446)		this->debugger->stats->onFocusLost();
HXLINE( 449)		this->get_stage()->set_frameRate(this->focusLostFramerate);
...
void FlxGame_obj::onResize( ::Dynamic _){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(_,"_")
HXLINE( 459)		HX_VARI( int,width) = ::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_stageWidth();
HXLINE( 460)		HX_VARI( int,height) = ::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_stageHeight();
...
HXLINE( 482)		this->debugger->onResize(width,height);
...
HXLINE( 534)						this->debugger->update();
HXLINE( 538)						if (this->debugger->interaction->isActive()) {
HXLINE( 540)							this->draw();
            						}
HXLINE( 543)						return;
            					}
            				}
...
HXLINE( 564)			::flixel::FlxBasic_obj::visibleCount = (int)0;
HXLINE( 567)			this->draw();
HXLINE( 570)			this->debugger->stats->visibleObjects(::flixel::FlxBasic_obj::visibleCount);
HXLINE( 571)			this->debugger->update();
            		}
            	}
...
HXLINE( 585)		this->_skipSplash = true;
...
HXLINE( 604)		if (::Std_obj::is(this->_requestedState,hx::ClassOf< ::flixel::FlxSubState >())) {
HXLINE( 606)			HX_STACK_DO_THROW(HX_("You can't set FlxSubState class instance as the state for you game",f2,8e,2c,80));
            		}
...
HXLINE( 657)		::haxe::IMap_obj::set(this->debugger->console->registeredObjects,HX_("state",11,76,0b,84),this->_state);
            	}
...
HXDLIN( 678)				if (::Std_obj::is(this->_requestedState,hx::ClassOf< ::flixel::FlxSubState >())) {
HXLINE( 678)					HX_STACK_DO_THROW(HX_("You can't set FlxSubState class instance as the state for you game",f2,8e,2c,80));
            				}
...
HXLINE( 686)		::flixel::FlxBasic_obj::activeCount = (int)0;
HXLINE( 689)		this->update();
HXLINE( 692)		this->debugger->stats->activeObjects(::flixel::FlxBasic_obj::activeCount);
            	}
...
HXLINE( 743)		if (::flixel::FlxG_obj::debugger->visible) {
HXLINE( 744)			int _hx_tmp1 = ( (int)(this->getTimer()) );
HXDLIN( 744)			this->ticks = (_hx_tmp1 - this->_startTime);
            		}
...
HXLINE( 763)						_hx_tmp2 = plugin->active;
            					}
            					else {
...
HXLINE( 767)						_hx_tmp4 = camera->exists;
            					}
            					else {
HXLINE( 767)						_hx_tmp4 = false;
            					}
HXDLIN( 767)					if (_hx_tmp4) {
HXLINE( 767)						_hx_tmp3 = camera->active;
            					}
            					else {
...
HXLINE( 771)		 ::flixel::_hx_system::debug::stats::Stats _hx_tmp5 = this->debugger->stats;
HXDLIN( 771)		int _hx_tmp6 = ( (int)(this->getTimer()) );
HXDLIN( 771)		_hx_tmp5->flixelUpdate(((_hx_tmp6 - this->_startTime) - this->ticks));
HXLINE( 775)		::flixel::util::FlxArrayUtil_obj::clearArray(::flixel::FlxG_obj::swipes,null());
HXLINE( 778)		::Array< ::Dynamic> _hx_tmp7;
HXDLIN( 778)		if (this->filtersEnabled) {
HXLINE( 778)			_hx_tmp7 = this->_filters;
            		}
            		else {
HXLINE( 778)			_hx_tmp7 = null();
            		}
HXDLIN( 778)		this->set_filters(_hx_tmp7);
            	}
...
HXLINE( 868)		if (::flixel::FlxG_obj::debugger->visible) {
HXLINE( 869)			int _hx_tmp1 = ( (int)(this->getTimer()) );
HXDLIN( 869)			this->ticks = (_hx_tmp1 - this->_startTime);
            		}
...
HXLINE( 880)		if (hx::IsNotNull( this->postProcesses->__get((int)0).StaticCast<  ::flixel::effects::postprocess::PostProcess >() )) {
HXLINE( 882)			this->postProcesses->__get((int)0).StaticCast<  ::flixel::effects::postprocess::PostProcess >()->capture();
            		}
HXLINE( 886)		{
HXLINE( 886)			HX_VARI( int,_g) = (int)0;
HXDLIN( 886)			HX_VARI( ::Array< ::Dynamic>,_g1) = ::flixel::FlxG_obj::cameras->list;
...
HXDLIN( 886)				bool _hx_tmp3;
HXDLIN( 886)				if (hx::IsNotNull( camera )) {
HXLINE( 886)					_hx_tmp3 = !(camera->exists);
            				}
            				else {
HXLINE( 886)					_hx_tmp3 = true;
            				}
HXDLIN( 886)				if (!(_hx_tmp3)) {
HXLINE( 886)					_hx_tmp2 = !(camera->visible);
            				}
            				else {
...
HXDLIN( 886)					camera->canvas->get_graphics()->clear();
HXDLIN( 886)					camera->debugLayer->get_graphics()->clear();
            				}
HXDLIN( 886)				if (::flixel::FlxG_obj::renderBlit) {
...
HXDLIN( 888)				bool _hx_tmp4;
HXDLIN( 888)				if (plugin->exists) {
HXLINE( 888)					_hx_tmp4 = plugin->visible;
            				}
            				else {
HXLINE( 888)					_hx_tmp4 = false;
            				}
...
HXDLIN( 894)					bool _hx_tmp6;
HXDLIN( 894)					if (hx::IsNotNull( camera1 )) {
HXLINE( 894)						_hx_tmp6 = camera1->exists;
            					}
            					else {
HXLINE( 894)						_hx_tmp6 = false;
            					}
HXDLIN( 894)					if (_hx_tmp6) {
HXLINE( 894)						_hx_tmp5 = camera1->visible;
            					}
            					else {
...
HXLINE( 897)			this->debugger->stats->drawCalls(::flixel::graphics::tile::FlxTilesheet_obj::_DRAWCALLS);
            		}
HXLINE( 901)		{
HXLINE( 901)			HX_VARI_NAME( int,_g4,"_g") = (int)0;
HXDLIN( 901)			HX_VARI_NAME( ::Array< ::Dynamic>,_g13,"_g1") = ::flixel::FlxG_obj::cameras->list;
...
HXLINE( 901)					_hx_tmp8 = !(camera2->exists);
            				}
            				else {
HXLINE( 901)					_hx_tmp8 = true;
            				}
HXDLIN( 901)				if (!(_hx_tmp8)) {
HXLINE( 901)					_hx_tmp7 = !(camera2->visible);
            				}
            				else {
...
HXLINE( 901)					camera2->screen->dirty = true;
            				}
            			}
            		}
HXLINE( 903)		::flixel::FlxG_obj::signals->postDraw->dispatch();
HXLINE( 906)		 ::flixel::_hx_system::debug::stats::Stats _hx_tmp9 = this->debugger->stats;
HXDLIN( 906)		int _hx_tmp10 = ( (int)(this->getTimer()) );
HXDLIN( 906)		_hx_tmp9->flixelDraw(((_hx_tmp10 - this->_startTime) - this->ticks));
            	}
...
HXLINE( 918)		return ::openfl::_legacy::Lib_obj::getTimer();
            	}
