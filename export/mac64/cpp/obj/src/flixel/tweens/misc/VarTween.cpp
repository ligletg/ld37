...
HX_DEFINE_STACK_FRAME(_hx_pos_a4370a0a6fec63c7_18_destroy,"flixel.tweens.misc.VarTween","destroy",0xef76787e,"flixel.tweens.misc.VarTween.destroy","flixel/tweens/misc/VarTween.hx",18,0x836bddcb)
HX_DEFINE_STACK_FRAME(_hx_pos_a4370a0a6fec63c7_37_tween,"flixel.tweens.misc.VarTween","tween",0xf3504cef,"flixel.tweens.misc.VarTween.tween","flixel/tweens/misc/VarTween.hx",37,0x836bddcb)
HX_DEFINE_STACK_FRAME(_hx_pos_a4370a0a6fec63c7_57_update,"flixel.tweens.misc.VarTween","update",0x50d41705,"flixel.tweens.misc.VarTween.update","flixel/tweens/misc/VarTween.hx",57,0x836bddcb)
HX_DEFINE_STACK_FRAME(_hx_pos_a4370a0a6fec63c7_84_initializeVars,"flixel.tweens.misc.VarTween","initializeVars",0x0a5a5e18,"flixel.tweens.misc.VarTween.initializeVars","flixel/tweens/misc/VarTween.hx",84,0x836bddcb)
namespace flixel{
namespace tweens{
namespace misc{
...
HXLINE(  78)					::Reflect_obj::setProperty(this->_object,( (::String)(info->__Field(HX_("name",4b,72,ff,48),hx::paccDynamic)) ),(( (Float)(info->__Field(HX_("startValue",af,57,cf,4d),hx::paccDynamic)) ) + (( (Float)(info->__Field(HX_("range",bd,a5,1f,e4),hx::paccDynamic)) ) * this->scale)));
            				}
            			}
            		}
            	}
