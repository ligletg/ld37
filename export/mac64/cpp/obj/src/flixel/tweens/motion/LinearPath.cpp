...
HX_DEFINE_STACK_FRAME(_hx_pos_a5dbf3466a77d348_41_destroy,"flixel.tweens.motion.LinearPath","destroy",0x4706681a,"flixel.tweens.motion.LinearPath.destroy","flixel/tweens/motion/LinearPath.hx",41,0x519b896f)
HX_DEFINE_STACK_FRAME(_hx_pos_a5dbf3466a77d348_60_setMotion,"flixel.tweens.motion.LinearPath","setMotion",0x1a623e98,"flixel.tweens.motion.LinearPath.setMotion","flixel/tweens/motion/LinearPath.hx",60,0x519b896f)
HX_DEFINE_STACK_FRAME(_hx_pos_a5dbf3466a77d348_79_addPoint,"flixel.tweens.motion.LinearPath","addPoint",0x4da05b4f,"flixel.tweens.motion.LinearPath.addPoint","flixel/tweens/motion/LinearPath.hx",79,0x519b896f)
HX_DEFINE_STACK_FRAME(_hx_pos_a5dbf3466a77d348_90_getPoint,"flixel.tweens.motion.LinearPath","getPoint",0x341a44ba,"flixel.tweens.motion.LinearPath.getPoint","flixel/tweens/motion/LinearPath.hx",90,0x519b896f)
HX_DEFINE_STACK_FRAME(_hx_pos_a5dbf3466a77d348_99_start,"flixel.tweens.motion.LinearPath","start",0xb880a782,"flixel.tweens.motion.LinearPath.start","flixel/tweens/motion/LinearPath.hx",99,0x519b896f)
HX_DEFINE_STACK_FRAME(_hx_pos_a5dbf3466a77d348_106_update,"flixel.tweens.motion.LinearPath","update",0x391d0ee9,"flixel.tweens.motion.LinearPath.update","flixel/tweens/motion/LinearPath.hx",106,0x519b896f)
HX_DEFINE_STACK_FRAME(_hx_pos_a5dbf3466a77d348_168_updatePath,"flixel.tweens.motion.LinearPath","updatePath",0x8544492e,"flixel.tweens.motion.LinearPath.updatePath","flixel/tweens/motion/LinearPath.hx",168,0x519b896f)
namespace flixel{
namespace tweens{
namespace motion{
...
HXDLIN(  44)			HX_VARI( ::Array< ::Dynamic>,_g1) = this->points;
...
HXLINE( 108)		HX_VAR( Float,td);
HXLINE( 109)		HX_VAR( Float,tt);
HXLINE( 111)		if (hx::IsNull( this->points )) {
HXLINE( 112)			return;
            		}
HXLINE( 114)		if (!(this->backward)) {
HXLINE( 116)			if ((this->_index < (this->points->length - (int)1))) {
HXLINE( 118)				while((this->scale > this->_pointT->__get((this->_index + (int)1)))){
HXLINE( 120)					this->_index++;
HXLINE( 121)					if ((this->_index == (this->points->length - (int)1))) {
HXLINE( 123)						 ::flixel::tweens::motion::LinearPath _hx_tmp = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 123)						_hx_tmp->_index = (_hx_tmp->_index - (int)1);
...
HXLINE( 130)			tt = (this->_pointT->__get((this->_index + (int)1)) - td);
...
HXLINE( 133)			this->_nextPoint = this->points->__get((this->_index + (int)1)).StaticCast<  ::flixel::math::FlxPoint >();
...
HXLINE( 153)			tt = (this->_pointT->__get((this->_index - (int)1)) - td);
...
HXLINE( 156)			this->_nextPoint = this->points->__get((this->_index - (int)1)).StaticCast<  ::flixel::math::FlxPoint >();
...
HXLINE( 175)			HX_VARI_NAME( int,i1,"i") = i;
HXDLIN( 175)			i = (i + (int)1);
HXDLIN( 175)			this->_pointT[i1] = ((Float)this->_pointD->__get((i - (int)1)) / (Float)this->distance);
            		}
            	}
