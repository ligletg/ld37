...
HX_DEFINE_STACK_FRAME(_hx_pos_ce36efe445fffae6_1_boot,"flixel.tile.GraphicAutoAlt","boot",0x108b01e0,"flixel.tile.GraphicAutoAlt.boot","?",1,0x0000003f)
namespace flixel{
namespace tile{
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::tile::GraphicAutoAlt_obj::resourceName));
