...
HX_DEFINE_STACK_FRAME(_hx_pos_815e60e85891c3cd_1_boot,"flixel.tile.GraphicAuto","boot",0x23888f97,"flixel.tile.GraphicAuto.boot","?",1,0x0000003f)
namespace flixel{
namespace tile{
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::tile::GraphicAuto_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_tile_GraphicAuto",23,e3,b5,f1);
            	}
}
