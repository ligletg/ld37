...
HX_DEFINE_STACK_FRAME(_hx_pos_ca22d206eb905d85_39_destroy,"flixel.tile.FlxTileblock","destroy",0x5d3d80e7,"flixel.tile.FlxTileblock.destroy","flixel/tile/FlxTileblock.hx",39,0xecdf1de3)
HX_DEFINE_STACK_FRAME(_hx_pos_ca22d206eb905d85_52_loadFrames,"flixel.tile.FlxTileblock","loadFrames",0xaeb6fc9f,"flixel.tile.FlxTileblock.loadFrames","flixel/tile/FlxTileblock.hx",52,0xecdf1de3)
HX_DEFINE_STACK_FRAME(_hx_pos_ca22d206eb905d85_133_loadTiles,"flixel.tile.FlxTileblock","loadTiles",0x7f9232ac,"flixel.tile.FlxTileblock.loadTiles","flixel/tile/FlxTileblock.hx",133,0xecdf1de3)
HX_DEFINE_STACK_FRAME(_hx_pos_ca22d206eb905d85_162_setTile,"flixel.tile.FlxTileblock","setTile",0x4b385fdd,"flixel.tile.FlxTileblock.setTile","flixel/tile/FlxTileblock.hx",162,0xecdf1de3)
namespace flixel{
namespace tile{
...
HXLINE(  61)		HX_VARI( int,spriteWidth) = ::Std_obj::_hx_int(this->tileSprite->get_width());
HXLINE(  62)		HX_VARI( int,spriteHeight) = ::Std_obj::_hx_int(this->tileSprite->get_height());
...
HXLINE(  94)		HX_VARI( int,widthInTiles) = ::Std_obj::_hx_int(((Float)this->get_width() / (Float)spriteWidth));
HXLINE(  95)		HX_VARI( int,heightInTiles) = ::Std_obj::_hx_int(((Float)this->get_height() / (Float)spriteHeight));
...
HXLINE( 158)		return this->loadFrames(::flixel::graphics::frames::FlxTileFrames_obj::fromGraphic(graph,point,null(),null()),Empties);
            	}
