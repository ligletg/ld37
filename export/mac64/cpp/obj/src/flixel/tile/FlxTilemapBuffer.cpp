...
HX_DEFINE_STACK_FRAME(_hx_pos_ea53adae7ad7e842_96_destroy,"flixel.tile.FlxTilemapBuffer","destroy",0x52dcca56,"flixel.tile.FlxTilemapBuffer.destroy","flixel/tile/FlxTilemapBuffer.hx",96,0x56d29ad4)
HX_DEFINE_STACK_FRAME(_hx_pos_ea53adae7ad7e842_112_fill,"flixel.tile.FlxTilemapBuffer","fill",0x99957fa7,"flixel.tile.FlxTilemapBuffer.fill","flixel/tile/FlxTilemapBuffer.hx",112,0x56d29ad4)
HX_DEFINE_STACK_FRAME(_hx_pos_ea53adae7ad7e842_125_draw,"flixel.tile.FlxTilemapBuffer","draw",0x9849dd28,"flixel.tile.FlxTilemapBuffer.draw","flixel/tile/FlxTilemapBuffer.hx",125,0x56d29ad4)
HX_DEFINE_STACK_FRAME(_hx_pos_ea53adae7ad7e842_147_colorTransform,"flixel.tile.FlxTilemapBuffer","colorTransform",0x13c7ddad,"flixel.tile.FlxTilemapBuffer.colorTransform","flixel/tile/FlxTilemapBuffer.hx",147,0x56d29ad4)
HX_DEFINE_STACK_FRAME(_hx_pos_ea53adae7ad7e842_151_updateColumns,"flixel.tile.FlxTilemapBuffer","updateColumns",0xed291c30,"flixel.tile.FlxTilemapBuffer.updateColumns","flixel/tile/FlxTilemapBuffer.hx",151,0x56d29ad4)
HX_DEFINE_STACK_FRAME(_hx_pos_ea53adae7ad7e842_175_updateRows,"flixel.tile.FlxTilemapBuffer","updateRows",0xf31d03e6,"flixel.tile.FlxTilemapBuffer.updateRows","flixel/tile/FlxTilemapBuffer.hx",175,0x56d29ad4)
HX_DEFINE_STACK_FRAME(_hx_pos_ea53adae7ad7e842_202_isPixelPerfectRender,"flixel.tile.FlxTilemapBuffer","isPixelPerfectRender",0x7d4e558b,"flixel.tile.FlxTilemapBuffer.isPixelPerfectRender","flixel/tile/FlxTilemapBuffer.hx",202,0x56d29ad4)
namespace flixel{
namespace tile{
...
void FlxTilemapBuffer_obj::destroy(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  96)		if (::flixel::FlxG_obj::renderBlit) {
...
HXLINE( 162)		this->columns = (::Math_obj::ceil(((Float)Camera->width / (Float)(TileWidth * ScaleX))) + (int)1);
...
HXLINE( 186)		this->rows = (::Math_obj::ceil(((Float)Camera->height / (Float)(TileHeight * ScaleY))) + (int)1);
