...
HX_DEFINE_STACK_FRAME(_hx_pos_efb42de64cd9f379_67_moveTowardsMouse,"flixel.math.FlxVelocity","moveTowardsMouse",0x58da686d,"flixel.math.FlxVelocity.moveTowardsMouse","flixel/math/FlxVelocity.hx",67,0xbea30ec3)
HX_DEFINE_STACK_FRAME(_hx_pos_efb42de64cd9f379_122_accelerateTowardsMouse,"flixel.math.FlxVelocity","accelerateTowardsMouse",0x2dba9c79,"flixel.math.FlxVelocity.accelerateTowardsMouse","flixel/math/FlxVelocity.hx",122,0xbea30ec3)
...
HXLINE(  75)			Speed = ::Std_obj::_hx_int(((Float)::Std_obj::_hx_int(::Math_obj::sqrt(((dx * dx) + (dy * dy)))) / (Float)((Float)MaxTime / (Float)(int)1000)));
            		}
...
HXDLIN( 207)		HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get()->set(X,Y);
...
HXDLIN( 220)		HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get()->set(X,Y);
