...
HX_DEFINE_STACK_FRAME(_hx_pos_f8ebd3e8714d9448_20_rotateWithTrig,"flixel.math.FlxMatrix","rotateWithTrig",0xc09bf72c,"flixel.math.FlxMatrix.rotateWithTrig","flixel/math/FlxMatrix.hx",20,0x564a249f)
HX_DEFINE_STACK_FRAME(_hx_pos_f8ebd3e8714d9448_41_rotateBy180,"flixel.math.FlxMatrix","rotateBy180",0x7fa14e88,"flixel.math.FlxMatrix.rotateBy180","flixel/math/FlxMatrix.hx",41,0x564a249f)
HX_DEFINE_STACK_FRAME(_hx_pos_f8ebd3e8714d9448_51_rotateByPositive90,"flixel.math.FlxMatrix","rotateByPositive90",0xae397fb1,"flixel.math.FlxMatrix.rotateByPositive90","flixel/math/FlxMatrix.hx",51,0x564a249f)
HX_DEFINE_STACK_FRAME(_hx_pos_f8ebd3e8714d9448_61_rotateByNegative90,"flixel.math.FlxMatrix","rotateByNegative90",0xf52d666d,"flixel.math.FlxMatrix.rotateByNegative90","flixel/math/FlxMatrix.hx",61,0x564a249f)
namespace flixel{
namespace math{
...
void FlxMatrix_obj::__construct( ::Dynamic a, ::Dynamic b, ::Dynamic c, ::Dynamic d, ::Dynamic tx, ::Dynamic ty){
            	...
            	HX_STACK_ARG(tx,"tx")
            	HX_STACK_ARG(ty,"ty")
HXLINE(  10)		super::__construct(a,b,c,d,tx,ty);
            	}
...
HXLINE(  21)		HX_VARI( Float,a1) = ((this->a * cos) - (this->b * sin));
HXLINE(  22)		this->b = ((this->a * sin) + (this->b * cos));
HXLINE(  23)		this->a = a1;
HXLINE(  25)		HX_VARI( Float,c1) = ((this->c * cos) - (this->d * sin));
HXLINE(  26)		this->d = ((this->c * sin) + (this->d * cos));
HXLINE(  27)		this->c = c1;
HXLINE(  29)		HX_VARI( Float,tx1) = ((this->tx * cos) - (this->ty * sin));
