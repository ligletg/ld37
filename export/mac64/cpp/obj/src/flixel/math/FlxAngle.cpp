...
HX_DEFINE_STACK_FRAME(_hx_pos_5b56d9e1983dc02b_65_wrapAngle,"flixel.math.FlxAngle","wrapAngle",0xae3043f0,"flixel.math.FlxAngle.wrapAngle","flixel/math/FlxAngle.hx",65,0x32e99189)
HX_DEFINE_STACK_FRAME(_hx_pos_5b56d9e1983dc02b_87_asDegrees,"flixel.math.FlxAngle","asDegrees",0x8ea59f1c,"flixel.math.FlxAngle.asDegrees","flixel/math/FlxAngle.hx",87,0x32e99189)
HX_DEFINE_STACK_FRAME(_hx_pos_5b56d9e1983dc02b_99_asRadians,"flixel.math.FlxAngle","asRadians",0x7b3b01e7,"flixel.math.FlxAngle.asRadians","flixel/math/FlxAngle.hx",99,0x32e99189)
HX_DEFINE_STACK_FRAME(_hx_pos_5b56d9e1983dc02b_112_angleBetween,"flixel.math.FlxAngle","angleBetween",0x83e3464e,"flixel.math.FlxAngle.angleBetween","flixel/math/FlxAngle.hx",112,0x32e99189)
HX_DEFINE_STACK_FRAME(_hx_pos_5b56d9e1983dc02b_132_angleBetweenPoint,"flixel.math.FlxAngle","angleBetweenPoint",0x0a124322,"flixel.math.FlxAngle.angleBetweenPoint","flixel/math/FlxAngle.hx",132,0x32e99189)
HX_DEFINE_STACK_FRAME(_hx_pos_5b56d9e1983dc02b_154_angleBetweenMouse,"flixel.math.FlxAngle","angleBetweenMouse",0x4fe7a4f7,"flixel.math.FlxAngle.angleBetweenMouse","flixel/math/FlxAngle.hx",154,0x32e99189)
HX_DEFINE_STACK_FRAME(_hx_pos_5b56d9e1983dc02b_208_angleFromFacing,"flixel.math.FlxAngle","angleFromFacing",0x8474a75e,"flixel.math.FlxAngle.angleFromFacing","flixel/math/FlxAngle.hx",208,0x32e99189)
HX_DEFINE_STACK_FRAME(_hx_pos_5b56d9e1983dc02b_233_getCartesianCoords,"flixel.math.FlxAngle","getCartesianCoords",0x688d1f29,"flixel.math.FlxAngle.getCartesianCoords","flixel/math/FlxAngle.hx",233,0x32e99189)
HX_DEFINE_STACK_FRAME(_hx_pos_5b56d9e1983dc02b_252_getPolarCoords,"flixel.math.FlxAngle","getPolarCoords",0xf74e15df,"flixel.math.FlxAngle.getPolarCoords","flixel/math/FlxAngle.hx",252,0x32e99189)
HX_DEFINE_STACK_FRAME(_hx_pos_5b56d9e1983dc02b_264_get_TO_DEG,"flixel.math.FlxAngle","get_TO_DEG",0x36e6a544,"flixel.math.FlxAngle.get_TO_DEG","flixel/math/FlxAngle.hx",264,0x32e99189)
HX_DEFINE_STACK_FRAME(_hx_pos_5b56d9e1983dc02b_269_get_TO_RAD,"flixel.math.FlxAngle","get_TO_RAD",0x36f14153,"flixel.math.FlxAngle.get_TO_RAD","flixel/math/FlxAngle.hx",269,0x32e99189)
namespace flixel{
namespace math{
...
HXLINE(  87)		return (radians * ((Float)(int)180 / (Float)::Math_obj::PI));
            	}
...
HXLINE(  99)		return (degrees * ((Float)::Math_obj::PI / (Float)(int)180));
            	}
...
HXLINE( 113)		HX_VARI( Float,dx) = ((SpriteB->x + SpriteB->origin->x) - (SpriteA->x + SpriteA->origin->x));
HXLINE( 114)		HX_VARI( Float,dy) = ((SpriteB->y + SpriteB->origin->y) - (SpriteA->y + SpriteA->origin->y));
HXLINE( 116)		if (AsDegrees) {
HXLINE( 117)			return (::Math_obj::atan2(dy,dx) * ((Float)(int)180 / (Float)::Math_obj::PI));
            		}
            		else {
...
bool AsDegrees = __o_AsDegrees.Default(false);
            	...
            	HX_STACK_ARG(AsDegrees,"AsDegrees")
HXLINE( 133)		HX_VARI( Float,dx) = (Target->x - (Sprite->x + Sprite->origin->x));
HXLINE( 134)		HX_VARI( Float,dy) = (Target->y - (Sprite->y + Sprite->origin->y));
...
HXLINE( 159)		HX_VARI(  ::flixel::math::FlxPoint,p) = Object->getScreenPosition(null(),null());
HXLINE( 161)		HX_VARI( Float,dx) = (::flixel::FlxG_obj::mouse->screenX - p->x);
HXLINE( 162)		HX_VARI( Float,dy) = (::flixel::FlxG_obj::mouse->screenY - p->y);
HXLINE( 164)		p->put();
...
HXLINE( 209)				degrees = (int)90;
            			...
            			break;
            			default:{
HXLINE( 215)				if ((FacingBitmask == (int)257)) {
HXLINE( 209)					degrees = (int)-135;
            				}
            				else {
HXLINE( 216)					if ((FacingBitmask == (int)272)) {
HXLINE( 209)						degrees = (int)-45;
            					}
            					else {
HXLINE( 217)						if ((FacingBitmask == (int)4097)) {
HXLINE( 209)							degrees = (int)135;
            						}
            						else {
HXLINE( 218)							if ((FacingBitmask == (int)4112)) {
HXLINE( 209)								degrees = (int)45;
            							}
            							else {
HXLINE( 209)								degrees = (int)0;
...
HXLINE( 234)		HX_VARI(  ::flixel::math::FlxPoint,p) = point;
HXLINE( 235)		if (hx::IsNull( point )) {
HXLINE( 236)			HX_VARI_NAME(  ::flixel::math::FlxPoint,point1,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(FlxAngle_obj,getCartesianCoords,return )
 ...
 ::flixel::math::FlxPoint FlxAngle_obj::getPolarCoords(Float X,Float Y, ::flixel::math::FlxPoint point){
            	...
            	HX_STACK_ARG(Y,"Y")
            	HX_STACK_ARG(point,"point")
HXLINE( 253)		HX_VARI(  ::flixel::math::FlxPoint,p) = point;
HXLINE( 254)		if (hx::IsNull( point )) {
HXLINE( 255)			HX_VARI_NAME(  ::flixel::math::FlxPoint,point1,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 255)			point1->_inPool = false;
HXDLIN( 255)			p = point1;
            		}
HXLINE( 257)		p->set_x(::Math_obj::sqrt(((X * X) + (Y * Y))));
HXLINE( 258)		p->set_y((::Math_obj::atan2(Y,X) * ((Float)(int)180 / (Float)::Math_obj::PI)));
HXLINE( 259)		return p;
            	}
...
HXLINE( 264)		return ((Float)(int)180 / (Float)::Math_obj::PI);
            	}
...
HXLINE( 269)		return ((Float)::Math_obj::PI / (Float)(int)180);
            	}
