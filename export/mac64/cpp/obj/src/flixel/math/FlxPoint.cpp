...
HXLINE( 192)			HX_VARI_NAME(  ::flixel::math::FlxPoint,point1,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXDLIN( 428)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 428)		_this->label = HX_("x",78,00,00,00);
HXDLIN( 428)		_this->value = value;
HXLINE( 429)		 ::Dynamic value1 = this->y;
HXDLIN( 429)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this1,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
...
HXLINE(  16)		_pool =  ::flixel::util::FlxPool_flixel_math_FlxPoint_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::math::FlxPoint >());
            	}
}
