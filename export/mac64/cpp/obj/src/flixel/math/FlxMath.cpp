...
HX_DEFINE_STACK_FRAME(_hx_pos_5d39d2fff62ba7b8_194_mouseInFlxRect,"flixel.math.FlxMath","mouseInFlxRect",0x130b3df4,"flixel.math.FlxMath.mouseInFlxRect","flixel/math/FlxMath.hx",194,0x837802f8)
...
HX_DEFINE_STACK_FRAME(_hx_pos_5d39d2fff62ba7b8_390_distanceToMouse,"flixel.math.FlxMath","distanceToMouse",0xca964f6d,"flixel.math.FlxMath.distanceToMouse","flixel/math/FlxMath.hx",390,0x837802f8)
HX_DEFINE_STACK_FRAME(_hx_pos_5d39d2fff62ba7b8_406_isDistanceToMouseWithin,"flixel.math.FlxMath","isDistanceToMouseWithin",0xc43ab06e,"flixel.math.FlxMath.isDistanceToMouseWithin","flixel/math/FlxMath.hx",406,0x837802f8)
...
HXLINE( 202)			return ::flixel::math::FlxMath_obj::pointInFlxRect(::Math_obj::floor(::flixel::FlxG_obj::mouse->x),::Math_obj::floor(::flixel::FlxG_obj::mouse->y),rect);
            		}
            		else {
...
HXLINE( 221)			_hx_tmp1 = (pointX <= rect->get_right());
            		}
            		else {
...
HXLINE( 221)			return (pointY <= rect->get_bottom());
            		}
            		else {
...
int FlxMath_obj::distanceToMouse( ::flixel::FlxSprite Sprite){
            	...
            	HX_STACK_ARG(Sprite,"Sprite")
HXLINE( 391)		HX_VARI( Float,dx) = ((Sprite->x + Sprite->origin->x) - ::flixel::FlxG_obj::mouse->screenX);
HXLINE( 392)		HX_VARI( Float,dy) = ((Sprite->y + Sprite->origin->y) - ::flixel::FlxG_obj::mouse->screenY);
...
bool IncludeEqual = __o_IncludeEqual.Default(false);
            	...
            	HX_STACK_ARG(Distance,"Distance")
            	HX_STACK_ARG(IncludeEqual,"IncludeEqual")
HXLINE( 407)		HX_VARI( Float,dx) = ((Sprite->x + Sprite->origin->x) - ::flixel::FlxG_obj::mouse->screenX);
HXLINE( 408)		HX_VARI( Float,dy) = ((Sprite->y + Sprite->origin->y) - ::flixel::FlxG_obj::mouse->screenY);
