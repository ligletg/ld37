...
HXDLIN(  25)				HX_VARI_NAME(  ::openfl::_legacy::gl::GLShader,shader1,"shader") = this->compile(( (::String)(source->__Field(HX_("src",e4,a6,57,00),hx::paccDynamic)) ),shader);
...
HXLINE(  49)		HX_VARI( int,shader) = ::openfl::_legacy::gl::GL_obj::get_version();
HXDLIN(  49)		HX_VARI_NAME(  ::openfl::_legacy::gl::GLShader,shader1,"shader") =  ::openfl::_legacy::gl::GLShader_obj::__alloc( HX_CTX ,shader,::openfl::_legacy::gl::GL_obj::lime_gl_create_shader(type));
...
int Shader_obj::attribute(::String a){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
HXLINE(  68)		return ::openfl::_legacy::gl::GL_obj::lime_gl_get_attrib_location(this->program->id,a);
            	}
