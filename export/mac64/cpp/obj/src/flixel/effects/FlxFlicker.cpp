...
HX_DEFINE_STACK_FRAME(_hx_pos_605e85deecbe4d03_187_new,"flixel.effects.FlxFlicker","new",0x4bc826b6,"flixel.effects.FlxFlicker.new","flixel/effects/FlxFlicker.hx",187,0x4fa53f38)
HX_DEFINE_STACK_FRAME(_hx_pos_605e85deecbe4d03_120_destroy,"flixel.effects.FlxFlicker","destroy",0x34536650,"flixel.effects.FlxFlicker.destroy","flixel/effects/FlxFlicker.hx",120,0x4fa53f38)
HX_DEFINE_STACK_FRAME(_hx_pos_605e85deecbe4d03_131_start,"flixel.effects.FlxFlicker","start",0xd6028c38,"flixel.effects.FlxFlicker.start","flixel/effects/FlxFlicker.hx",131,0x4fa53f38)
HX_DEFINE_STACK_FRAME(_hx_pos_605e85deecbe4d03_145_stop,"flixel.effects.FlxFlicker","stop",0x06b324ec,"flixel.effects.FlxFlicker.stop","flixel/effects/FlxFlicker.hx",145,0x4fa53f38)
HX_DEFINE_STACK_FRAME(_hx_pos_605e85deecbe4d03_155_release,"flixel.effects.FlxFlicker","release",0x68babf1d,"flixel.effects.FlxFlicker.release","flixel/effects/FlxFlicker.hx",155,0x4fa53f38)
HX_DEFINE_STACK_FRAME(_hx_pos_605e85deecbe4d03_164_flickerProgress,"flixel.effects.FlxFlicker","flickerProgress",0x5258c61b,"flixel.effects.FlxFlicker.flickerProgress","flixel/effects/FlxFlicker.hx",164,0x4fa53f38)
HX_DEFINE_STACK_FRAME(_hx_pos_605e85deecbe4d03_35_flicker,"flixel.effects.FlxFlicker","flicker",0x86ba144e,"flixel.effects.FlxFlicker.flicker","flixel/effects/FlxFlicker.hx",35,0x4fa53f38)
HX_DEFINE_STACK_FRAME(_hx_pos_605e85deecbe4d03_65_isFlickering,"flixel.effects.FlxFlicker","isFlickering",0x76c8b45e,"flixel.effects.FlxFlicker.isFlickering","flixel/effects/FlxFlicker.hx",65,0x4fa53f38)
HX_DEFINE_STACK_FRAME(_hx_pos_605e85deecbe4d03_73_stopFlickering,"flixel.effects.FlxFlicker","stopFlickering",0xf09864f6,"flixel.effects.FlxFlicker.stopFlickering","flixel/effects/FlxFlicker.hx",73,0x4fa53f38)
HX_DEFINE_STACK_FRAME(_hx_pos_605e85deecbe4d03_15_boot,"flixel.effects.FlxFlicker","boot",0xfb72b91c,"flixel.effects.FlxFlicker.boot","flixel/effects/FlxFlicker.hx",15,0x4fa53f38)
HX_DEFINE_STACK_FRAME(_hx_pos_605e85deecbe4d03_20_boot,"flixel.effects.FlxFlicker","boot",0xfb72b91c,"flixel.effects.FlxFlicker.boot","flixel/effects/FlxFlicker.hx",20,0x4fa53f38)
namespace flixel{
namespace effects{

void FlxFlicker_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_605e85deecbe4d03_187_new)
            	HX_STACK_THIS(this)
            	}
...
void FlxFlicker_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_605e85deecbe4d03_120_destroy)
            	HX_STACK_THIS(this)
HXLINE( 121)		this->object = null();
HXLINE( 122)		this->timer = null();
HXLINE( 123)		this->completionCallback = null();
HXLINE( 124)		this->progressCallback = null();
            	}
...
void FlxFlicker_obj::start( ::flixel::FlxObject Object,Float Duration,Float Interval,bool EndVisibility, ::Dynamic CompletionCallback, ::Dynamic ProgressCallback){
            	HX_GC_STACKFRAME(&_hx_pos_605e85deecbe4d03_131_start)
            	HX_STACK_THIS(this)
...
HXLINE( 132)		this->object = Object;
HXLINE( 133)		this->duration = Duration;
HXLINE( 134)		this->interval = Interval;
HXLINE( 135)		this->completionCallback = CompletionCallback;
HXLINE( 136)		this->progressCallback = ProgressCallback;
HXLINE( 137)		this->endVisibility = EndVisibility;
HXLINE( 138)		 ::flixel::util::FlxTimer _hx_tmp =  ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null());
HXDLIN( 138)		Float _hx_tmp1 = this->interval;
HXDLIN( 138)		this->timer = _hx_tmp->start(_hx_tmp1,this->flickerProgress_dyn(),::Std_obj::_hx_int(((Float)this->duration / (Float)this->interval)));
            	}
...
void FlxFlicker_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_605e85deecbe4d03_145_stop)
            	HX_STACK_THIS(this)
HXLINE( 146)		this->timer->cancel();
HXLINE( 147)		this->object->set_visible(true);
HXLINE( 148)		this->release();
            	}
...
void FlxFlicker_obj::release(){
            	HX_STACKFRAME(&_hx_pos_605e85deecbe4d03_155_release)
            	HX_STACK_THIS(this)
HXLINE( 156)		::flixel::effects::FlxFlicker_obj::_boundObjects->remove(this->object);
HXLINE( 157)		::flixel::effects::FlxFlicker_obj::_pool->put(hx::ObjectPtr<OBJ_>(this));
            	}
...
void FlxFlicker_obj::flickerProgress( ::flixel::util::FlxTimer Timer){
            	HX_STACKFRAME(&_hx_pos_605e85deecbe4d03_164_flickerProgress)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Timer,"Timer")
HXLINE( 165)		this->object->set_visible(!(this->object->visible));
HXLINE( 167)		if (hx::IsNotNull( this->progressCallback )) {
HXLINE( 169)			this->progressCallback(hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE( 172)		bool _hx_tmp;
HXDLIN( 172)		if ((Timer->loops > (int)0)) {
HXLINE( 172)			_hx_tmp = ((Timer->loops - Timer->_loopsCounter) == (int)0);
            		}
            		else {
HXLINE( 172)			_hx_tmp = false;
            		}
HXDLIN( 172)		if (_hx_tmp) {
HXLINE( 174)			this->object->set_visible(this->endVisibility);
HXLINE( 175)			if (hx::IsNotNull( this->completionCallback )) {
HXLINE( 177)				this->completionCallback(hx::ObjectPtr<OBJ_>(this));
            			}
HXLINE( 179)			this->release();
            		}
            	}
...
bool ForceRestart = __o_ForceRestart.Default(true);
            	HX_STACKFRAME(&_hx_pos_605e85deecbe4d03_35_flicker)
            	HX_STACK_ARG(Object,"Object")
            	HX_STACK_ARG(Duration,"Duration")
            	HX_STACK_ARG(Interval,"Interval")
            	HX_STACK_ARG(EndVisibility,"EndVisibility")
            	...
            	HX_STACK_ARG(CompletionCallback,"CompletionCallback")
            	HX_STACK_ARG(ProgressCallback,"ProgressCallback")
HXLINE(  36)		if (::flixel::effects::FlxFlicker_obj::isFlickering(Object)) {
HXLINE(  38)			if (ForceRestart) {
HXLINE(  40)				::flixel::effects::FlxFlicker_obj::stopFlickering(Object);
            			}
            			else {
HXLINE(  45)				return ::flixel::effects::FlxFlicker_obj::_boundObjects->get(Object).StaticCast<  ::flixel::effects::FlxFlicker >();
            			}
            		}
HXLINE(  49)		if ((Interval <= (int)0)) {
HXLINE(  51)			Interval = ::flixel::FlxG_obj::elapsed;
            		}
HXLINE(  54)		HX_VARI(  ::flixel::effects::FlxFlicker,flicker) = ::flixel::effects::FlxFlicker_obj::_pool->get();
HXLINE(  55)		flicker->start(Object,Duration,Interval,EndVisibility,CompletionCallback,ProgressCallback);
HXLINE(  56)		::flixel::effects::FlxFlicker_obj::_boundObjects->set(Object,flicker);
HXDLIN(  56)		return flicker;
            	}
...
bool FlxFlicker_obj::isFlickering( ::flixel::FlxObject Object){
            	HX_STACKFRAME(&_hx_pos_605e85deecbe4d03_65_isFlickering)
            	HX_STACK_ARG(Object,"Object")
HXLINE(  65)		return ::flixel::effects::FlxFlicker_obj::_boundObjects->exists(Object);
            	}
...
void FlxFlicker_obj::stopFlickering( ::flixel::FlxObject Object){
            	HX_STACKFRAME(&_hx_pos_605e85deecbe4d03_73_stopFlickering)
            	HX_STACK_ARG(Object,"Object")
HXLINE(  74)		HX_VARI(  ::flixel::effects::FlxFlicker,boundFlicker) = ::flixel::effects::FlxFlicker_obj::_boundObjects->get(Object).StaticCast<  ::flixel::effects::FlxFlicker >();
HXLINE(  75)		if (hx::IsNotNull( boundFlicker )) {
HXLINE(  77)			boundFlicker->stop();
            		}
            	}
...
HXLINE(  15)		_pool =  ::flixel::util::FlxPool_flixel_effects_FlxFlicker_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::effects::FlxFlicker >());
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_605e85deecbe4d03_20_boot)
HXLINE(  20)		_boundObjects =  ::haxe::ds::ObjectMap_obj::__alloc( HX_CTX );
            	}
}
