...
HX_DEFINE_STACK_FRAME(_hx_pos_1fbac93af6038753_98_destroy,"flixel.effects.particles.FlxParticle","destroy",0xa0ae8f85,"flixel.effects.particles.FlxParticle.destroy","flixel/effects/particles/FlxParticle.hx",98,0xdb578328)
HX_DEFINE_STACK_FRAME(_hx_pos_1fbac93af6038753_136_update,"flixel.effects.particles.FlxParticle","update",0xc345fdde,"flixel.effects.particles.FlxParticle.update","flixel/effects/particles/FlxParticle.hx",136,0xdb578328)
HX_DEFINE_STACK_FRAME(_hx_pos_1fbac93af6038753_201_reset,"flixel.effects.particles.FlxParticle","reset",0xddde639a,"flixel.effects.particles.FlxParticle.reset","flixel/effects/particles/FlxParticle.hx",201,0xdb578328)
HX_DEFINE_STACK_FRAME(_hx_pos_1fbac93af6038753_211_onEmit,"flixel.effects.particles.FlxParticle","onEmit",0x21e01ee7,"flixel.effects.particles.FlxParticle.onEmit","flixel/effects/particles/FlxParticle.hx",211,0xdb578328)
namespace flixel{
namespace effects{
namespace particles{
...
HXDLIN(  82)		this->velocityRange =  ::flixel::util::helpers::FlxRange_obj::__alloc( HX_CTX ,point,point1);
...
HXDLIN(  84)		this->scaleRange =  ::flixel::util::helpers::FlxRange_obj::__alloc( HX_CTX ,point2,point3);
...
HXDLIN(  87)		this->dragRange =  ::flixel::util::helpers::FlxRange_obj::__alloc( HX_CTX ,point4,point5);
...
HXDLIN(  88)		this->accelerationRange =  ::flixel::util::helpers::FlxRange_obj::__alloc( HX_CTX ,point6,point7);
...
HXDLIN( 153)					_g->set_x((_g->x + ((( ( ::flixel::math::FlxPoint)(this->velocityRange->end) )->x - ( ( ::flixel::math::FlxPoint)(this->velocityRange->start) )->x) * this->_delta)));
            				}
HXLINE( 154)				{
HXLINE( 154)					HX_VARI_NAME(  ::flixel::math::FlxPoint,_g1,"_g") = this->velocity;
HXDLIN( 154)					_g1->set_y((_g1->y + ((( ( ::flixel::math::FlxPoint)(this->velocityRange->end) )->y - ( ( ::flixel::math::FlxPoint)(this->velocityRange->start) )->y) * this->_delta)));
            				}
            			}
...
HXDLIN( 164)					_g2->set_x((_g2->x + ((( ( ::flixel::math::FlxPoint)(this->scaleRange->end) )->x - ( ( ::flixel::math::FlxPoint)(this->scaleRange->start) )->x) * this->_delta)));
            				}
HXLINE( 165)				{
HXLINE( 165)					HX_VARI_NAME(  ::flixel::math::FlxPoint,_g3,"_g") = this->scale;
HXDLIN( 165)					_g3->set_y((_g3->y + ((( ( ::flixel::math::FlxPoint)(this->scaleRange->end) )->y - ( ( ::flixel::math::FlxPoint)(this->scaleRange->start) )->y) * this->_delta)));
            				}
...
HXDLIN( 171)				_g4->set_alpha((_g4->alpha + ((( (Float)(this->alphaRange->end) ) - ( (Float)(this->alphaRange->start) )) * this->_delta)));
            			}
...
HXDLIN( 181)					_g5->set_x((_g5->x + ((( ( ::flixel::math::FlxPoint)(this->dragRange->end) )->x - ( ( ::flixel::math::FlxPoint)(this->dragRange->start) )->x) * this->_delta)));
            				}
HXLINE( 182)				{
HXLINE( 182)					HX_VARI_NAME(  ::flixel::math::FlxPoint,_g6,"_g") = this->drag;
HXDLIN( 182)					_g6->set_y((_g6->y + ((( ( ::flixel::math::FlxPoint)(this->dragRange->end) )->y - ( ( ::flixel::math::FlxPoint)(this->dragRange->start) )->y) * this->_delta)));
            				}
            			}
HXLINE( 185)			if (this->accelerationRange->active) {
HXLINE( 187)				{
HXLINE( 187)					HX_VARI_NAME(  ::flixel::math::FlxPoint,_g7,"_g") = this->acceleration;
HXDLIN( 187)					_g7->set_x((_g7->x + ((( ( ::flixel::math::FlxPoint)(this->accelerationRange->end) )->x - ( ( ::flixel::math::FlxPoint)(this->accelerationRange->start) )->x) * this->_delta)));
            				}
HXLINE( 188)				{
HXLINE( 188)					HX_VARI_NAME(  ::flixel::math::FlxPoint,_g8,"_g") = this->acceleration;
HXDLIN( 188)					_g8->set_y((_g8->y + ((( ( ::flixel::math::FlxPoint)(this->accelerationRange->end) )->y - ( ( ::flixel::math::FlxPoint)(this->accelerationRange->start) )->y) * this->_delta)));
            				}
            			}
