...
HXLINE( 365)		HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
...
HXLINE( 360)		this->_scrollRect =  ::openfl::_legacy::display::Sprite_obj::__alloc( HX_CTX );
HXLINE( 340)		this->initialZoom = ((Float)1);
HXLINE( 331)		HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXLINE( 283)		HX_VARI_NAME(  ::flixel::math::FlxPoint,point1,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXLINE( 252)		HX_VARI_NAME(  ::flixel::math::FlxPoint,point2,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 252)		point2->_inPool = false;
HXDLIN( 252)		this->_flashOffset = point2;
HXLINE( 244)		this->_flashPoint =  ::openfl::_legacy::geom::Point_obj::__alloc( HX_CTX ,null(),null());
HXLINE( 231)		this->filtersEnabled = true;
HXLINE( 227)		HX_VARI_NAME(  ::flixel::math::FlxPoint,point3,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXLINE( 182)		this->flashSprite =  ::openfl::_legacy::display::Sprite_obj::__alloc( HX_CTX );
HXLINE( 173)		this->useBgAlphaBlending = false;
HXLINE( 145)		this->regen = false;
HXLINE( 135)		HX_VARI_NAME(  ::flixel::math::FlxPoint,point4,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXLINE( 100)		HX_VARI_NAME(  ::flixel::math::FlxPoint,point5,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXLINE( 741)		this->_flashRect =  ::openfl::_legacy::geom::Rectangle_obj::__alloc( HX_CTX ,(int)0,(int)0,this->width,this->height);
HXLINE( 743)		this->flashSprite->addChild(this->_scrollRect);
HXLINE( 744)		 ::openfl::_legacy::display::Sprite _hx_tmp2 = this->_scrollRect;
HXDLIN( 744)		_hx_tmp2->set_scrollRect( ::openfl::_legacy::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null()));
...
HXLINE( 751)			this->buffer =  ::openfl::_legacy::display::BitmapData_obj::__alloc( HX_CTX ,this->width,this->height,true,(int)0,null());
HXLINE( 752)			this->screen->set_pixels(this->buffer);
HXLINE( 753)			this->screen->origin->set(null(),null());
HXLINE( 754)			this->_flashBitmap =  ::openfl::_legacy::display::Bitmap_obj::__alloc( HX_CTX ,this->buffer,null(),null());
HXLINE( 755)			this->_scrollRect->addChild(this->_flashBitmap);
HXLINE( 756)			this->_fill =  ::openfl::_legacy::display::BitmapData_obj::__alloc( HX_CTX ,this->width,this->height,true,(int)0,null());
            		}
            		else {
...
bool isColored = __o_isColored.Default(false);
            	...
            	HX_STACK_ARG(blend,"blend")
HXLINE( 495)		HX_VARI( int,blendInt) = ::flixel::graphics::tile::FlxDrawBaseItem_obj::blendToInt(blend);
...
HXLINE( 497)			_hx_tmp = (this->_headTriangles->blending == blendInt);
            		}
            		else {
...
bool smoothing = __o_smoothing.Default(false);
            	HX_STACKFRAME(&_hx_pos_d1aae230bd422321_651_drawTriangles)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(graphic,"graphic")
...
HXLINE( 664)			::flixel::FlxCamera_obj::drawVertices->removeRange((int)0,::flixel::FlxCamera_obj::drawVertices->length);
...
HXLINE( 671)				{
HXLINE( 671)					currentVertexPosition = (currentVertexPosition + (int)1);
HXDLIN( 671)					::flixel::FlxCamera_obj::drawVertices[(currentVertexPosition - (int)1)] = tempX;
            				}
HXLINE( 672)				{
HXLINE( 672)					currentVertexPosition = (currentVertexPosition + (int)1);
HXDLIN( 672)					::flixel::FlxCamera_obj::drawVertices[(currentVertexPosition - (int)1)] = tempY;
            				}
...
HXLINE( 690)				::flixel::FlxCamera_obj::drawVertices->removeRange((::flixel::FlxCamera_obj::drawVertices->length - verticesLength),verticesLength);
            			}
            			else {
HXLINE( 694)				::flixel::FlxCamera_obj::trianglesSprite->get_graphics()->clear();
HXLINE( 695)				::flixel::FlxCamera_obj::trianglesSprite->get_graphics()->beginBitmapFill(graphic->bitmap,null(),repeat,smoothing);
...
HXLINE( 702)					HX_VARI(  ::openfl::_legacy::display::Graphics,gfx) = ::flixel::util::FlxSpriteUtil_obj::flashGfx;
...
HXDLIN( 808)					HX_VARI( int,_g) = this->canvas->get_numChildren();
...
HXDLIN( 856)		this->flashSprite->set_filters(_hx_tmp);
...
HXLINE(1031)					HX_VARI(  ::openfl::_legacy::display::Sprite,_g) = this->flashSprite;
HXDLIN(1031)					Float _hx_tmp1 = _g->get_x();
...
HXDLIN(1031)					_g->set_x((_hx_tmp1 + ((_hx_tmp2 * this->zoom) * ::flixel::FlxG_obj::scaleMode->scale->x)));
            				}
HXLINE(1033)				if (hx::IsNotEq( this->_fxShakeAxes,::flixel::util::FlxAxes_obj::X_dyn() )) {
HXLINE(1035)					HX_VARI_NAME(  ::openfl::_legacy::display::Sprite,_g1,"_g") = this->flashSprite;
HXDLIN(1035)					Float _hx_tmp3 = _g1->get_y();
...
HXDLIN(1035)					_g1->set_y((_hx_tmp3 + ((_hx_tmp4 * this->zoom) * ::flixel::FlxG_obj::scaleMode->scale->y)));
            				}
            			}
            		}
            	}
...
HXLINE(1049)			this->flashSprite->set_x(((this->x * ::flixel::FlxG_obj::scaleMode->scale->x) + this->_flashOffset->x));
HXLINE(1050)			this->flashSprite->set_y(((this->y * ::flixel::FlxG_obj::scaleMode->scale->y) + this->_flashOffset->y));
            		}
            	}
...
void FlxCamera_obj::updateScrollRect(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1074)		HX_VAR(  ::openfl::_legacy::geom::Rectangle,rect);
HXDLIN(1074)		if (hx::IsNotNull( this->_scrollRect )) {
HXLINE(1074)			rect = this->_scrollRect->get_scrollRect();
            		}
            		else {
...
HXLINE(1081)			this->_scrollRect->set_scrollRect(rect);
HXLINE(1082)			this->_scrollRect->set_x((((Float)-0.5) * rect->width));
HXLINE(1083)			this->_scrollRect->set_y((((Float)-0.5) * rect->height));
            		}
            	}
...
HXLINE(1098)					int _hx_tmp2 = this->width;
HXDLIN(1098)					_hx_tmp1 = (_hx_tmp2 != this->buffer->get_width());
            				}
            				else {
HXLINE(1098)					_hx_tmp1 = true;
            				}
HXDLIN(1098)				if (!(_hx_tmp1)) {
HXLINE(1098)					int _hx_tmp3 = this->height;
HXDLIN(1098)					_hx_tmp = (_hx_tmp3 != this->buffer->get_height());
            				}
            				else {
HXLINE(1098)					_hx_tmp = true;
            				}
HXDLIN(1098)				this->regen = _hx_tmp;
HXLINE(1100)				this->_flashBitmap->set_x((((((Float)-0.5) * this->width) * (this->scaleX - this->initialZoom)) * ::flixel::FlxG_obj::scaleMode->scale->x));
HXLINE(1101)				this->_flashBitmap->set_y((((((Float)-0.5) * this->height) * (this->scaleY - this->initialZoom)) * ::flixel::FlxG_obj::scaleMode->scale->y));
            			}
            		}
            		else {
HXLINE(1106)			if (hx::IsNotNull( this->canvas )) {
HXLINE(1108)				this->canvas->set_x((((((Float)-0.5) * this->width) * (this->scaleX - this->initialZoom)) * ::flixel::FlxG_obj::scaleMode->scale->x));
HXLINE(1109)				this->canvas->set_y((((((Float)-0.5) * this->height) * (this->scaleY - this->initialZoom)) * ::flixel::FlxG_obj::scaleMode->scale->y));
...
HXLINE(1117)					 ::openfl::_legacy::display::Sprite _hx_tmp4 = this->debugLayer;
HXDLIN(1117)					_hx_tmp4->set_x(this->canvas->get_x());
HXLINE(1118)					 ::openfl::_legacy::display::Sprite _hx_tmp5 = this->debugLayer;
HXDLIN(1118)					_hx_tmp5->set_y(this->canvas->get_y());
...
HXDLIN(1160)				HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
...
HXDLIN(1165)				HX_VARI_NAME(  ::flixel::math::FlxRect,_this1,"_this") = ::flixel::math::FlxRect_obj::_pool->get();
...
HXDLIN(1169)				HX_VARI_NAME(  ::flixel::math::FlxRect,_this2,"_this") = ::flixel::math::FlxRect_obj::_pool->get();
...
HXDLIN(1173)				HX_VARI_NAME(  ::flixel::math::FlxRect,_this3,"_this") = ::flixel::math::FlxRect_obj::_pool->get();
...
HXDLIN(1176)				HX_VARI_NAME(  ::flixel::math::FlxRect,_this4,"_this") = ::flixel::math::FlxRect_obj::_pool->get();
...
HXLINE(1319)					HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
...
HXLINE(1350)			if ((FxAlpha == (int)0)) {
HXLINE(1351)				return;
            			}
HXLINE(1354)			HX_VAR(  ::openfl::_legacy::display::Graphics,targetGraphics);
HXDLIN(1354)			if (hx::IsNull( graphics )) {
HXLINE(1354)				targetGraphics = this->canvas->get_graphics();
            			}
            			else {
...
HXDLIN(1383)				this->fill(_hx_tmp2,true,_hx_tmp4,this->canvas->get_graphics());
            			}
            		}
...
HXDLIN(1398)				this->fill(_hx_tmp7,true,_hx_tmp9,this->canvas->get_graphics());
            			}
            		}
            	}
...
HXDLIN(1409)		int _hx_tmp2 = this->width;
HXDLIN(1409)		if ((_hx_tmp2 == this->buffer->get_width())) {
HXLINE(1409)			int _hx_tmp3 = this->height;
HXDLIN(1409)			_hx_tmp1 = (_hx_tmp3 != this->buffer->get_height());
            		}
            		else {
...
HXLINE(1412)			this->buffer =  ::openfl::_legacy::display::BitmapData_obj::__alloc( HX_CTX ,this->width,this->height,true,(int)0,null());
HXLINE(1413)			this->screen->set_pixels(this->buffer);
HXLINE(1414)			this->screen->origin->set(null(),null());
HXLINE(1415)			this->_flashBitmap->set_bitmapData(this->buffer);
...
HXLINE(1419)			this->_fill =  ::openfl::_legacy::display::BitmapData_obj::__alloc( HX_CTX ,this->width,this->height,true,(int)0,null());
...
HXLINE(1505)			this->_flashBitmap->set_scaleX(this->totalScaleX);
HXLINE(1506)			this->_flashBitmap->set_scaleY(this->totalScaleY);
            		}
            		else {
...
HXLINE(1576)			this->_flashBitmap->set_alpha(Alpha);
            		}
            		else {
HXLINE(1580)			this->canvas->set_alpha(Alpha);
            		}
...
HXLINE(1588)		this->flashSprite->set_rotation(Angle);
...
HXLINE(1595)		HX_VAR(  ::openfl::_legacy::geom::ColorTransform,colorTransform);
HXLINE(1597)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1599)			if (hx::IsNull( this->_flashBitmap )) {
HXLINE(1601)				return Color;
            			}
HXLINE(1603)			colorTransform = this->_flashBitmap->get_transform()->get_colorTransform();
            		}
            		else {
HXLINE(1607)			colorTransform = this->canvas->get_transform()->get_colorTransform();
            		}
...
HXLINE(1616)			this->_flashBitmap->get_transform()->set_colorTransform(colorTransform);
            		}
            		else {
HXLINE(1620)			this->canvas->get_transform()->set_colorTransform(colorTransform);
            		}
...
HXLINE(1631)			this->_flashBitmap->set_smoothing(Antialiasing);
            		}
...
HXLINE(1654)			this->flashSprite->set_visible(visible);
            		}
...
HXLINE( 420)			HX_VARI_NAME( ::Array< Float >,this1,"this") = ::Array_obj< Float >::__new();
HXDLIN( 420)			this1->__SetSizeExact(null());
...
HXLINE( 424)		trianglesSprite =  ::openfl::_legacy::display::Sprite_obj::__alloc( HX_CTX );
            	}
{
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::Dynamic _hx_run(){
            			HX_STACKFRAME(&_hx_pos_d1aae230bd422321_429_boot)
HXLINE( 429)			HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXLINE( 430)			HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
