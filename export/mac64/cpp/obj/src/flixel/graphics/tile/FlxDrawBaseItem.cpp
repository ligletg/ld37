...
HX_DEFINE_STACK_FRAME(_hx_pos_0484b113da1bcafb_14_new,"flixel.graphics.tile.FlxDrawBaseItem","new",0x1069797d,"flixel.graphics.tile.FlxDrawBaseItem.new","flixel/graphics/tile/FlxDrawBaseItem.hx",14,0xe6349cf4)
HX_DEFINE_STACK_FRAME(_hx_pos_0484b113da1bcafb_71_reset,"flixel.graphics.tile.FlxDrawBaseItem","reset",0x6670342c,"flixel.graphics.tile.FlxDrawBaseItem.reset","flixel/graphics/tile/FlxDrawBaseItem.hx",71,0xe6349cf4)
HX_DEFINE_STACK_FRAME(_hx_pos_0484b113da1bcafb_79_dispose,"flixel.graphics.tile.FlxDrawBaseItem","dispose",0x64897c3c,"flixel.graphics.tile.FlxDrawBaseItem.dispose","flixel/graphics/tile/FlxDrawBaseItem.hx",79,0xe6349cf4)
HX_DEFINE_STACK_FRAME(_hx_pos_0484b113da1bcafb_86_render,"flixel.graphics.tile.FlxDrawBaseItem","render",0x386e9259,"flixel.graphics.tile.FlxDrawBaseItem.render","flixel/graphics/tile/FlxDrawBaseItem.hx",86,0xe6349cf4)
HX_DEFINE_STACK_FRAME(_hx_pos_0484b113da1bcafb_88_addQuad,"flixel.graphics.tile.FlxDrawBaseItem","addQuad",0x30847725,"flixel.graphics.tile.FlxDrawBaseItem.addQuad","flixel/graphics/tile/FlxDrawBaseItem.hx",88,0xe6349cf4)
HX_DEFINE_STACK_FRAME(_hx_pos_0484b113da1bcafb_92_get_numVertices,"flixel.graphics.tile.FlxDrawBaseItem","get_numVertices",0x6c4b2893,"flixel.graphics.tile.FlxDrawBaseItem.get_numVertices","flixel/graphics/tile/FlxDrawBaseItem.hx",92,0xe6349cf4)
HX_DEFINE_STACK_FRAME(_hx_pos_0484b113da1bcafb_97_get_numTriangles,"flixel.graphics.tile.FlxDrawBaseItem","get_numTriangles",0x6bc74ed1,"flixel.graphics.tile.FlxDrawBaseItem.get_numTriangles","flixel/graphics/tile/FlxDrawBaseItem.hx",97,0xe6349cf4)
HX_DEFINE_STACK_FRAME(_hx_pos_0484b113da1bcafb_17_blendToInt,"flixel.graphics.tile.FlxDrawBaseItem","blendToInt",0xc101e4a6,"flixel.graphics.tile.FlxDrawBaseItem.blendToInt","flixel/graphics/tile/FlxDrawBaseItem.hx",17,0xe6349cf4)
namespace flixel{
namespace graphics{
namespace tile{

void FlxDrawBaseItem_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_14_new)
            	HX_STACK_THIS(this)
HXLINE(  60)		this->blending = (int)0;
HXLINE(  59)		this->hasColorOffsets = false;
HXLINE(  58)		this->colored = false;
HXLINE(  57)		this->antialiasing = false;
            	}
...
void FlxDrawBaseItem_obj::reset(){
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_71_reset)
            	HX_STACK_THIS(this)
HXLINE(  72)		this->graphics = null();
HXLINE(  73)		this->antialiasing = false;
HXLINE(  74)		this->nextTyped = null();
HXLINE(  75)		this->next = null();
            	}
...
void FlxDrawBaseItem_obj::dispose(){
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_79_dispose)
            	HX_STACK_THIS(this)
HXLINE(  80)		this->graphics = null();
HXLINE(  81)		this->next = null();
HXLINE(  82)		this->type = null();
HXLINE(  83)		this->nextTyped = null();
            	}
...
void FlxDrawBaseItem_obj::render( ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_86_render)
            	HX_STACK_THIS(this)
...
void FlxDrawBaseItem_obj::addQuad( ::flixel::graphics::frames::FlxFrame frame, ::flixel::math::FlxMatrix matrix, ::openfl::_legacy::geom::ColorTransform transform){
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_88_addQuad)
            	HX_STACK_THIS(this)
...
int FlxDrawBaseItem_obj::get_numVertices(){
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_92_get_numVertices)
            	HX_STACK_THIS(this)
...
int FlxDrawBaseItem_obj::get_numTriangles(){
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_97_get_numTriangles)
            	HX_STACK_THIS(this)
...
int FlxDrawBaseItem_obj::blendToInt( ::openfl::_legacy::display::BlendMode blend){
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_17_blendToInt)
            	HX_STACK_ARG(blend,"blend")
HXLINE(  18)		if (hx::IsNull( blend )) {
HXLINE(  19)			return (int)0;
            		}
HXLINE(  21)		switch((int)(_hx_getEnumValueIndex(blend))){
            			case (int)2: {
HXLINE(  21)				return (int)131072;
            			}
            			break;
            			case (int)3: {
HXLINE(  21)				return (int)262144;
            			}
            			break;
            			case (int)7: {
HXLINE(  21)				return (int)65536;
            			}
            			break;
            			case (int)8: {
HXLINE(  21)				return (int)524288;
            			}
            			break;
            			default:{
...
static hx::StaticInfo *FlxDrawBaseItem_obj_sStaticStorageInfo = 0;
#endif
