...
void FlxDrawTrianglesItem_obj::__construct(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  38)		HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
...
HXLINE(  27)			HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
