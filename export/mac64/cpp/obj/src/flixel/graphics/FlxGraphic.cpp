...
HX_DEFINE_STACK_FRAME(_hx_pos_3b8710f86d15c371_409_dump,"flixel.graphics.FlxGraphic","dump",0xe78dc2db,"flixel.graphics.FlxGraphic.dump","flixel/graphics/FlxGraphic.hx",409,0xb3633517)
...
void FlxGraphic_obj::dump(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_409_dump)
            	HX_STACK_THIS(this)
HXLINE( 409)		bool _hx_tmp;
HXDLIN( 409)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 409)			if (hx::IsNull( this->assetsClass )) {
...
HXLINE( 527)		HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
...
HXLINE( 539)			HX_VARI( bool,dumped) = this->isDumped;
HXLINE( 541)			if (dumped) {
HXLINE( 542)				this->undump();
            			}
HXLINE( 544)			this->_tilesheet =  ::openfl::_legacy::display::Tilesheet_obj::__alloc( HX_CTX ,this->bitmap);
HXLINE( 546)			if (dumped) {
HXLINE( 547)				this->dump();
            			}
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxGraphic_obj,get_tilesheet,return )
 ...
 ::openfl::_legacy::display::BitmapData FlxGraphic_obj::getBitmapFromSystem(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 559)		HX_VARI(  ::openfl::_legacy::display::BitmapData,newBitmap) = null();
HXLINE( 560)		if (hx::IsNotNull( this->assetsClass )) {
HXLINE( 562)			newBitmap = ( ( ::openfl::_legacy::display::BitmapData)(::Type_obj::createInstance(this->assetsClass,::cpp::VirtualArray_obj::__new(2)->init(0,(int)0)->init(1,(int)0))) );
            		}
            		else {
HXLINE( 564)			if (hx::IsNotNull( this->assetsKey )) {
HXLINE( 566)				HX_VARI( ::String,id) = this->assetsKey;
HXDLIN( 566)				if (::openfl::_legacy::Assets_obj::exists(id,null())) {
...
HXLINE( 616)			Float Width = this->bitmap->get_width();
HXDLIN( 616)			Float Height = this->bitmap->get_height();
HXDLIN( 616)			HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
...
HXLINE( 632)			this->width = this->bitmap->get_width();
HXLINE( 633)			this->height = this->bitmap->get_height();
...
HXLINE( 636)				this->_tilesheet =  ::openfl::_legacy::display::Tilesheet_obj::__alloc( HX_CTX ,this->bitmap);
            			}
            		}
...
HXLINE(  41)		if (!(Cache)) {
HXLINE(  43)			 ::openfl::_legacy::display::BitmapData bitmap1;
HXDLIN(  43)			if (::openfl::_legacy::Assets_obj::exists(Source,null())) {
...
HXLINE( 235)		return ::flixel::graphics::FlxGraphic_obj::createGraphic( ::openfl::_legacy::display::BitmapData_obj::__alloc( HX_CTX ,Width,Height,true,Color,null()),key,null(),null());
            	}
