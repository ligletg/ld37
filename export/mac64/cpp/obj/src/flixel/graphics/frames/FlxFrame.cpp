...
HXLINE( 294)				bmd1 =  ::openfl::_legacy::display::BitmapData_obj::__alloc( HX_CTX ,w,h,true,(int)0,null());
            			}
            		}
HXDLIN( 294)		bmd = bmd1;
...
HXLINE( 303)					FlashPoint =  ::openfl::_legacy::geom::Point_obj::__alloc( HX_CTX ,null(),null());
            				}
HXDLIN( 303)				FlashPoint->x = _this->x;
HXDLIN( 303)				FlashPoint->y = _this->y;
            			}
HXLINE( 304)			 ::openfl::_legacy::geom::Point _hx_tmp = this->point2;
HXDLIN( 304)			_hx_tmp->x = (_hx_tmp->x + point->x);
HXLINE( 305)			 ::openfl::_legacy::geom::Point _hx_tmp1 = this->point2;
...
HXLINE( 306)				FlashRect =  ::openfl::_legacy::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            			}
...
HXLINE( 312)					FlashRect1 =  ::openfl::_legacy::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            				}
...
HXLINE( 344)				bmd1 =  ::openfl::_legacy::display::BitmapData_obj::__alloc( HX_CTX ,w,h,true,(int)0,null());
            			}
            		}
HXDLIN( 344)		bmd = bmd1;
...
HXLINE( 356)				FlashRect =  ::openfl::_legacy::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            			}
...
HXLINE( 395)				bmd =  ::openfl::_legacy::display::BitmapData_obj::__alloc( HX_CTX ,w,h,true,(int)0,null());
            			}
            		}
...
HXLINE( 416)		HX_VARI_NAME(  ::flixel::math::FlxRect,_this2,"_this") = ::flixel::math::FlxRect_obj::_pool->get();
...
HXLINE( 417)				FlashRect =  ::openfl::_legacy::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            			}
...
HXLINE( 452)		HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
...
HXDLIN( 479)			HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get()->set(X,Y1);
...
HXDLIN( 480)			HX_VARI_NAME(  ::flixel::math::FlxPoint,point1,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set(X1,Y2);
...
HXLINE( 556)		HX_VARI_NAME(  ::flixel::math::FlxRect,_this1,"_this") = ::flixel::math::FlxRect_obj::_pool->get();
...
HXLINE( 634)		HX_VARI_NAME(  ::flixel::math::FlxRect,_this2,"_this") = ::flixel::math::FlxRect_obj::_pool->get();
...
HXDLIN( 659)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get();
...
HXLINE( 667)				HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
