...
HXLINE( 175)				HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get();
...
HXDLIN( 181)				HX_VARI_NAME(  ::flixel::math::FlxPoint,point2,"point") = ::flixel::math::FlxPoint_obj::_pool->get();
...
HXDLIN( 243)				HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
...
HXLINE( 245)					size =  ::openfl::_legacy::geom::Rectangle_obj::__alloc( HX_CTX ,size1,size2,size3,::Std_obj::parseInt(val->att->resolve(HX_("frameHeight",f4,d3,93,e0))));
            				}
            				else {
HXLINE( 245)					size =  ::openfl::_legacy::geom::Rectangle_obj::__alloc( HX_CTX ,(int)0,(int)0,_this->width,_this->height);
            				}
