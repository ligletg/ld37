...
HXDLIN( 223)		HX_VARI_NAME( int,insertWidth1,"insertWidth") = (insertWidth + this->border);
HXLINE( 224)		int insertHeight = data->get_height();
HXDLIN( 224)		HX_VARI_NAME( int,insertHeight1,"insertHeight") = (insertHeight + this->border);
HXLINE( 226)		HX_VARI( bool,rotateNode) = false;
HXLINE( 227)		HX_VARI(  ::flixel::graphics::atlas::FlxNode,nodeToInsert) = this->findNodeToInsert(insertWidth1,insertHeight1);
HXLINE( 229)		if (this->allowRotation) {
HXLINE( 231)			HX_VARI(  ::flixel::graphics::atlas::FlxNode,nodeToInsertWithRotation) = this->findNodeToInsert(insertHeight1,insertWidth1);
...
HXLINE( 241)					HX_VARI( int,temp) = insertWidth1;
...
HXLINE( 251)			return this->divideNode(nodeToInsert,insertWidth1,insertHeight1,this->needToDivideHorizontally(nodeToInsert,insertWidth1,insertHeight1),data,key,rotateNode);
            		}
...
HXLINE( 324)					 ::openfl::_legacy::geom::Matrix _hx_tmp1 = ::flixel::graphics::atlas::FlxAtlas_obj::matrix;
HXDLIN( 324)					int _hx_tmp2 = firstGrandChildData->get_height();
HXDLIN( 324)					int _hx_tmp3 = (_hx_tmp2 + ::Std_obj::_hx_int(firstGrandChild->rect->x));
HXDLIN( 324)					_hx_tmp1->translate(_hx_tmp3,::Std_obj::_hx_int(firstGrandChild->rect->y));
HXLINE( 325)					this->bitmapData->draw(firstGrandChildData,::flixel::graphics::atlas::FlxAtlas_obj::matrix,null(),null(),null(),null());
            				}
            				else {
HXLINE( 329)					 ::openfl::_legacy::geom::Point _hx_tmp4 = ::flixel::graphics::atlas::FlxAtlas_obj::point;
HXDLIN( 329)					int _hx_tmp5 = ::Std_obj::_hx_int(firstGrandChild->rect->x);
HXDLIN( 329)					_hx_tmp4->setTo(_hx_tmp5,::Std_obj::_hx_int(firstGrandChild->rect->y));
HXLINE( 330)					 ::openfl::_legacy::display::BitmapData _hx_tmp6 = this->bitmapData;
HXDLIN( 330)					 ::openfl::_legacy::geom::Rectangle _hx_tmp7 = firstGrandChildData->get_rect();
HXDLIN( 330)					_hx_tmp6->copyPixels(firstGrandChildData,_hx_tmp7,::flixel::graphics::atlas::FlxAtlas_obj::point,null(),null(),null());
            				}
...
HXDLIN( 347)			HX_VARI_NAME( int,insertWidth1,"insertWidth") = (insertWidth + this->border);
HXLINE( 348)			int insertHeight = data->get_height();
HXDLIN( 348)			HX_VARI_NAME( int,insertHeight1,"insertHeight") = (insertHeight + this->border);
HXLINE( 350)			HX_VARI( int,rootWidth) = insertWidth1;
HXLINE( 351)			HX_VARI( int,rootHeight) = insertHeight1;
HXLINE( 353)			if (this->powerOfTwo) {
HXLINE( 355)				rootWidth = this->getNextPowerOfTwo(insertWidth1);
HXLINE( 356)				rootHeight = this->getNextPowerOfTwo(insertHeight1);
            			}
...
HXLINE( 379)			HX_VARI( bool,horizontally) = this->needToDivideHorizontally(this->root,insertWidth1,insertHeight1);
...
HXDLIN( 390)			HX_VARI_NAME( int,insertWidth1,"insertWidth") = (insertWidth + this->border);
HXLINE( 391)			int insertHeight = data->get_height();
HXDLIN( 391)			HX_VARI_NAME( int,insertHeight1,"insertHeight") = (insertHeight + this->border);
HXLINE( 394)			HX_VARI( int,addRightWidth) = (::Std_obj::_hx_int(this->root->rect->width) + insertWidth1);
HXLINE( 395)			HX_VARI( int,addRightHeight) = ::Std_obj::_hx_int(::Math_obj::max(::Std_obj::_hx_int(this->root->rect->height),insertHeight1));
HXLINE( 397)			HX_VARI( int,addBottomWidth) = ::Std_obj::_hx_int(::Math_obj::max(::Std_obj::_hx_int(this->root->rect->width),insertWidth1));
HXLINE( 398)			HX_VARI( int,addBottomHeight) = (::Std_obj::_hx_int(this->root->rect->height) + insertHeight1);
...
HXLINE( 470)				_hx_tmp15 = (addRightArea > (addRightWidthRotate * addRightHeightRotate));
            			}
            			else {
...
HXLINE( 501)			HX_VARI( int,insertNodeWidth) = insertWidth1;
HXLINE( 502)			HX_VARI( int,insertNodeHeight) = insertHeight1;
...
HXDLIN( 557)		HX_VARI_NAME(  ::openfl::_legacy::display::BitmapData,newBitmapData1,"newBitmapData") =  ::openfl::_legacy::display::BitmapData_obj::__alloc( HX_CTX ,newBitmapData,::Std_obj::_hx_int(this->root->rect->height),true,(int)0,null());
...
HXDLIN( 670)				HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get()->set(X2,Y2);
...
HXDLIN( 670)				HX_VARI_NAME(  ::flixel::math::FlxPoint,point1,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set(X4,Y4);
...
HXLINE( 747)			HX_VARI( int,area1) = ( ( ::openfl::_legacy::display::BitmapData)(obj1->__Field(HX_("bmd",39,bc,4a,00),hx::paccDynamic)) )->get_width();
HXDLIN( 747)			HX_VARI_NAME( int,area11,"area1") = (area1 * ( ( ::openfl::_legacy::display::BitmapData)(obj1->__Field(HX_("bmd",39,bc,4a,00),hx::paccDynamic)) )->get_height());
HXLINE( 748)			HX_VARI( int,area2) = ( ( ::openfl::_legacy::display::BitmapData)(obj2->__Field(HX_("bmd",39,bc,4a,00),hx::paccDynamic)) )->get_width();
HXLINE( 749)			return ((area2 * ( ( ::openfl::_legacy::display::BitmapData)(obj2->__Field(HX_("bmd",39,bc,4a,00),hx::paccDynamic)) )->get_height()) - area11);
            		}
...
HXLINE(  27)		point =  ::openfl::_legacy::geom::Point_obj::__alloc( HX_CTX ,null(),null());
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_f38becfab6571882_28_boot)
HXLINE(  28)		matrix =  ::openfl::_legacy::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
            	}
{
