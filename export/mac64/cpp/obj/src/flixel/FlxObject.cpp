...
HX_DEFINE_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1033_drawDebug,"flixel.FlxObject","drawDebug",0x2ad45ea0,"flixel.FlxObject.drawDebug","flixel/FlxObject.hx",1033,0xf0fe0d80)
HX_DEFINE_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1055_drawDebugOnCamera,"flixel.FlxObject","drawDebugOnCamera",0x0b2ef7e4,"flixel.FlxObject.drawDebugOnCamera","flixel/FlxObject.hx",1055,0xf0fe0d80)
HX_DEFINE_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1068_drawDebugBoundingBox,"flixel.FlxObject","drawDebugBoundingBox",0xa96b1247,"flixel.FlxObject.drawDebugBoundingBox","flixel/FlxObject.hx",1068,0xf0fe0d80)
HX_DEFINE_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1090_beginDrawDebug,"flixel.FlxObject","beginDrawDebug",0x8677cfb5,"flixel.FlxObject.beginDrawDebug","flixel/FlxObject.hx",1090,0xf0fe0d80)
HX_DEFINE_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1103_endDrawDebug,"flixel.FlxObject","endDrawDebug",0x2518e603,"flixel.FlxObject.endDrawDebug","flixel/FlxObject.hx",1103,0xf0fe0d80)
...
HX_DEFINE_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1151_set_width,"flixel.FlxObject","set_width",0x7d06d55a,"flixel.FlxObject.set_width","flixel/FlxObject.hx",1151,0xf0fe0d80)
HX_DEFINE_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1165_set_height,"flixel.FlxObject","set_height",0x9f435213,"flixel.FlxObject.set_height","flixel/FlxObject.hx",1165,0xf0fe0d80)
...
HX_DEFINE_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1235_set_debugBoundingBoxColorSolid,"flixel.FlxObject","set_debugBoundingBoxColorSolid",0xb8a23688,"flixel.FlxObject.set_debugBoundingBoxColorSolid","flixel/FlxObject.hx",1235,0xf0fe0d80)
HX_DEFINE_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1240_set_debugBoundingBoxColorNotSolid,"flixel.FlxObject","set_debugBoundingBoxColorNotSolid",0x55ae1bdb,"flixel.FlxObject.set_debugBoundingBoxColorNotSolid","flixel/FlxObject.hx",1240,0xf0fe0d80)
HX_DEFINE_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1245_set_debugBoundingBoxColorPartial,"flixel.FlxObject","set_debugBoundingBoxColorPartial",0x34746b1e,"flixel.FlxObject.set_debugBoundingBoxColorPartial","flixel/FlxObject.hx",1245,0xf0fe0d80)
...
HXLINE( 583)		HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
...
HXLINE( 581)		HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXDLIN( 610)		HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get()->set(X,Y);
HXDLIN( 610)		point->_inPool = false;
HXDLIN( 610)		this->last = point;
HXLINE( 611)		HX_VARI_NAME(  ::flixel::math::FlxPoint,point1,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)1,(int)1);
...
HXLINE( 614)		{
HXLINE( 614)			HX_VARI_NAME(  ::flixel::math::FlxPoint,point2,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 614)			point2->_inPool = false;
HXDLIN( 614)			this->velocity = point2;
HXDLIN( 614)			HX_VARI_NAME(  ::flixel::math::FlxPoint,point3,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 614)			point3->_inPool = false;
HXDLIN( 614)			this->acceleration = point3;
HXDLIN( 614)			HX_VARI_NAME(  ::flixel::math::FlxPoint,point4,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 614)			point4->_inPool = false;
HXDLIN( 614)			this->drag = point4;
HXDLIN( 614)			HX_VARI_NAME(  ::flixel::math::FlxPoint,point5,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)10000,(int)10000);
...
void FlxObject_obj::initMotionVars(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 623)		HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 623)		point->_inPool = false;
HXDLIN( 623)		this->velocity = point;
HXLINE( 624)		HX_VARI_NAME(  ::flixel::math::FlxPoint,point1,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 624)		point1->_inPool = false;
HXDLIN( 624)		this->acceleration = point1;
HXLINE( 625)		HX_VARI_NAME(  ::flixel::math::FlxPoint,point2,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 625)		point2->_inPool = false;
HXDLIN( 625)		this->drag = point2;
HXLINE( 626)		HX_VARI_NAME(  ::flixel::math::FlxPoint,point3,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)10000,(int)10000);
...
HXLINE( 857)			HX_VARI_NAME(  ::flixel::math::FlxPoint,point1,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXLINE( 876)			HX_VARI_NAME(  ::flixel::math::FlxPoint,point1,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXLINE( 890)			HX_VARI_NAME(  ::flixel::math::FlxPoint,point1,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXLINE( 898)			HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
...
HXLINE(1039)		{
HXLINE(1039)			HX_VARI( int,_g) = (int)0;
HXDLIN(1039)			HX_VARI( ::Array< ::Dynamic>,_g1) = this->get_cameras();
HXDLIN(1039)			while((_g < _g1->length)){
HXLINE(1039)				HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
...
HXLINE(1061)		HX_VARI(  ::flixel::math::FlxRect,rect) = this->getBoundingBox(camera);
HXLINE(1062)		HX_VAR(  ::openfl::_legacy::display::Graphics,gfx);
...
HXLINE(1070)		HX_VARI(  ::Dynamic,color) = this->debugBoundingBoxColor;
...
HXDLIN(1129)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(1129)		_this->label = HX_("x",78,00,00,00);
HXDLIN(1129)		_this->value = value;
HXLINE(1130)		 ::Dynamic value1 = this->y;
HXDLIN(1130)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this1,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(1130)		_this1->label = HX_("y",79,00,00,00);
HXDLIN(1130)		_this1->value = value1;
HXLINE(1131)		 ::Dynamic value2 = this->get_width();
HXDLIN(1131)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this2,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(1131)		_this2->label = HX_("w",77,00,00,00);
HXDLIN(1131)		_this2->value = value2;
HXLINE(1132)		 ::Dynamic value3 = this->get_height();
HXDLIN(1132)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this3,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(1132)		_this3->label = HX_("h",68,00,00,00);
HXDLIN(1132)		_this3->value = value3;
HXLINE(1133)		 ::Dynamic value4 = this->visible;
HXDLIN(1133)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this4,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(1133)		_this4->label = HX_("visible",72,78,24,a3);
HXDLIN(1133)		_this4->value = value4;
HXLINE(1134)		 ::Dynamic value5 = this->velocity;
HXDLIN(1134)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this5,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
...
HXLINE(  70)			HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
...
HXLINE(  72)			HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
