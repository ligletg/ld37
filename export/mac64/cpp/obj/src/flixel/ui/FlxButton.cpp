...
HXDLIN(  63)			this->label->set_alpha(this->labelAlphas->__get(this->status));
...
HXLINE(  86)			this->label->set_alpha(this->labelAlphas->__get(this->status));
...
::String FlxButton_obj::get_text(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  93)		if (hx::IsNotNull( this->label )) {
HXLINE(  93)			return this->label->text;
            		}
            		else {
...
HXDLIN( 100)				this->label->set_alpha(this->labelAlphas->__get(this->status));
