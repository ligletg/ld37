...
HX_DEFINE_STACK_FRAME(_hx_pos_f71e48b1d97abdba_41_get,"flixel.util.FlxBitmapDataPool","get",0x62a51335,"flixel.util.FlxBitmapDataPool.get","flixel/util/FlxBitmapDataPool.hx",41,0x992b0db1)
HX_DEFINE_STACK_FRAME(_hx_pos_f71e48b1d97abdba_89_put,"flixel.util.FlxBitmapDataPool","put",0x62abf56e,"flixel.util.FlxBitmapDataPool.put","flixel/util/FlxBitmapDataPool.hx",89,0x992b0db1)
HX_DEFINE_STACK_FRAME(_hx_pos_f71e48b1d97abdba_121_clear,"flixel.util.FlxBitmapDataPool","clear",0xdb7329ec,"flixel.util.FlxBitmapDataPool.clear","flixel/util/FlxBitmapDataPool.hx",121,0x992b0db1)
HX_DEFINE_STACK_FRAME(_hx_pos_f71e48b1d97abdba_135_set_maxLength,"flixel.util.FlxBitmapDataPool","set_maxLength",0xa2220bec,"flixel.util.FlxBitmapDataPool.set_maxLength","flixel/util/FlxBitmapDataPool.hx",135,0x992b0db1)
HX_DEFINE_STACK_FRAME(_hx_pos_f71e48b1d97abdba_21_boot,"flixel.util.FlxBitmapDataPool","boot",0xea853cb3,"flixel.util.FlxBitmapDataPool.boot","flixel/util/FlxBitmapDataPool.hx",21,0x992b0db1)
HX_DEFINE_STACK_FRAME(_hx_pos_f71e48b1d97abdba_26_boot,"flixel.util.FlxBitmapDataPool","boot",0xea853cb3,"flixel.util.FlxBitmapDataPool.boot","flixel/util/FlxBitmapDataPool.hx",26,0x992b0db1)
HX_DEFINE_STACK_FRAME(_hx_pos_f71e48b1d97abdba_28_boot,"flixel.util.FlxBitmapDataPool","boot",0xea853cb3,"flixel.util.FlxBitmapDataPool.boot","flixel/util/FlxBitmapDataPool.hx",28,0x992b0db1)
HX_DEFINE_STACK_FRAME(_hx_pos_f71e48b1d97abdba_29_boot,"flixel.util.FlxBitmapDataPool","boot",0xea853cb3,"flixel.util.FlxBitmapDataPool.boot","flixel/util/FlxBitmapDataPool.hx",29,0x992b0db1)
HX_DEFINE_STACK_FRAME(_hx_pos_f71e48b1d97abdba_31_boot,"flixel.util.FlxBitmapDataPool","boot",0xea853cb3,"flixel.util.FlxBitmapDataPool.boot","flixel/util/FlxBitmapDataPool.hx",31,0x992b0db1)
namespace flixel{
namespace util{
...
HXLINE(  42)		HX_VARI(  ::openfl::_legacy::display::BitmapData,res) = null();
HXLINE(  45)		HX_VARI(  ::flixel::util::_FlxBitmapDataPool::FlxBitmapDataPoolNode,node) = ::flixel::util::FlxBitmapDataPool_obj::_head;
HXLINE(  46)		while(hx::IsNotNull( node )){
HXLINE(  48)			HX_VARI(  ::openfl::_legacy::display::BitmapData,bmd) = node->bmd;
...
HXLINE(  92)			HX_VARI(  ::flixel::util::_FlxBitmapDataPool::FlxBitmapDataPoolNode,last) = ::flixel::util::FlxBitmapDataPool_obj::_tail;
...
HXLINE( 103)		HX_VARI(  ::flixel::util::_FlxBitmapDataPool::FlxBitmapDataPoolNode,node) =  ::flixel::util::_FlxBitmapDataPool::FlxBitmapDataPoolNode_obj::__alloc( HX_CTX ,bmd,null(),null());
...
HXLINE( 122)		HX_VARI(  ::flixel::util::_FlxBitmapDataPool::FlxBitmapDataPoolNode,node) = ::flixel::util::FlxBitmapDataPool_obj::_head;
HXLINE( 123)		while(hx::IsNotNull( node )){
HXLINE( 125)			HX_VARI(  ::openfl::_legacy::display::BitmapData,bmd) = node->bmd;
...
HXLINE( 138)			HX_VARI(  ::flixel::util::_FlxBitmapDataPool::FlxBitmapDataPoolNode,node) = ::flixel::util::FlxBitmapDataPool_obj::_tail;
...
HXLINE( 141)				HX_VARI(  ::openfl::_legacy::display::BitmapData,bmd) = node->bmd;
