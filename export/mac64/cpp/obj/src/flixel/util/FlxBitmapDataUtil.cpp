...
HX_DEFINE_STACK_FRAME(_hx_pos_412bf34bd2ca21dd_32_merge,"flixel.util.FlxBitmapDataUtil","merge",0x21db12bd,"flixel.util.FlxBitmapDataUtil.merge","flixel/util/FlxBitmapDataUtil.hx",32,0xf477b24b)
HX_DEFINE_STACK_FRAME(_hx_pos_412bf34bd2ca21dd_149_mergeColorComponent,"flixel.util.FlxBitmapDataUtil","mergeColorComponent",0x5b71b277,"flixel.util.FlxBitmapDataUtil.mergeColorComponent","flixel/util/FlxBitmapDataUtil.hx",149,0xf477b24b)
HX_DEFINE_STACK_FRAME(_hx_pos_412bf34bd2ca21dd_164_compare,"flixel.util.FlxBitmapDataUtil","compare",0x217d53ea,"flixel.util.FlxBitmapDataUtil.compare","flixel/util/FlxBitmapDataUtil.hx",164,0xf477b24b)
HX_DEFINE_STACK_FRAME(_hx_pos_412bf34bd2ca21dd_232_getDiff,"flixel.util.FlxBitmapDataUtil","getDiff",0xb3004700,"flixel.util.FlxBitmapDataUtil.getDiff","flixel/util/FlxBitmapDataUtil.hx",232,0xf477b24b)
HX_DEFINE_STACK_FRAME(_hx_pos_412bf34bd2ca21dd_242_getMemorySize,"flixel.util.FlxBitmapDataUtil","getMemorySize",0x5bc2859d,"flixel.util.FlxBitmapDataUtil.getMemorySize","flixel/util/FlxBitmapDataUtil.hx",242,0xf477b24b)
HX_DEFINE_STACK_FRAME(_hx_pos_412bf34bd2ca21dd_257_replaceColor,"flixel.util.FlxBitmapDataUtil","replaceColor",0xbc41272a,"flixel.util.FlxBitmapDataUtil.replaceColor","flixel/util/FlxBitmapDataUtil.hx",257,0xf477b24b)
HX_DEFINE_STACK_FRAME(_hx_pos_412bf34bd2ca21dd_326_addSpacesAndBorders,"flixel.util.FlxBitmapDataUtil","addSpacesAndBorders",0xf8f1a643,"flixel.util.FlxBitmapDataUtil.addSpacesAndBorders","flixel/util/FlxBitmapDataUtil.hx",326,0xf477b24b)
HX_DEFINE_STACK_FRAME(_hx_pos_412bf34bd2ca21dd_409_copyBorderPixels,"flixel.util.FlxBitmapDataUtil","copyBorderPixels",0x739e20a9,"flixel.util.FlxBitmapDataUtil.copyBorderPixels","flixel/util/FlxBitmapDataUtil.hx",409,0xf477b24b)
HX_DEFINE_STACK_FRAME(_hx_pos_412bf34bd2ca21dd_469_generateRotations,"flixel.util.FlxBitmapDataUtil","generateRotations",0xe085af05,"flixel.util.FlxBitmapDataUtil.generateRotations","flixel/util/FlxBitmapDataUtil.hx",469,0xf477b24b)
HX_DEFINE_STACK_FRAME(_hx_pos_412bf34bd2ca21dd_17_boot,"flixel.util.FlxBitmapDataUtil","boot",0x2db7bbcd,"flixel.util.FlxBitmapDataUtil.boot","flixel/util/FlxBitmapDataUtil.hx",17,0xf477b24b)
namespace flixel{
namespace util{
...
HXDLIN(  36)		HX_VARI_NAME( Float,destPoint1,"destPoint") = destPoint->x;
HXDLIN(  36)		if (!((destPoint1 >= destBitmapData->get_width()))) {
HXLINE(  37)			HX_VARI_NAME( Float,destPoint2,"destPoint") = destPoint->y;
...
HXLINE(  38)			HX_VARI_NAME( Float,sourceRect1,"sourceRect") = sourceRect->x;
...
HXLINE(  39)			HX_VARI_NAME( Float,sourceRect2,"sourceRect") = sourceRect->y;
...
HXDLIN(  71)			HX_VARI_NAME( Float,destPoint3,"destPoint") = destPoint->x;
HXDLIN(  71)			if (!((destPoint3 >= destBitmapData->get_width()))) {
HXLINE(  71)				HX_VARI_NAME( Float,destPoint4,"destPoint") = destPoint->y;
...
HXLINE( 184)				HX_VARI(  ::openfl::_legacy::display::BitmapData,result) =  ::openfl::_legacy::display::BitmapData_obj::__alloc( HX_CTX ,width,height,true,(int)0,null());
HXLINE( 185)				HX_VARI( bool,identical) = true;
HXLINE( 187)				{
HXLINE( 187)					HX_VARI( int,_g1) = (int)0;
HXDLIN( 187)					while((_g1 < width)){
HXLINE( 187)						_g1 = (_g1 + (int)1);
HXDLIN( 187)						HX_VARI( int,i) = (_g1 - (int)1);
HXLINE( 189)						{
HXLINE( 189)							HX_VARI( int,_g3) = (int)0;
HXDLIN( 189)							while((_g3 < height)){
HXLINE( 189)								_g3 = (_g3 + (int)1);
HXDLIN( 189)								HX_VARI( int,j) = (_g3 - (int)1);
...
HXDLIN( 200)											color = ((int)color | (int)(int)-16777216);
            										}
...
HXDLIN( 213)											HX_VARI_NAME( int,color4,"color") = ::flixel::util::_FlxColor::FlxColor_Impl__obj::_new(null());
HXDLIN( 213)											{
HXLINE( 213)												color4 = ((int)color4 & (int)(int)-16711681);
HXDLIN( 213)												color4 = ((int)color4 | (int)(int)16711680);
            											}
HXDLIN( 213)											{
HXLINE( 213)												color4 = ((int)color4 & (int)(int)-65281);
HXDLIN( 213)												color4 = ((int)color4 | (int)(int)65280);
            											}
HXDLIN( 213)											{
HXLINE( 213)												color4 = ((int)color4 & (int)(int)-256);
HXDLIN( 213)												color4 = ((int)color4 | (int)(int)255);
            											}
HXDLIN( 213)											{
HXLINE( 213)												color4 = ((int)color4 & (int)(int)16777215);
HXDLIN( 213)												int color5;
HXDLIN( 213)												if ((Alpha > (int)255)) {
HXLINE( 213)													color5 = (int)255;
            												}
            												else {
HXLINE( 213)													if ((Alpha < (int)0)) {
HXLINE( 213)														color5 = (int)0;
            													}
            													else {
HXLINE( 213)														color5 = Alpha;
            													}
            												}
HXDLIN( 213)												color4 = ((int)color4 | (int)((int)color5 << (int)(int)24));
            											}
HXDLIN( 213)											result->setPixel32(i,j,color4);
            										}
            									}
            								}
            							}
...
HXLINE( 341)		HX_VARI( int,numHorizontalFrames) = ::Std_obj::_hx_int(((Float)region->width / (Float)frameWidth));
HXLINE( 342)		HX_VARI( int,numVerticalFrames) = ::Std_obj::_hx_int(((Float)region->height / (Float)frameHeight));
...
HXLINE( 363)		HX_VARI( int,result) = ::Std_obj::_hx_int(((region->width + ((numHorizontalFrames - (int)1) * spaceX)) + (((int)2 * numHorizontalFrames) * borderX)));
HXLINE( 362)		HX_VARI_NAME(  ::openfl::_legacy::display::BitmapData,result1,"result") =  ::openfl::_legacy::display::BitmapData_obj::__alloc( HX_CTX ,result,::Std_obj::_hx_int(((region->height + ((numVerticalFrames - (int)1) * spaceY)) + (((int)2 * numVerticalFrames) * borderY))),true,(int)0,null());
HXLINE( 369)		HX_VARI(  ::openfl::_legacy::geom::Rectangle,tempRect) =  ::openfl::_legacy::geom::Rectangle_obj::__alloc( HX_CTX ,(int)0,(int)0,frameWidth,frameHeight);
HXLINE( 370)		HX_VARI(  ::openfl::_legacy::geom::Point,tempPoint) =  ::openfl::_legacy::geom::Point_obj::__alloc( HX_CTX ,null(),null());
HXLINE( 373)		{
HXLINE( 373)			HX_VARI( int,_g1) = (int)0;
HXDLIN( 373)			while((_g1 < numHorizontalFrames)){
HXLINE( 373)				_g1 = (_g1 + (int)1);
HXDLIN( 373)				HX_VARI( int,i) = (_g1 - (int)1);
...
HXDLIN( 378)						HX_VARI( int,j) = (_g3 - (int)1);
...
HXLINE( 411)		HX_VARI(  ::openfl::_legacy::geom::Rectangle,tempRect) =  ::openfl::_legacy::geom::Rectangle_obj::__alloc( HX_CTX ,(int)0,(int)0,(int)1,bitmapData->get_height());
HXLINE( 412)		HX_VARI(  ::openfl::_legacy::geom::Point,tempPoint) =  ::openfl::_legacy::geom::Point_obj::__alloc( HX_CTX ,null(),null());
HXLINE( 415)		{
HXLINE( 415)			HX_VARI( int,_g1) = (int)0;
HXDLIN( 415)			while((_g1 < horizontalFrames)){
HXLINE( 415)				_g1 = (_g1 + (int)1);
HXLINE( 417)				tempRect->x = (((_g1 - (int)1) * ((frameWidth + ((int)2 * borderX)) + spaceX)) + borderX);
HXLINE( 419)				{
HXLINE( 419)					HX_VARI( int,_g3) = (int)0;
HXDLIN( 419)					while((_g3 < borderX)){
HXLINE( 419)						_g3 = (_g3 + (int)1);
HXLINE( 421)						tempPoint->x = ((tempRect->x - (_g3 - (int)1)) - (int)1);
HXLINE( 422)						bitmapData->copyPixels(bitmapData,tempRect,tempPoint,null(),null(),null());
            					}
            				}
HXLINE( 425)				tempRect->x = (tempRect->x + (frameWidth - (int)1));
HXLINE( 427)				{
HXLINE( 427)					HX_VARI_NAME( int,_g31,"_g3") = (int)0;
HXDLIN( 427)					while((_g31 < borderX)){
HXLINE( 427)						_g31 = (_g31 + (int)1);
HXLINE( 429)						tempPoint->x = ((tempRect->x + (_g31 - (int)1)) + (int)1);
...
HXLINE( 475)		HX_VARI( int,rows) = ::Std_obj::_hx_int(::Math_obj::sqrt(rotations));
...
HXLINE( 482)		HX_VARI(  ::openfl::_legacy::display::BitmapData,result) =  ::openfl::_legacy::display::BitmapData_obj::__alloc( HX_CTX ,(max * columns),(max * rows),true,(int)0,null());
...
HXLINE( 499)				::flixel::util::FlxBitmapDataUtil_obj::matrix->rotate((bakedAngle * ((Float)::Math_obj::PI / (Float)(int)180)));
...
HXLINE(  17)		matrix =  ::flixel::math::FlxMatrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
            	}
}
