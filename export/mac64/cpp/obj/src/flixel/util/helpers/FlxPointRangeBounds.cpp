...
HX_DEFINE_STACK_FRAME(_hx_pos_473cc0ec95a2faaa_61_set,"flixel.util.helpers.FlxPointRangeBounds","set",0x02e07305,"flixel.util.helpers.FlxPointRangeBounds.set","flixel/util/helpers/FlxPointRangeBounds.hx",61,0x6e9a8e2e)
HX_DEFINE_STACK_FRAME(_hx_pos_473cc0ec95a2faaa_82_equals,"flixel.util.helpers.FlxPointRangeBounds","equals",0x60ba96bc,"flixel.util.helpers.FlxPointRangeBounds.equals","flixel/util/helpers/FlxPointRangeBounds.hx",82,0x6e9a8e2e)
HX_DEFINE_STACK_FRAME(_hx_pos_473cc0ec95a2faaa_93_toString,"flixel.util.helpers.FlxPointRangeBounds","toString",0x58cf5269,"flixel.util.helpers.FlxPointRangeBounds.toString","flixel/util/helpers/FlxPointRangeBounds.hx",93,0x6e9a8e2e)
HX_DEFINE_STACK_FRAME(_hx_pos_473cc0ec95a2faaa_105_destroy,"flixel.util.helpers.FlxPointRangeBounds","destroy",0x3271f1dd,"flixel.util.helpers.FlxPointRangeBounds.destroy","flixel/util/helpers/FlxPointRangeBounds.hx",105,0x6e9a8e2e)
namespace flixel{
namespace util{
namespace helpers{
...
HXLINE(  41)		HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN(  41)		point->_inPool = false;
HXDLIN(  41)		HX_VARI_NAME(  ::flixel::math::FlxPoint,point1,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN(  41)		point1->_inPool = false;
HXDLIN(  41)		this->start =  ::flixel::util::helpers::FlxBounds_obj::__alloc( HX_CTX ,point,point1);
HXLINE(  42)		HX_VARI_NAME(  ::flixel::math::FlxPoint,point2,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN(  42)		point2->_inPool = false;
HXDLIN(  42)		HX_VARI_NAME(  ::flixel::math::FlxPoint,point3,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN(  42)		point3->_inPool = false;
HXDLIN(  42)		this->end =  ::flixel::util::helpers::FlxBounds_obj::__alloc( HX_CTX ,point2,point3);
...
HXDLIN(  82)		HX_VARI(  ::flixel::math::FlxPoint,_this) = ( ( ::flixel::math::FlxPoint)(this->start->min) );
HXDLIN(  82)		HX_VARI(  ::flixel::math::FlxPoint,point) = ( ( ::flixel::math::FlxPoint)(OtherFlxPointRangeBounds->start->min) );
HXDLIN(  82)		HX_VAR( bool,result);
...
HXDLIN(  82)		if (result) {
HXLINE(  83)			HX_VARI_NAME(  ::flixel::math::FlxPoint,_this1,"_this") = ( ( ::flixel::math::FlxPoint)(this->start->max) );
HXDLIN(  83)			HX_VARI_NAME(  ::flixel::math::FlxPoint,point1,"point") = ( ( ::flixel::math::FlxPoint)(OtherFlxPointRangeBounds->start->max) );
HXDLIN(  83)			HX_VAR_NAME( bool,result1,"result");
...
HXLINE(  84)			HX_VARI_NAME(  ::flixel::math::FlxPoint,_this2,"_this") = ( ( ::flixel::math::FlxPoint)(this->end->min) );
HXDLIN(  84)			HX_VARI_NAME(  ::flixel::math::FlxPoint,point2,"point") = ( ( ::flixel::math::FlxPoint)(OtherFlxPointRangeBounds->end->min) );
HXDLIN(  84)			HX_VAR_NAME( bool,result2,"result");
...
HXLINE(  85)			HX_VARI_NAME(  ::flixel::math::FlxPoint,_this3,"_this") = ( ( ::flixel::math::FlxPoint)(this->end->max) );
HXDLIN(  85)			HX_VARI_NAME(  ::flixel::math::FlxPoint,point3,"point") = ( ( ::flixel::math::FlxPoint)(OtherFlxPointRangeBounds->end->max) );
HXDLIN(  85)			HX_VAR_NAME( bool,result3,"result");
...
HXDLIN(  94)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get();
...
HXDLIN(  95)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this1,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
...
HXDLIN(  96)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this2,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
...
HXDLIN(  97)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this3,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
...
HXDLIN(  98)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this4,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
...
HXDLIN(  99)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this5,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
...
HXDLIN( 100)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this6,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
...
HXDLIN( 101)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this7,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 101)		_this7->label = HX_("end.max.y",5c,97,de,72);
HXDLIN( 101)		_this7->value = value7;
HXLINE(  93)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(8)->init(0,_this)->init(1,_this1)->init(2,_this2)->init(3,_this3)->init(4,_this4)->init(5,_this5)->init(6,_this6)->init(7,_this7));
            	}
