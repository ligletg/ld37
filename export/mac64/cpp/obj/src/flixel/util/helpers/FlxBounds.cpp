...
HX_DEFINE_STACK_FRAME(_hx_pos_85edadf37d18a05f_43_set,"flixel.util.helpers.FlxBounds","set",0x7ac66c98,"flixel.util.helpers.FlxBounds.set","flixel/util/helpers/FlxBounds.hx",43,0x3d29a4bb)
HX_DEFINE_STACK_FRAME(_hx_pos_85edadf37d18a05f_57_equals,"flixel.util.helpers.FlxBounds","equals",0x1d409b09,"flixel.util.helpers.FlxBounds.equals","flixel/util/helpers/FlxBounds.hx",57,0x3d29a4bb)
HX_DEFINE_STACK_FRAME(_hx_pos_85edadf37d18a05f_65_toString,"flixel.util.helpers.FlxBounds","toString",0xc618c3f6,"flixel.util.helpers.FlxBounds.toString","flixel/util/helpers/FlxBounds.hx",65,0x3d29a4bb)
namespace flixel{
namespace util{
namespace helpers{
...
bool FlxBounds_obj::equals( ::flixel::util::helpers::FlxBounds otherBounds){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(otherBounds,"otherBounds")
HXLINE(  57)		if (hx::IsEq( this->min,otherBounds->min )) {
HXLINE(  57)			return hx::IsEq( this->max,otherBounds->max );
            		}
            		else {
...
HXDLIN(  66)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(  66)		_this->label = HX_("min",92,11,53,00);
HXDLIN(  66)		_this->value = value;
HXLINE(  67)		 ::Dynamic value1 = this->max;
HXDLIN(  67)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this1,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(  67)		_this1->label = HX_("max",a4,0a,53,00);
HXDLIN(  67)		_this1->value = value1;
HXLINE(  65)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(2)->init(0,_this)->init(1,_this1));
            	}
