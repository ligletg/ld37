...
HX_DEFINE_STACK_FRAME(_hx_pos_05e7652c5709bfbb_43_set,"flixel.util.helpers.FlxRange","set",0x6d2f1be2,"flixel.util.helpers.FlxRange.set","flixel/util/helpers/FlxRange.hx",43,0x9ab2f00f)
HX_DEFINE_STACK_FRAME(_hx_pos_05e7652c5709bfbb_58_equals,"flixel.util.helpers.FlxRange","equals",0x791915ff,"flixel.util.helpers.FlxRange.equals","flixel/util/helpers/FlxRange.hx",58,0x9ab2f00f)
HX_DEFINE_STACK_FRAME(_hx_pos_05e7652c5709bfbb_66_toString,"flixel.util.helpers.FlxRange","toString",0x253e686c,"flixel.util.helpers.FlxRange.toString","flixel/util/helpers/FlxRange.hx",66,0x9ab2f00f)
namespace flixel{
namespace util{
namespace helpers{
...
HXDLIN(  67)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(  67)		_this->label = HX_("start",62,74,0b,84);
HXDLIN(  67)		_this->value = value;
HXLINE(  68)		 ::Dynamic value1 = this->end;
HXDLIN(  68)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this1,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
