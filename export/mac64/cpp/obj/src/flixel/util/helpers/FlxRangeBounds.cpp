...
HX_DEFINE_STACK_FRAME(_hx_pos_2994a453e9fce1dd_49_set,"flixel.util.helpers.FlxRangeBounds","set",0x191e7b77,"flixel.util.helpers.FlxRangeBounds.set","flixel/util/helpers/FlxRangeBounds.hx",49,0xa540535a)
HX_DEFINE_STACK_FRAME(_hx_pos_2994a453e9fce1dd_66_equals,"flixel.util.helpers.FlxRangeBounds","equals",0xda4be18a,"flixel.util.helpers.FlxRangeBounds.equals","flixel/util/helpers/FlxRangeBounds.hx",66,0xa540535a)
HX_DEFINE_STACK_FRAME(_hx_pos_2994a453e9fce1dd_74_toString,"flixel.util.helpers.FlxRangeBounds","toString",0x51636cb7,"flixel.util.helpers.FlxRangeBounds.toString","flixel/util/helpers/FlxRangeBounds.hx",74,0xa540535a)
namespace flixel{
namespace util{
namespace helpers{
...
HXDLIN(  75)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(  75)		_this->label = HX_("start.min",86,2f,d5,ec);
HXDLIN(  75)		_this->value = value;
HXLINE(  76)		 ::Dynamic value1 = this->start->min;
HXDLIN(  76)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this1,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(  76)		_this1->label = HX_("start.max",98,28,d5,ec);
HXDLIN(  76)		_this1->value = value1;
HXLINE(  77)		 ::Dynamic value2 = this->end->min;
HXDLIN(  77)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this2,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(  77)		_this2->label = HX_("end.min",7f,6f,06,16);
HXDLIN(  77)		_this2->value = value2;
HXLINE(  78)		 ::Dynamic value3 = this->end->max;
HXDLIN(  78)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this3,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
