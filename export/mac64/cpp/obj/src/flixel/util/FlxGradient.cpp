...
HX_DEFINE_STACK_FRAME(_hx_pos_5278df5c1114b3d6_26_createGradientMatrix,"flixel.util.FlxGradient","createGradientMatrix",0x11545e53,"flixel.util.FlxGradient.createGradientMatrix","flixel/util/FlxGradient.hx",26,0x5a5037d6)
HX_DEFINE_STACK_FRAME(_hx_pos_5278df5c1114b3d6_70_createGradientArray,"flixel.util.FlxGradient","createGradientArray",0xc5836dc7,"flixel.util.FlxGradient.createGradientArray","flixel/util/FlxGradient.hx",70,0x5a5037d6)
HX_DEFINE_STACK_FRAME(_hx_pos_5278df5c1114b3d6_95_createGradientFlxSprite,"flixel.util.FlxGradient","createGradientFlxSprite",0xca14a545,"flixel.util.FlxGradient.createGradientFlxSprite","flixel/util/FlxGradient.hx",95,0x5a5037d6)
HX_DEFINE_STACK_FRAME(_hx_pos_5278df5c1114b3d6_104_createGradientBitmapData,"flixel.util.FlxGradient","createGradientBitmapData",0xa3b74ecb,"flixel.util.FlxGradient.createGradientBitmapData","flixel/util/FlxGradient.hx",104,0x5a5037d6)
HX_DEFINE_STACK_FRAME(_hx_pos_5278df5c1114b3d6_163_overlayGradientOnFlxSprite,"flixel.util.FlxGradient","overlayGradientOnFlxSprite",0xe400659e,"flixel.util.FlxGradient.overlayGradientOnFlxSprite","flixel/util/FlxGradient.hx",163,0x5a5037d6)
HX_DEFINE_STACK_FRAME(_hx_pos_5278df5c1114b3d6_197_overlayGradientOnBitmapData,"flixel.util.FlxGradient","overlayGradientOnBitmapData",0x3813dc52,"flixel.util.FlxGradient.overlayGradientOnBitmapData","flixel/util/FlxGradient.hx",197,0x5a5037d6)
namespace flixel{
namespace util{
...
HXLINE(  27)		HX_VARI(  ::openfl::_legacy::geom::Matrix,gradientMatrix) =  ::openfl::_legacy::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
...
HXDLIN(  33)		gradientMatrix->createGradientBox(width,((Float)_hx_tmp / (Float)_hx_tmp1),(rotation * ((Float)::Math_obj::PI / (Float)(int)180)),(int)0,(int)0);
...
HXLINE(  40)				alpha->push(((Float)((int)((int)colors->__get((_g1 - (int)1)) >> (int)(int)24) & (int)(int)255) / (Float)(int)255));
            			}
            		}
...
HXLINE(  53)			HX_VARI( int,spread) = ::Std_obj::_hx_int(((Float)(int)255 / (Float)(colors->length - (int)1)));
...
HXLINE(  59)					ratio->push(((_g11 - (int)1) * spread));
            				}
            			}
...
HXLINE(  76)				result->push(data->getPixel32((int)0,(_g1 - (int)1)));
            			}
            		}
...
HXLINE(  97)		HX_VARI(  ::flixel::FlxSprite,dest) =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null());
...
HXDLIN( 106)		if ((false != (width < (int)0))) {
...
HXDLIN( 111)		if ((false != (height < (int)0))) {
...
HXLINE( 117)		HX_VARI(  ::openfl::_legacy::display::Shape,shape) =  ::openfl::_legacy::display::Shape_obj::__alloc( HX_CTX );
HXLINE( 118)		HX_VAR(  ::openfl::_legacy::display::InterpolationMethod,interpolationMethod);
...
HXLINE( 125)		HX_VARI(  ::openfl::_legacy::display::BitmapData,data) =  ::openfl::_legacy::display::BitmapData_obj::__alloc( HX_CTX ,width,height,true,(int)0,null());
...
HXDLIN( 133)			HX_VARI_NAME(  ::openfl::_legacy::display::Bitmap,tempBitmap2,"tempBitmap") =  ::openfl::_legacy::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::_legacy::display::BitmapData_obj::__alloc( HX_CTX ,width,::Std_obj::_hx_int(((Float)tempBitmap / (Float)tempBitmap1)),true,(int)0,null()),null(),null());
...
HXLINE( 137)			HX_VARI(  ::openfl::_legacy::geom::Matrix,sM) =  ::openfl::_legacy::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
...
HXDLIN( 209)		int _hx_tmp1 = source->get_height();
HXDLIN( 209)		dest->copyPixels(source, ::openfl::_legacy::geom::Rectangle_obj::__alloc( HX_CTX ,(int)0,(int)0,_hx_tmp,_hx_tmp1), ::openfl::_legacy::geom::Point_obj::__alloc( HX_CTX ,destX,destY),null(),null(),true);
