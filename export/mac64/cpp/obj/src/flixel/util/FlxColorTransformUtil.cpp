...
HX_DEFINE_STACK_FRAME(_hx_pos_01a1e505d1c84d1c_9_setMultipliers,"flixel.util.FlxColorTransformUtil","setMultipliers",0x2ef980db,"flixel.util.FlxColorTransformUtil.setMultipliers","flixel/util/FlxColorTransformUtil.hx",9,0xf5538e7b)
HX_DEFINE_STACK_FRAME(_hx_pos_01a1e505d1c84d1c_20_setOffsets,"flixel.util.FlxColorTransformUtil","setOffsets",0xbbc06809,"flixel.util.FlxColorTransformUtil.setOffsets","flixel/util/FlxColorTransformUtil.hx",20,0xf5538e7b)
HX_DEFINE_STACK_FRAME(_hx_pos_01a1e505d1c84d1c_34_hasRGBMultipliers,"flixel.util.FlxColorTransformUtil","hasRGBMultipliers",0xd2859e14,"flixel.util.FlxColorTransformUtil.hasRGBMultipliers","flixel/util/FlxColorTransformUtil.hx",34,0xf5538e7b)
HX_DEFINE_STACK_FRAME(_hx_pos_01a1e505d1c84d1c_42_hasRGBAMultipliers,"flixel.util.FlxColorTransformUtil","hasRGBAMultipliers",0xfe0e906f,"flixel.util.FlxColorTransformUtil.hasRGBAMultipliers","flixel/util/FlxColorTransformUtil.hx",42,0xf5538e7b)
HX_DEFINE_STACK_FRAME(_hx_pos_01a1e505d1c84d1c_50_hasRGBOffsets,"flixel.util.FlxColorTransformUtil","hasRGBOffsets",0x81d534c2,"flixel.util.FlxColorTransformUtil.hasRGBOffsets","flixel/util/FlxColorTransformUtil.hx",50,0xf5538e7b)
HX_DEFINE_STACK_FRAME(_hx_pos_01a1e505d1c84d1c_58_hasRGBAOffsets,"flixel.util.FlxColorTransformUtil","hasRGBAOffsets",0xc8891d9d,"flixel.util.FlxColorTransformUtil.hasRGBAOffsets","flixel/util/FlxColorTransformUtil.hx",58,0xf5538e7b)
namespace flixel{
namespace util{
...
HXLINE(  34)			_hx_tmp = (transform->greenMultiplier != (int)1);
            		}
            		else {
HXLINE(  34)			_hx_tmp = true;
            		}
HXDLIN(  34)		if (!(_hx_tmp)) {
HXLINE(  34)			return (transform->blueMultiplier != (int)1);
            		}
            		else {
...
bool FlxColorTransformUtil_obj::hasRGBAMultipliers( ::openfl::_legacy::geom::ColorTransform transform){
            	...
            	HX_STACK_ARG(transform,"transform")
HXLINE(  42)		if (!(::flixel::util::FlxColorTransformUtil_obj::hasRGBMultipliers(transform))) {
HXLINE(  42)			return (transform->alphaMultiplier != (int)1);
            		}
            		else {
...
HXLINE(  50)			_hx_tmp = (transform->greenOffset != (int)0);
            		}
            		else {
HXLINE(  50)			_hx_tmp = true;
            		}
HXDLIN(  50)		if (!(_hx_tmp)) {
HXLINE(  50)			return (transform->blueOffset != (int)0);
            		}
            		else {
...
bool FlxColorTransformUtil_obj::hasRGBAOffsets( ::openfl::_legacy::geom::ColorTransform transform){
            	...
            	HX_STACK_ARG(transform,"transform")
HXLINE(  58)		if (!(::flixel::util::FlxColorTransformUtil_obj::hasRGBOffsets(transform))) {
HXLINE(  58)			return (transform->alphaOffset != (int)0);
            		}
            		else {
