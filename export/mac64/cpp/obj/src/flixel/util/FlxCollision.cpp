...
HXLINE( 109)		HX_VARI(  ::openfl::_legacy::display::BitmapData,testA) = Contact->framePixels;
HXLINE( 110)		HX_VARI(  ::openfl::_legacy::display::BitmapData,testB) = Target->framePixels;
...
HXLINE( 130)			HX_VARI(  ::openfl::_legacy::display::BitmapData,testA2) = ::flixel::util::FlxBitmapDataPool_obj::get(::Math_obj::floor(::flixel::util::FlxCollision_obj::boundsA->width),::Math_obj::floor(::flixel::util::FlxCollision_obj::boundsA->height),true,(int)0,false);
...
HXLINE( 142)			HX_VARI(  ::openfl::_legacy::display::BitmapData,testB2) = ::flixel::util::FlxBitmapDataPool_obj::get(::Math_obj::floor(::flixel::util::FlxCollision_obj::boundsB->width),::Math_obj::floor(::flixel::util::FlxCollision_obj::boundsB->height),true,(int)0,false);
...
HXDLIN( 157)			HX_VARI(  ::openfl::_legacy::geom::Rectangle,FlashRect) = ::flixel::util::FlxCollision_obj::flashRect;
...
HXLINE( 158)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,pixelsA) = testA->getPixels(::flixel::util::FlxCollision_obj::flashRect);
HXLINE( 160)		{
HXLINE( 160)			HX_VARI_NAME(  ::flixel::math::FlxRect,_this5,"_this") = ::flixel::util::FlxCollision_obj::boundsB;
HXDLIN( 160)			HX_VARI_NAME(  ::openfl::_legacy::geom::Rectangle,FlashRect1,"FlashRect") = ::flixel::util::FlxCollision_obj::flashRect;
...
HXLINE( 161)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,pixelsB) = testB->getPixels(::flixel::util::FlxCollision_obj::flashRect);
...
HXLINE(  35)		flashRect =  ::openfl::_legacy::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            	}
}
