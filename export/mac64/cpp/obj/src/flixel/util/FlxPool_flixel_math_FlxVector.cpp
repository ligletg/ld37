...
HX_DEFINE_STACK_FRAME(_hx_pos_f5296e3067081a4b_12_new,"flixel.util.FlxPool_flixel_math_FlxVector","new",0xff321b68,"flixel.util.FlxPool_flixel_math_FlxVector.new","flixel/util/FlxPool.hx",12,0xdd4de86a)
HX_DEFINE_STACK_FRAME(_hx_pos_f5296e3067081a4b_31_get,"flixel.util.FlxPool_flixel_math_FlxVector","get",0xff2ccb9e,"flixel.util.FlxPool_flixel_math_FlxVector.get","flixel/util/FlxPool.hx",31,0xdd4de86a)
HX_DEFINE_STACK_FRAME(_hx_pos_f5296e3067081a4b_42_put,"flixel.util.FlxPool_flixel_math_FlxVector","put",0xff33add7,"flixel.util.FlxPool_flixel_math_FlxVector.put","flixel/util/FlxPool.hx",42,0xdd4de86a)
HX_DEFINE_STACK_FRAME(_hx_pos_f5296e3067081a4b_56_putUnsafe,"flixel.util.FlxPool_flixel_math_FlxVector","putUnsafe",0x73f1215d,"flixel.util.FlxPool_flixel_math_FlxVector.putUnsafe","flixel/util/FlxPool.hx",56,0xdd4de86a)
HX_DEFINE_STACK_FRAME(_hx_pos_f5296e3067081a4b_65_preAllocate,"flixel.util.FlxPool_flixel_math_FlxVector","preAllocate",0x047fdd08,"flixel.util.FlxPool_flixel_math_FlxVector.preAllocate","flixel/util/FlxPool.hx",65,0xdd4de86a)
HX_DEFINE_STACK_FRAME(_hx_pos_f5296e3067081a4b_72_clear,"flixel.util.FlxPool_flixel_math_FlxVector","clear",0x73a88e95,"flixel.util.FlxPool_flixel_math_FlxVector.clear","flixel/util/FlxPool.hx",72,0xdd4de86a)
HX_DEFINE_STACK_FRAME(_hx_pos_f5296e3067081a4b_81_get_length,"flixel.util.FlxPool_flixel_math_FlxVector","get_length",0xd973aaa7,"flixel.util.FlxPool_flixel_math_FlxVector.get_length","flixel/util/FlxPool.hx",81,0xdd4de86a)
namespace flixel{
namespace util{

void FlxPool_flixel_math_FlxVector_obj::__construct(hx::Class classObj){
            	HX_STACKFRAME(&_hx_pos_f5296e3067081a4b_12_new)
            	HX_STACK_THIS(this)
...
void *FlxPool_flixel_math_FlxVector_obj::_hx_vtable = 0;
...
bool FlxPool_flixel_math_FlxVector_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x30a9aef2;
}
...
void *FlxPool_flixel_math_FlxVector_obj::_hx_getInterface(int inHash) {
 ...
 ::flixel::math::FlxVector FlxPool_flixel_math_FlxVector_obj::get(){
            	HX_STACKFRAME(&_hx_pos_f5296e3067081a4b_31_get)
            	HX_STACK_THIS(this)
...
void FlxPool_flixel_math_FlxVector_obj::put( ::flixel::math::FlxVector obj){
            	HX_STACKFRAME(&_hx_pos_f5296e3067081a4b_42_put)
            	HX_STACK_THIS(this)
...
void FlxPool_flixel_math_FlxVector_obj::putUnsafe( ::flixel::math::FlxVector obj){
            	HX_STACKFRAME(&_hx_pos_f5296e3067081a4b_56_putUnsafe)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(obj,"obj")
...
void FlxPool_flixel_math_FlxVector_obj::preAllocate(int numObjects){
            	HX_STACKFRAME(&_hx_pos_f5296e3067081a4b_65_preAllocate)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(numObjects,"numObjects")
HXLINE(  65)		while(true){
HXLINE(  65)			numObjects = (numObjects - (int)1);
HXDLIN(  65)			if (!(((numObjects + (int)1) > (int)0))) {
HXLINE(  65)				goto _hx_goto_4;
            			}
HXLINE(  67)			this->_pool[this->_count++] = ( ( ::flixel::math::FlxVector)(::Type_obj::createInstance(this->_class,::cpp::VirtualArray_obj::__new(0))) );
            		}
            		_hx_goto_4:;
            	}
...
::Array< ::Dynamic> FlxPool_flixel_math_FlxVector_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_f5296e3067081a4b_72_clear)
            	HX_STACK_THIS(this)
...
int FlxPool_flixel_math_FlxVector_obj::get_length(){
            	HX_STACKFRAME(&_hx_pos_f5296e3067081a4b_81_get_length)
            	HX_STACK_THIS(this)
...
hx::ObjectPtr< FlxPool_flixel_math_FlxVector_obj > FlxPool_flixel_math_FlxVector_obj::__new(hx::Class classObj) {
	hx::ObjectPtr< FlxPool_flixel_math_FlxVector_obj > __this = new FlxPool_flixel_math_FlxVector_obj();
	__this->__construct(classObj);
	return __this;
}

hx::ObjectPtr< FlxPool_flixel_math_FlxVector_obj > FlxPool_flixel_math_FlxVector_obj::__alloc(hx::Ctx *_hx_ctx,hx::Class classObj) {
	FlxPool_flixel_math_FlxVector_obj *__this = (FlxPool_flixel_math_FlxVector_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(FlxPool_flixel_math_FlxVector_obj), true, "flixel.util.FlxPool_flixel_math_FlxVector"));
	*(void **)__this = FlxPool_flixel_math_FlxVector_obj::_hx_vtable;
	__this->__construct(classObj);
	return __this;
}
...
{
	hx::Object *dummy = new FlxPool_flixel_math_FlxVector_obj;
	FlxPool_flixel_math_FlxVector_obj::_hx_vtable = *(void **)dummy;
