...
HX_DEFINE_STACK_FRAME(_hx_pos_53443e31a49e57d3_615_create,"flixel.util.LabelValuePair","create",0x3da24a39,"flixel.util.LabelValuePair.create","flixel/util/FlxStringUtil.hx",615,0x4e012e33)
HX_DEFINE_STACK_FRAME(_hx_pos_53443e31a49e57d3_623_put,"flixel.util.LabelValuePair","put",0x8e76c772,"flixel.util.LabelValuePair.put","flixel/util/FlxStringUtil.hx",623,0x4e012e33)
HX_DEFINE_STACK_FRAME(_hx_pos_53443e31a49e57d3_627_destroy,"flixel.util.LabelValuePair","destroy",0xc37a1f1d,"flixel.util.LabelValuePair.destroy","flixel/util/FlxStringUtil.hx",627,0x4e012e33)
HX_DEFINE_STACK_FRAME(_hx_pos_53443e31a49e57d3_608_weak,"flixel.util.LabelValuePair","weak",0x1e0c0675,"flixel.util.LabelValuePair.weak","flixel/util/FlxStringUtil.hx",608,0x4e012e33)
HX_DEFINE_STACK_FRAME(_hx_pos_53443e31a49e57d3_604_boot,"flixel.util.LabelValuePair","boot",0x10322e2f,"flixel.util.LabelValuePair.boot","flixel/util/FlxStringUtil.hx",604,0x4e012e33)
namespace flixel{
namespace util{
...
void LabelValuePair_obj::put(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 623)		::flixel::util::LabelValuePair_obj::_pool->put(hx::ObjectPtr<OBJ_>(this));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(LabelValuePair_obj,destroy,(void))
 ...
 ::flixel::util::LabelValuePair LabelValuePair_obj::weak(::String label, ::Dynamic value){
            	...
            	HX_STACK_ARG(label,"label")
            	HX_STACK_ARG(value,"value")
HXLINE( 608)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get();
...
HXLINE( 604)		_pool =  ::flixel::util::FlxPool_flixel_util_LabelValuePair_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::util::LabelValuePair >());
            	}
}
