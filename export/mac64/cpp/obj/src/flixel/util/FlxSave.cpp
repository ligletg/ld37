...
HX_DEFINE_STACK_FRAME(_hx_pos_2a670326751daced_43_destroy,"flixel.util.FlxSave","destroy",0x7bc03d21,"flixel.util.FlxSave.destroy","flixel/util/FlxSave.hx",43,0xc43cd0a9)
HX_DEFINE_STACK_FRAME(_hx_pos_2a670326751daced_59_bind,"flixel.util.FlxSave","bind",0x8d6a5736,"flixel.util.FlxSave.bind","flixel/util/FlxSave.hx",59,0xc43cd0a9)
HX_DEFINE_STACK_FRAME(_hx_pos_2a670326751daced_86_close,"flixel.util.FlxSave","close",0xc505001f,"flixel.util.FlxSave.close","flixel/util/FlxSave.hx",86,0xc43cd0a9)
HX_DEFINE_STACK_FRAME(_hx_pos_2a670326751daced_99_flush,"flixel.util.FlxSave","flush",0x7f3d4b2b,"flixel.util.FlxSave.flush","flixel/util/FlxSave.hx",99,0xc43cd0a9)
HX_DEFINE_STACK_FRAME(_hx_pos_2a670326751daced_126_erase,"flixel.util.FlxSave","erase",0xefbed14d,"flixel.util.FlxSave.erase","flixel/util/FlxSave.hx",126,0xc43cd0a9)
HX_DEFINE_STACK_FRAME(_hx_pos_2a670326751daced_144_onDone,"flixel.util.FlxSave","onDone",0x76016afa,"flixel.util.FlxSave.onDone","flixel/util/FlxSave.hx",144,0xc43cd0a9)
HX_DEFINE_STACK_FRAME(_hx_pos_2a670326751daced_169_checkBinding,"flixel.util.FlxSave","checkBinding",0xf0eb45d6,"flixel.util.FlxSave.checkBinding","flixel/util/FlxSave.hx",169,0xc43cd0a9)
namespace flixel{
namespace util{
...
HXLINE( 105)		HX_VARI(  ::Dynamic,result) = null();
HXLINE( 106)		try {
            			HX_STACK_CATCHABLE( ::openfl::errors::Error, 0);
...
HXLINE( 155)			this->_onComplete(hx::IsEq( Result,::flixel::util::FlxSaveStatus_obj::SUCCESS_dyn() ));
            		}
