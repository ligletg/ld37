...
HX_DEFINE_STACK_FRAME(_hx_pos_dc7d302d1976d073_31_get,"flixel.util.FlxPool_flixel_effects_FlxFlicker","get",0xff19dc43,"flixel.util.FlxPool_flixel_effects_FlxFlicker.get","flixel/util/FlxPool.hx",31,0xdd4de86a)
HX_DEFINE_STACK_FRAME(_hx_pos_dc7d302d1976d073_42_put,"flixel.util.FlxPool_flixel_effects_FlxFlicker","put",0xff20be7c,"flixel.util.FlxPool_flixel_effects_FlxFlicker.put","flixel/util/FlxPool.hx",42,0xdd4de86a)
HX_DEFINE_STACK_FRAME(_hx_pos_dc7d302d1976d073_56_putUnsafe,"flixel.util.FlxPool_flixel_effects_FlxFlicker","putUnsafe",0xc85fbbc2,"flixel.util.FlxPool_flixel_effects_FlxFlicker.putUnsafe","flixel/util/FlxPool.hx",56,0xdd4de86a)
HX_DEFINE_STACK_FRAME(_hx_pos_dc7d302d1976d073_65_preAllocate,"flixel.util.FlxPool_flixel_effects_FlxFlicker","preAllocate",0x45959aad,"flixel.util.FlxPool_flixel_effects_FlxFlicker.preAllocate","flixel/util/FlxPool.hx",65,0xdd4de86a)
HX_DEFINE_STACK_FRAME(_hx_pos_dc7d302d1976d073_72_clear,"flixel.util.FlxPool_flixel_effects_FlxFlicker","clear",0x1576d27a,"flixel.util.FlxPool_flixel_effects_FlxFlicker.clear","flixel/util/FlxPool.hx",72,0xdd4de86a)
HX_DEFINE_STACK_FRAME(_hx_pos_dc7d302d1976d073_81_get_length,"flixel.util.FlxPool_flixel_effects_FlxFlicker","get_length",0x65cc28a2,"flixel.util.FlxPool_flixel_effects_FlxFlicker.get_length","flixel/util/FlxPool.hx",81,0xdd4de86a)
namespace flixel{
namespace util{
...
bool FlxPool_flixel_effects_FlxFlicker_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x433db717;
}
...
static ::flixel::util::IFlxPool_obj _hx_flixel_util_FlxPool_flixel_effects_FlxFlicker__hx_flixel_util_IFlxPool= {
	...
	( ::cpp::VirtualArray (hx::Object::*)())&::flixel::util::FlxPool_flixel_effects_FlxFlicker_obj::clear_615cc599,
};

::cpp::VirtualArray FlxPool_flixel_effects_FlxFlicker_obj::clear_615cc599() {
			return clear();
}
...
static void FlxPool_flixel_effects_FlxFlicker_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(FlxPool_flixel_effects_FlxFlicker_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void FlxPool_flixel_effects_FlxFlicker_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new FlxPool_flixel_effects_FlxFlicker_obj;
	FlxPool_flixel_effects_FlxFlicker_obj::_hx_vtable = *(void **)dummy;
	...
	__mClass->mMarkFunc = FlxPool_flixel_effects_FlxFlicker_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = FlxPool_flixel_effects_FlxFlicker_obj_sVisitStatics;
#endif
#ifdef HXCPP_SCRIPTABLE
