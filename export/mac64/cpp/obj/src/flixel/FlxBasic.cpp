...
HX_DEFINE_STACK_FRAME(_hx_pos_a86a375242b5e1cf_103_update,"flixel.FlxBasic","update",0x307e9d29,"flixel.FlxBasic.update","flixel/FlxBasic.hx",103,0xd8d6cfcf)
HX_DEFINE_STACK_FRAME(_hx_pos_a86a375242b5e1cf_114_draw,"flixel.FlxBasic","draw",0x12af3b24,"flixel.FlxBasic.draw","flixel/FlxBasic.hx",114,0xd8d6cfcf)
...
HX_DEFINE_STACK_FRAME(_hx_pos_a86a375242b5e1cf_17_boot,"flixel.FlxBasic","boot",0x115a9352,"flixel.FlxBasic.boot","flixel/FlxBasic.hx",17,0xd8d6cfcf)
HX_DEFINE_STACK_FRAME(_hx_pos_a86a375242b5e1cf_19_boot,"flixel.FlxBasic","boot",0x115a9352,"flixel.FlxBasic.boot","flixel/FlxBasic.hx",19,0xd8d6cfcf)
namespace flixel{
...
HXDLIN( 121)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 121)		_this->label = HX_("active",c6,41,46,16);
HXDLIN( 121)		_this->value = value;
HXLINE( 122)		 ::Dynamic value1 = this->visible;
HXDLIN( 122)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this1,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 122)		_this1->label = HX_("visible",72,78,24,a3);
HXDLIN( 122)		_this1->value = value1;
HXLINE( 123)		 ::Dynamic value2 = this->alive;
HXDLIN( 123)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this2,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 123)		_this2->label = HX_("alive",cd,63,91,21);
HXDLIN( 123)		_this2->value = value2;
HXLINE( 124)		 ::Dynamic value3 = this->exists;
HXDLIN( 124)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this3,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
