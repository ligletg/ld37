...
HX_DEFINE_STACK_FRAME(_hx_pos_4f421a3440b44d31_10_new,"flixel.FlxSubState","new",0xef991343,"flixel.FlxSubState.new","flixel/FlxSubState.hx",10,0xd8a3e54e)
HX_DEFINE_STACK_FRAME(_hx_pos_4f421a3440b44d31_53_draw,"flixel.FlxSubState","draw",0xafc56fc1,"flixel.FlxSubState.draw","flixel/FlxSubState.hx",53,0xd8a3e54e)
HX_DEFINE_STACK_FRAME(_hx_pos_4f421a3440b44d31_72_destroy,"flixel.FlxSubState","destroy",0xc08a1d5d,"flixel.FlxSubState.destroy","flixel/FlxSubState.hx",72,0xd8a3e54e)
HX_DEFINE_STACK_FRAME(_hx_pos_4f421a3440b44d31_84_close,"flixel.FlxSubState","close",0x85a9195b,"flixel.FlxSubState.close","flixel/FlxSubState.hx",84,0xd8a3e54e)
HX_DEFINE_STACK_FRAME(_hx_pos_4f421a3440b44d31_93_get_bgColor,"flixel.FlxSubState","get_bgColor",0x02e53f58,"flixel.FlxSubState.get_bgColor","flixel/FlxSubState.hx",93,0xd8a3e54e)
HX_DEFINE_STACK_FRAME(_hx_pos_4f421a3440b44d31_98_set_bgColor,"flixel.FlxSubState","set_bgColor",0x0d524664,"flixel.FlxSubState.set_bgColor","flixel/FlxSubState.hx",98,0xd8a3e54e)
namespace flixel{

void FlxSubState_obj::__construct(hx::Null< int >  __o_BGColor){
int BGColor = __o_BGColor.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_4f421a3440b44d31_10_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(BGColor,"BGColor")
HXLINE(  35)		this->_created = false;
HXLINE(  42)		super::__construct(null());
HXLINE(  43)		this->closeCallback = null();
HXLINE(  45)		if (::flixel::FlxG_obj::renderTile) {
HXLINE(  47)			this->_bgSprite =  ::flixel::_hx_system::FlxBGSprite_obj::__alloc( HX_CTX );
            		}
HXLINE(  49)		this->set_bgColor(BGColor);
            	}
...
void FlxSubState_obj::draw(){
            	HX_STACKFRAME(&_hx_pos_4f421a3440b44d31_53_draw)
            	HX_STACK_THIS(this)
HXLINE(  55)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(  57)			HX_VARI( int,_g) = (int)0;
HXDLIN(  57)			HX_VARI( ::Array< ::Dynamic>,_g1) = this->get_cameras();
HXDLIN(  57)			while((_g < _g1->length)){
HXLINE(  57)				HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN(  57)				_g = (_g + (int)1);
HXLINE(  59)				camera->fill(this->_bgColor,null(),null(),null());
            			}
            		}
            		else {
HXLINE(  64)			this->_bgSprite->draw();
            		}
...
void FlxSubState_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_4f421a3440b44d31_72_destroy)
            	HX_STACK_THIS(this)
HXLINE(  73)		this->super::destroy();
HXLINE(  74)		this->closeCallback = null();
HXLINE(  75)		this->_parentState = null();
HXLINE(  76)		this->_bgSprite = null();
            	}


void FlxSubState_obj::close(){
            	HX_STACKFRAME(&_hx_pos_4f421a3440b44d31_84_close)
            	HX_STACK_THIS(this)
HXLINE(  84)		bool _hx_tmp;
HXDLIN(  84)		if (hx::IsNotNull( this->_parentState )) {
HXLINE(  84)			_hx_tmp = hx::IsEq( this->_parentState->subState,hx::ObjectPtr<OBJ_>(this) );
            		}
            		else {
HXLINE(  84)			_hx_tmp = false;
            		}
HXDLIN(  84)		if (_hx_tmp) {
HXLINE(  86)			this->_parentState->closeSubState();
            		}
            	}
...
int FlxSubState_obj::get_bgColor(){
            	HX_STACKFRAME(&_hx_pos_4f421a3440b44d31_93_get_bgColor)
            	HX_STACK_THIS(this)
HXLINE(  93)		return this->_bgColor;
            	}


int FlxSubState_obj::set_bgColor(int Value){
            	HX_STACKFRAME(&_hx_pos_4f421a3440b44d31_98_set_bgColor)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
HXLINE(  99)		bool _hx_tmp;
HXDLIN(  99)		if (::flixel::FlxG_obj::renderTile) {
HXLINE(  99)			_hx_tmp = hx::IsNotNull( this->_bgSprite );
            		}
            		else {
HXLINE(  99)			_hx_tmp = false;
            		}
HXDLIN(  99)		if (_hx_tmp) {
HXLINE( 100)			this->_bgSprite->get_pixels()->setPixel32((int)0,(int)0,Value);
            		}
HXLINE( 102)		return (this->_bgColor = Value);
            	}
...
{
	hx::Object *dummy = new FlxSubState_obj;
	FlxSubState_obj::_hx_vtable = *(void **)dummy;
