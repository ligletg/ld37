...
HX_DEFINE_STACK_FRAME(_hx_pos_3c0477ee7bfdb1b1_1_boot,"flixel.system.debug.GraphicWatch","boot",0x91b6ddd1,"flixel.system.debug.GraphicWatch.boot","?",1,0x0000003f)
namespace flixel{
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::GraphicWatch_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_GraphicWatch",66,8f,5d,86);
            	}
}
