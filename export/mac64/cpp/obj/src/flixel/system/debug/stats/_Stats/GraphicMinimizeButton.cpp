...
HX_DEFINE_STACK_FRAME(_hx_pos_5800a68c299b2399_1_boot,"flixel.system.debug.stats._Stats.GraphicMinimizeButton","boot",0x04ed3cdf,"flixel.system.debug.stats._Stats.GraphicMinimizeButton.boot","?",1,0x0000003f)
namespace flixel{
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::stats::_Stats::GraphicMinimizeButton_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_stats__Stats_GraphicMinimizeButton",38,20,46,56);
            	}
}
