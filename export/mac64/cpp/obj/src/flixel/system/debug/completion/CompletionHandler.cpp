...
HX_DEFINE_STACK_FRAME(_hx_pos_d4c828664754b74a_34_getTextUntilCaret,"flixel.system.debug.completion.CompletionHandler","getTextUntilCaret",0x57018dfe,"flixel.system.debug.completion.CompletionHandler.getTextUntilCaret","flixel/system/debug/completion/CompletionHandler.hx",34,0x776a5e1a)
HX_DEFINE_STACK_FRAME(_hx_pos_d4c828664754b74a_41_getCaretIndex,"flixel.system.debug.completion.CompletionHandler","getCaretIndex",0x5ae25f7b,"flixel.system.debug.completion.CompletionHandler.getCaretIndex","flixel/system/debug/completion/CompletionHandler.hx",41,0x776a5e1a)
HX_DEFINE_STACK_FRAME(_hx_pos_d4c828664754b74a_48_onKeyUp,"flixel.system.debug.completion.CompletionHandler","onKeyUp",0x7f599871,"flixel.system.debug.completion.CompletionHandler.onKeyUp","flixel/system/debug/completion/CompletionHandler.hx",48,0x776a5e1a)
HX_DEFINE_STACK_FRAME(_hx_pos_d4c828664754b74a_75_invokeCompletion,"flixel.system.debug.completion.CompletionHandler","invokeCompletion",0x74f655be,"flixel.system.debug.completion.CompletionHandler.invokeCompletion","flixel/system/debug/completion/CompletionHandler.hx",75,0x776a5e1a)
HX_DEFINE_STACK_FRAME(_hx_pos_d4c828664754b74a_111_getGlobals,"flixel.system.debug.completion.CompletionHandler","getGlobals",0x3af6d144,"flixel.system.debug.completion.CompletionHandler.getGlobals","flixel/system/debug/completion/CompletionHandler.hx",111,0x776a5e1a)
HX_DEFINE_STACK_FRAME(_hx_pos_d4c828664754b74a_116_getCharXPosition,"flixel.system.debug.completion.CompletionHandler","getCharXPosition",0x2e5e3e1f,"flixel.system.debug.completion.CompletionHandler.getCharXPosition","flixel/system/debug/completion/CompletionHandler.hx",116,0x776a5e1a)
HX_DEFINE_STACK_FRAME(_hx_pos_d4c828664754b74a_126_getCompletedText,"flixel.system.debug.completion.CompletionHandler","getCompletedText",0xf1336e6c,"flixel.system.debug.completion.CompletionHandler.getCompletedText","flixel/system/debug/completion/CompletionHandler.hx",126,0x776a5e1a)
HX_DEFINE_STACK_FRAME(_hx_pos_d4c828664754b74a_130_completed,"flixel.system.debug.completion.CompletionHandler","completed",0x0b4edb41,"flixel.system.debug.completion.CompletionHandler.completed","flixel/system/debug/completion/CompletionHandler.hx",130,0x776a5e1a)
HX_DEFINE_STACK_FRAME(_hx_pos_d4c828664754b74a_138_selectionChanged,"flixel.system.debug.completion.CompletionHandler","selectionChanged",0xb4bbcb12,"flixel.system.debug.completion.CompletionHandler.selectionChanged","flixel/system/debug/completion/CompletionHandler.hx",138,0x776a5e1a)
HX_DEFINE_STACK_FRAME(_hx_pos_d4c828664754b74a_154_completionClosed,"flixel.system.debug.completion.CompletionHandler","completionClosed",0xa9f12ef2,"flixel.system.debug.completion.CompletionHandler.completionClosed","flixel/system/debug/completion/CompletionHandler.hx",154,0x776a5e1a)
HX_DEFINE_STACK_FRAME(_hx_pos_d4c828664754b74a_163_getPathBeforeDot,"flixel.system.debug.completion.CompletionHandler","getPathBeforeDot",0x9fcc8f79,"flixel.system.debug.completion.CompletionHandler.getPathBeforeDot","flixel/system/debug/completion/CompletionHandler.hx",163,0x776a5e1a)
HX_DEFINE_STACK_FRAME(_hx_pos_d4c828664754b74a_170_getWordAfterDot,"flixel.system.debug.completion.CompletionHandler","getWordAfterDot",0x4edfa1a3,"flixel.system.debug.completion.CompletionHandler.getWordAfterDot","flixel/system/debug/completion/CompletionHandler.hx",170,0x776a5e1a)
HX_DEFINE_STACK_FRAME(_hx_pos_d4c828664754b74a_185_getLastWord,"flixel.system.debug.completion.CompletionHandler","getLastWord",0xa19a712c,"flixel.system.debug.completion.CompletionHandler.getLastWord","flixel/system/debug/completion/CompletionHandler.hx",185,0x776a5e1a)
namespace flixel{
...
HXLINE(  58)		switch((int)(e->keyCode)){
...
HXLINE(  61)				this->completionList->close();
            			...
            			break;
            			default:{
HXLINE(  67)				this->getPathBeforeDot(text);
HXLINE(  69)				if (this->completionList->get_visible()) {
HXLINE(  70)					 ::flixel::_hx_system::debug::completion::CompletionList _hx_tmp2 = this->completionList;
HXDLIN(  70)					_hx_tmp2->set_filter(this->getWordAfterDot(text));
            				}
            			}
            		}
            	}
...
::Array< ::String > CompletionHandler_obj::getGlobals(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 111)		return ::Array_obj< ::String >::__new(0);
            	}
...
HXLINE( 126)		return  ::EReg_obj::__alloc( HX_CTX ,(this->getWordAfterDot(text) + HX_("$",24,00,00,00)),HX_("g",67,00,00,00))->replace(text,selectedItem);
            	}
...
void CompletionHandler_obj::completed(::String selectedItem){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(selectedItem,"selectedItem")
HXLINE( 132)		HX_VARI( ::String,insert) = this->getCompletedText(this->getTextUntilCaret(),selectedItem);
...
HXLINE( 158)		::flixel::FlxG_obj::game->debugger->watch->remove(HX_("Selection",2c,d8,ed,2f),::flixel::_hx_system::debug::watch::WatchEntryData_obj::QUICK(null()));
...
HXLINE( 166)		return lastWord.substr((int)0,lastWord.lastIndexOf(HX_(".",2e,00,00,00),null()));
            	}
...
::String CompletionHandler_obj::getLastWord(::String text){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(text,"text")
HXLINE( 185)		return ::flixel::util::FlxArrayUtil_obj::last( ::EReg_obj::__alloc( HX_CTX ,HX_("([^.a-zA-Z0-9_\\[\\]\"']+)",90,0f,11,57),HX_("g",67,00,00,00))->split(text));
            	}
