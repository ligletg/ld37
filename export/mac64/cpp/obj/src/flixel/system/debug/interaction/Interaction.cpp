...
HX_DEFINE_STACK_FRAME(_hx_pos_b2dd90bb9bc9fb13_330_updateCustomCursors,"flixel.system.debug.interaction.Interaction","updateCustomCursors",0x218c1283,"flixel.system.debug.interaction.Interaction.updateCustomCursors","flixel/system/debug/interaction/Interaction.hx",330,0x4548a912)
...
HX_DEFINE_STACK_FRAME(_hx_pos_b2dd90bb9bc9fb13_414_setSystemCursorVisibility,"flixel.system.debug.interaction.Interaction","setSystemCursorVisibility",0x3bad5fb9,"flixel.system.debug.interaction.Interaction.setSystemCursorVisibility","flixel/system/debug/interaction/Interaction.hx",414,0x4548a912)
...
void Interaction_obj::handleDebuggerVisibilityChanged(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  84)		if (::flixel::FlxG_obj::debugger->visible) {
...
HXLINE( 104)			HX_VARI(  ::openfl::_legacy::display::BitmapData,cursorIcon) = this->activeTool->cursor;
...
HXLINE( 112)		this->_customCursor->set_x((event->stageX + offsetX));
HXLINE( 113)		this->_customCursor->set_y((event->stageY + offsetY));
HXLINE( 117)		{
HXLINE( 117)			HX_VARI(  ::flixel::input::FlxPointer,_this) = this->_flixelPointer;
...
HXLINE( 121)		this->flixelPointer->set_x((this->_flixelPointer->x + offsetX));
HXLINE( 122)		this->flixelPointer->set_y((this->_flixelPointer->y + offsetY));
            	}
...
HXLINE( 133)		this->pointerJustPressed = (event->get_type() == ::openfl::_legacy::events::MouseEvent_obj::MOUSE_DOWN);
HXLINE( 134)		this->pointerJustReleased = (event->get_type() == ::openfl::_legacy::events::MouseEvent_obj::MOUSE_UP);
...
HXLINE( 149)		if ((event->get_type() == ::openfl::_legacy::events::MouseEvent_obj::MOUSE_OVER)) {
HXLINE( 150)			this->_debuggerInteraction = true;
            		}
            		else {
HXLINE( 151)			if ((event->get_type() == ::openfl::_legacy::events::MouseEvent_obj::MOUSE_OUT)) {
...
void Interaction_obj::handleKeyEvent( ::openfl::_legacy::events::KeyboardEvent event){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(event,"event")
HXLINE( 159)		if ((event->get_type() == ::openfl::_legacy::events::KeyboardEvent_obj::KEY_DOWN)) {
HXLINE( 160)			this->_keysDown->set(event->keyCode,this->_turn);
            		}
            		else {
HXLINE( 161)			if ((event->get_type() == ::openfl::_legacy::events::KeyboardEvent_obj::KEY_UP)) {
...
HXLINE( 218)			return this->get_visible();
            		}
            		else {
...
void Interaction_obj::drawItemsSelection(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 267)		HX_VARI(  ::openfl::_legacy::display::Graphics,gfx) = this->getDebugGraphics();
...
HXLINE( 316)		HX_VARI(  ::openfl::_legacy::display::Sprite,sprite) =  ::openfl::_legacy::display::Sprite_obj::__alloc( HX_CTX );
...
HXLINE( 330)			_hx_tmp = !(this->_debuggerInteraction);
            		}
            		else {
...
HXLINE( 343)				HX_VARI( int,_g1) = (int)0;
HXDLIN( 343)				HX_VARI( int,_g) = this->_customCursor->get_numChildren();
HXDLIN( 343)				while((_g1 < _g)){
HXLINE( 343)					_g1 = (_g1 + (int)1);
HXLINE( 345)					HX_VARI(  ::openfl::_legacy::display::DisplayObject,sprite) = this->_customCursor->getChildAt((_g1 - (int)1));
...
HXDLIN( 434)			HX_VARI( int,_g) = this->_customCursor->get_numChildren();
HXDLIN( 434)			while((_g1 < _g)){
HXLINE( 434)				_g1 = (_g1 + (int)1);
HXLINE( 435)				this->_customCursor->getChildAt((_g1 - (int)1))->set_visible(false);
            			}
            		}
            	}
