...
HX_DEFINE_STACK_FRAME(_hx_pos_33514f197bd465e7_78_drawAxes,"flixel.system.debug.stats.StatsGraph","drawAxes",0x7d893d71,"flixel.system.debug.stats.StatsGraph.drawAxes","flixel/system/debug/stats/StatsGraph.hx",78,0xbadd4916)
HX_DEFINE_STACK_FRAME(_hx_pos_33514f197bd465e7_96_drawGraph,"flixel.system.debug.stats.StatsGraph","drawGraph",0xcaf9ad82,"flixel.system.debug.stats.StatsGraph.drawGraph","flixel/system/debug/stats/StatsGraph.hx",96,0xbadd4916)
HX_DEFINE_STACK_FRAME(_hx_pos_33514f197bd465e7_117_update,"flixel.system.debug.stats.StatsGraph","update",0x0745a631,"flixel.system.debug.stats.StatsGraph.update","flixel/system/debug/stats/StatsGraph.hx",117,0xbadd4916)
HX_DEFINE_STACK_FRAME(_hx_pos_33514f197bd465e7_137_formatValue,"flixel.system.debug.stats.StatsGraph","formatValue",0xec642792,"flixel.system.debug.stats.StatsGraph.formatValue","flixel/system/debug/stats/StatsGraph.hx",137,0xbadd4916)
HX_DEFINE_STACK_FRAME(_hx_pos_33514f197bd465e7_141_average,"flixel.system.debug.stats.StatsGraph","average",0x1ab77435,"flixel.system.debug.stats.StatsGraph.average","flixel/system/debug/stats/StatsGraph.hx",141,0xbadd4916)
HX_DEFINE_STACK_FRAME(_hx_pos_33514f197bd465e7_149_destroy,"flixel.system.debug.stats.StatsGraph","destroy",0xdc622fd2,"flixel.system.debug.stats.StatsGraph.destroy","flixel/system/debug/stats/StatsGraph.hx",149,0xbadd4916)
HX_DEFINE_STACK_FRAME(_hx_pos_33514f197bd465e7_18_boot,"flixel.system.debug.stats.StatsGraph","boot",0x031fca5a,"flixel.system.debug.stats.StatsGraph.boot","flixel/system/debug/stats/StatsGraph.hx",18,0xbadd4916)
HX_DEFINE_STACK_FRAME(_hx_pos_33514f197bd465e7_19_boot,"flixel.system.debug.stats.StatsGraph","boot",0x031fca5a,"flixel.system.debug.stats.StatsGraph.boot","flixel/system/debug/stats/StatsGraph.hx",19,0xbadd4916)
HX_DEFINE_STACK_FRAME(_hx_pos_33514f197bd465e7_20_boot,"flixel.system.debug.stats.StatsGraph","boot",0x031fca5a,"flixel.system.debug.stats.StatsGraph.boot","flixel/system/debug/stats/StatsGraph.hx",20,0xbadd4916)
namespace flixel{
...
HXLINE(  54)		this->_axis->set_x((this->_labelWidth + (int)10));
...
HXLINE(  60)		this->avgLabel = ::flixel::_hx_system::debug::DebuggerUtil_obj::createTextField((this->_labelWidth + (int)20),((((Float)this->_height / (Float)(int)2) - ((Float)5.5)) - (int)10),(int)-1426063361,(int)11);
...
void StatsGraph_obj::drawAxes(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  79)		HX_VARI(  ::openfl::_legacy::display::Graphics,gfx) = this->_axis->get_graphics();
HXLINE(  80)		gfx->clear();
...
void StatsGraph_obj::drawGraph(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  97)		HX_VARI(  ::openfl::_legacy::display::Graphics,gfx) = this->get_graphics();
HXLINE(  98)		gfx->clear();
...
HXLINE( 102)		HX_VARI( Float,range) = ::Math_obj::max((this->maxValue - this->minValue),(this->maxValue * ((Float)0.1)));
HXLINE( 103)		HX_VARI( Float,graphX) = (this->_axis->get_x() + (int)1);
HXLINE( 105)		{
...
HXLINE( 126)		this->minLabel->set_text(this->formatValue(this->minValue));
HXLINE( 127)		this->curLabel->set_text(this->formatValue(Value));
HXLINE( 128)		this->maxLabel->set_text(this->formatValue(this->maxValue));
HXLINE( 130)		this->avgLabel->set_text(((this->_label + HX_("\nAvg: ",8e,d8,ea,ba)) + this->formatValue(this->average())));
...
::String StatsGraph_obj::formatValue(Float value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 137)		return ((::flixel::math::FlxMath_obj::roundDecimal(value,(int)1) + HX_(" ",20,00,00,00)) + this->_unit);
            	}
