...
HX_DEFINE_STACK_FRAME(_hx_pos_76b66bebb6c05d45_1_boot,"flixel.system.debug.stats._Stats.GraphicMaximizeButton","boot",0x8f53f9f1,"flixel.system.debug.stats._Stats.GraphicMaximizeButton.boot","?",1,0x0000003f)
namespace flixel{
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::stats::_Stats::GraphicMaximizeButton_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_stats__Stats_GraphicMaximizeButton",66,7c,bc,b9);
            	}
}
