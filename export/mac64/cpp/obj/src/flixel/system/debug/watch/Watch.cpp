...
HX_DEFINE_STACK_FRAME(_hx_pos_f3919820c0c3a2ee_36_add,"flixel.system.debug.watch.Watch","add",0xfea5b5fb,"flixel.system.debug.watch.Watch.add","flixel/system/debug/watch/Watch.hx",36,0x446c9b58)
HX_DEFINE_STACK_FRAME(_hx_pos_f3919820c0c3a2ee_57_isInvalid,"flixel.system.debug.watch.Watch","isInvalid",0x369d7b87,"flixel.system.debug.watch.Watch.isInvalid","flixel/system/debug/watch/Watch.hx",57,0x446c9b58)
HX_DEFINE_STACK_FRAME(_hx_pos_f3919820c0c3a2ee_69_getExistingEntry,"flixel.system.debug.watch.Watch","getExistingEntry",0xcc1e3f57,"flixel.system.debug.watch.Watch.getExistingEntry","flixel/system/debug/watch/Watch.hx",69,0x446c9b58)
HX_DEFINE_STACK_FRAME(_hx_pos_f3919820c0c3a2ee_84_addEntry,"flixel.system.debug.watch.Watch","addEntry",0xc2d1a477,"flixel.system.debug.watch.Watch.addEntry","flixel/system/debug/watch/Watch.hx",84,0x446c9b58)
HX_DEFINE_STACK_FRAME(_hx_pos_f3919820c0c3a2ee_92_remove,"flixel.system.debug.watch.Watch","remove",0xa5c13caa,"flixel.system.debug.watch.Watch.remove","flixel/system/debug/watch/Watch.hx",92,0x446c9b58)
HX_DEFINE_STACK_FRAME(_hx_pos_f3919820c0c3a2ee_99_removeEntry,"flixel.system.debug.watch.Watch","removeEntry",0x44a48368,"flixel.system.debug.watch.Watch.removeEntry","flixel/system/debug/watch/Watch.hx",99,0x446c9b58)
HX_DEFINE_STACK_FRAME(_hx_pos_f3919820c0c3a2ee_107_removeAll,"flixel.system.debug.watch.Watch","removeAll",0xc23c3a97,"flixel.system.debug.watch.Watch.removeAll","flixel/system/debug/watch/Watch.hx",107,0x446c9b58)
HX_DEFINE_STACK_FRAME(_hx_pos_f3919820c0c3a2ee_115_update,"flixel.system.debug.watch.Watch","update",0x283e266f,"flixel.system.debug.watch.Watch.update","flixel/system/debug/watch/Watch.hx",115,0x446c9b58)
HX_DEFINE_STACK_FRAME(_hx_pos_f3919820c0c3a2ee_120_updateSize,"flixel.system.debug.watch.Watch","updateSize",0x79f056d0,"flixel.system.debug.watch.Watch.updateSize","flixel/system/debug/watch/Watch.hx",120,0x446c9b58)
HX_DEFINE_STACK_FRAME(_hx_pos_f3919820c0c3a2ee_130_resetEntries,"flixel.system.debug.watch.Watch","resetEntries",0x423b6427,"flixel.system.debug.watch.Watch.resetEntries","flixel/system/debug/watch/Watch.hx",130,0x446c9b58)
HX_DEFINE_STACK_FRAME(_hx_pos_f3919820c0c3a2ee_140_getMaxNameWidth,"flixel.system.debug.watch.Watch","getMaxNameWidth",0x1ee45d07,"flixel.system.debug.watch.Watch.getMaxNameWidth","flixel/system/debug/watch/Watch.hx",140,0x446c9b58)
HX_DEFINE_STACK_FRAME(_hx_pos_f3919820c0c3a2ee_145_getMaxMinWidth,"flixel.system.debug.watch.Watch","getMaxMinWidth",0x4606f748,"flixel.system.debug.watch.Watch.getMaxMinWidth","flixel/system/debug/watch/Watch.hx",145,0x446c9b58)
HX_DEFINE_STACK_FRAME(_hx_pos_f3919820c0c3a2ee_149_getMax,"flixel.system.debug.watch.Watch","getMax",0x445ae414,"flixel.system.debug.watch.Watch.getMax","flixel/system/debug/watch/Watch.hx",149,0x446c9b58)
HX_DEFINE_STACK_FRAME(_hx_pos_f3919820c0c3a2ee_17_boot,"flixel.system.debug.watch.Watch","boot",0xd30b1f18,"flixel.system.debug.watch.Watch.boot","flixel/system/debug/watch/Watch.hx",17,0x446c9b58)
namespace flixel{
...
HXLINE(  20)		HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)2,(int)15);
...
HXLINE(  40)		HX_VARI(  ::flixel::_hx_system::debug::watch::WatchEntry,existing) = this->getExistingEntry(displayName,data);
...
HXLINE(  57)		switch((int)(_hx_getEnumValueIndex(data))){
            			case (int)0: {
HXLINE(  60)				if (hx::IsNotNull( data->_hx_getObject(0) )) {
HXLINE(  57)					return hx::IsNull( data->_hx_getString(1) );
            				}
            				else {
...
HXLINE(  57)					return (displayName.length == (int)0);
            				}
            				else {
HXLINE(  57)					return true;
            				}
            			...
            			break;
            			case (int)2: {
HXLINE(  63)				HX_VARI( ::String,expression) = data->_hx_getString(0);
HXLINE(  64)				if (hx::IsNotNull( expression )) {
HXLINE(  57)					return (expression.length == (int)0);
            				}
            				else {
HXLINE(  57)					return true;
            				}
...
HXDLIN(  70)			HX_VARI( ::Array< ::Dynamic>,_g1) = this->entries;
HXDLIN(  70)			while((_g < _g1->length)){
HXLINE(  70)				HX_VARI(  ::flixel::_hx_system::debug::watch::WatchEntry,entry) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::watch::WatchEntry >();
HXDLIN(  70)				_g = (_g + (int)1);
HXLINE(  72)				bool _hx_tmp;
HXDLIN(  72)				if ((_hx_getEnumValueIndex(data) == (int)1)) {
...
void Watch_obj::addEntry(::String displayName, ::flixel::_hx_system::debug::watch::WatchEntryData data){
            	...
            	HX_STACK_ARG(displayName,"displayName")
            	HX_STACK_ARG(data,"data")
HXLINE(  85)		HX_VARI(  ::flixel::_hx_system::debug::watch::WatchEntry,entry) =  ::flixel::_hx_system::debug::watch::WatchEntry_obj::__alloc( HX_CTX ,displayName,data,this->removeEntry_dyn());
...
void Watch_obj::remove(::String displayName, ::flixel::_hx_system::debug::watch::WatchEntryData data){
            	...
            	HX_STACK_ARG(displayName,"displayName")
            	HX_STACK_ARG(data,"data")
HXLINE(  93)		HX_VARI(  ::flixel::_hx_system::debug::watch::WatchEntry,existing) = this->getExistingEntry(displayName,data);
...
HXLINE( 100)		{
HXLINE( 100)			HX_VARI( ::Array< ::Dynamic>,array) = this->entries;
HXDLIN( 100)			HX_VARI( int,index) = array->indexOf(entry,null());
...
HXDLIN( 108)			HX_VARI( ::Array< ::Dynamic>,_g1) = this->entries->copy();
HXDLIN( 108)			while((_g < _g1->length)){
HXLINE( 108)				HX_VARI(  ::flixel::_hx_system::debug::watch::WatchEntry,entry) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::watch::WatchEntry >();
HXDLIN( 108)				_g = (_g + (int)1);
HXLINE( 109)				this->removeEntry(entry);
            			}
            		}
HXLINE( 110)		this->entries = ::Array_obj< ::Dynamic>::__new(0);
            	}
...
void Watch_obj::update(){
            	HX_STACKFRAME(&_hx_pos_f3919820c0c3a2ee_115_update)
            	HX_STACK_THIS(this)
HXLINE( 115)		HX_VARI( int,_g) = (int)0;
HXDLIN( 115)		HX_VARI( ::Array< ::Dynamic>,_g1) = this->entries;
HXDLIN( 115)		while((_g < _g1->length)){
HXLINE( 115)			HX_VARI(  ::flixel::_hx_system::debug::watch::WatchEntry,entry) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::watch::WatchEntry >();
HXDLIN( 115)			_g = (_g + (int)1);
HXLINE( 116)			entry->updateValue();
            		}
            	}


void Watch_obj::updateSize(){
            	HX_STACKFRAME(&_hx_pos_f3919820c0c3a2ee_120_updateSize)
            	HX_STACK_THIS(this)
HXLINE( 121)		 ::openfl::_legacy::geom::Point _hx_tmp = this->minSize;
HXLINE( 122)		Float _hx_tmp1 = this->getMaxMinWidth();
HXDLIN( 122)		Float _hx_tmp2 = (_hx_tmp1 + this->entriesContainerOffset->x);
HXLINE( 123)		Float _hx_tmp3 = this->entriesContainer->get_height();
HXLINE( 121)		_hx_tmp->setTo(_hx_tmp2,(_hx_tmp3 + this->entriesContainerOffset->y));
HXLINE( 124)		this->super::updateSize();
HXLINE( 125)		this->resetEntries();
            	}


void Watch_obj::resetEntries(){
            	HX_STACKFRAME(&_hx_pos_f3919820c0c3a2ee_130_resetEntries)
            	HX_STACK_THIS(this)
HXLINE( 130)		HX_VARI( int,_g1) = (int)0;
HXDLIN( 130)		HX_VARI( int,_g) = this->entries->length;
HXDLIN( 130)		while((_g1 < _g)){
HXLINE( 130)			_g1 = (_g1 + (int)1);
HXDLIN( 130)			HX_VARI( int,i) = (_g1 - (int)1);
HXLINE( 132)			HX_VARI(  ::flixel::_hx_system::debug::watch::WatchEntry,entry) = this->entries->__get(i).StaticCast<  ::flixel::_hx_system::debug::watch::WatchEntry >();
HXLINE( 133)			entry->set_y((i * (int)15));
HXLINE( 134)			Float _hx_tmp = this->getMaxNameWidth();
HXDLIN( 134)			entry->updateSize(_hx_tmp,this->_width);
            		}
            	}
...
Float Watch_obj::getMaxNameWidth(){
            		...
            		Float _hx_run( ::flixel::_hx_system::debug::watch::WatchEntry entry){
            			HX_STACKFRAME(&_hx_pos_f3919820c0c3a2ee_140_getMaxNameWidth)
            			HX_STACK_ARG(entry,"entry")
HXLINE( 140)			return entry->getNameWidth();
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_STACKFRAME(&_hx_pos_f3919820c0c3a2ee_140_getMaxNameWidth)
            	HX_STACK_THIS(this)
HXLINE( 140)		return this->getMax( ::Dynamic(new _hx_Closure_0()));
            	}
...
Float Watch_obj::getMaxMinWidth(){
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            		Float _hx_run( ::flixel::_hx_system::debug::watch::WatchEntry entry){
            			HX_STACKFRAME(&_hx_pos_f3919820c0c3a2ee_145_getMaxMinWidth)
            			HX_STACK_ARG(entry,"entry")
HXLINE( 145)			return entry->getMinWidth();
            		}
            		HX_END_LOCAL_FUNC1(return)
...
Float Watch_obj::getMax( ::Dynamic getValue){
            	HX_STACKFRAME(&_hx_pos_f3919820c0c3a2ee_149_getMax)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(getValue,"getValue")
HXLINE( 150)		HX_VARI( Float,max) = ((Float)0.0);
HXLINE( 151)		{
HXLINE( 151)			HX_VARI( int,_g) = (int)0;
HXDLIN( 151)			HX_VARI( ::Array< ::Dynamic>,_g1) = this->entries;
HXDLIN( 151)			while((_g < _g1->length)){
HXLINE( 151)				HX_VARI(  ::flixel::_hx_system::debug::watch::WatchEntry,entry) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::watch::WatchEntry >();
HXDLIN( 151)				_g = (_g + (int)1);
HXLINE( 153)				HX_VARI( Float,value) = ( (Float)(getValue(entry)) );
HXLINE( 154)				if ((value > max)) {
HXLINE( 155)					max = value;
            				}
            			}
            		}
HXLINE( 157)		return max;
            	}
