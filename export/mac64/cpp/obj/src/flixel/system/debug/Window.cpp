...
HX_DEFINE_STACK_FRAME(_hx_pos_4e51d5a8805713a4_439_close,"flixel.system.debug.Window","close",0x8465b962,"flixel.system.debug.Window.close","flixel/system/debug/Window.hx",439,0xb8dfd4e5)
...
HXLINE( 126)			HX_VARI(  ::openfl::_legacy::display::Bitmap,icon) =  ::openfl::_legacy::display::Bitmap_obj::__alloc( HX_CTX ,Icon,null(),null());
...
HXLINE( 198)		HX_VARI(  ::openfl::_legacy::display::Stage,stage) = ::openfl::_legacy::Lib_obj::get_current()->get_stage();
...
HXLINE( 258)			 ::Dynamic(::flixel::FlxG_obj::save->data->__Field(HX_("windowSettings",f3,3c,19,85),hx::paccDynamic))->__SetItem(this->_id,this->get_visible());
...
HXDLIN( 263)			_hx_tmp->set_toggled(!(this->get_visible()));
            		}
...
void Window_obj::toggleVisible(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 271)		this->setVisible(!(this->get_visible()));
            	}
...
void Window_obj::putOnTop(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 276)		this->get_parent()->addChild(hx::ObjectPtr<OBJ_>(this));
            	}
...
HXLINE( 356)						_hx_tmp6 = (mouseY <= this->_header->get_height());
            					}
            					else {
...
HXDLIN( 359)						if ((mouseX >= (_hx_tmp8 - this->_handle->get_width()))) {
HXLINE( 359)							int _hx_tmp9 = this->_height;
HXDLIN( 359)							_hx_tmp7 = (mouseY >= (_hx_tmp9 - this->_handle->get_height()));
            						}
            						else {
...
HXLINE( 407)			HX_VARI( Float,Value) = this->get_x();
HXDLIN( 407)			HX_VARI(  ::Dynamic,Min) = this->_bounds->get_left();
HXDLIN( 407)			HX_VARI(  ::Dynamic,Max) = (this->_bounds->get_right() - this->_width);
...
HXDLIN( 407)			Float _hx_tmp;
HXDLIN( 407)			bool _hx_tmp1;
HXDLIN( 407)			if (hx::IsNotNull( Max )) {
HXLINE( 407)				_hx_tmp1 = hx::IsGreater( lowerBound,Max );
            			}
            			else {
HXLINE( 407)				_hx_tmp1 = false;
            			}
HXDLIN( 407)			if (_hx_tmp1) {
HXLINE( 407)				_hx_tmp = Max;
            			}
            			else {
HXLINE( 407)				_hx_tmp = lowerBound;
            			}
HXDLIN( 407)			this->set_x(_hx_tmp);
HXLINE( 408)			HX_VARI_NAME( Float,Value1,"Value") = this->get_y();
HXDLIN( 408)			HX_VARI_NAME(  ::Dynamic,Min1,"Min") = this->_bounds->get_top();
HXDLIN( 408)			HX_VARI_NAME(  ::Dynamic,Max1,"Max") = (this->_bounds->get_bottom() - this->_height);
...
HXDLIN( 408)			Float _hx_tmp2;
HXDLIN( 408)			bool _hx_tmp3;
HXDLIN( 408)			if (hx::IsNotNull( Max1 )) {
HXLINE( 408)				_hx_tmp3 = hx::IsGreater( lowerBound2,Max1 );
            			}
            			else {
HXLINE( 408)				_hx_tmp3 = false;
            			}
HXDLIN( 408)			if (_hx_tmp3) {
HXLINE( 408)				_hx_tmp2 = Max1;
            			}
            			else {
HXLINE( 408)				_hx_tmp2 = lowerBound2;
            			}
HXDLIN( 408)			this->set_y(_hx_tmp2);
            		}
            	}
...
HXLINE( 420)		this->_header->set_scaleX(this->_width);
HXLINE( 421)		this->_background->set_scaleX(this->_width);
HXLINE( 422)		 ::openfl::_legacy::display::Bitmap _hx_tmp4 = this->_background;
HXDLIN( 422)		int _hx_tmp5 = this->_height;
HXDLIN( 422)		_hx_tmp4->set_scaleY((_hx_tmp5 - this->_header->get_height()));
HXLINE( 423)		this->_shadow->set_scaleX(this->_width);
HXLINE( 424)		this->_shadow->set_y(this->_height);
HXLINE( 425)		this->_title->set_width((this->_width - (int)4));
HXLINE( 426)		if (this->_resizable) {
HXLINE( 428)			 ::openfl::_legacy::display::Bitmap _hx_tmp6 = this->_handle;
HXDLIN( 428)			int _hx_tmp7 = this->_width;
HXDLIN( 428)			_hx_tmp6->set_x((_hx_tmp7 - this->_handle->get_width()));
HXLINE( 429)			 ::openfl::_legacy::display::Bitmap _hx_tmp8 = this->_handle;
HXDLIN( 429)			int _hx_tmp9 = this->_height;
HXDLIN( 429)			_hx_tmp8->set_y((_hx_tmp9 - this->_handle->get_height()));
            		}
HXLINE( 431)		if (hx::IsNotNull( this->_closeButton )) {
HXLINE( 433)			 ::flixel::_hx_system::ui::FlxSystemButton _hx_tmp10 = this->_closeButton;
HXDLIN( 433)			int _hx_tmp11 = this->_width;
HXDLIN( 433)			_hx_tmp10->set_x(((_hx_tmp11 - this->_closeButton->get_width()) - (int)3));
HXLINE( 434)			this->_closeButton->set_y((int)3);
            		}
            	}
...
HXLINE( 442)		{
HXLINE( 442)			HX_VARI(  ::flixel::_hx_system::debug::FlxDebugger,_this) = ::flixel::FlxG_obj::game->debugger;
HXDLIN( 442)			if (_this->contains(hx::ObjectPtr<OBJ_>(this))) {
HXLINE( 442)				_this->removeChild(hx::ObjectPtr<OBJ_>(this));
            			}
HXDLIN( 442)			{
HXLINE( 442)				HX_VARI( ::Array< ::Dynamic>,array) = _this->_windows;
HXDLIN( 442)				HX_VARI( int,index) = array->indexOf(hx::ObjectPtr<OBJ_>(this),null());
