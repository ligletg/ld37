...
HX_DEFINE_STACK_FRAME(_hx_pos_26e7abcd62afef0c_2010_new,"flixel.system.debug._VCR.GraphicOpen","new",0x5cfdc604,"flixel.system.debug._VCR.GraphicOpen.new","openfl/_legacy/Assets.hx",2010,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_8d12d9b2de896b6c_1_boot,"flixel.system.debug._VCR.GraphicOpen","boot",0xf9287e0e,"flixel.system.debug._VCR.GraphicOpen.boot","?",1,0x0000003f)
namespace flixel{
...
void GraphicOpen_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACKFRAME(&_hx_pos_26e7abcd62afef0c_2010_new)
            	HX_STACK_THIS(this)
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::_VCR::GraphicOpen_obj::resourceName));
...
bool GraphicOpen_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x0cd766e7) {
		...
		return inClassId==(int)0x27824af0;
	}
}
...
static hx::StaticInfo GraphicOpen_obj_sStaticStorageInfo[] = {
	{hx::fsString,(void *) &GraphicOpen_obj::resourceName,HX_HCSTRING("resourceName","\x39","\x7a","\x62","\x90")},
	{ hx::fsUnknown, 0, null()}
};
#endif

static void GraphicOpen_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(GraphicOpen_obj::__mClass,"__mClass");
...
static void GraphicOpen_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(GraphicOpen_obj::__mClass,"__mClass");
...
{
	hx::Object *dummy = new GraphicOpen_obj;
	GraphicOpen_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("flixel.system.debug._VCR.GraphicOpen","\x12","\xb4","\x21","\x9c");
...
{
{
            	HX_STACKFRAME(&_hx_pos_8d12d9b2de896b6c_1_boot)
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug__VCR_GraphicOpen",38,bb,f9,19);
            	}
}
