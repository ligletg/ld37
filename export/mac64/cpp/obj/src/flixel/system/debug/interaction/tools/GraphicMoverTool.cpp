...
HX_DEFINE_STACK_FRAME(_hx_pos_ed6eb6e0daea6016_1_boot,"flixel.system.debug.interaction.tools.GraphicMoverTool","boot",0x183dca78,"flixel.system.debug.interaction.tools.GraphicMoverTool.boot","?",1,0x0000003f)
namespace flixel{
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::interaction::tools::GraphicMoverTool_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_interaction_tools_GraphicMoverTool",81,a4,f3,1e);
            	}
}
