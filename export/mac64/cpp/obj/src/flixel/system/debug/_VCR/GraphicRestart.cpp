...
HX_DEFINE_STACK_FRAME(_hx_pos_685a7fe6a537f5f1_1_boot,"flixel.system.debug._VCR.GraphicRestart","boot",0xb8f5f579,"flixel.system.debug._VCR.GraphicRestart.boot","?",1,0x0000003f)
namespace flixel{
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::_VCR::GraphicRestart_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug__VCR_GraphicRestart",21,e9,41,92);
            	}
}
