...
HX_DEFINE_STACK_FRAME(_hx_pos_60725c8fd849460b_170_destroy,"flixel.system.debug.watch.Tracker","destroy",0x264ff07d,"flixel.system.debug.watch.Tracker.destroy","flixel/system/debug/watch/Tracker.hx",170,0x14368dcf)
HX_DEFINE_STACK_FRAME(_hx_pos_60725c8fd849460b_179_findProfileByClass,"flixel.system.debug.watch.Tracker","findProfileByClass",0x1c23782e,"flixel.system.debug.watch.Tracker.findProfileByClass","flixel/system/debug/watch/Tracker.hx",179,0x14368dcf)
HX_DEFINE_STACK_FRAME(_hx_pos_60725c8fd849460b_189_initWatchEntries,"flixel.system.debug.watch.Tracker","initWatchEntries",0xac4e4a0e,"flixel.system.debug.watch.Tracker.initWatchEntries","flixel/system/debug/watch/Tracker.hx",189,0x14368dcf)
HX_DEFINE_STACK_FRAME(_hx_pos_60725c8fd849460b_197_addExtensions,"flixel.system.debug.watch.Tracker","addExtensions",0x13338d58,"flixel.system.debug.watch.Tracker.addExtensions","flixel/system/debug/watch/Tracker.hx",197,0x14368dcf)
HX_DEFINE_STACK_FRAME(_hx_pos_60725c8fd849460b_216_addVariables,"flixel.system.debug.watch.Tracker","addVariables",0x5f6aa5f3,"flixel.system.debug.watch.Tracker.addVariables","flixel/system/debug/watch/Tracker.hx",216,0x14368dcf)
HX_DEFINE_STACK_FRAME(_hx_pos_60725c8fd849460b_56_addProfile,"flixel.system.debug.watch.Tracker","addProfile",0x17dc8565,"flixel.system.debug.watch.Tracker.addProfile","flixel/system/debug/watch/Tracker.hx",56,0x14368dcf)
HX_DEFINE_STACK_FRAME(_hx_pos_60725c8fd849460b_64_findProfile,"flixel.system.debug.watch.Tracker","findProfile",0x9e194af3,"flixel.system.debug.watch.Tracker.findProfile","flixel/system/debug/watch/Tracker.hx",64,0x14368dcf)
HX_DEFINE_STACK_FRAME(_hx_pos_60725c8fd849460b_77_onStateSwitch,"flixel.system.debug.watch.Tracker","onStateSwitch",0xc2667bc9,"flixel.system.debug.watch.Tracker.onStateSwitch","flixel/system/debug/watch/Tracker.hx",77,0x14368dcf)
HX_DEFINE_STACK_FRAME(_hx_pos_60725c8fd849460b_82_initProfiles,"flixel.system.debug.watch.Tracker","initProfiles",0x6f40e3f7,"flixel.system.debug.watch.Tracker.initProfiles","flixel/system/debug/watch/Tracker.hx",82,0x14368dcf)
...
HX_DEFINE_STACK_FRAME(_hx_pos_60725c8fd849460b_50_boot,"flixel.system.debug.watch.Tracker","boot",0x1225c0cf,"flixel.system.debug.watch.Tracker.boot","flixel/system/debug/watch/Tracker.hx",50,0x14368dcf)
HX_DEFINE_STACK_FRAME(_hx_pos_60725c8fd849460b_52_boot,"flixel.system.debug.watch.Tracker","boot",0x1225c0cf,"flixel.system.debug.watch.Tracker.boot","flixel/system/debug/watch/Tracker.hx",52,0x14368dcf)
namespace flixel{
...
HXDLIN( 180)			HX_VARI( ::Array< ::Dynamic>,_g1) = ::flixel::_hx_system::debug::watch::Tracker_obj::profiles;
HXDLIN( 180)			while((_g < _g1->length)){
HXLINE( 180)				HX_VARI(  ::flixel::_hx_system::debug::watch::TrackerProfile,profile) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::watch::TrackerProfile >();
...
void Tracker_obj::initWatchEntries( ::flixel::_hx_system::debug::watch::TrackerProfile Profile){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Profile,"Profile")
HXLINE( 189)		if (hx::IsNotNull( Profile )) {
...
HXDLIN( 201)			HX_VARI( ::Array< ::Dynamic>,_g1) = Profile->extensions;
HXDLIN( 201)			while((_g < _g1->length)){
HXLINE( 201)				HX_VARI( hx::Class,extension) = _g1->__get(_g).StaticCast< hx::Class >();
HXDLIN( 201)				_g = (_g + (int)1);
HXLINE( 203)				if (hx::IsNull( extension )) {
HXLINE( 204)					continue;
            				}
HXLINE( 206)				HX_VARI(  ::flixel::_hx_system::debug::watch::TrackerProfile,extensionProfile) = this->findProfileByClass(extension);
...
HXLINE( 220)				HX_VARI( ::String,variable) = Variables->__get(_g);
...
void Tracker_obj::addProfile( ::flixel::_hx_system::debug::watch::TrackerProfile Profile){
            	...
            	HX_STACK_ARG(Profile,"Profile")
HXLINE(  56)		if (hx::IsNotNull( Profile )) {
...
HXLINE(  67)		HX_VARI(  ::flixel::_hx_system::debug::watch::TrackerProfile,lastMatchingProfile) = null();
HXLINE(  68)		{
HXLINE(  68)			HX_VARI( int,_g) = (int)0;
HXDLIN(  68)			HX_VARI( ::Array< ::Dynamic>,_g1) = ::flixel::_hx_system::debug::watch::Tracker_obj::profiles;
HXDLIN(  68)			while((_g < _g1->length)){
HXLINE(  68)				HX_VARI(  ::flixel::_hx_system::debug::watch::TrackerProfile,profile) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::watch::TrackerProfile >();
...
HXLINE(  77)		::flixel::_hx_system::debug::watch::Tracker_obj::_numTrackerWindows = (int)0;
            	}
...
HXLINE(  82)		if (hx::IsNull( ::flixel::_hx_system::debug::watch::Tracker_obj::profiles )) {
HXLINE(  84)			::flixel::_hx_system::debug::watch::Tracker_obj::profiles = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  86)			{
HXLINE(  86)				HX_VARI(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile) =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::FlxG >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_14,14),null());
...
HXLINE(  90)			{
HXLINE(  90)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile1,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::math::FlxPoint >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_15,2),null());
...
HXLINE(  91)			{
HXLINE(  91)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile2,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::math::FlxRect >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_16,2),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::math::FlxPoint >()));
...
HXLINE(  93)			{
HXLINE(  93)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile3,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::FlxBasic >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_17,4),null());
...
HXLINE(  94)			{
HXLINE(  94)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile4,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::FlxObject >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_18,5),::Array_obj< ::Dynamic>::__new(2)->init(0,hx::ClassOf< ::flixel::math::FlxRect >())->init(1,hx::ClassOf< ::flixel::FlxBasic >()));
...
HXLINE(  95)			{
HXLINE(  95)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile5,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::tile::FlxTilemap >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_19,5),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::FlxObject >()));
...
HXLINE(  96)			{
HXLINE(  96)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile6,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::FlxSprite >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_20,6),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::FlxObject >()));
...
HXLINE(  97)			{
HXLINE(  97)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile7,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::ui::FlxTypedButton >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_21,2),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::FlxSprite >()));
...
HXLINE(  98)			{
HXLINE(  98)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile8,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::ui::FlxBar >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_22,6),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::FlxSprite >()));
...
HXLINE(  99)			{
HXLINE(  99)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile9,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::text::FlxText >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_23,9),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::FlxSprite >()));
...
HXLINE( 102)			{
HXLINE( 102)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile10,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::group::FlxTypedGroup >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_24,3),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::FlxBasic >()));
...
HXLINE( 103)			{
HXLINE( 103)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile11,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::group::FlxTypedSpriteGroup >(),null(),::Array_obj< ::Dynamic>::__new(2)->init(0,hx::ClassOf< ::flixel::FlxSprite >())->init(1,hx::ClassOf< ::flixel::group::FlxTypedGroup >()));
...
HXLINE( 104)			{
HXLINE( 104)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile12,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::FlxState >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_25,4),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::group::FlxTypedGroup >()));
...
HXLINE( 106)			{
HXLINE( 106)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile13,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::FlxCamera >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_26,8),::Array_obj< ::Dynamic>::__new(2)->init(0,hx::ClassOf< ::flixel::FlxBasic >())->init(1,hx::ClassOf< ::flixel::math::FlxRect >()));
...
HXLINE( 109)			{
HXLINE( 109)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile14,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::tweens::FlxTween >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_27,10),null());
...
HXLINE( 112)			{
HXLINE( 112)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile15,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::util::FlxPath >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_28,6),null());
...
HXLINE( 113)			{
HXLINE( 113)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile16,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::util::FlxTimer >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_29,9),null());
...
HXLINE( 115)			{
HXLINE( 115)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile17,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::animation::FlxAnimationController >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_30,6),null());
...
HXLINE( 117)			{
HXLINE( 117)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile18,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::effects::particles::FlxTypedEmitter >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_31,3),::Array_obj< ::Dynamic>::__new(2)->init(0,hx::ClassOf< ::flixel::group::FlxTypedGroup >())->init(1,hx::ClassOf< ::flixel::math::FlxRect >()));
...
HXLINE( 121)			{
HXLINE( 121)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile19,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::input::mouse::FlxMouse >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_32,14),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::math::FlxPoint >()));
...
HXLINE( 130)			{
HXLINE( 130)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile20,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::input::gamepad::FlxGamepad >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_33,8),null());
...
HXLINE( 134)			{
HXLINE( 134)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile21,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::input::FlxSwipe >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_34,6),null());
...
HXLINE( 137)			{
HXLINE( 137)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile22,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::openfl::_legacy::display::DisplayObject >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_35,8),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::math::FlxRect >()));
...
HXLINE( 138)			{
HXLINE( 138)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile23,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::openfl::_legacy::geom::Point >(),null(),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::math::FlxPoint >()));
...
HXLINE( 139)			{
HXLINE( 139)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile24,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::openfl::_legacy::geom::Rectangle >(),null(),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::math::FlxRect >()));
...
HXLINE( 140)			{
HXLINE( 140)				HX_VARI_NAME(  ::flixel::_hx_system::debug::watch::TrackerProfile,Profile25,"Profile") =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::openfl::_legacy::geom::Matrix >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_36,6),null());
...
HXLINE(  50)		objectsBeingTracked = ::cpp::VirtualArray_obj::__new(0);
            	}
{
            	HX_STACKFRAME(&_hx_pos_60725c8fd849460b_52_boot)
HXLINE(  52)		_numTrackerWindows = (int)0;
            	}
}
