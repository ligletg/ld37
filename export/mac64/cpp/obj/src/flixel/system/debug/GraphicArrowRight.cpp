...
HX_DEFINE_STACK_FRAME(_hx_pos_df9815548b13178b_2010_new,"flixel.system.debug.GraphicArrowRight","new",0x7bbb3ee5,"flixel.system.debug.GraphicArrowRight.new","openfl/_legacy/Assets.hx",2010,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_79ee4984206c5085_1_boot,"flixel.system.debug.GraphicArrowRight","boot",0xc034ca0d,"flixel.system.debug.GraphicArrowRight.boot","?",1,0x0000003f)
namespace flixel{
...
void GraphicArrowRight_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACKFRAME(&_hx_pos_df9815548b13178b_2010_new)
            	HX_STACK_THIS(this)
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::GraphicArrowRight_obj::resourceName));
...
bool GraphicArrowRight_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x0cd766e7) {
		...
		return inClassId==(int)0x1a78021b;
	}
}
...
static hx::StaticInfo GraphicArrowRight_obj_sStaticStorageInfo[] = {
	{hx::fsString,(void *) &GraphicArrowRight_obj::resourceName,HX_HCSTRING("resourceName","\x39","\x7a","\x62","\x90")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
{
{
            	HX_STACKFRAME(&_hx_pos_79ee4984206c5085_1_boot)
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_GraphicArrowRight",dc,1c,ad,91);
            	}
}
