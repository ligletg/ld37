...
HX_DEFINE_STACK_FRAME(_hx_pos_f763da37e1ae9263_2010_new,"flixel.system.debug._VCR.GraphicStop","new",0x0e7c2e3c,"flixel.system.debug._VCR.GraphicStop.new","openfl/_legacy/Assets.hx",2010,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_596f23337b5d5c70_1_boot,"flixel.system.debug._VCR.GraphicStop","boot",0x964546d6,"flixel.system.debug._VCR.GraphicStop.boot","?",1,0x0000003f)
namespace flixel{
...
void GraphicStop_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACKFRAME(&_hx_pos_f763da37e1ae9263_2010_new)
            	HX_STACK_THIS(this)
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::_VCR::GraphicStop_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug__VCR_GraphicStop",70,a7,a1,1c);
            	}
}
