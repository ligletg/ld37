...
HX_DEFINE_STACK_FRAME(_hx_pos_58465ca8ab419233_1_boot,"flixel.system.debug.GraphicBitmapLog","boot",0xbe36e28b,"flixel.system.debug.GraphicBitmapLog.boot","?",1,0x0000003f)
namespace flixel{
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::GraphicBitmapLog_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_GraphicBitmapLog",6c,ac,7b,3e);
            	}
}
