...
HX_DEFINE_STACK_FRAME(_hx_pos_74b294447f2d4a38_1_boot,"flixel.system.debug._VCR.GraphicStep","boot",0xf66ea34c,"flixel.system.debug._VCR.GraphicStep.boot","?",1,0x0000003f)
namespace flixel{
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::_VCR::GraphicStep_obj::resourceName));
