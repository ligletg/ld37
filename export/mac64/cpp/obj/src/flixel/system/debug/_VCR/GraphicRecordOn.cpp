...
HX_DEFINE_STACK_FRAME(_hx_pos_eb2563972ed54822_2010_new,"flixel.system.debug._VCR.GraphicRecordOn","new",0x07d5634a,"flixel.system.debug._VCR.GraphicRecordOn.new","openfl/_legacy/Assets.hx",2010,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_42c888a01c85d32f_1_boot,"flixel.system.debug._VCR.GraphicRecordOn","boot",0xcafa7e08,"flixel.system.debug._VCR.GraphicRecordOn.boot","?",1,0x0000003f)
namespace flixel{
...
void GraphicRecordOn_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACKFRAME(&_hx_pos_eb2563972ed54822_2010_new)
            	HX_STACK_THIS(this)
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::_VCR::GraphicRecordOn_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug__VCR_GraphicRecordOn",7e,48,e5,2b);
            	}
}
