...
HX_DEFINE_STACK_FRAME(_hx_pos_c69022abc8c5c26b_96_createInputTextField,"flixel.system.debug.console.Console","createInputTextField",0x91c24015,"flixel.system.debug.console.Console.createInputTextField","flixel/system/debug/console/Console.hx",96,0x367943c8)
HX_DEFINE_STACK_FRAME(_hx_pos_c69022abc8c5c26b_122_registerEventListeners,"flixel.system.debug.console.Console","registerEventListeners",0x714c11de,"flixel.system.debug.console.Console.registerEventListeners","flixel/system/debug/console/Console.hx",122,0x367943c8)
HX_DEFINE_STACK_FRAME(_hx_pos_c69022abc8c5c26b_126_registerEventListeners,"flixel.system.debug.console.Console","registerEventListeners",0x714c11de,"flixel.system.debug.console.Console.registerEventListeners","flixel/system/debug/console/Console.hx",126,0x367943c8)
HX_DEFINE_STACK_FRAME(_hx_pos_c69022abc8c5c26b_111_registerEventListeners,"flixel.system.debug.console.Console","registerEventListeners",0x714c11de,"flixel.system.debug.console.Console.registerEventListeners","flixel/system/debug/console/Console.hx",111,0x367943c8)
HX_DEFINE_STACK_FRAME(_hx_pos_c69022abc8c5c26b_134_update,"flixel.system.debug.console.Console","update",0x661b601f,"flixel.system.debug.console.Console.update","flixel/system/debug/console/Console.hx",134,0x367943c8)
HX_DEFINE_STACK_FRAME(_hx_pos_c69022abc8c5c26b_151_onFocus,"flixel.system.debug.console.Console","onFocus",0xeecff763,"flixel.system.debug.console.Console.onFocus","flixel/system/debug/console/Console.hx",151,0x367943c8)
HX_DEFINE_STACK_FRAME(_hx_pos_c69022abc8c5c26b_174_onFocusLost,"flixel.system.debug.console.Console","onFocusLost",0x2ed3bae7,"flixel.system.debug.console.Console.onFocusLost","flixel/system/debug/console/Console.hx",174,0x367943c8)
HX_DEFINE_STACK_FRAME(_hx_pos_c69022abc8c5c26b_282_registerFunction,"flixel.system.debug.console.Console","registerFunction",0xf8dd3a31,"flixel.system.debug.console.Console.registerFunction","flixel/system/debug/console/Console.hx",282,0x367943c8)
HX_DEFINE_STACK_FRAME(_hx_pos_c69022abc8c5c26b_300_registerObject,"flixel.system.debug.console.Console","registerObject",0x0bbfe598,"flixel.system.debug.console.Console.registerObject","flixel/system/debug/console/Console.hx",300,0x367943c8)
HX_DEFINE_STACK_FRAME(_hx_pos_c69022abc8c5c26b_313_registerClass,"flixel.system.debug.console.Console","registerClass",0x7ad06f7f,"flixel.system.debug.console.Console.registerClass","flixel/system/debug/console/Console.hx",313,0x367943c8)
HX_DEFINE_STACK_FRAME(_hx_pos_c69022abc8c5c26b_317_destroy,"flixel.system.debug.console.Console","destroy",0x788f2624,"flixel.system.debug.console.Console.destroy","flixel/system/debug/console/Console.hx",317,0x367943c8)
HX_DEFINE_STACK_FRAME(_hx_pos_c69022abc8c5c26b_343_updateSize,"flixel.system.debug.console.Console","updateSize",0x97e42880,"flixel.system.debug.console.Console.updateSize","flixel/system/debug/console/Console.hx",343,0x367943c8)
HX_DEFINE_STACK_FRAME(_hx_pos_c69022abc8c5c26b_37_boot,"flixel.system.debug.console.Console","boot",0x712d8cc8,"flixel.system.debug.console.Console.boot","flixel/system/debug/console/Console.hx",37,0x367943c8)
namespace flixel{
...
HXLINE( 100)		this->input->set_defaultTextFormat( ::openfl::_legacy::text::TextFormat_obj::__alloc( HX_CTX ,::flixel::_hx_system::FlxAssets_obj::FONT_DEBUGGER,(int)12,(int)16777215,false,false,false,null(),null(),null(),null(),null(),null(),null()));
HXLINE( 102)		this->input->set_text(HX_("Using the console requires hscript - please run 'haxelib install hscript'.",1a,91,ca,5f));
HXLINE( 103)		this->input->set_width((this->_width - (int)4));
HXLINE( 104)		this->input->set_height((this->_height - (int)15));
...
HXLINE( 126)			_gthis->stageMouseDown = true;
            	...
            	HX_STACK_THIS(this)
HXLINE( 110)		HX_VARI(  ::flixel::_hx_system::debug::console::Console,_gthis) = hx::ObjectPtr<OBJ_>(this);
...
void Console_obj::registerClass(hx::Class cl){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(cl,"cl")
HXLINE( 313)		::String objectAlias = ::flixel::util::FlxStringUtil_obj::getClassName(cl,true);
...
HXLINE( 346)		this->input->set_width((this->_width - (int)4));
HXLINE( 347)		this->input->set_height((this->_height - (int)15));
            	}
...
HXLINE(  37)		DEFAULT_TEXT = HX_("Using the console requires hscript - please run 'haxelib install hscript'.",1a,91,ca,5f);
            	}
}
