...
HX_DEFINE_STACK_FRAME(_hx_pos_741757cec8ede88f_21_init,"flixel.system.debug.interaction.tools.Eraser","init",0x188d11db,"flixel.system.debug.interaction.tools.Eraser.init","flixel/system/debug/interaction/tools/Eraser.hx",21,0xa546bf98)
HX_DEFINE_STACK_FRAME(_hx_pos_741757cec8ede88f_29_update,"flixel.system.debug.interaction.tools.Eraser","update",0x1312e594,"flixel.system.debug.interaction.tools.Eraser.update","flixel/system/debug/interaction/tools/Eraser.hx",29,0xa546bf98)
HX_DEFINE_STACK_FRAME(_hx_pos_741757cec8ede88f_34_activate,"flixel.system.debug.interaction.tools.Eraser","activate",0x9778b3fe,"flixel.system.debug.interaction.tools.Eraser.activate","flixel/system/debug/interaction/tools/Eraser.hx",34,0xa546bf98)
HX_DEFINE_STACK_FRAME(_hx_pos_741757cec8ede88f_42_doDeletion,"flixel.system.debug.interaction.tools.Eraser","doDeletion",0x007d62c4,"flixel.system.debug.interaction.tools.Eraser.doDeletion","flixel/system/debug/interaction/tools/Eraser.hx",42,0xa546bf98)
HX_DEFINE_STACK_FRAME(_hx_pos_741757cec8ede88f_53_findAndDelete,"flixel.system.debug.interaction.tools.Eraser","findAndDelete",0xc5f7a2be,"flixel.system.debug.interaction.tools.Eraser.findAndDelete","flixel/system/debug/interaction/tools/Eraser.hx",53,0xa546bf98)
HX_DEFINE_STACK_FRAME(_hx_pos_741757cec8ede88f_73_removeFromMemory,"flixel.system.debug.interaction.tools.Eraser","removeFromMemory",0x828b48ba,"flixel.system.debug.interaction.tools.Eraser.removeFromMemory","flixel/system/debug/interaction/tools/Eraser.hx",73,0xa546bf98)
namespace flixel{
...
void Eraser_obj::update(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  29)		if (this->_brain->keyJustPressed((int)46)) {
...
bool remove = __o_remove.Default(false);
            	...
            	HX_STACK_ARG(remove,"remove")
HXLINE(  53)		HX_VARI(  ::flixel::group::FlxTypedGroupIterator,member) =  ::flixel::group::FlxTypedGroupIterator_obj::__alloc( HX_CTX ,items->members,null());
HXDLIN(  53)		while(member->hasNext()){
HXLINE(  53)			HX_VARI_NAME(  ::flixel::FlxObject,member1,"member") = member->next().StaticCast<  ::flixel::FlxObject >();
