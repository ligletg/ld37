...
HX_DEFINE_STACK_FRAME(_hx_pos_6e4222c53e856503_1_boot,"flixel.system.debug.GraphicArrowLeft","boot",0x1c4f2610,"flixel.system.debug.GraphicArrowLeft.boot","?",1,0x0000003f)
namespace flixel{
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::GraphicArrowLeft_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_GraphicArrowLeft",07,17,f4,7a);
            	}
}
