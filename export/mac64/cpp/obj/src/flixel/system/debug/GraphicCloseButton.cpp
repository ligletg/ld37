...
HX_DEFINE_STACK_FRAME(_hx_pos_f3bdba00b85a0c40_1_boot,"flixel.system.debug.GraphicCloseButton","boot",0xd5af4676,"flixel.system.debug.GraphicCloseButton.boot","?",1,0x0000003f)
namespace flixel{
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::GraphicCloseButton_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_GraphicCloseButton",21,6c,f7,70);
            	}
}
