...
HX_DEFINE_STACK_FRAME(_hx_pos_2a234d999e4b3fc8_56_getTextColor,"flixel.system.debug.watch.WatchEntry","getTextColor",0xd55318e4,"flixel.system.debug.watch.WatchEntry.getTextColor","flixel/system/debug/watch/WatchEntry.hx",56,0x2bd112d2)
HX_DEFINE_STACK_FRAME(_hx_pos_2a234d999e4b3fc8_65_initTextField,"flixel.system.debug.watch.WatchEntry","initTextField",0x8df9f439,"flixel.system.debug.watch.WatchEntry.initTextField","flixel/system/debug/watch/WatchEntry.hx",65,0x2bd112d2)
HX_DEFINE_STACK_FRAME(_hx_pos_2a234d999e4b3fc8_75_updateSize,"flixel.system.debug.watch.WatchEntry","updateSize",0x108dc54e,"flixel.system.debug.watch.WatchEntry.updateSize","flixel/system/debug/watch/WatchEntry.hx",75,0x2bd112d2)
HX_DEFINE_STACK_FRAME(_hx_pos_2a234d999e4b3fc8_85_updateName,"flixel.system.debug.watch.WatchEntry","updateName",0x0d3996d8,"flixel.system.debug.watch.WatchEntry.updateName","flixel/system/debug/watch/WatchEntry.hx",85,0x2bd112d2)
HX_DEFINE_STACK_FRAME(_hx_pos_2a234d999e4b3fc8_103_setNameText,"flixel.system.debug.watch.WatchEntry","setNameText",0x82ef23f6,"flixel.system.debug.watch.WatchEntry.setNameText","flixel/system/debug/watch/WatchEntry.hx",103,0x2bd112d2)
HX_DEFINE_STACK_FRAME(_hx_pos_2a234d999e4b3fc8_111_getValue,"flixel.system.debug.watch.WatchEntry","getValue",0xc769c7df,"flixel.system.debug.watch.WatchEntry.getValue","flixel/system/debug/watch/WatchEntry.hx",111,0x2bd112d2)
HX_DEFINE_STACK_FRAME(_hx_pos_2a234d999e4b3fc8_127_getFormattedValue,"flixel.system.debug.watch.WatchEntry","getFormattedValue",0xb861eca7,"flixel.system.debug.watch.WatchEntry.getFormattedValue","flixel/system/debug/watch/WatchEntry.hx",127,0x2bd112d2)
HX_DEFINE_STACK_FRAME(_hx_pos_2a234d999e4b3fc8_136_submitValue,"flixel.system.debug.watch.WatchEntry","submitValue",0x1e7eadd5,"flixel.system.debug.watch.WatchEntry.submitValue","flixel/system/debug/watch/WatchEntry.hx",136,0x2bd112d2)
HX_DEFINE_STACK_FRAME(_hx_pos_2a234d999e4b3fc8_146_updateValue,"flixel.system.debug.watch.WatchEntry","updateValue",0x205e5644,"flixel.system.debug.watch.WatchEntry.updateValue","flixel/system/debug/watch/WatchEntry.hx",146,0x2bd112d2)
HX_DEFINE_STACK_FRAME(_hx_pos_2a234d999e4b3fc8_152_getNameWidth,"flixel.system.debug.watch.WatchEntry","getNameWidth",0xb6209b29,"flixel.system.debug.watch.WatchEntry.getNameWidth","flixel/system/debug/watch/WatchEntry.hx",152,0x2bd112d2)
HX_DEFINE_STACK_FRAME(_hx_pos_2a234d999e4b3fc8_157_getMinWidth,"flixel.system.debug.watch.WatchEntry","getMinWidth",0xf09b5366,"flixel.system.debug.watch.WatchEntry.getMinWidth","flixel/system/debug/watch/WatchEntry.hx",157,0x2bd112d2)
HX_DEFINE_STACK_FRAME(_hx_pos_2a234d999e4b3fc8_161_destroy,"flixel.system.debug.watch.WatchEntry","destroy",0x012d9c96,"flixel.system.debug.watch.WatchEntry.destroy","flixel/system/debug/watch/WatchEntry.hx",161,0x2bd112d2)
HX_DEFINE_STACK_FRAME(_hx_pos_2a234d999e4b3fc8_22_boot,"flixel.system.debug.watch.WatchEntry","boot",0x6fe67b16,"flixel.system.debug.watch.WatchEntry.boot","flixel/system/debug/watch/WatchEntry.hx",22,0x2bd112d2)
HX_DEFINE_STACK_FRAME(_hx_pos_2a234d999e4b3fc8_23_boot,"flixel.system.debug.watch.WatchEntry","boot",0x6fe67b16,"flixel.system.debug.watch.WatchEntry.boot","flixel/system/debug/watch/WatchEntry.hx",23,0x2bd112d2)
HX_DEFINE_STACK_FRAME(_hx_pos_2a234d999e4b3fc8_24_boot,"flixel.system.debug.watch.WatchEntry","boot",0x6fe67b16,"flixel.system.debug.watch.WatchEntry.boot","flixel/system/debug/watch/WatchEntry.hx",24,0x2bd112d2)
namespace flixel{
...
HXLINE(  43)		HX_VARI(  ::ValueType,expectedType) = ::Type_obj::_hx_typeof(this->getValue());
...
int WatchEntry_obj::getTextColor(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  56)		switch((int)(_hx_getEnumValueIndex(this->data))){
            			case (int)0: {
...
HXLINE(  76)		HX_VARI( Float,textWidth) = ((windowWidth - this->removeButton->get_width()) - (int)4);
...
HXLINE(  92)		{
HXLINE(  92)			HX_VARI(  ::flixel::_hx_system::debug::watch::WatchEntryData,_g) = this->data;
HXDLIN(  92)			switch((int)(_hx_getEnumValueIndex(_g))){
            				case (int)0: {
HXLINE(  95)					this->setNameText(((::flixel::util::FlxStringUtil_obj::getClassName(_g->_hx_getObject(0),true) + HX_(".",2e,00,00,00)) + _g->_hx_getString(1)));
            				}
            				break;
            				case (int)1: {
            				}
...
HXLINE( 105)		HX_VARI( Float,currentWidth) = (this->nameText->get_textWidth() + (int)4);
HXLINE( 106)		this->nameText->set_width(::Math_obj::min(currentWidth,(int)125));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(WatchEntry_obj,setNameText,(void))
 ...
 ::Dynamic WatchEntry_obj::getValue(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 111)		HX_VARI(  ::flixel::_hx_system::debug::watch::WatchEntryData,_g) = this->data;
...
HXLINE( 111)				return _g->_hx_getString(0);
            			...
            			break;
            			case (int)2: {
HXLINE( 111)				return HX_("hscript is not installed",84,84,f9,28);
            			}
            			break;
            		}
...
HXLINE( 136)		HX_VARI(  ::flixel::_hx_system::debug::watch::WatchEntryData,_g) = this->data;
...
void WatchEntry_obj::updateValue(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 146)		if (!(this->valueText->isEditing)) {
...
Float WatchEntry_obj::getMinWidth(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 157)		Float _hx_tmp = (this->valueText->get_x() + (int)8);
