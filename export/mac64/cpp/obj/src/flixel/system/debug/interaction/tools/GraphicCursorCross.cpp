...
HX_DEFINE_STACK_FRAME(_hx_pos_d3734fbf89df3b5e_1_boot,"flixel.system.debug.interaction.tools.GraphicCursorCross","boot",0x6f198a87,"flixel.system.debug.interaction.tools.GraphicCursorCross.boot","?",1,0x0000003f)
namespace flixel{
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::interaction::tools::GraphicCursorCross_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_interaction_tools_GraphicCursorCross",12,f7,e2,fa);
            	}
}
