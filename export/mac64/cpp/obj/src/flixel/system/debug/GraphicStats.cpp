...
HX_DEFINE_STACK_FRAME(_hx_pos_b867a354763055c8_2010_new,"flixel.system.debug.GraphicStats","new",0xb5925771,"flixel.system.debug.GraphicStats.new","openfl/_legacy/Assets.hx",2010,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_f1c5fdc734e3a086_1_boot,"flixel.system.debug.GraphicStats","boot",0x22932c01,"flixel.system.debug.GraphicStats.boot","?",1,0x0000003f)
namespace flixel{
...
void GraphicStats_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACKFRAME(&_hx_pos_b867a354763055c8_2010_new)
            	HX_STACK_THIS(this)
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::GraphicStats_obj::resourceName));
...
bool GraphicStats_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x0cd766e7) {
		...
		return inClassId==(int)0x6ed2861f;
	}
}
...
static hx::StaticInfo GraphicStats_obj_sStaticStorageInfo[] = {
	{hx::fsString,(void *) &GraphicStats_obj::resourceName,HX_HCSTRING("resourceName","\x39","\x7a","\x62","\x90")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
{
{
            	HX_STACKFRAME(&_hx_pos_f1c5fdc734e3a086_1_boot)
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_GraphicStats",36,ef,43,45);
            	}
}
