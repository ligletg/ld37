...
HX_DEFINE_STACK_FRAME(_hx_pos_cb03c3d9d9578e55_1_boot,"flixel.system.debug.interaction.tools.GraphicEraserTool","boot",0xa917638b,"flixel.system.debug.interaction.tools.GraphicEraserTool.boot","?",1,0x0000003f)
namespace flixel{
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::interaction::tools::GraphicEraserTool_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_interaction_tools_GraphicEraserTool",fc,e0,4e,03);
            	}
}
