...
HX_DEFINE_STACK_FRAME(_hx_pos_a572caf517e025a2_1_boot,"flixel.system.debug._VCR.GraphicRecordOff","boot",0xee16538a,"flixel.system.debug._VCR.GraphicRecordOff.boot","?",1,0x0000003f)
namespace flixel{
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::_VCR::GraphicRecordOff_obj::resourceName));
