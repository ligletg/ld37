...
HX_DEFINE_STACK_FRAME(_hx_pos_80093d47a78edb3b_28_updateHandle,"flixel.system.debug.completion.CompletionListScrollBar","updateHandle",0x7238a89d,"flixel.system.debug.completion.CompletionListScrollBar.updateHandle","flixel/system/debug/completion/CompletionListScrollBar.hx",28,0x884a099c)
HX_DEFINE_STACK_FRAME(_hx_pos_80093d47a78edb3b_10_boot,"flixel.system.debug.completion.CompletionListScrollBar","boot",0x8660163e,"flixel.system.debug.completion.CompletionListScrollBar.boot","flixel/system/debug/completion/CompletionListScrollBar.hx",10,0x884a099c)
HX_DEFINE_STACK_FRAME(_hx_pos_80093d47a78edb3b_11_boot,"flixel.system.debug.completion.CompletionListScrollBar","boot",0x8660163e,"flixel.system.debug.completion.CompletionListScrollBar.boot","flixel/system/debug/completion/CompletionListScrollBar.hx",11,0x884a099c)
namespace flixel{
...
HXDLIN(  31)		HX_VARI( Float,Value) = this->handle->get_y();
HXDLIN(  31)		HX_VARI( Float,Max) = this->get_height();
HXDLIN(  31)		HX_VARI_NAME(  ::Dynamic,Max1,"Max") = (Max - this->handle->get_scaleY());
