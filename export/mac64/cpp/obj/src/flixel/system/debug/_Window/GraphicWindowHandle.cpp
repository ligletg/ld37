...
HX_DEFINE_STACK_FRAME(_hx_pos_2a339334f8daac5e_2010_new,"flixel.system.debug._Window.GraphicWindowHandle","new",0x4f36000b,"flixel.system.debug._Window.GraphicWindowHandle.new","openfl/_legacy/Assets.hx",2010,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_2cfcd99d9199a9d5_1_boot,"flixel.system.debug._Window.GraphicWindowHandle","boot",0xf8230a27,"flixel.system.debug._Window.GraphicWindowHandle.boot","?",1,0x0000003f)
namespace flixel{
...
void GraphicWindowHandle_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACKFRAME(&_hx_pos_2a339334f8daac5e_2010_new)
            	HX_STACK_THIS(this)
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::_Window::GraphicWindowHandle_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug__Window_GraphicWindowHandle",b1,52,a1,65);
            	}
}
