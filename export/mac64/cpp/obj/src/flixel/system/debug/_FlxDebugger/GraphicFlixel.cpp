...
HX_DEFINE_STACK_FRAME(_hx_pos_e391139918871a05_1_boot,"flixel.system.debug._FlxDebugger.GraphicFlixel","boot",0xf98a79ee,"flixel.system.debug._FlxDebugger.GraphicFlixel.boot","?",1,0x0000003f)
namespace flixel{
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::_FlxDebugger::GraphicFlixel_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug__FlxDebugger_GraphicFlixel",d8,af,bc,0c);
            	}
}
