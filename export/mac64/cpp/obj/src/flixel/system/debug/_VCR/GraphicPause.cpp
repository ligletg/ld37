...
HX_DEFINE_STACK_FRAME(_hx_pos_f6414ef2a8b1fac0_1_boot,"flixel.system.debug._VCR.GraphicPause","boot",0xd5b076f2,"flixel.system.debug._VCR.GraphicPause.boot","?",1,0x0000003f)
namespace flixel{
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::_VCR::GraphicPause_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug__VCR_GraphicPause",c8,9f,12,2a);
            	}
}
