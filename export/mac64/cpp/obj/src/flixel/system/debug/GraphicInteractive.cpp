...
HX_DEFINE_STACK_FRAME(_hx_pos_2bdf57bec64ef88d_2010_new,"flixel.system.debug.GraphicInteractive","new",0x8c45a4b4,"flixel.system.debug.GraphicInteractive.new","openfl/_legacy/Assets.hx",2010,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_1feb984ebe451c64_1_boot,"flixel.system.debug.GraphicInteractive","boot",0x28c3795e,"flixel.system.debug.GraphicInteractive.boot","?",1,0x0000003f)
namespace flixel{
...
void GraphicInteractive_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACKFRAME(&_hx_pos_2bdf57bec64ef88d_2010_new)
            	HX_STACK_THIS(this)
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::GraphicInteractive_obj::resourceName));
...
bool GraphicInteractive_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x0cd766e7) {
		...
		return inClassId==(int)0x4dcc4de2;
	}
}
...
static hx::StaticInfo GraphicInteractive_obj_sStaticStorageInfo[] = {
	{hx::fsString,(void *) &GraphicInteractive_obj::resourceName,HX_HCSTRING("resourceName","\x39","\x7a","\x62","\x90")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
{
{
            	HX_STACKFRAME(&_hx_pos_1feb984ebe451c64_1_boot)
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_GraphicInteractive",39,22,20,19);
            	}
}
