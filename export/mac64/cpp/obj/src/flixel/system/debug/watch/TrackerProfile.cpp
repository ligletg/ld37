...
HX_DEFINE_STACK_FRAME(_hx_pos_045fa5a979169169_241_toString,"flixel.system.debug.watch.TrackerProfile","toString",0x9a236fa2,"flixel.system.debug.watch.TrackerProfile.toString","flixel/system/debug/watch/Tracker.hx",241,0x14368dcf)
namespace flixel{
...
HXDLIN( 242)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 242)		_this->label = HX_("variables",b7,e2,62,82);
HXDLIN( 242)		_this->value = value;
HXLINE( 243)		 ::Dynamic value1 = this->extensions;
HXDLIN( 243)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this1,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
