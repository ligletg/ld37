...
HX_DEFINE_STACK_FRAME(_hx_pos_6f944dca4f3bb528_54_setLayout,"flixel.system.frontEnds.DebuggerFrontEnd","setLayout",0x96c2386b,"flixel.system.frontEnds.DebuggerFrontEnd.setLayout","flixel/system/frontEnds/DebuggerFrontEnd.hx",54,0x2ebb4b30)
HX_DEFINE_STACK_FRAME(_hx_pos_6f944dca4f3bb528_64_resetLayout,"flixel.system.frontEnds.DebuggerFrontEnd","resetLayout",0xc33ca418,"flixel.system.frontEnds.DebuggerFrontEnd.resetLayout","flixel/system/frontEnds/DebuggerFrontEnd.hx",64,0x2ebb4b30)
HX_DEFINE_STACK_FRAME(_hx_pos_6f944dca4f3bb528_81_addButton,"flixel.system.frontEnds.DebuggerFrontEnd","addButton",0x7066ab72,"flixel.system.frontEnds.DebuggerFrontEnd.addButton","flixel/system/frontEnds/DebuggerFrontEnd.hx",81,0x2ebb4b30)
HX_DEFINE_STACK_FRAME(_hx_pos_6f944dca4f3bb528_95_track,"flixel.system.frontEnds.DebuggerFrontEnd","track",0x1a1fb78a,"flixel.system.frontEnds.DebuggerFrontEnd.track","flixel/system/frontEnds/DebuggerFrontEnd.hx",95,0x2ebb4b30)
HX_DEFINE_STACK_FRAME(_hx_pos_6f944dca4f3bb528_121_addTrackerProfile,"flixel.system.frontEnds.DebuggerFrontEnd","addTrackerProfile",0xb36941d1,"flixel.system.frontEnds.DebuggerFrontEnd.addTrackerProfile","flixel/system/frontEnds/DebuggerFrontEnd.hx",121,0x2ebb4b30)
HX_DEFINE_STACK_FRAME(_hx_pos_6f944dca4f3bb528_134_removeButton,"flixel.system.frontEnds.DebuggerFrontEnd","removeButton",0xa0228237,"flixel.system.frontEnds.DebuggerFrontEnd.removeButton","flixel/system/frontEnds/DebuggerFrontEnd.hx",134,0x2ebb4b30)
...
HXLINE(  27)		this->toggleKeys = ::Array_obj< int >::fromData( _hx_array_data_ec6bb02d_1,3);
...
void DebuggerFrontEnd_obj::setLayout( ::flixel::_hx_system::debug::FlxDebuggerLayout Layout){
            	HX_STACKFRAME(&_hx_pos_6f944dca4f3bb528_54_setLayout)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Layout,"Layout")
HXLINE(  54)		HX_VARI(  ::flixel::_hx_system::debug::FlxDebugger,_this) = ::flixel::FlxG_obj::game->debugger;
HXDLIN(  54)		_this->_layout = Layout;
HXDLIN(  54)		_this->resetLayout();
            	}
...
void DebuggerFrontEnd_obj::resetLayout(){
            	HX_STACKFRAME(&_hx_pos_6f944dca4f3bb528_64_resetLayout)
            	HX_STACK_THIS(this)
HXLINE(  64)		::flixel::FlxG_obj::game->debugger->resetLayout();
            	}


HX_DEFINE_DYNAMIC_FUNC0(DebuggerFrontEnd_obj,resetLayout,(void))

 ::flixel::_hx_system::ui::FlxSystemButton DebuggerFrontEnd_obj::addButton( ::flixel::util::FlxHorizontalAlign Alignment, ::openfl::_legacy::display::BitmapData Icon, ::Dynamic UpHandler,hx::Null< bool >  __o_ToggleMode,hx::Null< bool >  __o_UpdateLayout){
bool ToggleMode = __o_ToggleMode.Default(false);
bool UpdateLayout = __o_UpdateLayout.Default(true);
            	HX_STACKFRAME(&_hx_pos_6f944dca4f3bb528_81_addButton)
            	HX_STACK_THIS(this)
...
HXLINE(  81)		return ::flixel::FlxG_obj::game->debugger->addButton(Alignment,Icon,UpHandler,ToggleMode,UpdateLayout);
            	}
...
HX_DEFINE_DYNAMIC_FUNC5(DebuggerFrontEnd_obj,addButton,return )
 ...
 ::flixel::_hx_system::debug::Window DebuggerFrontEnd_obj::track( ::Dynamic ObjectOrClass,::String WindowTitle){
            	HX_GC_STACKFRAME(&_hx_pos_6f944dca4f3bb528_95_track)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(ObjectOrClass,"ObjectOrClass")
            	HX_STACK_ARG(WindowTitle,"WindowTitle")
HXLINE(  97)		if ((::flixel::_hx_system::debug::watch::Tracker_obj::objectsBeingTracked->indexOf(ObjectOrClass,null()) != (int)-1)) {
HXLINE(  98)			return null();
            		}
HXLINE( 100)		HX_VARI(  ::flixel::_hx_system::debug::watch::TrackerProfile,profile) = ::flixel::_hx_system::debug::watch::Tracker_obj::findProfile(ObjectOrClass);
HXLINE( 101)		if (hx::IsNull( profile )) {
HXLINE( 103)			{
HXLINE( 103)				 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 103)				 ::Dynamic Data = ((HX_("Could not find a tracking profile for object of class '",1a,ec,71,30) + ::flixel::util::FlxStringUtil_obj::getClassName(ObjectOrClass,true)) + HX_("'.",27,22,00,00));
HXDLIN( 103)				_this->advanced(Data,::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            			}
HXLINE( 105)			return null();
            		}
            		else {
HXLINE( 108)			HX_VARI_NAME(  ::flixel::_hx_system::debug::FlxDebugger,_this1,"_this") = ::flixel::FlxG_obj::game->debugger;
HXDLIN( 108)			HX_VARI(  ::flixel::_hx_system::debug::Window,window) =  ::flixel::_hx_system::debug::watch::Tracker_obj::__alloc( HX_CTX ,profile,ObjectOrClass,WindowTitle);
HXDLIN( 108)			_this1->_windows->push(window);
HXDLIN( 108)			_this1->addChild(window);
HXDLIN( 108)			if (hx::IsNotNull( _this1->_screenBounds )) {
HXLINE( 108)				_this1->updateBounds();
HXDLIN( 108)				window->bound();
            			}
HXDLIN( 108)			return window;
            		}
...
void DebuggerFrontEnd_obj::addTrackerProfile( ::flixel::_hx_system::debug::watch::TrackerProfile Profile){
            	HX_STACKFRAME(&_hx_pos_6f944dca4f3bb528_121_addTrackerProfile)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Profile,"Profile")
HXLINE( 121)		if (hx::IsNotNull( Profile )) {
HXLINE( 121)			::flixel::_hx_system::debug::watch::Tracker_obj::initProfiles();
HXDLIN( 121)			::flixel::_hx_system::debug::watch::Tracker_obj::profiles->push(Profile);
            		}
            	}
...
bool UpdateLayout = __o_UpdateLayout.Default(true);
            	HX_STACKFRAME(&_hx_pos_6f944dca4f3bb528_134_removeButton)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Button,"Button")
            	HX_STACK_ARG(UpdateLayout,"UpdateLayout")
HXLINE( 134)		::flixel::FlxG_obj::game->debugger->removeButton(Button,UpdateLayout);
            	}
...
HXLINE( 148)		this->drawDebugChanged->dispatch();
...
HXLINE( 161)		::flixel::FlxG_obj::game->debugger->set_visible(Value);
HXLINE( 165)		if (!(Value)) {
HXLINE( 167)			::openfl::_legacy::Lib_obj::get_current()->get_stage()->set_stageFocusRect(false);
HXLINE( 168)			::openfl::_legacy::Lib_obj::get_current()->get_stage()->set_focus(::flixel::FlxG_obj::game);
            		}
HXLINE( 171)		this->visibilityChanged->dispatch();
