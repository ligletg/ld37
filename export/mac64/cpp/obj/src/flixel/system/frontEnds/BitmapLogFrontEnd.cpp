...
HX_DEFINE_STACK_FRAME(_hx_pos_729ca37c5683ec35_11_add,"flixel.system.frontEnds.BitmapLogFrontEnd","add",0xa17c2360,"flixel.system.frontEnds.BitmapLogFrontEnd.add","flixel/system/frontEnds/BitmapLogFrontEnd.hx",11,0x20ede752)
HX_DEFINE_STACK_FRAME(_hx_pos_729ca37c5683ec35_21_clear,"flixel.system.frontEnds.BitmapLogFrontEnd","clear",0x3f6bb08c,"flixel.system.frontEnds.BitmapLogFrontEnd.clear","flixel/system/frontEnds/BitmapLogFrontEnd.hx",21,0x20ede752)
HX_DEFINE_STACK_FRAME(_hx_pos_729ca37c5683ec35_32_clearAt,"flixel.system.frontEnds.BitmapLogFrontEnd","clearAt",0xb622249f,"flixel.system.frontEnds.BitmapLogFrontEnd.clearAt","flixel/system/frontEnds/BitmapLogFrontEnd.hx",32,0x20ede752)
...
HXLINE(  11)		::flixel::FlxG_obj::game->debugger->bitmapLog->add(Data,Name);
            	}
...
void BitmapLogFrontEnd_obj::clear(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  21)		::flixel::FlxG_obj::game->debugger->bitmapLog->clear();
            	}
...
HXLINE(  32)		::flixel::FlxG_obj::game->debugger->bitmapLog->clearAt(Index);
            	}
...
HXLINE(  43)		{
HXLINE(  43)			HX_VARI(  ::Dynamic,cachedGraphic) = ::flixel::FlxG_obj::bitmap->_cache->iterator();
HXDLIN(  43)			while(( (bool)(cachedGraphic->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(  43)				HX_VARI_NAME(  ::flixel::graphics::FlxGraphic,cachedGraphic1,"cachedGraphic") = ( ( ::flixel::graphics::FlxGraphic)(cachedGraphic->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
