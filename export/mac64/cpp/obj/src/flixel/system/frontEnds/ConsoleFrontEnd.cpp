...
HX_DEFINE_STACK_FRAME(_hx_pos_2427e5c2ee20ebaa_29_registerFunction,"flixel.system.frontEnds.ConsoleFrontEnd","registerFunction",0xa673a5ba,"flixel.system.frontEnds.ConsoleFrontEnd.registerFunction","flixel/system/frontEnds/ConsoleFrontEnd.hx",29,0x0ff3a650)
HX_DEFINE_STACK_FRAME(_hx_pos_2427e5c2ee20ebaa_42_registerObject,"flixel.system.frontEnds.ConsoleFrontEnd","registerObject",0x557f2ce1,"flixel.system.frontEnds.ConsoleFrontEnd.registerObject","flixel/system/frontEnds/ConsoleFrontEnd.hx",42,0x0ff3a650)
HX_DEFINE_STACK_FRAME(_hx_pos_2427e5c2ee20ebaa_54_registerClass,"flixel.system.frontEnds.ConsoleFrontEnd","registerClass",0x3d276456,"flixel.system.frontEnds.ConsoleFrontEnd.registerClass","flixel/system/frontEnds/ConsoleFrontEnd.hx",54,0x0ff3a650)
namespace flixel{
...
HXLINE(  29)		::haxe::IMap_obj::set(::flixel::FlxG_obj::game->debugger->console->registeredFunctions,FunctionAlias,Function);
            	}
...
HXLINE(  42)		::haxe::IMap_obj::set(::flixel::FlxG_obj::game->debugger->console->registeredObjects,ObjectAlias,AnyObject);
            	}
...
void ConsoleFrontEnd_obj::registerClass(hx::Class cl){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(cl,"cl")
HXLINE(  54)		 ::flixel::_hx_system::debug::console::Console _this = ::flixel::FlxG_obj::game->debugger->console;
HXDLIN(  54)		{
HXLINE(  54)			::String objectAlias = ::flixel::util::FlxStringUtil_obj::getClassName(cl,true);
