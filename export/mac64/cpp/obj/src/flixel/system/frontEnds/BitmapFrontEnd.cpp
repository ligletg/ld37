...
HXLINE( 305)			::openfl::_legacy::IAssetCache_obj::removeBitmapData(::openfl::_legacy::Assets_obj::cache,key);
...
int BitmapFrontEnd_obj::get_maxTextureSize(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 373)		return ( (int)(::openfl::_legacy::gl::GL_obj::lime_gl_get_parameter((int)3379)) );
            	}
...
HXLINE( 381)			HX_VARI(  ::openfl::_legacy::display::BitmapData,bd) =  ::openfl::_legacy::display::BitmapData_obj::__alloc( HX_CTX ,(int)10,(int)10,true,(int)-1,null());
