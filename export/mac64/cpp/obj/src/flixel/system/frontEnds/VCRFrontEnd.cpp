...
HX_DEFINE_STACK_FRAME(_hx_pos_9c3075758433de87_60_pause,"flixel.system.frontEnds.VCRFrontEnd","pause",0x6797a245,"flixel.system.frontEnds.VCRFrontEnd.pause","flixel/system/frontEnds/VCRFrontEnd.hx",60,0xa1666a42)
HX_DEFINE_STACK_FRAME(_hx_pos_9c3075758433de87_80_resume,"flixel.system.frontEnds.VCRFrontEnd","resume",0x5616837e,"flixel.system.frontEnds.VCRFrontEnd.resume","flixel/system/frontEnds/VCRFrontEnd.hx",80,0xa1666a42)
namespace flixel{
...
HXLINE(  70)			{
HXLINE(  70)				HX_VARI(  ::flixel::_hx_system::debug::VCR,_this) = ::flixel::FlxG_obj::game->debugger->vcr;
HXDLIN(  70)				_this->playbackToggleBtn->upHandler = ::flixel::FlxG_obj::vcr->resume_dyn();
HXDLIN(  70)				HX_VARI_NAME(  ::flixel::_hx_system::ui::FlxSystemButton,_this1,"_this") = _this->playbackToggleBtn;
...
HXLINE(  90)			{
HXLINE(  90)				HX_VARI(  ::flixel::_hx_system::debug::VCR,_this) = ::flixel::FlxG_obj::game->debugger->vcr;
HXDLIN(  90)				_this->playbackToggleBtn->upHandler = ::flixel::FlxG_obj::vcr->pause_dyn();
HXDLIN(  90)				HX_VARI_NAME(  ::flixel::_hx_system::ui::FlxSystemButton,_this1,"_this") = _this->playbackToggleBtn;
