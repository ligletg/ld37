...
HX_DEFINE_STACK_FRAME(_hx_pos_25766fbc3da200fe_20_add,"flixel.system.frontEnds.WatchFrontEnd","add",0xbd17f1da,"flixel.system.frontEnds.WatchFrontEnd.add","flixel/system/frontEnds/WatchFrontEnd.hx",20,0xd7ade198)
HX_DEFINE_STACK_FRAME(_hx_pos_25766fbc3da200fe_33_remove,"flixel.system.frontEnds.WatchFrontEnd","remove",0x8d8c762b,"flixel.system.frontEnds.WatchFrontEnd.remove","flixel/system/frontEnds/WatchFrontEnd.hx",33,0xd7ade198)
HX_DEFINE_STACK_FRAME(_hx_pos_25766fbc3da200fe_48_addQuick,"flixel.system.frontEnds.WatchFrontEnd","addQuick",0x8c660eb3,"flixel.system.frontEnds.WatchFrontEnd.addQuick","flixel/system/frontEnds/WatchFrontEnd.hx",48,0xd7ade198)
HX_DEFINE_STACK_FRAME(_hx_pos_25766fbc3da200fe_60_removeQuick,"flixel.system.frontEnds.WatchFrontEnd","removeQuick",0x15fb44c2,"flixel.system.frontEnds.WatchFrontEnd.removeQuick","flixel/system/frontEnds/WatchFrontEnd.hx",60,0xd7ade198)
HX_DEFINE_STACK_FRAME(_hx_pos_25766fbc3da200fe_75_addExpression,"flixel.system.frontEnds.WatchFrontEnd","addExpression",0xe5869c12,"flixel.system.frontEnds.WatchFrontEnd.addExpression","flixel/system/frontEnds/WatchFrontEnd.hx",75,0xd7ade198)
HX_DEFINE_STACK_FRAME(_hx_pos_25766fbc3da200fe_88_removeExpression,"flixel.system.frontEnds.WatchFrontEnd","removeExpression",0xc4a80fa3,"flixel.system.frontEnds.WatchFrontEnd.removeExpression","flixel/system/frontEnds/WatchFrontEnd.hx",88,0xd7ade198)
HX_DEFINE_STACK_FRAME(_hx_pos_25766fbc3da200fe_99_addMouse,"flixel.system.frontEnds.WatchFrontEnd","addMouse",0x3add9deb,"flixel.system.frontEnds.WatchFrontEnd.addMouse","flixel/system/frontEnds/WatchFrontEnd.hx",99,0xd7ade198)
HX_DEFINE_STACK_FRAME(_hx_pos_25766fbc3da200fe_109_removeMouse,"flixel.system.frontEnds.WatchFrontEnd","removeMouse",0xc472d3fa,"flixel.system.frontEnds.WatchFrontEnd.removeMouse","flixel/system/frontEnds/WatchFrontEnd.hx",109,0xd7ade198)
namespace flixel{
...
HXLINE(  20)		::flixel::FlxG_obj::game->debugger->watch->add(displayName,::flixel::_hx_system::debug::watch::WatchEntryData_obj::FIELD(object,field));
            	}
...
void WatchFrontEnd_obj::remove( ::Dynamic object,::String field){
            	...
            	HX_STACK_ARG(object,"object")
            	HX_STACK_ARG(field,"field")
HXLINE(  33)		::flixel::FlxG_obj::game->debugger->watch->remove(null(),::flixel::_hx_system::debug::watch::WatchEntryData_obj::FIELD(object,field));
            	}
...
HXLINE(  48)		::flixel::FlxG_obj::game->debugger->watch->add(displayName,::flixel::_hx_system::debug::watch::WatchEntryData_obj::QUICK(value));
            	}
...
void WatchFrontEnd_obj::removeQuick(::String displayName){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(displayName,"displayName")
HXLINE(  60)		::flixel::FlxG_obj::game->debugger->watch->remove(displayName,::flixel::_hx_system::debug::watch::WatchEntryData_obj::QUICK(null()));
            	}
...
void WatchFrontEnd_obj::addExpression(::String expression,::String displayName){
            	...
            	HX_STACK_ARG(displayName,"displayName")
HXLINE(  75)		::flixel::FlxG_obj::game->debugger->watch->add(displayName,::flixel::_hx_system::debug::watch::WatchEntryData_obj::EXPRESSION(expression));
            	}
...
void WatchFrontEnd_obj::removeExpression(::String expression){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(expression,"expression")
HXLINE(  88)		::flixel::FlxG_obj::game->debugger->watch->remove(null(),::flixel::_hx_system::debug::watch::WatchEntryData_obj::EXPRESSION(expression));
            	}
...
void WatchFrontEnd_obj::addMouse(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  99)		::flixel::FlxG_obj::game->debugger->watch->add(HX_("Mouse Position",44,8e,3a,9d),::flixel::_hx_system::debug::watch::WatchEntryData_obj::FIELD(hx::ClassOf< ::flixel::FlxG >(),HX_("mouse",25,16,65,0c)));
            	}
...
void WatchFrontEnd_obj::removeMouse(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 109)		::flixel::FlxG_obj::game->debugger->watch->remove(null(),::flixel::_hx_system::debug::watch::WatchEntryData_obj::FIELD(hx::ClassOf< ::flixel::FlxG >(),HX_("mouse",25,16,65,0c)));
            	}
