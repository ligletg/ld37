...
HX_DEFINE_STACK_FRAME(_hx_pos_ff18a02f3055fb45_73_replace_flixel_input_mouse_FlxMouse,"flixel.system.frontEnds.InputFrontEnd","replace_flixel_input_mouse_FlxMouse",0x59a38f0e,"flixel.system.frontEnds.InputFrontEnd.replace_flixel_input_mouse_FlxMouse","flixel/system/frontEnds/InputFrontEnd.hx",73,0x759f67bd)
...
HX_DEFINE_STACK_FRAME(_hx_pos_ff18a02f3055fb45_28_add_flixel_input_mouse_FlxMouse,"flixel.system.frontEnds.InputFrontEnd","add_flixel_input_mouse_FlxMouse",0xe1e4487b,"flixel.system.frontEnds.InputFrontEnd.add_flixel_input_mouse_FlxMouse","flixel/system/frontEnds/InputFrontEnd.hx",28,0x759f67bd)
HX_DEFINE_STACK_FRAME(_hx_pos_ff18a02f3055fb45_28_add_flixel_input_keyboard_FlxKeyboard,"flixel.system.frontEnds.InputFrontEnd","add_flixel_input_keyboard_FlxKeyboard",0xa934da2f,"flixel.system.frontEnds.InputFrontEnd.add_flixel_input_keyboard_FlxKeyboard","flixel/system/frontEnds/InputFrontEnd.hx",28,0x759f67bd)
...
HXLINE(  74)		HX_VARI( int,i) = (int)0;
HXLINE(  75)		HX_VARI( bool,success) = false;
HXLINE(  76)		{
HXLINE(  76)			HX_VARI( int,_g) = (int)0;
HXDLIN(  76)			HX_VARI( ::Array< ::Dynamic>,_g1) = this->list;
HXDLIN(  76)			while((_g < _g1->length)){
HXLINE(  76)				HX_VARI( ::Dynamic,input) = _g1->__get(_g);
