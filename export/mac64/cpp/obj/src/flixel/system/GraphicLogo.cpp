...
HX_DEFINE_STACK_FRAME(_hx_pos_94a792490c1ea930_1_boot,"flixel.system.GraphicLogo","boot",0x1f0bc0ba,"flixel.system.GraphicLogo.boot","?",1,0x0000003f)
namespace flixel{
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::GraphicLogo_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_GraphicLogo",a0,bd,f5,14);
            	}
}
