...
HX_DEFINE_STACK_FRAME(_hx_pos_c713eb0ccb2ced4e_27_onMeasure,"flixel.system.scaleModes.BaseScaleMode","onMeasure",0xbc54a592,"flixel.system.scaleModes.BaseScaleMode.onMeasure","flixel/system/scaleModes/BaseScaleMode.hx",27,0x5a3188fe)
HX_DEFINE_STACK_FRAME(_hx_pos_c713eb0ccb2ced4e_39_updateGameSize,"flixel.system.scaleModes.BaseScaleMode","updateGameSize",0x99f00e89,"flixel.system.scaleModes.BaseScaleMode.updateGameSize","flixel/system/scaleModes/BaseScaleMode.hx",39,0x5a3188fe)
HX_DEFINE_STACK_FRAME(_hx_pos_c713eb0ccb2ced4e_44_updateDeviceSize,"flixel.system.scaleModes.BaseScaleMode","updateDeviceSize",0xb35132ad,"flixel.system.scaleModes.BaseScaleMode.updateDeviceSize","flixel/system/scaleModes/BaseScaleMode.hx",44,0x5a3188fe)
HX_DEFINE_STACK_FRAME(_hx_pos_c713eb0ccb2ced4e_48_updateScaleOffset,"flixel.system.scaleModes.BaseScaleMode","updateScaleOffset",0x13e546c7,"flixel.system.scaleModes.BaseScaleMode.updateScaleOffset","flixel/system/scaleModes/BaseScaleMode.hx",48,0x5a3188fe)
HX_DEFINE_STACK_FRAME(_hx_pos_c713eb0ccb2ced4e_57_updateOffsetX,"flixel.system.scaleModes.BaseScaleMode","updateOffsetX",0xcbc7256f,"flixel.system.scaleModes.BaseScaleMode.updateOffsetX","flixel/system/scaleModes/BaseScaleMode.hx",57,0x5a3188fe)
HX_DEFINE_STACK_FRAME(_hx_pos_c713eb0ccb2ced4e_70_updateOffsetY,"flixel.system.scaleModes.BaseScaleMode","updateOffsetY",0xcbc72570,"flixel.system.scaleModes.BaseScaleMode.updateOffsetY","flixel/system/scaleModes/BaseScaleMode.hx",70,0x5a3188fe)
HX_DEFINE_STACK_FRAME(_hx_pos_c713eb0ccb2ced4e_82_updateGamePosition,"flixel.system.scaleModes.BaseScaleMode","updateGamePosition",0xebf59271,"flixel.system.scaleModes.BaseScaleMode.updateGamePosition","flixel/system/scaleModes/BaseScaleMode.hx",82,0x5a3188fe)
HX_DEFINE_STACK_FRAME(_hx_pos_c713eb0ccb2ced4e_91_set_horizontalAlign,"flixel.system.scaleModes.BaseScaleMode","set_horizontalAlign",0x8b3e18b7,"flixel.system.scaleModes.BaseScaleMode.set_horizontalAlign","flixel/system/scaleModes/BaseScaleMode.hx",91,0x5a3188fe)
HX_DEFINE_STACK_FRAME(_hx_pos_c713eb0ccb2ced4e_102_set_verticalAlign,"flixel.system.scaleModes.BaseScaleMode","set_verticalAlign",0x71923e65,"flixel.system.scaleModes.BaseScaleMode.set_verticalAlign","flixel/system/scaleModes/BaseScaleMode.hx",102,0x5a3188fe)
namespace flixel{
...
HXLINE(  20)		HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN(  20)		point->_inPool = false;
HXDLIN(  20)		this->deviceSize = point;
HXLINE(  21)		HX_VARI_NAME(  ::flixel::math::FlxPoint,point1,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN(  21)		point1->_inPool = false;
HXDLIN(  21)		this->gameSize = point1;
HXLINE(  22)		HX_VARI_NAME(  ::flixel::math::FlxPoint,point2,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN(  22)		point2->_inPool = false;
HXDLIN(  22)		this->scale = point2;
HXLINE(  23)		HX_VARI_NAME(  ::flixel::math::FlxPoint,point3,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
void BaseScaleMode_obj::updateGameSize(int Width,int Height){
            	...
            	HX_STACK_ARG(Width,"Width")
            	HX_STACK_ARG(Height,"Height")
HXLINE(  39)		this->gameSize->set(Width,Height);
            	}
...
void BaseScaleMode_obj::updateDeviceSize(int Width,int Height){
            	...
            	HX_STACK_ARG(Width,"Width")
            	HX_STACK_ARG(Height,"Height")
HXLINE(  44)		this->deviceSize->set(Width,Height);
            	}
...
void BaseScaleMode_obj::updateScaleOffset(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  49)		this->scale->set_x(((Float)this->gameSize->x / (Float)(::flixel::FlxG_obj::width * ::flixel::FlxG_obj::initialZoom)));
HXLINE(  50)		this->scale->set_y(((Float)this->gameSize->y / (Float)(::flixel::FlxG_obj::height * ::flixel::FlxG_obj::initialZoom)));
...
void BaseScaleMode_obj::updateOffsetX(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  57)		 ::flixel::math::FlxPoint _hx_tmp = this->offset;
HXDLIN(  57)		Float _hx_tmp1;
HXDLIN(  57)		switch((int)(_hx_getEnumValueIndex(this->horizontalAlign))){
            			case (int)0: {
HXLINE(  57)				_hx_tmp1 = (int)0;
            			}
            			break;
            			case (int)1: {
HXLINE(  57)				_hx_tmp1 = ::Math_obj::ceil(((this->deviceSize->x - this->gameSize->x) * ((Float)0.5)));
            			}
            			break;
            			case (int)2: {
HXLINE(  57)				_hx_tmp1 = (this->deviceSize->x - this->gameSize->x);
            			}
            			break;
            		}
...
void BaseScaleMode_obj::updateOffsetY(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  70)		 ::flixel::math::FlxPoint _hx_tmp = this->offset;
HXDLIN(  70)		Float _hx_tmp1;
HXDLIN(  70)		switch((int)(_hx_getEnumValueIndex(this->verticalAlign))){
            			case (int)0: {
HXLINE(  70)				_hx_tmp1 = (int)0;
            			}
            			break;
            			case (int)1: {
HXLINE(  70)				_hx_tmp1 = ::Math_obj::ceil(((this->deviceSize->y - this->gameSize->y) * ((Float)0.5)));
            			}
            			break;
            			case (int)2: {
HXLINE(  70)				_hx_tmp1 = (this->deviceSize->y - this->gameSize->y);
            			}
            			break;
            		}
...
hx::Val BaseScaleMode_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"verticalAlign") ) { if (inCallProp == hx::paccAlways) return hx::Val( set_verticalAlign(inValue) );verticalAlign=inValue.Cast<  ::flixel::util::FlxVerticalAlign >(); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"horizontalAlign") ) { if (inCallProp == hx::paccAlways) return hx::Val( set_horizontalAlign(inValue) );horizontalAlign=inValue.Cast<  ::flixel::util::FlxHorizontalAlign >(); return inValue; }
	}
