...
HXLINE(  57)		HX_VARI( int,stageWidth) = ::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_stageWidth();
HXLINE(  58)		HX_VARI( int,stageHeight) = ::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_stageHeight();
...
HXLINE(  67)		HX_VARI(  ::openfl::_legacy::text::TextFormat,dtf) =  ::openfl::_legacy::text::TextFormat_obj::__alloc( HX_CTX ,::flixel::_hx_system::FlxAssets_obj::FONT_DEFAULT,(int)16,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
...
HXDLIN(  76)		_hx_tmp->load(::openfl::_legacy::Assets_obj::getSound((HX_("flixel/sounds/flixel",54,41,d6,5d) + HX_(".ogg",e1,64,bc,1e)),null()),null(),null(),null(),null(),null(),null(),null())->play(null(),null(),null());
            	}
...
HXLINE(  95)		this->_sprite->set_x(((Float)Width / (Float)(int)2));
HXLINE(  96)		 ::openfl::_legacy::display::Sprite _hx_tmp = this->_sprite;
HXDLIN(  96)		_hx_tmp->set_y((((Float)Height / (Float)(int)2) - ((int)20 * ::flixel::FlxG_obj::game->get_scaleY())));
HXLINE(  98)		 ::openfl::_legacy::text::TextField _hx_tmp1 = this->_text;
HXDLIN(  98)		_hx_tmp1->set_width(((Float)Width / (Float)::flixel::FlxG_obj::game->get_scaleX()));
HXLINE(  99)		this->_text->set_x((int)0);
HXLINE( 100)		 ::openfl::_legacy::text::TextField _hx_tmp2 = this->_text;
HXDLIN( 100)		Float _hx_tmp3 = this->_sprite->get_y();
HXDLIN( 100)		_hx_tmp2->set_y((_hx_tmp3 + ((int)80 * ::flixel::FlxG_obj::game->get_scaleY())));
HXLINE( 102)		 ::openfl::_legacy::display::Sprite _hx_tmp4 = this->_sprite;
HXDLIN( 102)		 ::openfl::_legacy::text::TextField _hx_tmp5 = this->_text;
HXDLIN( 102)		_hx_tmp4->set_scaleX(_hx_tmp5->set_scaleX(::flixel::FlxG_obj::game->get_scaleX()));
HXLINE( 103)		 ::openfl::_legacy::display::Sprite _hx_tmp6 = this->_sprite;
HXDLIN( 103)		 ::openfl::_legacy::text::TextField _hx_tmp7 = this->_text;
