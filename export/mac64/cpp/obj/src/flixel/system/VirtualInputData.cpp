...
HX_DEFINE_STACK_FRAME(_hx_pos_2d88934a15080808_2181_new,"flixel.system.VirtualInputData","new",0x4566b028,"flixel.system.VirtualInputData.new","openfl/_legacy/Assets.hx",2181,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_b9d97b5828a49549_1_boot,"flixel.system.VirtualInputData","boot",0x6c8c736a,"flixel.system.VirtualInputData.boot","?",1,0x0000003f)
namespace flixel{
namespace _hx_system{

void VirtualInputData_obj::__construct( ::Dynamic __o_size){
 ::Dynamic size = __o_size.Default(0);
            	HX_STACKFRAME(&_hx_pos_2d88934a15080808_2181_new)
            	HX_STACK_THIS(this)
...
hx::ObjectPtr< VirtualInputData_obj > VirtualInputData_obj::__alloc(hx::Ctx *_hx_ctx, ::Dynamic __o_size) {
...
{
{
            	HX_STACKFRAME(&_hx_pos_b9d97b5828a49549_1_boot)
HXLINE(   1)		resourceName = HX_("__ASSET__:file_flixel_system_VirtualInputData",cf,a9,c1,46);
            	}
}
