...
HXLINE(  56)		HX_VARI(  ::openfl::_legacy::display::Bitmap,tmp) =  ::openfl::_legacy::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::_legacy::display::BitmapData_obj::__alloc( HX_CTX ,this->_width,(int)30,true,(int)2130706432,null()),null(),null());
HXLINE(  57)		this->screenCenter();
HXLINE(  58)		this->addChild(tmp);
HXLINE(  60)		HX_VARI(  ::openfl::_legacy::text::TextField,text) =  ::openfl::_legacy::text::TextField_obj::__alloc( HX_CTX );
...
HXLINE(  74)		HX_VARI(  ::openfl::_legacy::text::TextFormat,dtf) =  ::openfl::_legacy::text::TextFormat_obj::__alloc( HX_CTX ,::flixel::_hx_system::FlxAssets_obj::FONT_DEFAULT,(int)10,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
...
HXLINE(  87)				tmp =  ::openfl::_legacy::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::_legacy::display::BitmapData_obj::__alloc( HX_CTX ,(int)4,((_g - (int)1) + (int)1),false,(int)-1,null()),null(),null());
...
HXLINE( 136)			HX_VARI(  ::openfl::_legacy::media::Sound,sound) = ::openfl::_legacy::Assets_obj::getSound((HX_("flixel/sounds/beep",e6,b5,a9,33) + HX_(".ogg",e1,64,bc,1e)),null());
