...
HX_DEFINE_STACK_FRAME(_hx_pos_36ad37cf669080a5_93_checkRaw,"flixel.input.gamepad.lists.FlxGamepadAnalogStateList","checkRaw",0x43d8cbba,"flixel.input.gamepad.lists.FlxGamepadAnalogStateList.checkRaw","flixel/input/gamepad/lists/FlxGamepadAnalogStateList.hx",93,0xa4c0584e)
namespace flixel{
namespace input{
namespace gamepad{
namespace lists{
...
HXLINE(  17)			HX_VARI( int,RawID) = stick->x;
HXDLIN(  17)			RawID = this->gamepad->mapping->axisIndexToRawID(RawID);
HXDLIN(  17)			return this->gamepad->checkStatusRaw(RawID,this->status);
            		}
...
HXLINE(  18)			HX_VARI( int,RawID) = stick->y;
HXDLIN(  18)			RawID = this->gamepad->mapping->axisIndexToRawID(RawID);
HXDLIN(  18)			return this->gamepad->checkStatusRaw(RawID,this->status);
            		}
...
HXLINE(  20)			HX_VARI( int,RawID) = stick->x;
HXDLIN(  20)			RawID = this->gamepad->mapping->axisIndexToRawID(RawID);
HXDLIN(  20)			return this->gamepad->checkStatusRaw(RawID,this->status);
            		}
...
HXLINE(  21)			HX_VARI( int,RawID) = stick->y;
HXDLIN(  21)			RawID = this->gamepad->mapping->axisIndexToRawID(RawID);
HXDLIN(  21)			return this->gamepad->checkStatusRaw(RawID,this->status);
            		}
...
HXLINE(  45)		HX_VARI( int,RawID) = stick->x;
HXDLIN(  45)		RawID = this->gamepad->mapping->axisIndexToRawID(RawID);
HXDLIN(  45)		HX_VARI( bool,xVal) = this->gamepad->checkStatusRaw(RawID,this->status);
HXLINE(  46)		HX_VARI_NAME( int,RawID1,"RawID") = stick->y;
HXDLIN(  46)		RawID1 = this->gamepad->mapping->axisIndexToRawID(RawID1);
HXDLIN(  46)		HX_VARI( bool,yVal) = this->gamepad->checkStatusRaw(RawID1,this->status);
...
HXLINE(  53)		if (xVal) {
HXLINE(  55)			HX_VARI_NAME( int,RawID2,"RawID") = stick->y;
HXDLIN(  55)			RawID2 = this->gamepad->mapping->axisIndexToRawID(RawID2);
HXLINE(  56)			HX_VARI_NAME( int,RawID3,"RawID") = stick->y;
HXDLIN(  56)			RawID3 = this->gamepad->mapping->axisIndexToRawID(RawID3);
HXLINE(  57)			bool _hx_tmp1;
HXDLIN(  57)			if (!(this->gamepad->checkStatusRaw(RawID2,(int)0))) {
HXLINE(  57)				_hx_tmp1 = this->gamepad->checkStatusRaw(RawID3,(int)-1);
            			}
            			else {
...
HXLINE(  63)		if (yVal) {
HXLINE(  65)			HX_VARI_NAME( int,RawID4,"RawID") = stick->x;
HXDLIN(  65)			RawID4 = this->gamepad->mapping->axisIndexToRawID(RawID4);
HXLINE(  66)			HX_VARI_NAME( int,RawID5,"RawID") = stick->x;
HXDLIN(  66)			RawID5 = this->gamepad->mapping->axisIndexToRawID(RawID5);
HXLINE(  67)			bool _hx_tmp2;
HXDLIN(  67)			if (!(this->gamepad->checkStatusRaw(RawID4,(int)0))) {
HXLINE(  67)				_hx_tmp2 = this->gamepad->checkStatusRaw(RawID5,(int)-1);
            			}
            			else {
...
HXLINE(  81)		HX_VARI( int,RawID) = stick->x;
HXDLIN(  81)		RawID = this->gamepad->mapping->axisIndexToRawID(RawID);
HXDLIN(  81)		return this->gamepad->checkStatusRaw(RawID,this->status);
            	}
...
HXLINE(  89)		HX_VARI( int,RawID) = stick->y;
HXDLIN(  89)		RawID = this->gamepad->mapping->axisIndexToRawID(RawID);
HXDLIN(  89)		return this->gamepad->checkStatusRaw(RawID,this->status);
            	}
