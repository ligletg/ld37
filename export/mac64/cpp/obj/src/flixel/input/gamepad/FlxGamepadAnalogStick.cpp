...
HX_DEFINE_STACK_FRAME(_hx_pos_1ef7cee7c9b8631a_55_toString,"flixel.input.gamepad.FlxGamepadAnalogStick","toString",0x35569e4c,"flixel.input.gamepad.FlxGamepadAnalogStick.toString","flixel/input/gamepad/FlxGamepadAnalogStick.hx",55,0xc7b72a73)
namespace flixel{
namespace input{
namespace gamepad{
...
HXDLIN(  56)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(  56)		_this->label = HX_("x",78,00,00,00);
HXDLIN(  56)		_this->value = value;
HXLINE(  57)		 ::Dynamic value1 = this->y;
HXDLIN(  57)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this1,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(  57)		_this1->label = HX_("y",79,00,00,00);
HXDLIN(  57)		_this1->value = value1;
HXLINE(  58)		 ::Dynamic value2 = this->rawUp;
HXDLIN(  58)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this2,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(  58)		_this2->label = HX_("rawUp",63,6a,26,e4);
HXDLIN(  58)		_this2->value = value2;
HXLINE(  59)		 ::Dynamic value3 = this->rawDown;
HXDLIN(  59)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this3,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(  59)		_this3->label = HX_("rawDown",6a,0e,23,ff);
HXDLIN(  59)		_this3->value = value3;
HXLINE(  60)		 ::Dynamic value4 = this->rawLeft;
HXDLIN(  60)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this4,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(  60)		_this4->label = HX_("rawLeft",0f,1e,65,04);
HXDLIN(  60)		_this4->value = value4;
HXLINE(  61)		 ::Dynamic value5 = this->rawRight;
HXDLIN(  61)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this5,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
...
HXDLIN(  62)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this6,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(  62)		_this6->label = HX_("digitalThreshold",b3,20,9a,6e);
HXDLIN(  62)		_this6->value = value6;
HXLINE(  63)		 ::Dynamic value7 = this->mode;
HXDLIN(  63)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this7,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(  63)		_this7->label = HX_("mode",63,d3,60,48);
HXDLIN(  63)		_this7->value = value7;
HXLINE(  55)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(8)->init(0,_this)->init(1,_this1)->init(2,_this2)->init(3,_this3)->init(4,_this4)->init(5,_this5)->init(6,_this6)->init(7,_this7));
            	}
