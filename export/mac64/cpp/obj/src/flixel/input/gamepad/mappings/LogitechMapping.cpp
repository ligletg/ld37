...
HX_DEFINE_STACK_FRAME(_hx_pos_895a9f6ff22a02c8_95_axisIndexToRawID,"flixel.input.gamepad.mappings.LogitechMapping","axisIndexToRawID",0xf334b3d8,"flixel.input.gamepad.mappings.LogitechMapping.axisIndexToRawID","flixel/input/gamepad/mappings/LogitechMapping.hx",95,0x37446fef)
HX_DEFINE_STACK_FRAME(_hx_pos_895a9f6ff22a02c8_9_boot,"flixel.input.gamepad.mappings.LogitechMapping","boot",0x5a20a4f3,"flixel.input.gamepad.mappings.LogitechMapping.boot","flixel/input/gamepad/mappings/LogitechMapping.hx",9,0x37446fef)
HX_DEFINE_STACK_FRAME(_hx_pos_895a9f6ff22a02c8_10_boot,"flixel.input.gamepad.mappings.LogitechMapping","boot",0x5a20a4f3,"flixel.input.gamepad.mappings.LogitechMapping.boot","flixel/input/gamepad/mappings/LogitechMapping.hx",10,0x37446fef)
HX_DEFINE_STACK_FRAME(_hx_pos_895a9f6ff22a02c8_12_boot,"flixel.input.gamepad.mappings.LogitechMapping","boot",0x5a20a4f3,"flixel.input.gamepad.mappings.LogitechMapping.boot","flixel/input/gamepad/mappings/LogitechMapping.hx",12,0x37446fef)
HX_DEFINE_STACK_FRAME(_hx_pos_895a9f6ff22a02c8_13_boot,"flixel.input.gamepad.mappings.LogitechMapping","boot",0x5a20a4f3,"flixel.input.gamepad.mappings.LogitechMapping.boot","flixel/input/gamepad/mappings/LogitechMapping.hx",13,0x37446fef)
namespace flixel{
namespace input{
namespace gamepad{
namespace mappings{
...
HXLINE(  95)		if ((axisID == this->leftStick->x)) {
HXLINE(  95)			return (int)20;
            		}
            		else {
HXLINE(  96)			if ((axisID == this->leftStick->y)) {
HXLINE(  95)				return (int)21;
            			}
            			else {
HXLINE(  97)				if ((axisID == this->rightStick->x)) {
HXLINE(  95)					return (int)22;
            				}
            				else {
HXLINE(  98)					if ((axisID == this->rightStick->y)) {
HXLINE(  95)						return (int)23;
            					}
            					else {
HXLINE(  95)						return axisID;
            					}
            				}
            			}
            		}
