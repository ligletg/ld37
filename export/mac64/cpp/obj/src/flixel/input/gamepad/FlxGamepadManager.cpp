...
HX_DEFINE_STACK_FRAME(_hx_pos_dd40c6c1396c027e_408_getModelFromJoystick,"flixel.input.gamepad.FlxGamepadManager","getModelFromJoystick",0x94fdf62c,"flixel.input.gamepad.FlxGamepadManager.getModelFromJoystick","flixel/input/gamepad/FlxGamepadManager.hx",408,0xccfee0a6)
HX_DEFINE_STACK_FRAME(_hx_pos_dd40c6c1396c027e_421_handleButtonDownEvent,"flixel.input.gamepad.FlxGamepadManager","handleButtonDownEvent",0x228bc3cb,"flixel.input.gamepad.FlxGamepadManager.handleButtonDownEvent","flixel/input/gamepad/FlxGamepadManager.hx",421,0xccfee0a6)
HX_DEFINE_STACK_FRAME(_hx_pos_dd40c6c1396c027e_425_handleButtonDown,"flixel.input.gamepad.FlxGamepadManager","handleButtonDown",0x9a9405cf,"flixel.input.gamepad.FlxGamepadManager.handleButtonDown","flixel/input/gamepad/FlxGamepadManager.hx",425,0xccfee0a6)
HX_DEFINE_STACK_FRAME(_hx_pos_dd40c6c1396c027e_433_handleButtonUpEvent,"flixel.input.gamepad.FlxGamepadManager","handleButtonUpEvent",0x75a63c72,"flixel.input.gamepad.FlxGamepadManager.handleButtonUpEvent","flixel/input/gamepad/FlxGamepadManager.hx",433,0xccfee0a6)
HX_DEFINE_STACK_FRAME(_hx_pos_dd40c6c1396c027e_437_handleButtonUp,"flixel.input.gamepad.FlxGamepadManager","handleButtonUp",0x87ba4e88,"flixel.input.gamepad.FlxGamepadManager.handleButtonUp","flixel/input/gamepad/FlxGamepadManager.hx",437,0xccfee0a6)
HX_DEFINE_STACK_FRAME(_hx_pos_dd40c6c1396c027e_444_handleAxisMove,"flixel.input.gamepad.FlxGamepadManager","handleAxisMove",0xbb7c51ed,"flixel.input.gamepad.FlxGamepadManager.handleAxisMove","flixel/input/gamepad/FlxGamepadManager.hx",444,0xccfee0a6)
HX_DEFINE_STACK_FRAME(_hx_pos_dd40c6c1396c027e_473_copyToPointWithDeadzone,"flixel.input.gamepad.FlxGamepadManager","copyToPointWithDeadzone",0xd4338883,"flixel.input.gamepad.FlxGamepadManager.copyToPointWithDeadzone","flixel/input/gamepad/FlxGamepadManager.hx",473,0xccfee0a6)
HX_DEFINE_STACK_FRAME(_hx_pos_dd40c6c1396c027e_479_handleBallMove,"flixel.input.gamepad.FlxGamepadManager","handleBallMove",0x63851e4b,"flixel.input.gamepad.FlxGamepadManager.handleBallMove","flixel/input/gamepad/FlxGamepadManager.hx",479,0xccfee0a6)
HX_DEFINE_STACK_FRAME(_hx_pos_dd40c6c1396c027e_485_handleHatMove,"flixel.input.gamepad.FlxGamepadManager","handleHatMove",0x5f7942d1,"flixel.input.gamepad.FlxGamepadManager.handleHatMove","flixel/input/gamepad/FlxGamepadManager.hx",485,0xccfee0a6)
HX_DEFINE_STACK_FRAME(_hx_pos_dd40c6c1396c027e_502_checkDpadAxisChange,"flixel.input.gamepad.FlxGamepadManager","checkDpadAxisChange",0x1e10a175,"flixel.input.gamepad.FlxGamepadManager.checkDpadAxisChange","flixel/input/gamepad/FlxGamepadManager.hx",502,0xccfee0a6)
HX_DEFINE_STACK_FRAME(_hx_pos_dd40c6c1396c027e_522_handleDeviceAdded,"flixel.input.gamepad.FlxGamepadManager","handleDeviceAdded",0x86fef98f,"flixel.input.gamepad.FlxGamepadManager.handleDeviceAdded","flixel/input/gamepad/FlxGamepadManager.hx",522,0xccfee0a6)
HX_DEFINE_STACK_FRAME(_hx_pos_dd40c6c1396c027e_527_handleDeviceRemoved,"flixel.input.gamepad.FlxGamepadManager","handleDeviceRemoved",0xde69562f,"flixel.input.gamepad.FlxGamepadManager.handleDeviceRemoved","flixel/input/gamepad/FlxGamepadManager.hx",527,0xccfee0a6)
...
HX_DEFINE_DYNAMIC_FUNC0(FlxGamepadManager_obj,reset,(void))
 ...
 ::flixel::input::gamepad::FlxGamepadModel FlxGamepadManager_obj::getModelFromJoystick(Float id){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE( 408)		switch((int)(::Math_obj::round(id))){
            			case (int)0: {
...
void FlxGamepadManager_obj::handleAxisMove( ::openfl::_legacy::events::JoystickEvent event){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(event,"event")
HXLINE( 446)		HX_VARI(  ::flixel::input::gamepad::FlxGamepad,gamepad) = this->createByID(event->device,null());
...
HXDLIN( 474)		if ((::Math_obj::abs(event->x) < gamepad->get_deadZone())) {
...
HXLINE( 475)		Float _hx_tmp1;
HXDLIN( 475)		if ((::Math_obj::abs(event->y) < gamepad->get_deadZone())) {
HXLINE( 475)			_hx_tmp1 = (int)0;
            		}
            		else {
HXLINE( 475)			_hx_tmp1 = event->y;
            		}
HXDLIN( 475)		point->set_y(_hx_tmp1);
            	}
...
void FlxGamepadManager_obj::handleDeviceAdded( ::openfl::_legacy::events::JoystickEvent event){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(event,"event")
HXLINE( 522)		this->createByID(event->device,this->getModelFromJoystick(event->x));
            	}
