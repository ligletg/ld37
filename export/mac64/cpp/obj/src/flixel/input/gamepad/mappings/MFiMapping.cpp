...
HX_DEFINE_STACK_FRAME(_hx_pos_6a4fcdd8c98d6ad6_86_axisIndexToRawID,"flixel.input.gamepad.mappings.MFiMapping","axisIndexToRawID",0x61c1ec61,"flixel.input.gamepad.mappings.MFiMapping.axisIndexToRawID","flixel/input/gamepad/mappings/MFiMapping.hx",86,0xaa96aabc)
namespace flixel{
namespace input{
namespace gamepad{
namespace mappings{
