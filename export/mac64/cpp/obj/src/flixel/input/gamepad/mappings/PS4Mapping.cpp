...
HX_DEFINE_STACK_FRAME(_hx_pos_e4c9bfb09cde4791_97_axisIndexToRawID,"flixel.input.gamepad.mappings.PS4Mapping","axisIndexToRawID",0x10ca1942,"flixel.input.gamepad.mappings.PS4Mapping.axisIndexToRawID","flixel/input/gamepad/mappings/PS4Mapping.hx",97,0x24847fdd)
HX_DEFINE_STACK_FRAME(_hx_pos_e4c9bfb09cde4791_9_boot,"flixel.input.gamepad.mappings.PS4Mapping","boot",0xc215135d,"flixel.input.gamepad.mappings.PS4Mapping.boot","flixel/input/gamepad/mappings/PS4Mapping.hx",9,0x24847fdd)
HX_DEFINE_STACK_FRAME(_hx_pos_e4c9bfb09cde4791_10_boot,"flixel.input.gamepad.mappings.PS4Mapping","boot",0xc215135d,"flixel.input.gamepad.mappings.PS4Mapping.boot","flixel/input/gamepad/mappings/PS4Mapping.hx",10,0x24847fdd)
HX_DEFINE_STACK_FRAME(_hx_pos_e4c9bfb09cde4791_12_boot,"flixel.input.gamepad.mappings.PS4Mapping","boot",0xc215135d,"flixel.input.gamepad.mappings.PS4Mapping.boot","flixel/input/gamepad/mappings/PS4Mapping.hx",12,0x24847fdd)
HX_DEFINE_STACK_FRAME(_hx_pos_e4c9bfb09cde4791_13_boot,"flixel.input.gamepad.mappings.PS4Mapping","boot",0xc215135d,"flixel.input.gamepad.mappings.PS4Mapping.boot","flixel/input/gamepad/mappings/PS4Mapping.hx",13,0x24847fdd)
HX_DEFINE_STACK_FRAME(_hx_pos_e4c9bfb09cde4791_15_boot,"flixel.input.gamepad.mappings.PS4Mapping","boot",0xc215135d,"flixel.input.gamepad.mappings.PS4Mapping.boot","flixel/input/gamepad/mappings/PS4Mapping.hx",15,0x24847fdd)
HX_DEFINE_STACK_FRAME(_hx_pos_e4c9bfb09cde4791_16_boot,"flixel.input.gamepad.mappings.PS4Mapping","boot",0xc215135d,"flixel.input.gamepad.mappings.PS4Mapping.boot","flixel/input/gamepad/mappings/PS4Mapping.hx",16,0x24847fdd)
namespace flixel{
namespace input{
namespace gamepad{
namespace mappings{
...
HXLINE(  58)				return (int)4;
            			...
            			break;
            			case (int)25: {
HXLINE(  58)				return (int)25;
            			}
            			break;
            			case (int)26: {
HXLINE(  58)				return (int)26;
            			}
            			break;
            			case (int)34: {
...
HXLINE(  97)		if ((axisID == this->leftStick->x)) {
HXLINE(  97)			return (int)21;
            		}
            		else {
...
HXLINE(  97)					return (int)23;
            				}
            				else {
HXLINE( 100)					if ((axisID == this->rightStick->y)) {
HXLINE(  97)						return (int)24;
            					}
            					else {
HXLINE( 101)						if ((axisID == (int)3)) {
HXLINE(  97)							return (int)25;
            						}
            						else {
HXLINE( 102)							if ((axisID == (int)4)) {
HXLINE(  97)								return (int)26;
            							}
            							else {
HXLINE(  97)								return axisID;
            							}
            						}
            					}
            				}
