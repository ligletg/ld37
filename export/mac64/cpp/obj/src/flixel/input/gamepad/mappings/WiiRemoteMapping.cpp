...
HX_DEFINE_STACK_FRAME(_hx_pos_bff79226d1e7d85e_225_axisIndexToRawID,"flixel.input.gamepad.mappings.WiiRemoteMapping","axisIndexToRawID",0x493b61ce,"flixel.input.gamepad.mappings.WiiRemoteMapping.axisIndexToRawID","flixel/input/gamepad/mappings/WiiRemoteMapping.hx",225,0xc69520e9)
HX_DEFINE_STACK_FRAME(_hx_pos_bff79226d1e7d85e_257_checkForFakeAxis,"flixel.input.gamepad.mappings.WiiRemoteMapping","checkForFakeAxis",0xe60c374e,"flixel.input.gamepad.mappings.WiiRemoteMapping.checkForFakeAxis","flixel/input/gamepad/mappings/WiiRemoteMapping.hx",257,0xc69520e9)
...
HX_DEFINE_STACK_FRAME(_hx_pos_bff79226d1e7d85e_10_boot,"flixel.input.gamepad.mappings.WiiRemoteMapping","boot",0xbf60b9e9,"flixel.input.gamepad.mappings.WiiRemoteMapping.boot","flixel/input/gamepad/mappings/WiiRemoteMapping.hx",10,0xc69520e9)
HX_DEFINE_STACK_FRAME(_hx_pos_bff79226d1e7d85e_11_boot,"flixel.input.gamepad.mappings.WiiRemoteMapping","boot",0xbf60b9e9,"flixel.input.gamepad.mappings.WiiRemoteMapping.boot","flixel/input/gamepad/mappings/WiiRemoteMapping.hx",11,0xc69520e9)
HX_DEFINE_STACK_FRAME(_hx_pos_bff79226d1e7d85e_12_boot,"flixel.input.gamepad.mappings.WiiRemoteMapping","boot",0xbf60b9e9,"flixel.input.gamepad.mappings.WiiRemoteMapping.boot","flixel/input/gamepad/mappings/WiiRemoteMapping.hx",12,0xc69520e9)
HX_DEFINE_STACK_FRAME(_hx_pos_bff79226d1e7d85e_13_boot,"flixel.input.gamepad.mappings.WiiRemoteMapping","boot",0xbf60b9e9,"flixel.input.gamepad.mappings.WiiRemoteMapping.boot","flixel/input/gamepad/mappings/WiiRemoteMapping.hx",13,0xc69520e9)
namespace flixel{
namespace input{
namespace gamepad{
namespace mappings{
