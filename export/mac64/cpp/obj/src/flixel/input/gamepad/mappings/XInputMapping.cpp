...
HX_DEFINE_STACK_FRAME(_hx_pos_84c975cfdc90262d_115_axisIndexToRawID,"flixel.input.gamepad.mappings.XInputMapping","axisIndexToRawID",0x4e04638f,"flixel.input.gamepad.mappings.XInputMapping.axisIndexToRawID","flixel/input/gamepad/mappings/XInputMapping.hx",115,0x442329e6)
HX_DEFINE_STACK_FRAME(_hx_pos_84c975cfdc90262d_9_boot,"flixel.input.gamepad.mappings.XInputMapping","boot",0x6423de2a,"flixel.input.gamepad.mappings.XInputMapping.boot","flixel/input/gamepad/mappings/XInputMapping.hx",9,0x442329e6)
HX_DEFINE_STACK_FRAME(_hx_pos_84c975cfdc90262d_10_boot,"flixel.input.gamepad.mappings.XInputMapping","boot",0x6423de2a,"flixel.input.gamepad.mappings.XInputMapping.boot","flixel/input/gamepad/mappings/XInputMapping.hx",10,0x442329e6)
HX_DEFINE_STACK_FRAME(_hx_pos_84c975cfdc90262d_12_boot,"flixel.input.gamepad.mappings.XInputMapping","boot",0x6423de2a,"flixel.input.gamepad.mappings.XInputMapping.boot","flixel/input/gamepad/mappings/XInputMapping.hx",12,0x442329e6)
HX_DEFINE_STACK_FRAME(_hx_pos_84c975cfdc90262d_13_boot,"flixel.input.gamepad.mappings.XInputMapping","boot",0x6423de2a,"flixel.input.gamepad.mappings.XInputMapping.boot","flixel/input/gamepad/mappings/XInputMapping.hx",13,0x442329e6)
HX_DEFINE_STACK_FRAME(_hx_pos_84c975cfdc90262d_15_boot,"flixel.input.gamepad.mappings.XInputMapping","boot",0x6423de2a,"flixel.input.gamepad.mappings.XInputMapping.boot","flixel/input/gamepad/mappings/XInputMapping.hx",15,0x442329e6)
HX_DEFINE_STACK_FRAME(_hx_pos_84c975cfdc90262d_16_boot,"flixel.input.gamepad.mappings.XInputMapping","boot",0x6423de2a,"flixel.input.gamepad.mappings.XInputMapping.boot","flixel/input/gamepad/mappings/XInputMapping.hx",16,0x442329e6)
namespace flixel{
namespace input{
namespace gamepad{
namespace mappings{
...
HXLINE(  65)				return (int)1;
            			...
            			break;
            			case (int)2: {
HXLINE(  65)				return (int)2;
            			}
            			break;
            			case (int)3: {
HXLINE(  65)				return (int)3;
            			}
            			break;
            			case (int)4: {
...
HXLINE( 115)		if ((axisID == this->leftStick->x)) {
HXLINE( 115)			return (int)15;
            		}
            		else {
HXLINE( 116)			if ((axisID == this->leftStick->y)) {
HXLINE( 115)				return (int)16;
            			}
            			else {
HXLINE( 117)				if ((axisID == this->rightStick->x)) {
HXLINE( 115)					return (int)17;
            				}
            				else {
HXLINE( 118)					if ((axisID == this->rightStick->y)) {
HXLINE( 115)						return (int)18;
            					}
            					else {
HXLINE( 119)						if ((axisID == (int)2)) {
HXLINE( 115)							return (int)19;
            						}
            						else {
HXLINE( 120)							if ((axisID == (int)5)) {
HXLINE( 115)								return (int)20;
            							}
            							else {
HXLINE( 115)								return axisID;
            							}
            						}
            					}
            				}
