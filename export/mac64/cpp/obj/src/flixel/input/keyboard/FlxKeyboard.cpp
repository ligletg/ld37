...
HX_DEFINE_STACK_FRAME(_hx_pos_86aaea01378aa57b_93_onKeyUp,"flixel.input.keyboard.FlxKeyboard","onKeyUp",0xa36f8255,"flixel.input.keyboard.FlxKeyboard.onKeyUp","flixel/input/keyboard/FlxKeyboard.hx",93,0x41882875)
HX_DEFINE_STACK_FRAME(_hx_pos_86aaea01378aa57b_107_onKeyDown,"flixel.input.keyboard.FlxKeyboard","onKeyDown",0xf4d786dc,"flixel.input.keyboard.FlxKeyboard.onKeyDown","flixel/input/keyboard/FlxKeyboard.hx",107,0x41882875)
HX_DEFINE_STACK_FRAME(_hx_pos_86aaea01378aa57b_119_resolveKeyCode,"flixel.input.keyboard.FlxKeyboard","resolveKeyCode",0x581c5a06,"flixel.input.keyboard.FlxKeyboard.resolveKeyCode","flixel/input/keyboard/FlxKeyboard.hx",119,0x41882875)
HX_DEFINE_STACK_FRAME(_hx_pos_86aaea01378aa57b_137_record,"flixel.input.keyboard.FlxKeyboard","record",0x38ad8db7,"flixel.input.keyboard.FlxKeyboard.record","flixel/input/keyboard/FlxKeyboard.hx",137,0x41882875)
HX_DEFINE_STACK_FRAME(_hx_pos_86aaea01378aa57b_166_playback,"flixel.input.keyboard.FlxKeyboard","playback",0x84dcbec1,"flixel.input.keyboard.FlxKeyboard.playback","flixel/input/keyboard/FlxKeyboard.hx",166,0x41882875)
namespace flixel{
namespace input{
namespace keyboard{
...
HXLINE(  27)		{
HXLINE(  27)			HX_VARI(  ::Dynamic,code) = ::flixel::input::keyboard::_FlxKey::FlxKey_Impl__obj::fromStringMap->iterator();
HXDLIN(  27)			while(( (bool)(code->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(  27)				HX_VARI_NAME( int,code1,"code") = ( (int)(code->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
...
HXLINE(  31)					HX_VARI(  ::flixel::input::FlxInput,input) =  ::flixel::input::FlxInput_obj::__alloc( HX_CTX ,code1);
...
int FlxKeyboard_obj::resolveKeyCode( ::openfl::_legacy::events::KeyboardEvent e){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(e,"e")
HXLINE( 123)		HX_VARI(  ::Dynamic,code) = this->_nativeCorrection->get(((e->charCode + HX_("_",5f,00,00,00)) + e->keyCode));
...
::Array< ::Dynamic> FlxKeyboard_obj::record(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 138)		HX_VARI( ::Array< ::Dynamic>,data) = null();
HXLINE( 140)		{
HXLINE( 140)			HX_VARI( int,_g) = (int)0;
HXDLIN( 140)			HX_VARI( ::Array< ::Dynamic>,_g1) = this->_keyListArray;
HXDLIN( 140)			while((_g < _g1->length)){
HXLINE( 140)				HX_VARI(  ::flixel::input::FlxInput,key) = _g1->__get(_g).StaticCast<  ::flixel::input::FlxInput >();
...
HXLINE( 167)		HX_VARI( int,i) = (int)0;
HXLINE( 168)		HX_VARI( int,l) = Record->length;
HXLINE( 170)		while((i < l)){
HXLINE( 172)			i = (i + (int)1);
HXDLIN( 172)			HX_VARI(  ::flixel::_hx_system::replay::CodeValuePair,o) = Record->__get((i - (int)1)).StaticCast<  ::flixel::_hx_system::replay::CodeValuePair >();
HXLINE( 174)			( ( ::flixel::input::FlxInput)(::haxe::IMap_obj::get(this->_keyListMap,o->code)) )->current = o->value;
            		}
            	}
