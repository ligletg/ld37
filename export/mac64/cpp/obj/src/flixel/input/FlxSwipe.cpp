...
HX_DEFINE_STACK_FRAME(_hx_pos_223f15e5be8ee429_39_toString,"flixel.input.FlxSwipe","toString",0xb726199c,"flixel.input.FlxSwipe.toString","flixel/input/FlxSwipe.hx",39,0xe38cac7e)
HX_DEFINE_STACK_FRAME(_hx_pos_223f15e5be8ee429_50_get_distance,"flixel.input.FlxSwipe","get_distance",0xd139c82e,"flixel.input.FlxSwipe.get_distance","flixel/input/FlxSwipe.hx",50,0xe38cac7e)
HX_DEFINE_STACK_FRAME(_hx_pos_223f15e5be8ee429_55_get_angle,"flixel.input.FlxSwipe","get_angle",0xc834293a,"flixel.input.FlxSwipe.get_angle","flixel/input/FlxSwipe.hx",55,0xe38cac7e)
HX_DEFINE_STACK_FRAME(_hx_pos_223f15e5be8ee429_60_get_duration,"flixel.input.FlxSwipe","get_duration",0x79ce444d,"flixel.input.FlxSwipe.get_duration","flixel/input/FlxSwipe.hx",60,0xe38cac7e)
namespace flixel{
namespace input{
...
HXDLIN(  40)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(  40)		_this->label = HX_("ID",db,3f,00,00);
HXDLIN(  40)		_this->value = value;
HXLINE(  41)		 ::Dynamic value1 = this->startPosition;
HXDLIN(  41)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this1,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(  41)		_this1->label = HX_("start",62,74,0b,84);
HXDLIN(  41)		_this1->value = value1;
HXLINE(  42)		 ::Dynamic value2 = this->endPosition;
HXDLIN(  42)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this2,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(  42)		_this2->label = HX_("end",db,03,4d,00);
HXDLIN(  42)		_this2->value = value2;
HXLINE(  43)		HX_VARI( Float,dx) = (this->startPosition->x - this->endPosition->x);
HXDLIN(  43)		HX_VARI( Float,dy) = (this->startPosition->y - this->endPosition->y);
HXDLIN(  43)		 ::Dynamic value3 = ::Math_obj::sqrt(((dx * dx) + (dy * dy)));
HXDLIN(  43)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this3,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
...
HXDLIN(  44)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this4,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
...
HXDLIN(  45)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this5,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
...
Float FlxSwipe_obj::get_distance(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  50)		HX_VARI( Float,dx) = (this->startPosition->x - this->endPosition->x);
HXDLIN(  50)		HX_VARI( Float,dy) = (this->startPosition->y - this->endPosition->y);
