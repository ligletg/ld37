...
HX_DEFINE_STACK_FRAME(_hx_pos_e74b11cf5585adaf_31_getWorldPosition,"flixel.input.FlxPointer","getWorldPosition",0x52927af2,"flixel.input.FlxPointer.getWorldPosition","flixel/input/FlxPointer.hx",31,0xe6a2529b)
HX_DEFINE_STACK_FRAME(_hx_pos_e74b11cf5585adaf_55_getScreenPosition,"flixel.input.FlxPointer","getScreenPosition",0xae561a7e,"flixel.input.FlxPointer.getScreenPosition","flixel/input/FlxPointer.hx",55,0xe6a2529b)
HX_DEFINE_STACK_FRAME(_hx_pos_e74b11cf5585adaf_75_getPosition,"flixel.input.FlxPointer","getPosition",0x9fea8a32,"flixel.input.FlxPointer.getPosition","flixel/input/FlxPointer.hx",75,0xe6a2529b)
HX_DEFINE_STACK_FRAME(_hx_pos_e74b11cf5585adaf_92_overlaps,"flixel.input.FlxPointer","overlaps",0xe0967a59,"flixel.input.FlxPointer.overlaps","flixel/input/FlxPointer.hx",92,0xe6a2529b)
static const bool _hx_array_data_c28ed6c1_5[] = {
	0,
};
HX_DEFINE_STACK_FRAME(_hx_pos_e74b11cf5585adaf_100_overlaps,"flixel.input.FlxPointer","overlaps",0xe0967a59,"flixel.input.FlxPointer.overlaps","flixel/input/FlxPointer.hx",100,0xe6a2529b)
HX_DEFINE_STACK_FRAME(_hx_pos_e74b11cf5585adaf_122_setGlobalScreenPositionUnsafe,"flixel.input.FlxPointer","setGlobalScreenPositionUnsafe",0x8f7aed13,"flixel.input.FlxPointer.setGlobalScreenPositionUnsafe","flixel/input/FlxPointer.hx",122,0xe6a2529b)
HX_DEFINE_STACK_FRAME(_hx_pos_e74b11cf5585adaf_131_toString,"flixel.input.FlxPointer","toString",0xd3da77f9,"flixel.input.FlxPointer.toString","flixel/input/FlxPointer.hx",131,0xe6a2529b)
HX_DEFINE_STACK_FRAME(_hx_pos_e74b11cf5585adaf_141_updatePositions,"flixel.input.FlxPointer","updatePositions",0xb47050b4,"flixel.input.FlxPointer.updatePositions","flixel/input/FlxPointer.hx",141,0xe6a2529b)
HX_DEFINE_STACK_FRAME(_hx_pos_e74b11cf5585adaf_18_boot,"flixel.input.FlxPointer","boot",0x825440ff,"flixel.input.FlxPointer.boot","flixel/input/FlxPointer.hx",18,0xe6a2529b)
namespace flixel{
namespace input{
...
HXLINE(  65)		point->set_x(((Float)((this->_globalScreenX - Camera->x) + ((((Float)0.5) * Camera->width) * (Camera->zoom - Camera->initialZoom))) / (Float)Camera->zoom));
HXLINE(  66)		point->set_y(((Float)((this->_globalScreenY - Camera->y) + ((((Float)0.5) * Camera->height) * (Camera->zoom - Camera->initialZoom))) / (Float)Camera->zoom));
...
HX_DEFINE_DYNAMIC_FUNC2(FlxPointer_obj,getScreenPosition,return )
 ...
 ::flixel::math::FlxPoint FlxPointer_obj::getPosition( ::flixel::math::FlxPoint point){
            	HX_STACKFRAME(&_hx_pos_e74b11cf5585adaf_75_getPosition)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(point,"point")
HXLINE(  76)		if (hx::IsNull( point )) {
...
HXLINE(  96)		if (hx::IsNotNull( group )) {
            			...
            			void _hx_run( ::flixel::FlxBasic basic){
            				HX_STACKFRAME(&_hx_pos_e74b11cf5585adaf_100_overlaps)
            				HX_STACK_ARG(basic,"basic")
HXLINE( 100)				if (_gthis->overlaps(basic,Camera)) {
...
HXLINE( 111)			bool _hx_tmp = ( ( ::flixel::FlxObject)(ObjectOrGroup) )->overlapsPoint(::flixel::input::FlxPointer_obj::_cachedPoint,true,Camera);
HXDLIN( 111)			result[(int)0] = _hx_tmp;
            		}
...
void FlxPointer_obj::setGlobalScreenPositionUnsafe(Float newX,Float newY){
            	HX_STACKFRAME(&_hx_pos_e74b11cf5585adaf_122_setGlobalScreenPositionUnsafe)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(newX,"newX")
            	HX_STACK_ARG(newY,"newY")
HXLINE( 123)		this->_globalScreenX = ::Std_obj::_hx_int(((Float)newX / (Float)::flixel::FlxG_obj::scaleMode->scale->x));
HXLINE( 124)		this->_globalScreenY = ::Std_obj::_hx_int(((Float)newY / (Float)::flixel::FlxG_obj::scaleMode->scale->y));
...
::String FlxPointer_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_e74b11cf5585adaf_131_toString)
            	HX_STACK_THIS(this)
...
void FlxPointer_obj::updatePositions(){
            	HX_STACKFRAME(&_hx_pos_e74b11cf5585adaf_141_updatePositions)
            	HX_STACK_THIS(this)
...
HXLINE(  18)		_cachedPoint =  ::flixel::math::FlxPoint_obj::__alloc( HX_CTX ,null(),null());
            	}
}
