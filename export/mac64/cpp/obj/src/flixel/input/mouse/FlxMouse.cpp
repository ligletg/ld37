...
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_161_load,"flixel.input.mouse.FlxMouse","load",0xf3e8bd02,"flixel.input.mouse.FlxMouse.load","flixel/input/mouse/FlxMouse.hx",161,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_233_unload,"flixel.input.mouse.FlxMouse","unload",0x5a7132db,"flixel.input.mouse.FlxMouse.unload","flixel/input/mouse/FlxMouse.hx",233,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_320_destroy,"flixel.input.mouse.FlxMouse","destroy",0x77a13b9e,"flixel.input.mouse.FlxMouse.destroy","flixel/input/mouse/FlxMouse.hx",320,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_359_reset,"flixel.input.mouse.FlxMouse","reset",0xe595a773,"flixel.input.mouse.FlxMouse.reset","flixel/input/mouse/FlxMouse.hx",359,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_408_update,"flixel.input.mouse.FlxMouse","update",0x7bea17e5,"flixel.input.mouse.FlxMouse.update","flixel/input/mouse/FlxMouse.hx",408,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_439_onFocus,"flixel.input.mouse.FlxMouse","onFocus",0xede20cdd,"flixel.input.mouse.FlxMouse.onFocus","flixel/input/mouse/FlxMouse.hx",439,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_453_onFocusLost,"flixel.input.mouse.FlxMouse","onFocusLost",0xc7f71561,"flixel.input.mouse.FlxMouse.onFocusLost","flixel/input/mouse/FlxMouse.hx",453,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_470_onGameStart,"flixel.input.mouse.FlxMouse","onGameStart",0x61da7695,"flixel.input.mouse.FlxMouse.onGameStart","flixel/input/mouse/FlxMouse.hx",470,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_478_onMouseWheel,"flixel.input.mouse.FlxMouse","onMouseWheel",0xdc642911,"flixel.input.mouse.FlxMouse.onMouseWheel","flixel/input/mouse/FlxMouse.hx",478,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_491_onMouseLeave,"flixel.input.mouse.FlxMouse","onMouseLeave",0x84fd296d,"flixel.input.mouse.FlxMouse.onMouseLeave","flixel/input/mouse/FlxMouse.hx",491,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_497_get_pressed,"flixel.input.mouse.FlxMouse","get_pressed",0x4652635d,"flixel.input.mouse.FlxMouse.get_pressed","flixel/input/mouse/FlxMouse.hx",497,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_498_get_justPressed,"flixel.input.mouse.FlxMouse","get_justPressed",0x70091811,"flixel.input.mouse.FlxMouse.get_justPressed","flixel/input/mouse/FlxMouse.hx",498,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_499_get_justReleased,"flixel.input.mouse.FlxMouse","get_justReleased",0x9ec2046e,"flixel.input.mouse.FlxMouse.get_justReleased","flixel/input/mouse/FlxMouse.hx",499,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_502_get_pressedRight,"flixel.input.mouse.FlxMouse","get_pressedRight",0x90e8c73f,"flixel.input.mouse.FlxMouse.get_pressedRight","flixel/input/mouse/FlxMouse.hx",502,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_503_get_justPressedRight,"flixel.input.mouse.FlxMouse","get_justPressedRight",0xa8a2860b,"flixel.input.mouse.FlxMouse.get_justPressedRight","flixel/input/mouse/FlxMouse.hx",503,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_504_get_justReleasedRight,"flixel.input.mouse.FlxMouse","get_justReleasedRight",0x8742a88e,"flixel.input.mouse.FlxMouse.get_justReleasedRight","flixel/input/mouse/FlxMouse.hx",504,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_506_get_pressedMiddle,"flixel.input.mouse.FlxMouse","get_pressedMiddle",0x38fe0e92,"flixel.input.mouse.FlxMouse.get_pressedMiddle","flixel/input/mouse/FlxMouse.hx",506,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_507_get_justPressedMiddle,"flixel.input.mouse.FlxMouse","get_justPressedMiddle",0xe3cb4246,"flixel.input.mouse.FlxMouse.get_justPressedMiddle","flixel/input/mouse/FlxMouse.hx",507,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_508_get_justReleasedMiddle,"flixel.input.mouse.FlxMouse","get_justReleasedMiddle",0xd1495263,"flixel.input.mouse.FlxMouse.get_justReleasedMiddle","flixel/input/mouse/FlxMouse.hx",508,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_512_showSystemCursor,"flixel.input.mouse.FlxMouse","showSystemCursor",0xf4551c9e,"flixel.input.mouse.FlxMouse.showSystemCursor","flixel/input/mouse/FlxMouse.hx",512,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_523_hideSystemCursor,"flixel.input.mouse.FlxMouse","hideSystemCursor",0xb5438fe3,"flixel.input.mouse.FlxMouse.hideSystemCursor","flixel/input/mouse/FlxMouse.hx",523,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_540_set_useSystemCursor,"flixel.input.mouse.FlxMouse","set_useSystemCursor",0x074e74d3,"flixel.input.mouse.FlxMouse.set_useSystemCursor","flixel/input/mouse/FlxMouse.hx",540,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_554_showCursor,"flixel.input.mouse.FlxMouse","showCursor",0xa585e38f,"flixel.input.mouse.FlxMouse.showCursor","flixel/input/mouse/FlxMouse.hx",554,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_573_hideCursor,"flixel.input.mouse.FlxMouse","hideCursor",0xd396e514,"flixel.input.mouse.FlxMouse.hideCursor","flixel/input/mouse/FlxMouse.hx",573,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_579_set_visible,"flixel.input.mouse.FlxMouse","set_visible",0xb9fd1039,"flixel.input.mouse.FlxMouse.set_visible","flixel/input/mouse/FlxMouse.hx",579,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_590_record,"flixel.input.mouse.FlxMouse","record",0xf2d1086d,"flixel.input.mouse.FlxMouse.record","flixel/input/mouse/FlxMouse.hx",590,0xe4e80b89)
HX_DEFINE_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_606_playback,"flixel.input.mouse.FlxMouse","playback",0xaadcd2f7,"flixel.input.mouse.FlxMouse.playback","flixel/input/mouse/FlxMouse.hx",606,0xe4e80b89)
namespace flixel{
namespace input{
namespace mouse{
...
HXLINE( 184)					HX_VARI( ::String,id) = ( (::String)(Graphic) );
...
void FlxMouse_obj::unload(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 233)		if (hx::IsNotNull( this->_cursor )) {
...
void FlxMouse_obj::onGameStart(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 470)		this->set_visible(this->visible);
            	}
...
bool FlxMouse_obj::get_pressed(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 497)		HX_VARI(  ::flixel::input::mouse::FlxMouseButton,_this) = this->_leftButton;
HXDLIN( 497)		if ((_this->current != (int)1)) {
HXLINE( 497)			return (_this->current == (int)2);
            		}
            		else {
...
bool FlxMouse_obj::get_justPressed(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 498)		return (this->_leftButton->current == (int)2);
            	}
...
bool FlxMouse_obj::get_justReleased(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 499)		return (this->_leftButton->current == (int)-1);
            	}
...
bool FlxMouse_obj::get_pressedRight(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 502)		HX_VARI(  ::flixel::input::mouse::FlxMouseButton,_this) = this->_rightButton;
HXDLIN( 502)		if ((_this->current != (int)1)) {
HXLINE( 502)			return (_this->current == (int)2);
            		}
            		else {
...
bool FlxMouse_obj::get_justPressedRight(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 503)		return (this->_rightButton->current == (int)2);
            	}
...
bool FlxMouse_obj::get_justReleasedRight(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 504)		return (this->_rightButton->current == (int)-1);
            	}
...
bool FlxMouse_obj::get_pressedMiddle(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 506)		HX_VARI(  ::flixel::input::mouse::FlxMouseButton,_this) = this->_middleButton;
HXDLIN( 506)		if ((_this->current != (int)1)) {
HXLINE( 506)			return (_this->current == (int)2);
            		}
            		else {
...
bool FlxMouse_obj::get_justPressedMiddle(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 507)		return (this->_middleButton->current == (int)2);
            	}
...
bool FlxMouse_obj::get_justReleasedMiddle(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 508)		return (this->_middleButton->current == (int)-1);
            	}
...
void FlxMouse_obj::showCursor(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 554)		if (this->useSystemCursor) {
...
HXLINE( 613)			this->_stage->dispatchEvent( ::openfl::_legacy::events::MouseEvent_obj::__alloc( HX_CTX ,::openfl::_legacy::events::MouseEvent_obj::MOUSE_UP,true,false,Record->x,Record->y,null(),null(),null(),null(),null(),null(),null(),null()));
            		}
