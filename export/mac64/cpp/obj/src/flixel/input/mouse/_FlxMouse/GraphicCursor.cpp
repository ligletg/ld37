...
HX_DEFINE_STACK_FRAME(_hx_pos_0fa41812b345085d_1_boot,"flixel.input.mouse._FlxMouse.GraphicCursor","boot",0x42985a5d,"flixel.input.mouse._FlxMouse.GraphicCursor.boot","?",1,0x0000003f)
namespace flixel{
namespace input{
namespace mouse{
namespace _FlxMouse{
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::input::mouse::_FlxMouse::GraphicCursor_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_input_mouse__FlxMouse_GraphicCursor",c5,22,e3,93);
            	}
}
