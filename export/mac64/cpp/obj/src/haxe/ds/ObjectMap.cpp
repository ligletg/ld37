...
HX_DEFINE_STACK_FRAME(_hx_pos_d1a78e92de9dff66_70_keys,"haxe.ds.ObjectMap","keys",0x8fbf0ebc,"haxe.ds.ObjectMap.keys","/usr/local/lib/haxe/std/cpp/_std/haxe/ds/ObjectMap.hx",70,0xa4879efa)
namespace haxe{
namespace ds{
...
HX_DEFINE_DYNAMIC_FUNC1(ObjectMap_obj,remove,return )
 ...
 ::Dynamic ObjectMap_obj::keys(){
            	HX_STACKFRAME(&_hx_pos_d1a78e92de9dff66_70_keys)
            	HX_STACK_THIS(this)
HXLINE(  71)		HX_VARI( ::cpp::VirtualArray,a) = ::__object_hash_keys(this->h);
