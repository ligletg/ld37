...
HX_DEFINE_STACK_FRAME(_hx_pos_84f0fad7b22fcaf3_99_exists,"haxe.ds.BalancedTree","exists",0x238deccd,"haxe.ds.BalancedTree.exists","/usr/local/lib/haxe/std/haxe/ds/BalancedTree.hx",99,0xee0b42c4)
...
bool BalancedTree_obj::exists( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_84f0fad7b22fcaf3_99_exists)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
