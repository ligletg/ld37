...
HX_DEFINE_STACK_FRAME(_hx_pos_2be74ae4095285fe_33_compare,"haxe.ds.EnumValueMap","compare",0x806a7d1a,"haxe.ds.EnumValueMap.compare","/usr/local/lib/haxe/std/haxe/ds/EnumValueMap.hx",33,0xc570effe)
HX_DEFINE_STACK_FRAME(_hx_pos_2be74ae4095285fe_42_compareArgs,"haxe.ds.EnumValueMap","compareArgs",0x37a5cb97,"haxe.ds.EnumValueMap.compareArgs","/usr/local/lib/haxe/std/haxe/ds/EnumValueMap.hx",42,0xc570effe)
HX_DEFINE_STACK_FRAME(_hx_pos_2be74ae4095285fe_53_compareArg,"haxe.ds.EnumValueMap","compareArg",0xcee2e55c,"haxe.ds.EnumValueMap.compareArg","/usr/local/lib/haxe/std/haxe/ds/EnumValueMap.hx",53,0xc570effe)
namespace haxe{
namespace ds{
...
int EnumValueMap_obj::compare( ::Dynamic _tmp_k1, ::Dynamic _tmp_k2){
            	HX_STACKFRAME(&_hx_pos_2be74ae4095285fe_33_compare)
            	HX_STACK_THIS(this)
...
HXDLIN(  34)		HX_VARI( int,d) = _hx_getEnumValueIndex(k1);
HXDLIN(  34)		HX_VARI_NAME( int,d1,"d") = (d - _hx_getEnumValueIndex(k2));
...
int EnumValueMap_obj::compareArgs(::cpp::VirtualArray a1,::cpp::VirtualArray a2){
            	HX_STACKFRAME(&_hx_pos_2be74ae4095285fe_42_compareArgs)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a1,"a1")
            	HX_STACK_ARG(a2,"a2")
...
HXDLIN(  45)				HX_VARI( int,i) = (_g1 - (int)1);
...
int EnumValueMap_obj::compareArg( ::Dynamic v1, ::Dynamic v2){
            	HX_STACKFRAME(&_hx_pos_2be74ae4095285fe_53_compareArg)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v1,"v1")
            	HX_STACK_ARG(v2,"v2")
...
HXLINE(  53)				return this->compareArgs(( (::cpp::VirtualArray)(v1) ),( (::cpp::VirtualArray)(v2) ));
            			}
            			else {
