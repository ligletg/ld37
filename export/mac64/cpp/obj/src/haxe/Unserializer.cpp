...
HX_DEFINE_STACK_FRAME(_hx_pos_2249f02c049a2193_102_new,"haxe.Unserializer","new",0xa8f5e205,"haxe.Unserializer.new","/usr/local/lib/haxe/std/haxe/Unserializer.hx",102,0x60de4a67)
HX_DEFINE_STACK_FRAME(_hx_pos_2249f02c049a2193_128_setResolver,"haxe.Unserializer","setResolver",0x5545046d,"haxe.Unserializer.setResolver","/usr/local/lib/haxe/std/haxe/Unserializer.hx",128,0x60de4a67)
HX_DEFINE_STACK_FRAME(_hx_pos_2249f02c049a2193_147_readDigits,"haxe.Unserializer","readDigits",0x75598b17,"haxe.Unserializer.readDigits","/usr/local/lib/haxe/std/haxe/Unserializer.hx",147,0x60de4a67)
HX_DEFINE_STACK_FRAME(_hx_pos_2249f02c049a2193_172_readFloat,"haxe.Unserializer","readFloat",0x5bd86dcb,"haxe.Unserializer.readFloat","/usr/local/lib/haxe/std/haxe/Unserializer.hx",172,0x60de4a67)
HX_DEFINE_STACK_FRAME(_hx_pos_2249f02c049a2193_186_unserializeObject,"haxe.Unserializer","unserializeObject",0x1b3e66eb,"haxe.Unserializer.unserializeObject","/usr/local/lib/haxe/std/haxe/Unserializer.hx",186,0x60de4a67)
HX_DEFINE_STACK_FRAME(_hx_pos_2249f02c049a2193_201_unserializeEnum,"haxe.Unserializer","unserializeEnum",0x5018b02d,"haxe.Unserializer.unserializeEnum","/usr/local/lib/haxe/std/haxe/Unserializer.hx",201,0x60de4a67)
HX_DEFINE_STACK_FRAME(_hx_pos_2249f02c049a2193_233_unserialize,"haxe.Unserializer","unserialize",0x92cca30c,"haxe.Unserializer.unserialize","/usr/local/lib/haxe/std/haxe/Unserializer.hx",233,0x60de4a67)
HX_DEFINE_STACK_FRAME(_hx_pos_2249f02c049a2193_70_initCodes,"haxe.Unserializer","initCodes",0xee42ccdb,"haxe.Unserializer.initCodes","/usr/local/lib/haxe/std/haxe/Unserializer.hx",70,0x60de4a67)
HX_DEFINE_STACK_FRAME(_hx_pos_2249f02c049a2193_461_run,"haxe.Unserializer","run",0xa8f8f8f0,"haxe.Unserializer.run","/usr/local/lib/haxe/std/haxe/Unserializer.hx",461,0x60de4a67)
HX_DEFINE_STACK_FRAME(_hx_pos_2249f02c049a2193_63_boot,"haxe.Unserializer","boot",0x2648e2ed,"haxe.Unserializer.boot","/usr/local/lib/haxe/std/haxe/Unserializer.hx",63,0x60de4a67)
HX_DEFINE_STACK_FRAME(_hx_pos_2249f02c049a2193_65_boot,"haxe.Unserializer","boot",0x2648e2ed,"haxe.Unserializer.boot","/usr/local/lib/haxe/std/haxe/Unserializer.hx",65,0x60de4a67)
HX_DEFINE_STACK_FRAME(_hx_pos_2249f02c049a2193_68_boot,"haxe.Unserializer","boot",0x2648e2ed,"haxe.Unserializer.boot","/usr/local/lib/haxe/std/haxe/Unserializer.hx",68,0x60de4a67)
namespace haxe{

void Unserializer_obj::__construct(::String buf){
            	HX_GC_STACKFRAME(&_hx_pos_2249f02c049a2193_102_new)
            	HX_STACK_THIS(this)
...
void Unserializer_obj::setResolver( ::Dynamic r){
            	HX_GC_STACKFRAME(&_hx_pos_2249f02c049a2193_128_setResolver)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(r,"r")
HXLINE( 128)		if (hx::IsNull( r )) {
...
Float Unserializer_obj::readFloat(){
            	HX_STACKFRAME(&_hx_pos_2249f02c049a2193_172_readFloat)
            	HX_STACK_THIS(this)
HXLINE( 173)		HX_VARI( int,p1) = this->pos;
HXLINE( 174)		while(true){
HXLINE( 175)			HX_VARI( int,c) = this->buf.cca(this->pos);
...
HXLINE( 181)				goto _hx_goto_4;
            		...
            		_hx_goto_4:;
HXLINE( 183)		return ::Std_obj::parseFloat(this->buf.substr(p1,(this->pos - p1)));
            	}
...
void Unserializer_obj::unserializeObject( ::Dynamic o){
            	HX_STACKFRAME(&_hx_pos_2249f02c049a2193_186_unserializeObject)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(o,"o")
...
HXLINE( 196)			::Reflect_obj::setField(o,k,this->unserialize());
            		}
            		_hx_goto_6:;
HXLINE( 198)		this->pos++;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Unserializer_obj,unserializeObject,(void))
 ...
 ::Dynamic Unserializer_obj::unserializeEnum(hx::Class edecl,::String tag){
            	HX_STACKFRAME(&_hx_pos_2249f02c049a2193_201_unserializeEnum)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC2(Unserializer_obj,unserializeEnum,return )
 ...
 ::Dynamic Unserializer_obj::unserialize(){
            	HX_GC_STACKFRAME(&_hx_pos_2249f02c049a2193_233_unserialize)
            	HX_STACK_THIS(this)
HXLINE( 234)		switch((int)(this->buf.cca(this->pos++))){
            			case (int)65: {
HXLINE( 436)				HX_VARI( ::String,name) = ( (::String)(this->unserialize()) );
HXLINE( 437)				HX_VARI( hx::Class,cl) = this->resolver->__Field(HX_("resolveClass",ac,bd,dd,80),hx::paccDynamic)(name);
HXLINE( 438)				if (hx::IsNull( cl )) {
...
HXLINE( 443)				HX_VARI( hx::Class,e) = this->resolver->__Field(HX_("resolveEnum",0d,90,51,de),hx::paccDynamic)(name1);
HXLINE( 444)				if (hx::IsNull( e )) {
...
HXLINE( 426)				HX_VARI_NAME( hx::Class,cl1,"cl") = this->resolver->__Field(HX_("resolveClass",ac,bd,dd,80),hx::paccDynamic)(name2);
HXLINE( 427)				if (hx::IsNull( cl1 )) {
...
HXLINE( 431)				o->__Field(HX_("hxUnserialize",37,db,b9,86),hx::paccDynamic)(hx::ObjectPtr<OBJ_>(this));
HXLINE( 432)				if ((this->buf.cca(this->pos++) != (int)103)) {
...
HXLINE( 434)				return o;
            			...
            			break;
            			case (int)77: {
HXLINE( 359)				HX_VARI(  ::haxe::ds::ObjectMap,h) =  ::haxe::ds::ObjectMap_obj::__alloc( HX_CTX );
HXLINE( 360)				this->cache->push(h);
HXLINE( 362)				while((this->buf.cca(this->pos) != (int)104)){
HXLINE( 363)					HX_VARI(  ::Dynamic,s) = this->unserialize();
HXLINE( 364)					h->set(s,this->unserialize());
            				}
HXLINE( 366)				this->pos++;
HXLINE( 367)				return h;
            			}
...
HXLINE( 292)					_hx_tmp = (n >= this->scache->length);
            				}
            				else {
...
HXLINE( 267)					HX_VARI( int,c) = this->buf.cca(this->pos);
HXLINE( 268)					if ((c == (int)104)) {
HXLINE( 269)						this->pos++;
HXLINE( 270)						goto _hx_goto_11;
            					}
HXLINE( 272)					if ((c == (int)117)) {
HXLINE( 273)						this->pos++;
HXLINE( 274)						HX_VARI_NAME( int,n1,"n") = this->readDigits();
HXLINE( 275)						a->set(((a->get_length() + n1) - (int)1),null());
            					}
            					else {
HXLINE( 277)						a->push(this->unserialize());
            					}
            				}
            				_hx_goto_11:;
HXLINE( 279)				return a;
            			...
            			break;
            			case (int)98: {
HXLINE( 336)				HX_VARI_NAME(  ::haxe::ds::StringMap,h1,"h") =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 337)				this->cache->push(h1);
HXLINE( 339)				while((this->buf.cca(this->pos) != (int)104)){
HXLINE( 340)					HX_VARI_NAME( ::String,s1,"s") = ( (::String)(this->unserialize()) );
HXLINE( 341)					h1->set(s1,this->unserialize());
            				}
HXLINE( 343)				this->pos++;
...
HXLINE( 299)				HX_VARI_NAME( hx::Class,cl2,"cl") = this->resolver->__Field(HX_("resolveClass",ac,bd,dd,80),hx::paccDynamic)(name3);
HXLINE( 300)				if (hx::IsNull( cl2 )) {
...
HXLINE( 316)				HX_VARI( hx::Class,edecl) = this->resolver->__Field(HX_("resolveEnum",0d,90,51,de),hx::paccDynamic)(name4);
HXLINE( 317)				if (hx::IsNull( edecl )) {
HXLINE( 318)					HX_STACK_DO_THROW((HX_("Enum not found ",aa,e1,55,fd) + name4));
            				}
HXLINE( 319)				this->pos++;
HXLINE( 320)				HX_VARI( int,index) = this->readDigits();
HXLINE( 321)				HX_VARI( ::String,tag) = ::Type_obj::getEnumConstructs(edecl)->__get(index);
HXLINE( 322)				if (hx::IsNull( tag )) {
...
HXLINE( 257)				return ::Math_obj::NaN;
            			...
            			break;
            			case (int)108: {
HXLINE( 328)				HX_VARI(  ::List,l) =  ::List_obj::__alloc( HX_CTX );
HXLINE( 329)				this->cache->push(l);
HXLINE( 331)				while((this->buf.cca(this->pos) != (int)104)){
HXLINE( 332)					l->add(this->unserialize());
            				}
HXLINE( 333)				this->pos++;
HXLINE( 334)				return l;
            			}
...
HXLINE( 261)				return ::Math_obj::POSITIVE_INFINITY;
            			...
            			break;
            			case (int)113: {
HXLINE( 346)				HX_VARI_NAME(  ::haxe::ds::IntMap,h2,"h") =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE( 347)				this->cache->push(h2);
HXLINE( 349)				HX_VARI_NAME( int,c1,"c") = this->buf.cca(this->pos++);
HXLINE( 350)				while((c1 == (int)58)){
HXLINE( 351)					HX_VARI( int,i) = this->readDigits();
HXLINE( 352)					h2->set(i,this->unserialize());
HXLINE( 353)					c1 = this->buf.cca(this->pos++);
            				}
...
HXLINE( 287)					_hx_tmp1 = (n2 >= this->cache->get_length());
            				}
            				else {
...
HXDLIN( 386)				if ((this->buf.cca(this->pos++) == (int)58)) {
HXLINE( 386)					_hx_tmp2 = ((this->length - this->pos) < len);
            				}
            				else {
...
HXLINE( 398)					size = (rest - (int)1);
            				}
            				else {
HXLINE( 398)					size = (int)0;
            				}
HXLINE( 399)				HX_VARI( int,max) = (i1 + (len - rest));
HXLINE( 400)				HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::io::Bytes_obj::alloc(((((int)len >> (int)(int)2) * (int)3) + size));
HXLINE( 401)				HX_VARI( int,bpos) = (int)0;
HXLINE( 402)				while((i1 < max)){
HXLINE( 403)					i1 = (i1 + (int)1);
HXDLIN( 403)					HX_VARI_NAME( int,c11,"c1") = codes->__get(buf.cca((i1 - (int)1)));
HXLINE( 404)					i1 = (i1 + (int)1);
HXDLIN( 404)					HX_VARI( int,c2) = codes->__get(buf.cca((i1 - (int)1)));
HXLINE( 405)					{
HXLINE( 405)						bpos = (bpos + (int)1);
HXDLIN( 405)						bytes->b[(bpos - (int)1)] = ((int)((int)c11 << (int)(int)2) | (int)((int)c2 >> (int)(int)4));
            					}
HXLINE( 406)					i1 = (i1 + (int)1);
HXDLIN( 406)					HX_VARI( int,c3) = codes->__get(buf.cca((i1 - (int)1)));
HXLINE( 407)					{
HXLINE( 407)						bpos = (bpos + (int)1);
HXDLIN( 407)						bytes->b[(bpos - (int)1)] = ((int)((int)c2 << (int)(int)4) | (int)((int)c3 >> (int)(int)2));
            					}
HXLINE( 408)					i1 = (i1 + (int)1);
HXDLIN( 408)					HX_VARI( int,c4) = codes->__get(buf.cca((i1 - (int)1)));
HXLINE( 409)					{
HXLINE( 409)						bpos = (bpos + (int)1);
HXDLIN( 409)						bytes->b[(bpos - (int)1)] = ((int)((int)c3 << (int)(int)6) | (int)c4);
            					}
            				}
HXLINE( 411)				if ((rest >= (int)2)) {
HXLINE( 412)					i1 = (i1 + (int)1);
HXDLIN( 412)					HX_VARI_NAME( int,c12,"c1") = codes->__get(buf.cca((i1 - (int)1)));
HXLINE( 413)					i1 = (i1 + (int)1);
HXDLIN( 413)					HX_VARI_NAME( int,c21,"c2") = codes->__get(buf.cca((i1 - (int)1)));
HXLINE( 414)					{
HXLINE( 414)						bpos = (bpos + (int)1);
HXDLIN( 414)						bytes->b[(bpos - (int)1)] = ((int)((int)c12 << (int)(int)2) | (int)((int)c21 >> (int)(int)4));
            					}
HXLINE( 415)					if ((rest == (int)3)) {
HXLINE( 416)						i1 = (i1 + (int)1);
HXDLIN( 416)						HX_VARI_NAME( int,c31,"c3") = codes->__get(buf.cca((i1 - (int)1)));
HXLINE( 417)						{
HXLINE( 417)							bpos = (bpos + (int)1);
HXDLIN( 417)							bytes->b[(bpos - (int)1)] = ((int)((int)c21 << (int)(int)4) | (int)((int)c31 >> (int)(int)2));
            						}
            					}
            				}
HXLINE( 421)				 ::haxe::Unserializer _hx_tmp3 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 421)				_hx_tmp3->pos = (_hx_tmp3->pos + len);
...
HXDLIN( 370)				bool _hx_tmp5;
HXDLIN( 370)				bool _hx_tmp6;
HXDLIN( 370)				bool _hx_tmp7;
HXDLIN( 370)				bool _hx_tmp8;
HXDLIN( 370)				bool _hx_tmp9;
HXDLIN( 370)				bool _hx_tmp10;
HXDLIN( 370)				bool _hx_tmp11;
HXDLIN( 370)				if ((this->buf.cca(this->pos) >= (int)48)) {
HXLINE( 370)					_hx_tmp11 = (this->buf.cca(this->pos) <= (int)57);
            				}
            				else {
HXLINE( 370)					_hx_tmp11 = false;
            				}
HXDLIN( 370)				if (_hx_tmp11) {
HXLINE( 370)					_hx_tmp10 = (this->buf.cca((this->pos + (int)1)) >= (int)48);
            				}
            				else {
HXLINE( 370)					_hx_tmp10 = false;
            				}
HXDLIN( 370)				if (_hx_tmp10) {
HXLINE( 370)					_hx_tmp9 = (this->buf.cca((this->pos + (int)1)) <= (int)57);
            				}
            				else {
HXLINE( 370)					_hx_tmp9 = false;
            				}
HXDLIN( 370)				if (_hx_tmp9) {
HXLINE( 370)					_hx_tmp8 = (this->buf.cca((this->pos + (int)2)) >= (int)48);
            				}
            				else {
HXLINE( 370)					_hx_tmp8 = false;
            				}
HXDLIN( 370)				if (_hx_tmp8) {
HXLINE( 370)					_hx_tmp7 = (this->buf.cca((this->pos + (int)2)) <= (int)57);
            				}
            				else {
HXLINE( 370)					_hx_tmp7 = false;
            				}
HXDLIN( 370)				if (_hx_tmp7) {
HXLINE( 370)					_hx_tmp6 = (this->buf.cca((this->pos + (int)3)) >= (int)48);
            				}
            				else {
HXLINE( 370)					_hx_tmp6 = false;
            				}
HXDLIN( 370)				if (_hx_tmp6) {
HXLINE( 370)					_hx_tmp5 = (this->buf.cca((this->pos + (int)3)) <= (int)57);
            				}
            				else {
HXLINE( 370)					_hx_tmp5 = false;
            				}
HXDLIN( 370)				if (_hx_tmp5) {
HXLINE( 370)					_hx_tmp4 = (this->buf.cca((this->pos + (int)4)) == (int)45);
            				}
            				else {
HXLINE( 370)					_hx_tmp4 = false;
            				}
HXDLIN( 370)				if (_hx_tmp4) {
HXLINE( 377)					d = ::Date_obj::fromString(this->buf.substr(this->pos,(int)19));
HXLINE( 378)					 ::haxe::Unserializer _hx_tmp12 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 378)					_hx_tmp12->pos = (_hx_tmp12->pos + (int)19);
            				}
            				else {
HXLINE( 380)					d = ::Date_obj::fromTime(this->readFloat());
            				}
...
HXLINE( 308)				HX_VARI_NAME( hx::Class,edecl1,"edecl") = this->resolver->__Field(HX_("resolveEnum",0d,90,51,de),hx::paccDynamic)(name5);
HXLINE( 309)				if (hx::IsNull( edecl1 )) {
HXLINE( 310)					HX_STACK_DO_THROW((HX_("Enum not found ",aa,e1,55,fd) + name5));
            				}
HXLINE( 311)				HX_VARI_NAME(  ::Dynamic,e2,"e") = this->unserializeEnum(edecl1,( (::String)(this->unserialize()) ));
...
HXLINE( 449)		this->pos--;
HXLINE( 450)		::String _hx_tmp15 = ((HX_("Invalid char ",81,66,ec,29) + this->buf.charAt(this->pos)) + HX_(" at position ",0a,c2,01,e0));
HXDLIN( 450)		HX_STACK_DO_THROW((_hx_tmp15 + this->pos));
...
::Array< int > Unserializer_obj::initCodes(){
            	HX_STACKFRAME(&_hx_pos_2249f02c049a2193_70_initCodes)
...
HXDLIN(  77)				HX_VARI( int,i) = (_g1 - (int)1);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Unserializer_obj,initCodes,return )
 ...
 ::Dynamic Unserializer_obj::run(::String v){
            	HX_GC_STACKFRAME(&_hx_pos_2249f02c049a2193_461_run)
            	HX_STACK_ARG(v,"v")
HXLINE( 461)		return  ::haxe::Unserializer_obj::__alloc( HX_CTX ,v)->unserialize();
            	}
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_2249f02c049a2193_63_boot)
HXLINE(  63)		DEFAULT_RESOLVER =  ::haxe::_Unserializer::DefaultResolver_obj::__alloc( HX_CTX );
            	}
{
            	HX_STACKFRAME(&_hx_pos_2249f02c049a2193_65_boot)
HXLINE(  65)		BASE64 = HX_("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789%:",d4,3b,03,7f);
            	}
{
            	HX_STACKFRAME(&_hx_pos_2249f02c049a2193_68_boot)
