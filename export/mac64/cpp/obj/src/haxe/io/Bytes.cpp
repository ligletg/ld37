...
HX_DEFINE_STACK_FRAME(_hx_pos_dd4549ff8fa56c0b_79_blit,"haxe.io.Bytes","blit",0xd098ac78,"haxe.io.Bytes.blit","/usr/local/lib/haxe/std/haxe/io/Bytes.hx",79,0xd68ef8f0)
HX_DEFINE_STACK_FRAME(_hx_pos_dd4549ff8fa56c0b_133_sub,"haxe.io.Bytes","sub",0x393cae9d,"haxe.io.Bytes.sub","/usr/local/lib/haxe/std/haxe/io/Bytes.hx",133,0xd68ef8f0)
HX_DEFINE_STACK_FRAME(_hx_pos_dd4549ff8fa56c0b_360_getString,"haxe.io.Bytes","getString",0xa16beae4,"haxe.io.Bytes.getString","/usr/local/lib/haxe/std/haxe/io/Bytes.hx",360,0xd68ef8f0)
HX_DEFINE_STACK_FRAME(_hx_pos_dd4549ff8fa56c0b_440_toString,"haxe.io.Bytes","toString",0x0291226f,"haxe.io.Bytes.toString","/usr/local/lib/haxe/std/haxe/io/Bytes.hx",440,0xd68ef8f0)
HX_DEFINE_STACK_FRAME(_hx_pos_dd4549ff8fa56c0b_462_alloc,"haxe.io.Bytes","alloc",0x2199ead2,"haxe.io.Bytes.alloc","/usr/local/lib/haxe/std/haxe/io/Bytes.hx",462,0xd68ef8f0)
HX_DEFINE_STACK_FRAME(_hx_pos_dd4549ff8fa56c0b_490_ofString,"haxe.io.Bytes","ofString",0x6e53bb0b,"haxe.io.Bytes.ofString","/usr/local/lib/haxe/std/haxe/io/Bytes.hx",490,0xd68ef8f0)
HX_DEFINE_STACK_FRAME(_hx_pos_dd4549ff8fa56c0b_561_ofData,"haxe.io.Bytes","ofData",0x4f3005e4,"haxe.io.Bytes.ofData","/usr/local/lib/haxe/std/haxe/io/Bytes.hx",561,0xd68ef8f0)
HX_DEFINE_STACK_FRAME(_hx_pos_dd4549ff8fa56c0b_577_fastGet,"haxe.io.Bytes","fastGet",0xa10d56f7,"haxe.io.Bytes.fastGet","/usr/local/lib/haxe/std/haxe/io/Bytes.hx",577,0xd68ef8f0)
namespace haxe{
namespace io{
...
void Bytes_obj::blit(int pos, ::haxe::io::Bytes src,int srcpos,int len){
            	HX_STACKFRAME(&_hx_pos_dd4549ff8fa56c0b_79_blit)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC4(Bytes_obj,blit,(void))
 ...
 ::haxe::io::Bytes Bytes_obj::sub(int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_dd4549ff8fa56c0b_133_sub)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(len,"len")
...
HXLINE( 157)		return  ::haxe::io::Bytes_obj::__alloc( HX_CTX ,len,this->b->slice(pos,(pos + len)));
            	}
...
::String Bytes_obj::getString(int pos,int len){
            	HX_STACKFRAME(&_hx_pos_dd4549ff8fa56c0b_360_getString)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(len,"len")
...
::String Bytes_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_dd4549ff8fa56c0b_440_toString)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(Bytes_obj,toString,return )
 ...
 ::haxe::io::Bytes Bytes_obj::alloc(int length){
            	HX_GC_STACKFRAME(&_hx_pos_dd4549ff8fa56c0b_462_alloc)
            	HX_STACK_ARG(length,"length")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Bytes_obj,alloc,return )
 ...
 ::haxe::io::Bytes Bytes_obj::ofString(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_dd4549ff8fa56c0b_490_ofString)
            	HX_STACK_ARG(s,"s")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Bytes_obj,ofString,return )
 ...
 ::haxe::io::Bytes Bytes_obj::ofData(::Array< unsigned char > b){
            	HX_GC_STACKFRAME(&_hx_pos_dd4549ff8fa56c0b_561_ofData)
            	HX_STACK_ARG(b,"b")
HXLINE( 561)		return  ::haxe::io::Bytes_obj::__alloc( HX_CTX ,b->length,b);
            	}
...
int Bytes_obj::fastGet(::Array< unsigned char > b,int pos){
            	HX_STACKFRAME(&_hx_pos_dd4549ff8fa56c0b_577_fastGet)
            	HX_STACK_ARG(b,"b")
            	HX_STACK_ARG(pos,"pos")
HXLINE( 577)		return _hx_array_unsafe_get(b,pos);
            	}
