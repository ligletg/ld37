...
HX_DEFINE_STACK_FRAME(_hx_pos_9ba24db561a9c477_147_directory,"haxe.io.Path","directory",0xbcfe23c4,"haxe.io.Path.directory","/usr/local/lib/haxe/std/haxe/io/Path.hx",147,0xc99b0f1c)
HX_DEFINE_STACK_FRAME(_hx_pos_9ba24db561a9c477_262_addTrailingSlash,"haxe.io.Path","addTrailingSlash",0x8b4f8e69,"haxe.io.Path.addTrailingSlash","/usr/local/lib/haxe/std/haxe/io/Path.hx",262,0xc99b0f1c)
HX_DEFINE_STACK_FRAME(_hx_pos_9ba24db561a9c477_287_removeTrailingSlashes,"haxe.io.Path","removeTrailingSlashes",0x2dc73462,"haxe.io.Path.removeTrailingSlashes","/usr/local/lib/haxe/std/haxe/io/Path.hx",287,0xc99b0f1c)
namespace haxe{
namespace io{
...
::String Path_obj::directory(::String path){
            	...
            	HX_STACK_ARG(path,"path")
HXLINE( 148)		HX_VARI(  ::haxe::io::Path,s) =  ::haxe::io::Path_obj::__alloc( HX_CTX ,path);
...
::String Path_obj::addTrailingSlash(::String path){
            	HX_STACKFRAME(&_hx_pos_9ba24db561a9c477_262_addTrailingSlash)
            	HX_STACK_ARG(path,"path")
...
::String Path_obj::removeTrailingSlashes(::String path){
            	HX_STACKFRAME(&_hx_pos_9ba24db561a9c477_287_removeTrailingSlashes)
            	HX_STACK_ARG(path,"path")
