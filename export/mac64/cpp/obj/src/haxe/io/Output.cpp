...
HX_DEFINE_STACK_FRAME(_hx_pos_0e34c0ce46c21137_47_writeByte,"haxe.io.Output","writeByte",0xb4fe513a,"haxe.io.Output.writeByte","/usr/local/lib/haxe/std/haxe/io/Output.hx",47,0x72d66600)
HX_DEFINE_STACK_FRAME(_hx_pos_0e34c0ce46c21137_57_writeBytes,"haxe.io.Output","writeBytes",0xa988c1f9,"haxe.io.Output.writeBytes","/usr/local/lib/haxe/std/haxe/io/Output.hx",57,0x72d66600)
HX_DEFINE_STACK_FRAME(_hx_pos_0e34c0ce46c21137_93_close,"haxe.io.Output","close",0xe726bfeb,"haxe.io.Output.close","/usr/local/lib/haxe/std/haxe/io/Output.hx",93,0x72d66600)
HX_DEFINE_STACK_FRAME(_hx_pos_0e34c0ce46c21137_106_write,"haxe.io.Output","write",0x6f1d1512,"haxe.io.Output.write","/usr/local/lib/haxe/std/haxe/io/Output.hx",106,0x72d66600)
HX_DEFINE_STACK_FRAME(_hx_pos_0e34c0ce46c21137_123_writeFullBytes,"haxe.io.Output","writeFullBytes",0xc2c420ea,"haxe.io.Output.writeFullBytes","/usr/local/lib/haxe/std/haxe/io/Output.hx",123,0x72d66600)
HX_DEFINE_STACK_FRAME(_hx_pos_0e34c0ce46c21137_278_writeString,"haxe.io.Output","writeString",0x97e1cb83,"haxe.io.Output.writeString","/usr/local/lib/haxe/std/haxe/io/Output.hx",278,0x72d66600)
namespace haxe{
namespace io{
...
void Output_obj::close(){
            	HX_STACKFRAME(&_hx_pos_0e34c0ce46c21137_93_close)
            	HX_STACK_THIS(this)
            	}
...
void Output_obj::write( ::haxe::io::Bytes s){
            	HX_STACKFRAME(&_hx_pos_0e34c0ce46c21137_106_write)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
...
void Output_obj::writeFullBytes( ::haxe::io::Bytes s,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_0e34c0ce46c21137_123_writeFullBytes)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(len,"len")
