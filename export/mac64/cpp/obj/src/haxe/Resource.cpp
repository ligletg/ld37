...
HX_DEFINE_STACK_FRAME(_hx_pos_fca07e86ad3f4245_33_getBytes,"haxe.Resource","getBytes",0x9bc1712d,"haxe.Resource.getBytes","/usr/local/lib/haxe/std/cpp/_std/haxe/Resource.hx",33,0xfd53b169)
namespace haxe{
...
bool Resource_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes Resource_obj::getBytes(::String name){
            	HX_STACKFRAME(&_hx_pos_fca07e86ad3f4245_33_getBytes)
            	HX_STACK_ARG(name,"name")
HXLINE(  34)		HX_VARI( ::Array< unsigned char >,array) = ::__hxcpp_resource_bytes(name);
