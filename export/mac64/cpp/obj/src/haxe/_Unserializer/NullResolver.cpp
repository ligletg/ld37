...
HX_DEFINE_STACK_FRAME(_hx_pos_6789dee647201548_477_new,"haxe._Unserializer.NullResolver","new",0x49a2304b,"haxe._Unserializer.NullResolver.new","/usr/local/lib/haxe/std/haxe/Unserializer.hx",477,0x60de4a67)
HX_DEFINE_STACK_FRAME(_hx_pos_6789dee647201548_478_resolveClass,"haxe._Unserializer.NullResolver","resolveClass",0xc4a78861,"haxe._Unserializer.NullResolver.resolveClass","/usr/local/lib/haxe/std/haxe/Unserializer.hx",478,0x60de4a67)
HX_DEFINE_STACK_FRAME(_hx_pos_6789dee647201548_479_resolveEnum,"haxe._Unserializer.NullResolver","resolveEnum",0x5f3252f8,"haxe._Unserializer.NullResolver.resolveEnum","/usr/local/lib/haxe/std/haxe/Unserializer.hx",479,0x60de4a67)
namespace haxe{
namespace _Unserializer{

void NullResolver_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_6789dee647201548_477_new)
            	HX_STACK_THIS(this)
            	}
...
hx::Class NullResolver_obj::resolveClass(::String name){
            	HX_STACKFRAME(&_hx_pos_6789dee647201548_478_resolveClass)
            	HX_STACK_THIS(this)
...
hx::Class NullResolver_obj::resolveEnum(::String name){
            	HX_STACKFRAME(&_hx_pos_6789dee647201548_479_resolveEnum)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(name,"name")
