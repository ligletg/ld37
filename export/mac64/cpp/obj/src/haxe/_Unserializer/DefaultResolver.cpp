...
HX_DEFINE_STACK_FRAME(_hx_pos_68dfa52f787219bb_471_new,"haxe._Unserializer.DefaultResolver","new",0xe2809ead,"haxe._Unserializer.DefaultResolver.new","/usr/local/lib/haxe/std/haxe/Unserializer.hx",471,0x60de4a67)
HX_DEFINE_STACK_FRAME(_hx_pos_68dfa52f787219bb_472_resolveClass,"haxe._Unserializer.DefaultResolver","resolveClass",0xbc0d3dbf,"haxe._Unserializer.DefaultResolver.resolveClass","/usr/local/lib/haxe/std/haxe/Unserializer.hx",472,0x60de4a67)
HX_DEFINE_STACK_FRAME(_hx_pos_68dfa52f787219bb_473_resolveEnum,"haxe._Unserializer.DefaultResolver","resolveEnum",0x8198f35a,"haxe._Unserializer.DefaultResolver.resolveEnum","/usr/local/lib/haxe/std/haxe/Unserializer.hx",473,0x60de4a67)
namespace haxe{
namespace _Unserializer{

void DefaultResolver_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_68dfa52f787219bb_471_new)
            	HX_STACK_THIS(this)
            	}
...
hx::Class DefaultResolver_obj::resolveClass(::String name){
            	HX_STACKFRAME(&_hx_pos_68dfa52f787219bb_472_resolveClass)
            	HX_STACK_THIS(this)
...
hx::Class DefaultResolver_obj::resolveEnum(::String name){
            	HX_STACKFRAME(&_hx_pos_68dfa52f787219bb_473_resolveEnum)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(name,"name")
