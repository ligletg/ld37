...
HX_DEFINE_STACK_FRAME(_hx_pos_6f406d8fe1a53144_83_new,"haxe.xml._Fast.HasNodeAccess","new",0xd184aba0,"haxe.xml._Fast.HasNodeAccess.new","/usr/local/lib/haxe/std/haxe/xml/Fast.hx",83,0x1680b11e)
HX_DEFINE_STACK_FRAME(_hx_pos_6f406d8fe1a53144_87_resolve,"haxe.xml._Fast.HasNodeAccess","resolve",0x2b3f8e2c,"haxe.xml._Fast.HasNodeAccess.resolve","/usr/local/lib/haxe/std/haxe/xml/Fast.hx",87,0x1680b11e)
namespace haxe{
namespace xml{
namespace _Fast{

void HasNodeAccess_obj::__construct( ::Xml x){
            	HX_STACKFRAME(&_hx_pos_6f406d8fe1a53144_83_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
...
bool HasNodeAccess_obj::resolve(::String name){
            	HX_STACKFRAME(&_hx_pos_6f406d8fe1a53144_87_resolve)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(name,"name")
HXLINE(  87)		return this->_hx___x->elementsNamed(name)->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)();
            	}
