...
HX_DEFINE_STACK_FRAME(_hx_pos_103177870d11945e_29_new,"haxe.xml._Fast.NodeAccess","new",0xde09fb0a,"haxe.xml._Fast.NodeAccess.new","/usr/local/lib/haxe/std/haxe/xml/Fast.hx",29,0x1680b11e)
HX_DEFINE_STACK_FRAME(_hx_pos_103177870d11945e_32_resolve,"haxe.xml._Fast.NodeAccess","resolve",0x0e91da96,"haxe.xml._Fast.NodeAccess.resolve","/usr/local/lib/haxe/std/haxe/xml/Fast.hx",32,0x1680b11e)
namespace haxe{
namespace xml{
namespace _Fast{

void NodeAccess_obj::__construct( ::Xml x){
            	HX_STACKFRAME(&_hx_pos_103177870d11945e_29_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
HXLINE(  29)		this->_hx___x = x;
            	}
...
bool NodeAccess_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::xml::Fast NodeAccess_obj::resolve(::String name){
            	HX_GC_STACKFRAME(&_hx_pos_103177870d11945e_32_resolve)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(name,"name")
HXLINE(  33)		HX_VARI(  ::Xml,x) = ( ( ::Xml)(this->_hx___x->elementsNamed(name)->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE(  34)		if (hx::IsNull( x )) {
HXLINE(  35)			HX_VAR( ::String,xname);
HXDLIN(  35)			if ((this->_hx___x->nodeType == ::Xml_obj::Document)) {
HXLINE(  35)				xname = HX_("Document",3b,ab,c4,74);
            			}
            			else {
HXLINE(  35)				HX_VARI(  ::Xml,_this) = this->_hx___x;
