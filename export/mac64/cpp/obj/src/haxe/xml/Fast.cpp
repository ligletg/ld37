...
HX_DEFINE_STACK_FRAME(_hx_pos_af5e2f0886568b4e_211_new,"haxe.xml.Fast","new",0xda21546d,"haxe.xml.Fast.new","/usr/local/lib/haxe/std/haxe/xml/Fast.hx",211,0x1680b11e)
HX_DEFINE_STACK_FRAME(_hx_pos_af5e2f0886568b4e_223_get_name,"haxe.xml.Fast","get_name",0x9611daa7,"haxe.xml.Fast.get_name","/usr/local/lib/haxe/std/haxe/xml/Fast.hx",223,0x1680b11e)
HX_DEFINE_STACK_FRAME(_hx_pos_af5e2f0886568b4e_226_get_innerData,"haxe.xml.Fast","get_innerData",0x21ea0104,"haxe.xml.Fast.get_innerData","/usr/local/lib/haxe/std/haxe/xml/Fast.hx",226,0x1680b11e)
HX_DEFINE_STACK_FRAME(_hx_pos_af5e2f0886568b4e_259_get_elements,"haxe.xml.Fast","get_elements",0x6707fc93,"haxe.xml.Fast.get_elements","/usr/local/lib/haxe/std/haxe/xml/Fast.hx",259,0x1680b11e)
HX_DEFINE_STACK_FRAME(_hx_pos_af5e2f0886568b4e_255_get_elements,"haxe.xml.Fast","get_elements",0x6707fc93,"haxe.xml.Fast.get_elements","/usr/local/lib/haxe/std/haxe/xml/Fast.hx",255,0x1680b11e)
namespace haxe{
namespace xml{

void Fast_obj::__construct( ::Xml x){
            	HX_GC_STACKFRAME(&_hx_pos_af5e2f0886568b4e_211_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
...
::String Fast_obj::get_name(){
            	HX_STACKFRAME(&_hx_pos_af5e2f0886568b4e_223_get_name)
            	HX_STACK_THIS(this)
HXLINE( 223)		if ((this->x->nodeType == ::Xml_obj::Document)) {
HXLINE( 223)			return HX_("Document",3b,ab,c4,74);
            		}
            		else {
HXLINE( 223)			HX_VARI(  ::Xml,_this) = this->x;
HXDLIN( 223)			if ((_this->nodeType != ::Xml_obj::Element)) {
HXLINE( 223)				HX_STACK_DO_THROW((HX_("Bad node type, expected Element but found ",d8,90,8b,bb) + _this->nodeType));
            			}
...
::String Fast_obj::get_innerData(){
            	HX_STACKFRAME(&_hx_pos_af5e2f0886568b4e_226_get_innerData)
            	HX_STACK_THIS(this)
HXLINE( 227)		HX_VARI(  ::Xml,_this) = this->x;
...
HXDLIN( 227)		HX_VARI(  ::Dynamic,it) = _this->children->iterator();
...
HXLINE( 230)		HX_VARI(  ::Xml,v) = ( ( ::Xml)(it->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 231)		if (( (bool)(it->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )) {
HXLINE( 232)			HX_VARI(  ::Xml,n) = ( ( ::Xml)(it->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
...
HXLINE( 237)				HX_VARI(  ::Xml,n2) = ( ( ::Xml)(it->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
 ...
 ::Dynamic Fast_obj::get_elements(){
            		HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_0, ::Dynamic,it) HXARGC(0)
            		 ::haxe::xml::Fast _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_af5e2f0886568b4e_259_get_elements)
HXLINE( 260)			HX_VARI(  ::Xml,x) = ( ( ::Xml)(it->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
...
HXLINE( 263)			return  ::haxe::xml::Fast_obj::__alloc( HX_CTX ,x);
            	...
            	HX_STACKFRAME(&_hx_pos_af5e2f0886568b4e_255_get_elements)
            	HX_STACK_THIS(this)
HXLINE( 256)		HX_VARI(  ::Dynamic,it) = this->x->elements();
