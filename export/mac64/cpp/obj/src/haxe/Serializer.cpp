...
HX_DEFINE_STACK_FRAME(_hx_pos_1039146b25bb99c1_101_new,"haxe.Serializer","new",0xcdbbc7ec,"haxe.Serializer.new","/usr/local/lib/haxe/std/haxe/Serializer.hx",101,0xdc8a8f60)
HX_DEFINE_STACK_FRAME(_hx_pos_1039146b25bb99c1_117_toString,"haxe.Serializer","toString",0x95bdfda0,"haxe.Serializer.toString","/usr/local/lib/haxe/std/haxe/Serializer.hx",117,0xdc8a8f60)
HX_DEFINE_STACK_FRAME(_hx_pos_1039146b25bb99c1_153_serializeString,"haxe.Serializer","serializeString",0xd565bc5d,"haxe.Serializer.serializeString","/usr/local/lib/haxe/std/haxe/Serializer.hx",153,0xdc8a8f60)
...
HX_DEFINE_STACK_FRAME(_hx_pos_1039146b25bb99c1_172_serializeRef,"haxe.Serializer","serializeRef",0x0b8ed647,"haxe.Serializer.serializeRef","/usr/local/lib/haxe/std/haxe/Serializer.hx",172,0xdc8a8f60)
static const ::String _hx_array_data_6a6ea1fa_8[] = {
	HX_("r",72,00,00,00),
};
HX_DEFINE_STACK_FRAME(_hx_pos_1039146b25bb99c1_209_serializeFields,"haxe.Serializer","serializeFields",0x44c42205,"haxe.Serializer.serializeFields","/usr/local/lib/haxe/std/haxe/Serializer.hx",209,0xdc8a8f60)
static const ::String _hx_array_data_6a6ea1fa_11[] = {
	HX_("g",67,00,00,00),
};
HX_DEFINE_STACK_FRAME(_hx_pos_1039146b25bb99c1_228_serialize,"haxe.Serializer","serialize",0x3cea866c,"haxe.Serializer.serialize","/usr/local/lib/haxe/std/haxe/Serializer.hx",228,0xdc8a8f60)
...
HX_DEFINE_STACK_FRAME(_hx_pos_1039146b25bb99c1_551_run,"haxe.Serializer","run",0xcdbeded7,"haxe.Serializer.run","/usr/local/lib/haxe/std/haxe/Serializer.hx",551,0xdc8a8f60)
HX_DEFINE_STACK_FRAME(_hx_pos_1039146b25bb99c1_55_boot,"haxe.Serializer","boot",0x2eac2726,"haxe.Serializer.boot","/usr/local/lib/haxe/std/haxe/Serializer.hx",55,0xdc8a8f60)
HX_DEFINE_STACK_FRAME(_hx_pos_1039146b25bb99c1_67_boot,"haxe.Serializer","boot",0x2eac2726,"haxe.Serializer.boot","/usr/local/lib/haxe/std/haxe/Serializer.hx",67,0xdc8a8f60)
HX_DEFINE_STACK_FRAME(_hx_pos_1039146b25bb99c1_69_boot,"haxe.Serializer","boot",0x2eac2726,"haxe.Serializer.boot","/usr/local/lib/haxe/std/haxe/Serializer.hx",69,0xdc8a8f60)
HX_DEFINE_STACK_FRAME(_hx_pos_1039146b25bb99c1_70_boot,"haxe.Serializer","boot",0x2eac2726,"haxe.Serializer.boot","/usr/local/lib/haxe/std/haxe/Serializer.hx",70,0xdc8a8f60)
namespace haxe{

void Serializer_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_1039146b25bb99c1_101_new)
            	HX_STACK_THIS(this)
...
::String Serializer_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_1039146b25bb99c1_117_toString)
            	HX_STACK_THIS(this)
HXLINE( 117)		return this->buf->toString();
            	}
...
void Serializer_obj::serializeString(::String s){
            	HX_STACKFRAME(&_hx_pos_1039146b25bb99c1_153_serializeString)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
...
HXLINE( 157)					HX_VARI_NAME( ::Array< ::String >,_this2,"_this") = _this1->b;
...
HXLINE( 165)		{
HXLINE( 165)			HX_VARI_NAME(  ::StringBuf,_this3,"_this") = this->buf;
...
HXLINE( 167)		{
HXLINE( 167)			HX_VARI_NAME(  ::StringBuf,_this4,"_this") = this->buf;
HXDLIN( 167)			HX_VARI_NAME( int,x1,"x") = s.length;
...
HXLINE( 167)				HX_VARI_NAME( ::Array< ::String >,_this5,"_this") = _this4->b;
HXDLIN( 167)				_this5->push(::Std_obj::string(x1));
            			}
            		}
HXLINE( 168)		{
HXLINE( 168)			HX_VARI_NAME(  ::StringBuf,_this6,"_this") = this->buf;
...
HXLINE( 169)		{
HXLINE( 169)			HX_VARI_NAME(  ::StringBuf,_this7,"_this") = this->buf;
...
HXLINE( 169)				HX_VARI_NAME( ::Array< ::String >,_this8,"_this") = _this7->b;
...
bool Serializer_obj::serializeRef( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_1039146b25bb99c1_172_serializeRef)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
HXLINE( 176)		{
...
HXDLIN( 176)				HX_VARI( int,i) = (_g1 - (int)1);
...
HXLINE( 184)							HX_VARI_NAME( ::Array< ::String >,_this2,"_this") = _this1->b;
...
void Serializer_obj::serializeFields( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_1039146b25bb99c1_209_serializeFields)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
HXLINE( 210)		{
...
void Serializer_obj::serialize( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_1039146b25bb99c1_228_serialize)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
HXLINE( 228)		HX_VARI(  ::ValueType,_g) = ::Type_obj::_hx_typeof(v);
...
HXLINE( 238)						HX_VARI_NAME( ::Array< ::String >,_this4,"_this") = _this3->b;
...
HXLINE( 242)					HX_VARI_NAME(  ::StringBuf,_this5,"_this") = this->buf;
...
HXLINE( 244)						HX_VARI_NAME(  ::StringBuf,_this6,"_this") = this->buf;
HXDLIN( 244)						HX_VAR( ::String,x);
...
HXLINE( 244)							HX_VARI_NAME( ::Array< ::String >,_this7,"_this") = _this6->b;
HXDLIN( 244)							_this7->push(::Std_obj::string(x));
            						}
            					}
            					else {
HXLINE( 246)						{
HXLINE( 246)							HX_VARI_NAME(  ::StringBuf,_this8,"_this") = this->buf;
...
HXLINE( 247)						{
HXLINE( 247)							HX_VARI_NAME(  ::StringBuf,_this9,"_this") = this->buf;
...
HXLINE( 247)								HX_VARI_NAME( ::Array< ::String >,_this10,"_this") = _this9->b;
HXDLIN( 247)								_this10->push(::Std_obj::string(v2));
            			...
            			break;
            			case (int)3: {
HXLINE( 250)				HX_VARI_NAME(  ::StringBuf,_this11,"_this") = this->buf;
HXDLIN( 250)				HX_VAR_NAME( ::String,x1,"x");
...
HXLINE( 250)					HX_VARI_NAME( ::Array< ::String >,_this12,"_this") = _this11->b;
...
HXLINE( 403)						HX_VARI_NAME(  ::StringBuf,_this13,"_this") = this->buf;
...
HXLINE( 405)						HX_VARI_NAME(  ::StringBuf,_this14,"_this") = this->buf;
...
HXLINE( 408)						{
HXLINE( 408)							HX_VARI_NAME(  ::StringBuf,_this15,"_this") = this->buf;
...
HXLINE( 413)						{
HXLINE( 413)							HX_VARI_NAME(  ::StringBuf,_this16,"_this") = this->buf;
...
HXLINE( 261)						{
HXLINE( 261)							HX_VARI_NAME(  ::StringBuf,_this17,"_this") = this->buf;
...
HXDLIN( 266)								HX_VARI( int,i) = (_g1 - (int)1);
...
HXLINE( 272)											HX_VARI_NAME(  ::StringBuf,_this18,"_this") = this->buf;
...
HXLINE( 274)											{
HXLINE( 274)												HX_VARI_NAME(  ::StringBuf,_this19,"_this") = this->buf;
...
HXLINE( 275)											{
HXLINE( 275)												HX_VARI_NAME(  ::StringBuf,_this20,"_this") = this->buf;
...
HXLINE( 275)													HX_VARI_NAME( ::Array< ::String >,_this21,"_this") = _this20->b;
...
HXLINE( 284)								HX_VARI_NAME(  ::StringBuf,_this22,"_this") = this->buf;
...
HXLINE( 286)								{
HXLINE( 286)									HX_VARI_NAME(  ::StringBuf,_this23,"_this") = this->buf;
...
HXLINE( 287)								{
HXLINE( 287)									HX_VARI_NAME(  ::StringBuf,_this24,"_this") = this->buf;
...
HXLINE( 287)										HX_VARI_NAME( ::Array< ::String >,_this25,"_this") = _this24->b;
...
HXLINE( 290)						{
HXLINE( 290)							HX_VARI_NAME(  ::StringBuf,_this26,"_this") = this->buf;
...
HXLINE( 299)						{
HXLINE( 299)							HX_VARI_NAME(  ::StringBuf,_this27,"_this") = this->buf;
...
HXLINE( 300)						{
HXLINE( 300)							HX_VARI_NAME(  ::StringBuf,_this28,"_this") = this->buf;
HXDLIN( 300)							HX_VARI_NAME( Float,x2,"x") = ( ( ::Date)(v) )->getTime();
...
HXLINE( 300)								HX_VARI_NAME( ::Array< ::String >,_this29,"_this") = _this28->b;
...
HXLINE( 292)						{
HXLINE( 292)							HX_VARI_NAME(  ::StringBuf,_this30,"_this") = this->buf;
...
HXLINE( 294)						{
HXLINE( 294)							HX_VARI(  ::_List::ListNode,_g_head) = ( ( ::List)(v) )->h;
HXDLIN( 294)							while(hx::IsNotNull( _g_head )){
HXLINE( 294)								HX_VARI(  ::Dynamic,val) = _g_head->item;
HXDLIN( 294)								_g_head = _g_head->next;
HXLINE( 295)								this->serialize(val);
            							}
            						}
HXLINE( 296)						{
HXLINE( 296)							HX_VARI_NAME(  ::StringBuf,_this31,"_this") = this->buf;
...
HXLINE( 310)						{
HXLINE( 310)							HX_VARI_NAME(  ::StringBuf,_this32,"_this") = this->buf;
...
HXLINE( 311)						HX_VARI_NAME(  ::haxe::ds::IntMap,v3,"v") = ( ( ::haxe::ds::IntMap)(v) );
HXLINE( 312)						{
HXLINE( 312)							HX_VARI(  ::Dynamic,k) = v3->keys();
HXDLIN( 312)							while(( (bool)(k->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 312)								HX_VARI_NAME( int,k1,"k") = ( (int)(k->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 313)								{
HXLINE( 313)									HX_VARI_NAME(  ::StringBuf,_this33,"_this") = this->buf;
...
HXLINE( 314)								{
HXLINE( 314)									HX_VARI_NAME(  ::StringBuf,_this34,"_this") = this->buf;
...
HXLINE( 314)										HX_VARI_NAME( ::Array< ::String >,_this35,"_this") = _this34->b;
HXDLIN( 314)										_this35->push(::Std_obj::string(k1));
            									}
            								}
HXLINE( 315)								this->serialize(v3->get(k1));
            							}
            						}
HXLINE( 317)						{
HXLINE( 317)							HX_VARI_NAME(  ::StringBuf,_this36,"_this") = this->buf;
...
HXLINE( 319)						{
HXLINE( 319)							HX_VARI_NAME(  ::StringBuf,_this37,"_this") = this->buf;
...
HXLINE( 320)						HX_VARI_NAME(  ::haxe::ds::ObjectMap,v4,"v") = ( ( ::haxe::ds::ObjectMap)(v) );
HXLINE( 321)						{
HXLINE( 321)							HX_VARI_NAME(  ::Dynamic,k2,"k") = v4->keys();
HXDLIN( 321)							while(( (bool)(k2->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 321)								HX_VARI_NAME(  ::Dynamic,k3,"k") = k2->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)();
HXLINE( 328)								this->serialize(k3);
HXLINE( 330)								this->serialize(v4->get(k3));
            							}
            						}
HXLINE( 332)						{
HXLINE( 332)							HX_VARI_NAME(  ::StringBuf,_this38,"_this") = this->buf;
...
HXLINE( 302)						{
HXLINE( 302)							HX_VARI_NAME(  ::StringBuf,_this39,"_this") = this->buf;
...
HXLINE( 303)						HX_VARI_NAME(  ::haxe::ds::StringMap,v5,"v") = ( ( ::haxe::ds::StringMap)(v) );
HXLINE( 304)						{
HXLINE( 304)							HX_VARI_NAME(  ::Dynamic,k4,"k") = v5->keys();
HXDLIN( 304)							while(( (bool)(k4->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 304)								HX_VARI_NAME( ::String,k5,"k") = ( (::String)(k4->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 305)								this->serializeString(k5);
HXLINE( 306)								this->serialize(v5->get(k5));
            							}
            						}
HXLINE( 308)						{
HXLINE( 308)							HX_VARI_NAME(  ::StringBuf,_this40,"_this") = this->buf;
...
HXLINE( 334)						HX_VARI_NAME(  ::haxe::io::Bytes,v6,"v") = ( ( ::haxe::io::Bytes)(v) );
HXLINE( 343)						{
HXLINE( 343)							HX_VARI_NAME(  ::StringBuf,_this41,"_this") = this->buf;
...
HXLINE( 344)						{
HXLINE( 344)							HX_VARI_NAME(  ::StringBuf,_this42,"_this") = this->buf;
HXDLIN( 344)							HX_VARI_NAME( int,x3,"x") = ::Math_obj::ceil(((Float)(v6->length * (int)8) / (Float)(int)6));
...
HXLINE( 344)								HX_VARI_NAME( ::Array< ::String >,_this43,"_this") = _this42->b;
HXDLIN( 344)								_this43->push(::Std_obj::string(x3));
            							}
            						}
HXLINE( 345)						{
HXLINE( 345)							HX_VARI_NAME(  ::StringBuf,_this44,"_this") = this->buf;
...
HXLINE( 348)						HX_VARI( int,max) = (v6->length - (int)2);
HXLINE( 349)						HX_VARI( ::Array< ::Dynamic>,b64) = ::haxe::Serializer_obj::BASE64_CODES;
HXLINE( 350)						if (hx::IsNull( b64 )) {
HXLINE( 351)							b64 = ::Array_obj< ::Dynamic>::__new(::haxe::Serializer_obj::BASE64.length);
HXLINE( 352)							{
...
HXDLIN( 352)									HX_VARI_NAME( int,i2,"i") = (_g11 - (int)1);
HXLINE( 353)									{
...
HXLINE( 357)							i1 = (i1 + (int)1);
HXDLIN( 357)							HX_VARI( int,b1) = v6->b->__get((i1 - (int)1));
HXLINE( 358)							i1 = (i1 + (int)1);
HXDLIN( 358)							HX_VARI( int,b2) = v6->b->__get((i1 - (int)1));
HXLINE( 359)							i1 = (i1 + (int)1);
HXDLIN( 359)							HX_VARI( int,b3) = v6->b->__get((i1 - (int)1));
HXLINE( 361)							{
HXLINE( 361)								HX_VARI_NAME(  ::StringBuf,_this45,"_this") = this->buf;
...
HXLINE( 362)							{
HXLINE( 362)								HX_VARI_NAME(  ::StringBuf,_this46,"_this") = this->buf;
...
HXLINE( 363)							{
HXLINE( 363)								HX_VARI_NAME(  ::StringBuf,_this47,"_this") = this->buf;
...
HXLINE( 364)							{
HXLINE( 364)								HX_VARI_NAME(  ::StringBuf,_this48,"_this") = this->buf;
...
HXLINE( 367)							i1 = (i1 + (int)1);
HXDLIN( 367)							HX_VARI_NAME( int,b11,"b1") = v6->b->__get((i1 - (int)1));
HXLINE( 368)							i1 = (i1 + (int)1);
HXDLIN( 368)							HX_VARI_NAME( int,b21,"b2") = v6->b->__get((i1 - (int)1));
HXLINE( 369)							{
HXLINE( 369)								HX_VARI_NAME(  ::StringBuf,_this49,"_this") = this->buf;
...
HXLINE( 370)							{
HXLINE( 370)								HX_VARI_NAME(  ::StringBuf,_this50,"_this") = this->buf;
...
HXLINE( 371)							{
HXLINE( 371)								HX_VARI_NAME(  ::StringBuf,_this51,"_this") = this->buf;
...
HXLINE( 373)								i1 = (i1 + (int)1);
HXDLIN( 373)								HX_VARI_NAME( int,b12,"b1") = v6->b->__get((i1 - (int)1));
HXLINE( 374)								{
HXLINE( 374)									HX_VARI_NAME(  ::StringBuf,_this52,"_this") = this->buf;
...
HXLINE( 375)								{
HXLINE( 375)									HX_VARI_NAME(  ::StringBuf,_this53,"_this") = this->buf;
...
HXLINE( 381)							{
HXLINE( 381)								HX_VARI_NAME(  ::StringBuf,_this54,"_this") = this->buf;
...
HXLINE( 385)							{
HXLINE( 385)								HX_VARI_NAME(  ::StringBuf,_this55,"_this") = this->buf;
...
HXLINE( 387)							{
HXLINE( 387)								HX_VARI_NAME(  ::StringBuf,_this56,"_this") = this->buf;
...
HXLINE( 422)				{
HXLINE( 422)					HX_VARI_NAME(  ::StringBuf,_this57,"_this") = this->buf;
HXDLIN( 422)					HX_VAR_NAME( ::String,x4,"x");
...
HXLINE( 422)						HX_VARI_NAME( ::Array< ::String >,_this58,"_this") = _this57->b;
HXDLIN( 422)						_this58->push(::Std_obj::string(x4));
            					}
            				}
HXLINE( 423)				this->serializeString(::Type_obj::getEnumName(_g->_hx_getObject(0).StaticCast< hx::Class >()));
HXLINE( 456)				HX_VARI(  ::hx::EnumBase,enumBase) = ( ( ::hx::EnumBase)(v) );
HXLINE( 457)				if (this->useEnumIndex) {
HXLINE( 458)					{
HXLINE( 458)						HX_VARI_NAME(  ::StringBuf,_this59,"_this") = this->buf;
...
HXLINE( 459)					{
HXLINE( 459)						HX_VARI_NAME(  ::StringBuf,_this60,"_this") = this->buf;
HXDLIN( 459)						HX_VARI_NAME( int,x5,"x") = enumBase->_hx_getIndex();
...
HXLINE( 459)							HX_VARI_NAME( ::Array< ::String >,_this61,"_this") = _this60->b;
...
HXLINE( 462)				{
HXLINE( 462)					HX_VARI_NAME(  ::StringBuf,_this62,"_this") = this->buf;
...
HXLINE( 464)				{
HXLINE( 464)					HX_VARI_NAME(  ::StringBuf,_this63,"_this") = this->buf;
...
HXLINE( 464)						HX_VARI_NAME( ::Array< ::String >,_this64,"_this") = _this63->b;
...
HXLINE( 466)						this->serialize(enumBase->_hx_getParamI((_g12 - (int)1)));
            					}
            				}
HXLINE( 511)				if (this->useCache) {
HXLINE( 511)					this->cache->push(v);
            				}
            			}
            			break;
            			default:{
HXLINE( 522)				HX_STACK_DO_THROW((HX_("Cannot serialize ",1d,48,c9,ed) + ::Std_obj::string(v)));
            			}
            		}
            	}
...
::String Serializer_obj::run( ::Dynamic v){
            	HX_GC_STACKFRAME(&_hx_pos_1039146b25bb99c1_551_run)
            	HX_STACK_ARG(v,"v")
HXLINE( 552)		HX_VARI(  ::haxe::Serializer,s) =  ::haxe::Serializer_obj::__alloc( HX_CTX );
...
{
{
            	HX_STACKFRAME(&_hx_pos_1039146b25bb99c1_55_boot)
HXLINE(  55)		USE_CACHE = false;
            	}
{
            	HX_STACKFRAME(&_hx_pos_1039146b25bb99c1_67_boot)
HXLINE(  67)		USE_ENUM_INDEX = false;
            	}
{
            	HX_STACKFRAME(&_hx_pos_1039146b25bb99c1_69_boot)
