...
HX_DEFINE_STACK_FRAME(_hx_pos_5c4f2394ea68a40f_33_execute,"haxe.zip.Uncompress","execute",0xb3589a97,"haxe.zip.Uncompress.execute","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Uncompress.hx",33,0x2e2bbf2e)
HX_DEFINE_STACK_FRAME(_hx_pos_5c4f2394ea68a40f_37_setFlushMode,"haxe.zip.Uncompress","setFlushMode",0xbecba0a3,"haxe.zip.Uncompress.setFlushMode","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Uncompress.hx",37,0x2e2bbf2e)
HX_DEFINE_STACK_FRAME(_hx_pos_5c4f2394ea68a40f_41_close,"haxe.zip.Uncompress","close",0x4cc86b9a,"haxe.zip.Uncompress.close","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Uncompress.hx",41,0x2e2bbf2e)
HX_DEFINE_STACK_FRAME(_hx_pos_5c4f2394ea68a40f_44_run,"haxe.zip.Uncompress","run",0x34f61ead,"haxe.zip.Uncompress.run","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Uncompress.hx",44,0x2e2bbf2e)
namespace haxe{
namespace zip{
...
HXLINE(  45)		HX_VARI(  ::haxe::zip::Uncompress,u) =  ::haxe::zip::Uncompress_obj::__alloc( HX_CTX ,null());
...
HXLINE(  48)		HX_VARI(  ::haxe::io::BytesBuffer,b) =  ::haxe::io::BytesBuffer_obj::__alloc( HX_CTX );
...
HXDLIN(  53)						b->b->push(b2->__get((_g1 - (int)1)));
            					}
            				}
            			}
