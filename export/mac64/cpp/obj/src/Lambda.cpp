...
HX_DEFINE_STACK_FRAME(_hx_pos_a2b9229e56451ffa_44_array,"Lambda","array",0x9c8b0512,"Lambda.array","/usr/local/lib/haxe/std/Lambda.hx",44,0xf61dfe9a)
HX_DEFINE_STACK_FRAME(_hx_pos_a2b9229e56451ffa_124_has,"Lambda","has",0x3d8bd693,"Lambda.has","/usr/local/lib/haxe/std/Lambda.hx",124,0xf61dfe9a)
...
::cpp::VirtualArray Lambda_obj::array( ::Dynamic it){
            	HX_STACKFRAME(&_hx_pos_a2b9229e56451ffa_44_array)
            	HX_STACK_ARG(it,"it")
HXLINE(  45)		HX_VARI( ::cpp::VirtualArray,a) = ::cpp::VirtualArray_obj::__new();
HXLINE(  46)		{
HXLINE(  46)			HX_VARI(  ::Dynamic,i) = it->__Field(HX_("iterator",ee,49,9a,93),hx::paccDynamic)();
HXDLIN(  46)			while(( (bool)(i->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(  47)				a->push(i->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)());
            			}
            		}
HXLINE(  48)		return a;
            	}
...
HXLINE( 125)		{
HXLINE( 125)			HX_VARI(  ::Dynamic,x) = it->__Field(HX_("iterator",ee,49,9a,93),hx::paccDynamic)();
HXDLIN( 125)			while(( (bool)(x->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 126)				if (hx::IsEq( x->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)(),elt )) {
