...
HX_DEFINE_STACK_FRAME(_hx_pos_69fa5d54d4b87a01_32_new,"sys.io.FileOutput","new",0x19e22a16,"sys.io.FileOutput.new","/usr/local/lib/haxe/std/cpp/_std/sys/io/FileOutput.hx",32,0xfd4d01fc)
HX_DEFINE_STACK_FRAME(_hx_pos_69fa5d54d4b87a01_36_writeByte,"sys.io.FileOutput","writeByte",0x887099bd,"sys.io.FileOutput.writeByte","/usr/local/lib/haxe/std/cpp/_std/sys/io/FileOutput.hx",36,0xfd4d01fc)
HX_DEFINE_STACK_FRAME(_hx_pos_69fa5d54d4b87a01_40_writeBytes,"sys.io.FileOutput","writeBytes",0xda15ec16,"sys.io.FileOutput.writeBytes","/usr/local/lib/haxe/std/cpp/_std/sys/io/FileOutput.hx",40,0xfd4d01fc)
HX_DEFINE_STACK_FRAME(_hx_pos_69fa5d54d4b87a01_47_close,"sys.io.FileOutput","close",0xa583caee,"sys.io.FileOutput.close","/usr/local/lib/haxe/std/cpp/_std/sys/io/FileOutput.hx",47,0xfd4d01fc)
namespace sys{
namespace io{

void FileOutput_obj::__construct( ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_69fa5d54d4b87a01_32_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(f,"f")
...
void FileOutput_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_69fa5d54d4b87a01_36_writeByte)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(c,"c")
HXLINE(  36)		try {
...
int FileOutput_obj::writeBytes( ::haxe::io::Bytes s,int p,int l){
            	HX_STACKFRAME(&_hx_pos_69fa5d54d4b87a01_40_writeBytes)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
            	HX_STACK_ARG(p,"p")
            	HX_STACK_ARG(l,"l")
...
void FileOutput_obj::close(){
            	HX_STACKFRAME(&_hx_pos_69fa5d54d4b87a01_47_close)
            	HX_STACK_THIS(this)
