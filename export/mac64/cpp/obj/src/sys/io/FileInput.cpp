...
HX_DEFINE_STACK_FRAME(_hx_pos_1cbd96634e6b00f3_32_new,"sys.io.FileInput","new",0x565591b9,"sys.io.FileInput.new","/usr/local/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",32,0x0a6b0235)
HX_DEFINE_STACK_FRAME(_hx_pos_1cbd96634e6b00f3_36_readByte,"sys.io.FileInput","readByte",0x25e0b585,"sys.io.FileInput.readByte","/usr/local/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",36,0x0a6b0235)
HX_DEFINE_STACK_FRAME(_hx_pos_1cbd96634e6b00f3_57_close,"sys.io.FileInput","close",0x735aa151,"sys.io.FileInput.close","/usr/local/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",57,0x0a6b0235)
namespace sys{
namespace io{

void FileInput_obj::__construct( ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_1cbd96634e6b00f3_32_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(f,"f")
...
int FileInput_obj::readByte(){
            	HX_GC_STACKFRAME(&_hx_pos_1cbd96634e6b00f3_36_readByte)
            	HX_STACK_THIS(this)
HXLINE(  36)		try {
...
void FileInput_obj::close(){
            	HX_STACKFRAME(&_hx_pos_1cbd96634e6b00f3_57_close)
            	HX_STACK_THIS(this)
