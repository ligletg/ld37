...
HX_DEFINE_STACK_FRAME(_hx_pos_4ebd30807fe7ed8d_31_exists,"sys.FileSystem","exists",0xf55bed9e,"sys.FileSystem.exists","/usr/local/lib/haxe/std/cpp/_std/sys/FileSystem.hx",31,0x1f6d7d6f)
HX_DEFINE_STACK_FRAME(_hx_pos_4ebd30807fe7ed8d_38_stat,"sys.FileSystem","stat",0xa630df16,"sys.FileSystem.stat","/usr/local/lib/haxe/std/cpp/_std/sys/FileSystem.hx",38,0x1f6d7d6f)
HX_DEFINE_STACK_FRAME(_hx_pos_4ebd30807fe7ed8d_49_fullPath,"sys.FileSystem","fullPath",0xc6463316,"sys.FileSystem.fullPath","/usr/local/lib/haxe/std/cpp/_std/sys/FileSystem.hx",49,0x1f6d7d6f)
HX_DEFINE_STACK_FRAME(_hx_pos_4ebd30807fe7ed8d_65_createDirectory,"sys.FileSystem","createDirectory",0x63bad3cf,"sys.FileSystem.createDirectory","/usr/local/lib/haxe/std/cpp/_std/sys/FileSystem.hx",65,0x1f6d7d6f)
HX_DEFINE_STACK_FRAME(_hx_pos_4ebd30807fe7ed8d_80_deleteFile,"sys.FileSystem","deleteFile",0x4bd48509,"sys.FileSystem.deleteFile","/usr/local/lib/haxe/std/cpp/_std/sys/FileSystem.hx",80,0x1f6d7d6f)
namespace sys{
...
::String FileSystem_obj::fullPath(::String relPath){
            	HX_STACKFRAME(&_hx_pos_4ebd30807fe7ed8d_49_fullPath)
...
void FileSystem_obj::createDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_4ebd30807fe7ed8d_65_createDirectory)
            	HX_STACK_ARG(path,"path")
...
void FileSystem_obj::deleteFile(::String path){
            	...
            	HX_STACK_ARG(path,"path")
HXLINE(  80)		_hx_std_file_delete(path);
            	}
