...
HX_DEFINE_STACK_FRAME(_hx_pos_8e4589df03e4f3cc_31_getTime,"Date","getTime",0x0cac7da3,"Date.getTime","/usr/local/lib/haxe/std/cpp/_std/Date.hx",31,0xd1a513ee)
HX_DEFINE_STACK_FRAME(_hx_pos_8e4589df03e4f3cc_51_now,"Date","now",0x9aa26af6,"Date.now","/usr/local/lib/haxe/std/cpp/_std/Date.hx",51,0xd1a513ee)
HX_DEFINE_STACK_FRAME(_hx_pos_8e4589df03e4f3cc_54_new1,"Date","new1",0xb37395f1,"Date.new1","/usr/local/lib/haxe/std/cpp/_std/Date.hx",54,0xd1a513ee)
HX_DEFINE_STACK_FRAME(_hx_pos_8e4589df03e4f3cc_57_fromTime,"Date","fromTime",0x44fd3cb7,"Date.fromTime","/usr/local/lib/haxe/std/cpp/_std/Date.hx",57,0xd1a513ee)
HX_DEFINE_STACK_FRAME(_hx_pos_8e4589df03e4f3cc_64_fromString,"Date","fromString",0x5ead97fb,"Date.fromString","/usr/local/lib/haxe/std/cpp/_std/Date.hx",64,0xd1a513ee)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Date_obj,now,return )
 ...
 ::Date Date_obj::new1( ::Dynamic t){
            	...
            	HX_STACK_ARG(t,"t")
HXLINE(  54)		return  ::Date_obj::__alloc( HX_CTX ,(int)2005,(int)1,(int)1,(int)0,(int)0,(int)0);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Date_obj,fromTime,return )
 ...
 ::Date Date_obj::fromString(::String s){
            	...
            	HX_STACK_ARG(s,"s")
HXLINE(  64)		switch((int)(s.length)){
            			case (int)8: {
HXLINE(  66)				HX_VARI( ::Array< ::String >,k) = s.split(HX_(":",3a,00,00,00));
HXLINE(  67)				HX_VARI(  ::Dynamic,d) = ::Std_obj::parseInt(k->__get((int)0));
HXDLIN(  67)				HX_VARI_NAME(  ::Dynamic,d1,"d") = ::Std_obj::parseInt(k->__get((int)1));
HXLINE(  68)				return  ::Date_obj::__alloc( HX_CTX ,(int)0,(int)0,(int)0,d,d1,::Std_obj::parseInt(k->__get((int)2)));
            			}
            			break;
            			case (int)10: {
